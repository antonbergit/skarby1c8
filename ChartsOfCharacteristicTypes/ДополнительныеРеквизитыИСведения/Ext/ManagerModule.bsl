...
"Набор свойств %2 не связан ни с одним владельцем значений свойств.';uk='Помилка при зміні налаштування властивості %1."
"Набір властивостей %2 не зв`язаний з жодним власником значень властивостей.'"),
		...
		ИначеЕсли Свойство = СвойствоОбъект.Ссылка Тогда
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Ошибка при изменении настройки свойства %1."
"Тип значения не содержит дополнительных значений.';uk='Помилка при зміні налаштування властивості %1."
