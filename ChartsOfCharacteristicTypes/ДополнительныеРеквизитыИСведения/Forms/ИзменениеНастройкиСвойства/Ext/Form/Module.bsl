...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ЭтоДополнительноеСведение Тогда
		...
		Заголовок = НСтр("ru='Изменить настройку дополнительного сведения';uk='Змінити налаштування додаткової відомості'");
	Иначе
...
Процедура ЗаписатьНачало()
	...
	Состояние(НСтр("ru='Выполняется изменение настройки свойства. Пожалуйста, подождите';uk='Виконується зміна налаштування властивості. Будь ласка, почекайте'"));
...
Функция ЗаписатьНаСервере()
	...
	НаименованиеЗадания = НСтр("ru='Изменение настройки дополнительного свойства';uk='Зміна налаштування додаткової властивості'");
