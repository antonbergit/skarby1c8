...
"%1"
"';uk='Спроба завантаження стандартних значень з рядка (перші 2000 символів):"
"%1"
"'"),
							Лев(СтрокаСтандартныхЗначений, 2000));
					ЧтениеХМЛ = Новый ЧтениеXML;
					ЧтениеХМЛ.УстановитьСтроку(СтрокаСтандартныхЗначений);
					ЧтениеХМЛ.Прочитать();
				Исключение
...
"%1"
"';uk='Помилка завантаження стандартних значень з рядка через:"
"%1"
"'"),
...
"%ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%';uk='Не вдалося записати об`єкт метаданих через:"
"%ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%'");
		...
		СтрокаЛогаЗагрузки = СтрокаЛогаЗагрузки + ". "
			+ СтрШаблон(
				НСтр("ru='Произошла ошибка записи: %1';uk='Произошла ошибка записи: %1'"),
					ПодробноеПредставлениеОшибки(ИнформацияОбОшибке));
	КонецПопытки;
