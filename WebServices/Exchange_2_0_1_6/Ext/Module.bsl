...
Процедура ПроверитьБлокировкуИнформационнойБазыДляОбновления()
	...
	Если ЗначениеЗаполнено(ОбновлениеИнформационнойБазыСлужебный.ИнформационнаяБазаЗаблокированаДляОбновления()) Тогда
		...
		ВызватьИсключение НСтр("ru='Синхронизация данных временно недоступна в связи с обновлением приложения в Интернете.';uk='Синхронізація даних тимчасово недоступна у зв`язку з відновленням додатка в Інтернеті.'");
...
Функция КлючФоновогоЗаданияВыгрузкиЗагрузкиДанных(ПланОбмена, КодУзла)
	...
	Ключ = НСтр("ru='ПланОбмена:[ПланОбмена] КодУзла:[КодУзла]';uk='ПланОбмена:[ПланОбмена] КодУзла:[КодУзла]'");
