...
"не вказано в аналізованому типі ""Значення доступу"".'");
...
"в определяемом типе ""Значение доступа с группами значений доступа объект"".';uk='Тип значення доступу ""%1"", що використовує групи значень, не зазначений"
"в обумовленому типі ""Значення доступу із групами значень доступу об`єкт"".'"),
			Строка(ТипОбъекта));
	КонецЕсли;
...
"не указан в определяемом типе ""Значение доступа"".';uk='Тип значень доступу ""%1"" виду доступу ""%2"""
