					...
					Исключение
						Если Не СтруктураРеквизитовФормы.мАвтоВыборКодов Тогда
							...
							Если ЗначениеЗаполнено(ПолеТабличногоДокументаФормаОтчета.Области["П000005000101_" + Суффикс].Значение) Тогда
								Сообщение = Новый СообщениеПользователю;
								Сообщение.Текст = НСтр("ru='Не найдена единица измерения для наименования продукции, указанной в графе 1 раздела 5!';uk='Не найдена единица измерения для наименования продукции, указанной в графе 1 раздела 5!'");
								Сообщение.Сообщить();
							Иначе
								Сообщение = Новый СообщениеПользователю;
								Сообщение.Текст = НСтр("ru='Не указано наименование продукции в графе 1 раздела 5 для выбора единицы измерения!';uk='Не указано наименование продукции в графе 1 раздела 5 для выбора единицы измерения!'");
								Сообщение.Сообщить();
							КонецЕсли;
							СтандартнаяОбработка = Ложь;
						КонецЕсли;
