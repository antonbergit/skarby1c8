...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость в валюте (кратко)"].Теги = НСТР("ru='Взаиморасчеты,Долги,Авансы,Контрагенты,Покупатели,Поставщики,Валюты';uk='Взаєморозрахунки,Борги,Аванси,Контрагенти,Покупці,Постачальники,Валюти'");
