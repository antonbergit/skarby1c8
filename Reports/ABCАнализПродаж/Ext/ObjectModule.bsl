...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если СуммаПроцентов <> 100 Тогда
		ВызватьИсключение НСтр("ru='Сумма процентов критериев распределения по АВС-классам должна быть равна 100%';uk='Сума відсотків критеріїв розподілу по АВС-класам повинна бути рівна 100%'");
	КонецЕсли; 
...
Функция ПодготовитьПараметрыОтчета(НастройкиОтчета)
	...
	Заголовок = НСтр("ru='ABC-анализ продаж';uk='ABC-аналіз продажів'");
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["ABCанализПродажПоНоменклатуре"].Теги = НСтр("ru='Номенклатура,Продажи';uk='Номенклатура,Продажі'");
	НастройкиВариантов["ABCанализПродажПоКатегориямНоменклатуры"].Теги = НСтр("ru='Категории,Продажи';uk='Категорії,Продажі'");
	НастройкиВариантов["ABCанализПродажПоПокупателям"].Теги = НСтр("ru='Покупатели,Контрагенты,Продажи';uk='Покупці,Контрагенти,Продажі'");
	НастройкиВариантов["ABCанализПродажПоМенеджерам"].Теги = НСтр("ru='Менеджеры,Сотрудники,Продажи';uk='Менеджери,Співробітники,Продажі'");
