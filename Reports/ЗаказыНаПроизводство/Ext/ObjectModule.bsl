...
Процедура ПриКонтекстномОткрытии(СсылкаНаОбъект, ПолеСвязи, Отборы) Экспорт
	
	Если ПолеСвязи = "ЗаказНаПроизводство" Тогда
		Отборы.Вставить(ПолеСвязи, ОбщегоНазначения.ЗначениеРеквизитаОбъекта(СсылкаНаОбъект, "ЗаказНаПроизводство"));
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСТР("ru='Производство,Заказы,Продукция';uk='Виробництво,Замовлення,Продукція'");
	НастройкиВариантов["Остатки"].Теги = НСТР("ru='Производство,Заказы,Продукция';uk='Виробництво,Замовлення,Продукція'");
