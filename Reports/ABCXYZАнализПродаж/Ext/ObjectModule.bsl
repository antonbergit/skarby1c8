...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["ABCXYZанализПродажПоНоменклатуре"].Теги = НСТР("ru='Номенклатура,Продажи';uk='Номенклатура,Продажі'");
	НастройкиВариантов["ABCXYZанализПродажПоКатегориямНоменклатуры"].Теги = НСТР("ru='Категории,Продажи';uk='Категорії,Продажі'");
	НастройкиВариантов["ABCXYZанализПродажПоПокупателям"].Теги = НСТР("ru='Покупатели,Контрагенты,Продажи';uk='Покупці,Контрагенти,Продажі'");
	НастройкиВариантов["ABCXYZанализПродажПоМенеджерам"].Теги = НСТР("ru='Менеджеры,Сотрудники,Продажи';uk='Менеджери,Співробітники,Продажі'");
...
Функция ПолучитьРезультатРаспределения(ПараметрыОтчета)
	...
	ПараметрПериодичностьПредставление = Строка(ПараметрыОтчета.Периодичность);	
		
    Если ПараметрыОтчета.Периодичность = Перечисления.Периодичность.Неделя Тогда
		ПараметрПериодичностьПредставление = "Неделя";
	ИначеЕсли ПараметрыОтчета.Периодичность = Перечисления.Периодичность.Месяц Тогда
		ПараметрПериодичностьПредставление = "Месяц";
	ИначеЕсли ПараметрыОтчета.Периодичность = Перечисления.Периодичность.Год Тогда
		ПараметрПериодичностьПредставление = "Год";
	ИначеЕсли ПараметрыОтчета.Периодичность = Перечисления.Периодичность.Полугодие Тогда
	...
	Если Не ЕстьХарактеристики Тогда
		...
		|ПО
		|	ПродажиОбороты.Период ПЕРИОДАМИ("+ВРег(ПараметрПериодичностьПредставление)+", &НачалоПериода, &КонецПериода),
