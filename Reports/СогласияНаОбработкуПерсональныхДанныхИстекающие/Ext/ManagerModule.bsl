...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиОтчета.Описание = НСтр("ru='Согласия на обработку персональных данных, срок действия которых истекает.';uk='Згоди на обробку персональних даних, термін дії яких минає.'");
	
	НастройкиВарианта = МодульВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ИстекающиеСогласия");
	НастройкиВарианта.Описание = НСтр("ru='Согласия, срок действия которых истекает в заданном периоде.';uk='Згоди, термін дії яких минає в заданому періоді.'");
КонецПроцедуры
