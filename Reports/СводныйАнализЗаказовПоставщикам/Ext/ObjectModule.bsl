...
Процедура ОбновитьНастройкиНаФорме(НастройкиОтчета, НастройкиСКД, Форма) Экспорт
	...
	НСтр("ru='Состояние поступления';uk='Стан надходження'"),
	"Все заказы,Непоступившие,Поступившие частично,Поступившие полностью",
	"Все заказы");
...
Процедура ЗаполнитьПредопределенныеВариантыОформления(НастройкиВариантов)
	...
	Для каждого НастройкиТекВарианта Из НастройкиВариантов Цикл
		...
		ВариантыОформления,
		"ОсталосьЗакупить,Поступило,РазмещеноВЗаказах,Заказано");
		
		ОтчетыУНФ.ДобавитьВариантыОформленияСумм(
		ВариантыОформления,
		"Оплачено,ОсталосьОплатить,СуммаДокумента,Оплачено");
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	Для Каждого НастройкиТекВарианта Из НастройкиВариантов Цикл
		НастройкиТекВарианта.Значение.Теги = НСтр("ru='Запасы,Закупки,Заказы,Контрагенты,Поставщики,Номенклатура,Поступления,Оплаты';uk='Запаси,Закупівлі,Замовлення,Контрагенти,Постачальники,Номенклатура,Надходження,Оплати'");
	КонецЦикла;
