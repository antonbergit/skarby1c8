...
Процедура ЗакрытьФорму(Команда)
	...
	Если Модифицированность Тогда
		...
		ТекстВопроса = НСтр("ru='Состав дополнительных строк был изменен. Сохранить изменения?';uk='Состав дополнительных строк был изменен. Сохранить изменения?'");
...
"иначе изменения будут утеряны.';uk='Состав дополнительных строк был изменен."
"Перед завершением работы рекомендуется сохранить новый состав,"
