...
"требуется наличие совместно подключенных профилей ""Продажи"" и ""Закупки"".';uk='Недостаточно прав для формирования отчета:"
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСТР("ru='Главное,Продажи,CRM,Номенклатура,Выручка';uk='Головне,Продажі,CRM,Номенклатура,Виручка'");
	НастройкиВариантов["ВаловаяПрибыль"].Теги = НСТР("ru='Продажи,CRM,Номенклатура,Выручка,Себестоимость,Прибыль,Рентабельность,Маржа';uk='Продажи,CRM,Номенклатура,Выручка,Себестоимость,Прибыль,Рентабельность,Маржа'");
	НастройкиВариантов["ВаловаяПрибыльПоКатегориямНоменклатуры"].Теги = НСТР("ru='Продажи,CRM,Категории,Выручка,Себестоимость,Прибыль,Рентабельность,Маржа';uk='Продажи,CRM,Категории,Выручка,Себестоимость,Прибыль,Рентабельность,Маржа'");
	НастройкиВариантов["ВаловаяПрибыльПоПокупателям"].Теги = НСТР("ru='Продажи,CRM,Контрагенты,Покупатели,Выручка,Себестоимость,Прибыль,Рентабельность,Маржа';uk='Продажи,CRM,Контрагенты,Покупатели,Выручка,Себестоимость,Прибыль,Рентабельность,Маржа'");
	НастройкиВариантов["ВаловаяПрибыльПоМенеджерам"].Теги = НСТР("ru='Продажи,CRM,Менеджеры,Выручка,Себестоимость,Прибыль,Рентабельность,Маржа';uk='Продажи,CRM,Менеджеры,Выручка,Себестоимость,Прибыль,Рентабельность,Маржа'");
	НастройкиВариантов["ДинамикаПродаж"].Теги = НСТР("ru='Продажи,CRM';uk='Продажи,CRM'");
	НастройкиВариантов["ДинамикаПродажПоНоменклатуре"].Теги = НСТР("ru='Продажи,CRM,Выручка,Номенклатура';uk='Продажи,CRM,Выручка,Номенклатура'");
	НастройкиВариантов["ДинамикаПродажПоКатегориямНоменклатуры"].Теги = НСТР("ru='Продажи,Выручка,Категории';uk='Продажі,Виторг,Категорії'");
	НастройкиВариантов["ДинамикаПродажПоПокупателям"].Теги = НСТР("ru='Продажи,CRM,Выручка,Контрагенты,Покупатели';uk='Продажи,CRM,Выручка,Контрагенты,Покупатели'");
	НастройкиВариантов["ДинамикаПродажПоМенеджерам"].Теги = НСТР("ru='Продажи,CRM,Выручка,Менеджеры';uk='Продажи,CRM,Выручка,Менеджеры'");
...
Процедура УстановитьЗаголовокКолонкиВыручка()
	...
	ПолеСумма.Заголовок = НСтр("ru='Сумма';uk='Сума'");
