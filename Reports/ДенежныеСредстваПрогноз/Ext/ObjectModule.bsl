...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСТР("ru='Компания,Деньги,План,Факт';uk='Компанія,Гроші,План,Факт'");
	НастройкиВариантов["ВВалюте"].Теги = НСТР("ru='Компания,Деньги,План,Факт,Валюты';uk='Компанія,Гроші,План,Факт,Валюти'");
	НастройкиВариантов["План-фактный анализ"].Теги = НСТР("ru='Компания,Деньги,План,Факт';uk='Компанія,Гроші,План,Факт'");
	НастройкиВариантов["План-фактный анализ (вал.)"].Теги = НСТР("ru='Компания,Деньги,План,Факт,Валюты';uk='Компанія,Гроші,План,Факт,Валюти'");
