...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСТР("ru='Компания,Доходы,Расходы,План,Направление деятельности';uk='Компания,Доходы,Расходы,План,Направление деятельности'");
	НастройкиВариантов["План-фактный анализ"].Теги = НСТР("ru='Компания,Доходы,Расходы,План,Факт,Направление деятельности';uk='Компания,Доходы,Расходы,План,Факт,Направление деятельности'");
