...
Функция СформироватьОтчетНаСервере()
	...
	Если ИБФайловая Тогда
		...
		Отчеты.КнигаДоходовРасходов.СформироватьОтчет(ПараметрыОтчета, АдресХранилища);
		РезультатВыполнения = Новый Структура("ЗаданиеВыполнено", Истина);
	Иначе
		РезультатВыполнения = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
			УникальныйИдентификатор, 
			"Отчеты.КнигаДоходовРасходов.СформироватьОтчет", 
			ПараметрыОтчета, 
			"КнигаДоходовРасходов");
...
Процедура ВычислитьСуммуВыделенныхЯчеекТабличногоДокументаВКонтекстеНаСервере()
	...
	ПолеСумма = РегламентированнаяОтчетностьВызовСервера.ВычислитьСуммуВыделенныхЯчеекТабличногоДокумента(
...
Процедура Подключаемый_РезультатПриАктивизацииОбластиПодключаемый()
	...
	РегламентированнаяОтчетностьКлиент.ВычислитьСуммуВыделенныхЯчеекТабличногоДокумента(
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	Отчет 			= Форма.Отчет;
	ЗаголовокОтчета = НСтр("ru='Книга доходов (единый налог) ';uk='Книга доходів (єдиний податок) '") + ПредставлениеПериода(Отчет.НачалоПериода, КонецДня(Отчет.КонецПериода), "ФП = Истина");
...
Процедура ВыбратьПериод(Команда)	
	...
	ПараметрыВыбора = Новый Структура("НачалоПериода, КонецПериода, ВидПериода", Отчет.НачалоПериода, Отчет.КонецПериода, Неопределено);
