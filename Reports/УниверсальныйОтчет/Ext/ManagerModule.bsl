...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта.Описание = НСтр("ru='Универсальный отчет по справочникам, документам, регистрам.';uk='Універсальний звіт по довідниках, документах, регістрах.'");
...
Функция ДоступныеТаблицы(НастройкиКД, ТипОбъектаМетаданных = "", ПолноеИмяОбъектаМетаданных = "") Экспорт
	...
	ИначеЕсли ТипОбъектаМетаданных = "ПланыВидовРасчета" Тогда
		...
		ЗначенияДляВыбора.Добавить("ВытесняющиеВидыРасчета", НСтр("ru='Вытесняющие виды расчета';uk='Витісняючі види розрахунку'"));
...
Процедура ДобавитьПоказатели(ПараметрыОтчета, НастройкиКД)
	...
	Если ПараметрыОтчета.ИмяТаблицы = "ОстаткиИОбороты" Тогда
		...
		Если ПараметрыОтчета.ТипОбъектаМетаданных = "РегистрыНакопления" Тогда
			...
			ВыбранныеПоляПриход.Заголовок = НСтр("ru='Приход';uk='Прихід'");
			...
			ВыбранныеПоляРасход.Заголовок = НСтр("ru='Расход';uk='Витрата'");
