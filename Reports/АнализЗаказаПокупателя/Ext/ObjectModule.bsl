...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСТР("ru='Номенклатура,Заказы,Оплаты,Отгрузки,Запасы,Закупки,Остатки,Резервы,Продажи';uk='Номенклатура,Замовлення,Оплати,Відвантаження,Запаси,Закупівлі,Залишки,Резерви,Продажі'");
