...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта.Описание = НСтр("ru='Позволяет получить информацию об объеме данных, занятых ненужными файлами.';uk='Дозволяє одержати інформацію про обсяг даних, зайнятих непотрібними файлами.'");
