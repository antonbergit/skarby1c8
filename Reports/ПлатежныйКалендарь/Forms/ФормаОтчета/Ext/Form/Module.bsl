...
Функция ЗапросПоОстаткамПланируемыхПлатежей()
	...
	Запрос.УстановитьПараметр("ПросроченныеПлатежи", НСтр("ru='Итого просроченные платежи';uk='Разом прострочені платежі'"));
	Запрос.УстановитьПараметр("ЗапланированныеПлатежи", НСтр("ru='Итого запланированные платежи';uk='Разом заплановані платежі'"));
	Запрос.УстановитьПараметр("ТекстИтога", НСтр("ru='Всего платежи';uk='Всього платежі'"));
...
Функция ЗапросПоОстаткамДенежныхСредств()
	...
	Запрос.УстановитьПараметр("Организация", УправлениеНебольшойФирмойСервер.ПолучитьОрганизацию(Организация));
	Запрос.УстановитьПараметр("РабочаяДата", Отчет.РабочаяДата);
	Запрос.УстановитьПараметр("СтатусПлатежа", НСтр("ru='Доступный остаток';uk='Доступний залишок'"));
	Запрос.УстановитьПараметр("ТекстИтога", НСтр("ru='Всего платежи';uk='Всього платежі'"));
...
Функция ПодготовитьПараметрыОтчета(НастройкиОтчета)
	...
	Заголовок = НСтр("ru='Платежный календарь';uk='Платіжний календар'");
