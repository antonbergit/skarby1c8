...
Процедура ПриОпределенииНастроекОтчета(НастройкиОтчета, НастройкиВариантов) Экспорт
	...
	НастройкиВариантов["ПоМестамХранения"].Теги = НСТР("ru='Главное,Товары,Запасы,Закупки,Номенклатура';uk='Головне,Товари,Запаси,Закупівлі,Номенклатура'");
...
Процедура ОбновитьНастройкиНаФорме(НастройкиОтчета, НастройкиСКД, Форма) Экспорт
	...
	СтрВидЦен.Заголовок = НСтр("ru='Вид цен';uk='Вид цін'");
	...
	Для Каждого Элемент Из Форма.Элементы.ГруппаПоказателиЭлементы.ПодчиненныеЭлементы Цикл
	...
	Группа.Заголовок = НСтр("ru='Режим';uk='Режим'");
	...
	СтрСвой = ДобавитьПоле(Форма.ПоляНастроек, "Фильтр", "Режим", ОписаниеТиповБулево, НСтр("ru='Режим';uk='Режим'"), "Флажок");
	СтрСвой.Создан = Истина;
	СтрСвой.ИмяГруппы = Группа.Имя;
	СтрСвой.Поле = "Свой";
	ИмяРеквизита = "ФильтрРежимСвои";
	Если ИменаРеквизитов.Найти(ИмяРеквизита)=Неопределено Тогда
		МассивРеквизитов.Добавить(Новый РеквизитФормы(ИмяРеквизита, СтрСвой.ТипЗначения,, НСтр("ru='Свои';uk='Свої'")));
	КонецЕсли;
	...
	Если ИменаРеквизитов.Найти(ИмяРеквизита)=Неопределено Тогда
		МассивРеквизитов.Добавить(Новый РеквизитФормы(ИмяРеквизита, СтрСвой.ТипЗначения,, НСтр("ru='Чужие';uk='Чужі'")));
	КонецЕсли; 
	...
	СтрНаСкладе = ДобавитьПоле(Форма.ПоляНастроек, "Фильтр", "НаСкладе", ОписаниетиповБулево, НСтр("ru='Режим';uk='Режим'"), "Флажок");
	СтрНаСкладе.Создан = Истина;
	СтрНаСкладе.ИмяГруппы = Группа.Имя;
	ИмяРеквизита = "ФильтрРежимНаСкладах";
	Если ИменаРеквизитов.Найти(ИмяРеквизита)=Неопределено Тогда
		МассивРеквизитов.Добавить(Новый РеквизитФормы(ИмяРеквизита, СтрНаСкладе.ТипЗначения,, НСтр("ru='На складах';uk='На складах'")));
	КонецЕсли; 
	...
	Если ИменаРеквизитов.Найти(ИмяРеквизита)=Неопределено Тогда
		МассивРеквизитов.Добавить(Новый РеквизитФормы(ИмяРеквизита, СтрНаСкладе.ТипЗначения,, НСтр("ru='У реализаторов';uk='У реалізаторів'")));
	КонецЕсли; 
	...
	Для каждого ОписаниеРеквизита Из СтрВидЦен.Реквизиты Цикл
		...
		КонецЕсли; 
		Если ИндексПоказателя+1=Форма.Элементы.ГруппаПоказателиЭлементы.ПодчиненныеЭлементы.Количество() Тогда
			Элемент = Форма.Элементы.Добавить(ИмяРеквизита, Тип("ПолеФормы"), Форма.Элементы.ГруппаПоказателиЭлементы);
		ИначеЕсли ИндексПоказателя+1<Форма.Элементы.ГруппаПоказателиЭлементы.ПодчиненныеЭлементы.Количество() Тогда
			Элемент = Форма.Элементы.Вставить(ИмяРеквизита, Тип("ПолеФормы"), Форма.Элементы.ГруппаПоказателиЭлементы, Форма.Элементы.ГруппаПоказателиЭлементы.ПодчиненныеЭлементы[ИндексПоказателя+1]);
		Иначе
		...
		Если НЕ Элемент=Неопределено Тогда
			...
			Элемент.ПодсказкаВвода = НСтр("ru='Вид цен';uk='Вид цін'");
