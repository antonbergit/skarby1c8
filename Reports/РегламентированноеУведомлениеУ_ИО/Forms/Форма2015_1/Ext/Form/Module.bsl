...
Процедура Перенумеровать(Команда)
	...
	ТекстВопроса = НСтр("ru='При перенумерации страниц данные листов Г будут очищены. Продолжить?';uk='При перенумерації сторінок дані аркушів Г будуть очищені. Продовжити?'");
