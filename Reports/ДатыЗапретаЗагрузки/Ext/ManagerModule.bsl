...
Функция ПервыйВариант()
	...
	СвойстваВарианта.Вставить("Описание",
		НСтр("ru='Выводит даты запрета загрузки для объектов, сгруппированные по информационным базам.';uk='Виводить дати заборони завантаження для об`єктів, згруповані по інформаційних базах.'"));
...
Функция ВторойВариант()
	...
	Если Свойства.ПоказыватьРазделы И НЕ Свойства.ВсеРазделыБезОбъектов Тогда
		...
		ОписаниеВарианта =
			НСтр("ru='Выводит даты запрета загрузки, сгруппированные по разделам с объектами.';uk='Виводить дати заборони завантаження, згруповані по розділах з об`єктами.'");
	...
	ИначеЕсли Свойства.ВсеРазделыБезОбъектов Тогда
		...
		ОписаниеВарианта =
			НСтр("ru='Выводит даты запрета загрузки, сгруппированные по разделам.';uk='Виводить дати заборони завантаження, згруповані по розділах.'");
	Иначе
