...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСтр("ru='Запасы,Номенклатура,Товары,Ремонты,Серийные номера';uk='Запаси,Номенклатура,Товари,Ремонти,Серійні номери'");
	НастройкиВариантов["Остатки"].Теги = НСтр("ru='Запасы,Номенклатура,Товары,Ремонты,Серийные номера';uk='Запаси,Номенклатура,Товари,Ремонти,Серійні номери'");
