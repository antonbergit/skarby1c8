...
Процедура НастроитьРасписаниеРегламентногоЗадания(Команда)
	...
	Иначе
		ПоказатьПредупреждение(,НСтр("ru='Невозможно получить расписание регламентного задания: регламентное задание было удалено или не указано его наименование.';uk='Неможливо отримати розклад регламентного завдання: регламентне завдання було видалене або не зазначене його найменування.'"));
	КонецЕсли;
