...
Процедура УдалитьСтраницу(Команда)
	...
	ТекстВопроса = НСтр("ru='Удалить текущую страницу?';uk='Видалити поточну сторінку?'");
...
Процедура УдалитьСтроку(Команда)
	...
	ТекстВопроса = НСтр("ru='Удалить выбранную строку?';uk='Видалити вибраний рядок?'");
...
Процедура ОбновитьПользовательскиеНастройки()
	...
	Если ЕстьИзмененияВариантыЗаполнения ИЛИ ЕстьИзмененияНастройкаСтраниц Тогда
		...
		Сообщение.Текст = НСтр("ru='Обновление пользовательских настроек успешно завершено.';uk='Обновление пользовательских настроек успешно завершено.'");
	...
	Иначе
		...
		Сообщение.Текст = НСтр("ru='Изменения в структуре пользовательских настроек не обнаружены.';uk='Изменения в структуре пользовательских настроек не обнаружены.'");
...
"Сохранить отчет с таким же видом?';uk='Отчет с видом %1 уже существует."
...
Функция УниверсальнаяВыгрузка(ТекстВыгрузки = Неопределено, ПроверятьБлокировки = Истина, ВыгружатьСОшибками = Ложь) Экспорт
	...
	Если Открыта() Тогда
		Если СтруктураРеквизитовФормы.ЕдиницаИзмерения <> ПорядкиОкругленияОтчетности.ПеречислениеПорядкиОкругленияОтчетностиОкр1 Тогда
			...
			Сообщение.Текст = НСтр("ru='Перед выгрузкой необходимо установить единицу измерения ""в рублях"".';uk='Перед выгрузкой необходимо установить единицу измерения ""в рублях"".'");
		...
		Если СтруктураРеквизитовФормы.ТочностьЕдиницыИзмерения <> 0 Тогда
			...
			Сообщение.Текст = НСтр("ru='Перед выгрузкой необходимо установить точность ""0"".';uk='Перед выгрузкой необходимо установить точность ""0"".'");
...
Функция ИзвлечьСтруктуруXML()
	...
	Для НомерСтроки = 2 По ВысотаТаблицы Цикл
		...
		Если Макет.Область(НомерСтроки, 0, НомерСтроки, 0).Видимость = Неопределено Тогда
			...
			Сообщение.Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='%1';uk='%1'"), НомерСтроки);
...
Процедура ПроверитьЗаполнениеРаздел1(ПараметрыВыгрузки, ДеревоВыгрузки, СтатусПроверки)
	...
	ТекстОписанияОшибки = НСтр("ru='При заполненной строке 120 раздела 1 должен быть заполнен раздел 4!';uk='При заполненной строке 120 раздела 1 должен быть заполнен раздел 4!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Значение показателя в графе 3 строки 110 раздела 1 не равно сумме значений в графе 3 строк 250 и 252 по всем листам раздела 2!';uk='Значение показателя в графе 3 строки 110 раздела 1 не равно сумме значений в графе 3 строк 250 и 252 по всем листам раздела 2!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Значение показателя в графе 4 строки 110 раздела 1 не равно сумме значений в графе 3 строк 251 по всем листам раздела 2!';uk='Значение показателя в графе 4 строки 110 раздела 1 не равно сумме значений в графе 3 строк 251 по всем листам раздела 2!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Значение показателя в графе 5 строки 110 раздела 1 не равно сумме значений в графе 3 строк 276 по всем листам раздела 2!';uk='Значение показателя в графе 5 строки 110 раздела 1 не равно сумме значений в графе 3 строк 276 по всем листам раздела 2!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Значение показателя в графе 3 строки 111 раздела 1 не равно сумме значений в графе 4 строк 250 и 252 по всем листам раздела 2!';uk='Значение показателя в графе 3 строки 111 раздела 1 не равно сумме значений в графе 4 строк 250 и 252 по всем листам раздела 2!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Значение показателя в графе 4 строки 111 раздела 1 не равно сумме значений в графе 4 строк 251 по всем листам раздела 2!';uk='Значение показателя в графе 4 строки 111 раздела 1 не равно сумме значений в графе 4 строк 251 по всем листам раздела 2!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Значение показателя в графе 5 строки 111 раздела 1 не равно сумме значений в графе 4 строк 276 по всем листам раздела 2!';uk='Значение показателя в графе 5 строки 111 раздела 1 не равно сумме значений в графе 4 строк 276 по всем листам раздела 2!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Значение показателя в графе 3 строки 112 раздела 1 не равно сумме значений в графе 5 строк 250 и 252 по всем листам раздела 2!';uk='Значение показателя в графе 3 строки 112 раздела 1 не равно сумме значений в графе 5 строк 250 и 252 по всем листам раздела 2!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Значение показателя в графе 4 строки 112 раздела 1 не равно сумме значений в графе 5 строк 251 по всем листам раздела 2!';uk='Значение показателя в графе 4 строки 112 раздела 1 не равно сумме значений в графе 5 строк 251 по всем листам раздела 2!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Значение показателя в графе 5 строки 112 раздела 1 не равно сумме значений в графе 5 строк 276 по всем листам раздела 2!';uk='Значение показателя в графе 5 строки 112 раздела 1 не равно сумме значений в графе 5 строк 276 по всем листам раздела 2!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Значение показателя в графе 3 строки 113 раздела 1 не равно сумме значений в графе 6 строк 250 и 252 по всем листам раздела 2!';uk='Значение показателя в графе 3 строки 113 раздела 1 не равно сумме значений в графе 6 строк 250 и 252 по всем листам раздела 2!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Значение показателя в графе 4 строки 113 раздела 1 не равно сумме значений в графе 6 строк 251 по всем листам раздела 2!';uk='Значение показателя в графе 4 строки 113 раздела 1 не равно сумме значений в графе 6 строк 251 по всем листам раздела 2!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Значение показателя в графе 5 строки 113 раздела 1 не равно сумме значений в графе 6 строк 276 по всем листам раздела 2!';uk='Значение показателя в графе 5 строки 113 раздела 1 не равно сумме значений в графе 6 строк 276 по всем листам раздела 2!'");
	...
	ТекстОписанияОшибки = НСтр("ru='В разделе 1 значение показателя в графе 3 строки 114 не равно сумме значений в графе 3 строк 111, 112 и 113!';uk='В разделе 1 значение показателя в графе 3 строки 114 не равно сумме значений в графе 3 строк 111, 112 и 113!'");
	...
	ТекстОписанияОшибки = НСтр("ru='В разделе 1 значение показателя в графе 4 строки 114 не равно сумме значений в графе 4 строк 111, 112 и 113!';uk='В разделе 1 значение показателя в графе 4 строки 114 не равно сумме значений в графе 4 строк 111, 112 и 113!'");
	...
	ТекстОписанияОшибки = НСтр("ru='В разделе 1 значение показателя в графе 5 строки 114 не равно сумме значений в графе 5 строк 111, 112 и 113!';uk='В разделе 1 значение показателя в графе 5 строки 114 не равно сумме значений в графе 5 строк 111, 112 и 113!'");
	...
	ТекстОписанияОшибки = НСтр("ru='В разделе 1 значение показателя в графе 3 строки 120 не равно значению в графе 4 строки ""Итого доначислено"" раздела 4!';uk='В разделе 1 значение показателя в графе 3 строки 120 не равно значению в графе 4 строки ""Итого доначислено"" раздела 4!'");
	...
	ТекстОписанияОшибки = НСтр("ru='В разделе 1 значение показателя в графе 4 строки 120 не равно значению в графе 5 строки ""Итого доначислено"" раздела 4!';uk='В разделе 1 значение показателя в графе 4 строки 120 не равно значению в графе 5 строки ""Итого доначислено"" раздела 4!'");
	...
	ТекстОписанияОшибки = НСтр("ru='В разделе 1 значение показателя в графе 5 строки 120 не равно значению в графе 6 строки ""Итого доначислено"" раздела 4!';uk='В разделе 1 значение показателя в графе 5 строки 120 не равно значению в графе 6 строки ""Итого доначислено"" раздела 4!'");
	...
	ТекстОписанияОшибки = НСтр("ru='В разделе 1 значение показателя в графе 3 строки 130 не равно сумме значений в графе 3 строк 100, 110 и 120!';uk='В разделе 1 значение показателя в графе 3 строки 130 не равно сумме значений в графе 3 строк 100, 110 и 120!'");
	...
	ТекстОписанияОшибки = НСтр("ru='В разделе 1 значение показателя в графе 4 строки 130 не равно сумме значений в графе 4 строк 100, 110 и 120!';uk='В разделе 1 значение показателя в графе 4 строки 130 не равно сумме значений в графе 4 строк 100, 110 и 120!'");
	...
	ТекстОписанияОшибки = НСтр("ru='В разделе 1 значение показателя в графе 5 строки 130 не равно сумме значений в графе 5 строк 100, 110 и 120!';uk='В разделе 1 значение показателя в графе 5 строки 130 не равно сумме значений в графе 5 строк 100, 110 и 120!'");
	...
	ТекстОписанияОшибки = НСтр("ru='В разделе 1 значение показателя в графе 3 строки 144 не равно сумме значений в графе 3 строк 141, 142 и 143!';uk='В разделе 1 значение показателя в графе 3 строки 144 не равно сумме значений в графе 3 строк 141, 142 и 143!'");
	...
	ТекстОписанияОшибки = НСтр("ru='В разделе 1 значение показателя в графе 4 строки 144 не равно сумме значений в графе 4 строк 141, 142 и 143!';uk='В разделе 1 значение показателя в графе 4 строки 144 не равно сумме значений в графе 4 строк 141, 142 и 143!'");
	...
	ТекстОписанияОшибки = НСтр("ru='В разделе 1 значение показателя в графе 5 строки 144 не равно сумме значений в графе 5 строк 141, 142 и 143!';uk='В разделе 1 значение показателя в графе 5 строки 144 не равно сумме значений в графе 5 строк 141, 142 и 143!'");
	...
	ТекстОписанияОшибки = НСтр("ru='В разделе 1 значение показателя в графе 3 строки 150 не равно разности значений в графе 3 строк 130 и 140!';uk='В разделе 1 значение показателя в графе 3 строки 150 не равно разности значений в графе 3 строк 130 и 140!'");
	...
	ТекстОписанияОшибки = НСтр("ru='В разделе 1 значение показателя в графе 4 строки 150 не равно разности значений в графе 4 строк 130 и 140!';uk='В разделе 1 значение показателя в графе 4 строки 150 не равно разности значений в графе 4 строк 130 и 140!'");
	...
	ТекстОписанияОшибки = НСтр("ru='В разделе 1 значение показателя в графе 5 строки 150 не равно разности значений в графе 5 строк 130 и 140!';uk='В разделе 1 значение показателя в графе 5 строки 150 не равно разности значений в графе 5 строк 130 и 140!'");
...
Процедура ПроверитьЗаполнениеРаздел2(ПараметрыВыгрузки, ДеревоВыгрузки, СтатусПроверки)
	...
	ТекстОписанияОшибки = НСтр("ru='При заполненном разделе 2 с кодом тарифа 03 должен быть заполнен либо раздел 3.1, либо раздел 3.2, либо раздел 3.3!';uk='При заполненном разделе 2 с кодом тарифа 03 должен быть заполнен либо раздел 3.1, либо раздел 3.2, либо раздел 3.3!'");
	...
	ТекстОписанияОшибки = НСтр("ru='При заполненном разделе 2 с кодом тарифа 06 должен быть заполнен раздел 3.4!';uk='При заполненном разделе 2 с кодом тарифа 06 должен быть заполнен раздел 3.4!'");
	...
	ТекстОписанияОшибки = НСтр("ru='При заполненном разделе 2 с кодом тарифа 07 должен быть заполнен раздел 3.6!';uk='При заполненном разделе 2 с кодом тарифа 07 должен быть заполнен раздел 3.6!'");
	...
	ТекстОписанияОшибки = НСтр("ru='При заполненном разделе 2 с кодом тарифа 09 должен быть заполнен раздел 3.5!';uk='При заполненном разделе 2 с кодом тарифа 09 должен быть заполнен раздел 3.5!'");
	...
	ТекстОписанияОшибки = НСтр("ru='При заполненном разделе 2 с кодом тарифа 12 должен быть заполнен раздел 3.7!';uk='При заполненном разделе 2 с кодом тарифа 12 должен быть заполнен раздел 3.7!'");
	...
	ТекстОписанияОшибки = НСтр("ru='При заполненном разделе 2 с кодом тарифа 14 должен быть заполнен раздел 3.8!';uk='При заполненном разделе 2 с кодом тарифа 14 должен быть заполнен раздел 3.8!'");
...
Процедура ПроверитьЗаполнениеРаздел31(ПараметрыВыгрузки, ДеревоВыгрузки, СтатусПроверки)
	...
	ТекстОписанияОшибки = НСтр("ru='Значение итога по графе 5 раздела 31 не совпадает с суммой значений по строкам!';uk='Значение итога по графе 5 раздела 31 не совпадает с суммой значений по строкам!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Значение итога по графе 6 раздела 31 не совпадает с суммой значений по строкам!';uk='Значение итога по графе 6 раздела 31 не совпадает с суммой значений по строкам!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Значение итога по графе 7 раздела 31 не совпадает с суммой значений по строкам!';uk='Значение итога по графе 7 раздела 31 не совпадает с суммой значений по строкам!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Значение итога по графе 8 раздела 31 не совпадает с суммой значений по строкам!';uk='Значение итога по графе 8 раздела 31 не совпадает с суммой значений по строкам!'");
	...
	Для Графа = 3 По 6 Цикл
		...
		Если ДанныеРаздела[ИмяПоказателя321] = 0 Тогда
			Если ЗначениеЗаполнено(ДанныеРаздела[ИмяПоказателя322]) ИЛИ ЗначениеЗаполнено(ДанныеРаздела[ИмяПоказателя322]) Тогда
				ТекстОписанияОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Не указана численность членов организации в графе %1 строки 321 раздела 3.2!';uk='Не указана численность членов организации в графе %1 строки 321 раздела 3.2!'"), Графа);
				СообщитьОбОшибкеЗаполнения(СтатусПроверки, ТекстОписанияОшибки, "Раздел32", ИмяПоказателя321);
			КонецЕсли;
		Иначе
			ТекстОписанияОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Значение показателя в графе %1 строки 323 раздела 3.2 не равно отношению значений показателей строк 321 и 322, умноженному на 100!';uk='Значение показателя в графе %1 строки 323 раздела 3.2 не равно отношению значений показателей строк 321 и 322, умноженному на 100!'"), Графа);
		...
		ТекстОписанияОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Значение показателя в графе %1 строки 323 раздела 3.2 не может быть меньше 50!';uk='Значение показателя в графе %1 строки 323 раздела 3.2 не может быть меньше 50!'"), Графа);
...
Процедура ПроверитьЗаполнениеРаздел33(ПараметрыВыгрузки, ДеревоВыгрузки, СтатусПроверки)
	...
	Если ЕстьРаздел2СКодомТарифа("03") Тогда
		ТекстОписанияОшибки = НСтр("ru='Значение показателя в графе 3 строки 331 раздела 3.3 не равно значений показателя ""Среднесписочная численность"" на титульном листе!';uk='Значение показателя в графе 3 строки 331 раздела 3.3 не равно значений показателя ""Среднесписочная численность"" на титульном листе!'");
	...
	Для Графа = 3 По 6 Цикл
		...
		Если ДанныеРаздела[ИмяПоказателя331] = 0 Тогда
			Если ЗначениеЗаполнено(ДанныеРаздела[ИмяПоказателя332]) ИЛИ ЗначениеЗаполнено(ДанныеРаздела[ИмяПоказателя333]) Тогда
				ТекстОписанияОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Не указана среднесписочная численность в графе %1 строки 331 раздела 3.3!';uk='Не указана среднесписочная численность в графе %1 строки 331 раздела 3.3!'"), Графа);
				СообщитьОбОшибкеЗаполнения(СтатусПроверки, ТекстОписанияОшибки, "Раздел33", ИмяПоказателя331);
			КонецЕсли;
		Иначе
			ТекстОписанияОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Значение показателя в графе %1 строки 333 раздела 3.3 не равно отношению значений показателей строк 331 и 332, умноженному на 100!';uk='Значение показателя в графе %1 строки 333 раздела 3.3 не равно отношению значений показателей строк 331 и 332, умноженному на 100!'"), Графа);
		...
		ТекстОписанияОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Значение показателя в графе %1 строки 333 раздела 3.3 не может быть меньше 50!';uk='Значение показателя в графе %1 строки 333 раздела 3.3 не может быть меньше 50!'"), Графа);
		...
		Если ДанныеРаздела[ИмяПоказателя334] = 0 Тогда
			Если ЗначениеЗаполнено(ДанныеРаздела[ИмяПоказателя335]) ИЛИ ЗначениеЗаполнено(ДанныеРаздела[ИмяПоказателя336]) Тогда
				ТекстОписанияОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Не указан фонд оплаты труда в графе %1 строки 334 раздела 3.3!';uk='Не указан фонд оплаты труда в графе %1 строки 334 раздела 3.3!'"), Графа);
				СообщитьОбОшибкеЗаполнения(СтатусПроверки, ТекстОписанияОшибки, "Раздел33", ИмяПоказателя334);
			КонецЕсли;
		Иначе
			ТекстОписанияОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Значение показателя в графе %1 строки 336 раздела 3.3 не равно отношению значений показателей строк 334 и 335, умноженному на 100!';uk='Значение показателя в графе %1 строки 336 раздела 3.3 не равно отношению значений показателей строк 334 и 335, умноженному на 100!'"), Графа);
		...
		ТекстОписанияОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Значение показателя в графе %1 строки 336 раздела 3.3 не может быть меньше 25!';uk='Значение показателя в графе %1 строки 336 раздела 3.3 не может быть меньше 25!'"), Графа);
	...
	Если ЭтоПервыйКвартал Тогда
		ТекстОписанияОшибки = НСтр("ru='Сумма значений показателей в графах 4, 5, 6 строки 334 не равна значению показателя в графе 3 строки 334 (расчет за 1-й квартал)!';uk='Сумма значений показателей в графах 4, 5, 6 строки 334 не равна значению показателя в графе 3 строки 334 (расчет за 1-й квартал)!'");
		...
		КонецЕсли;
	Иначе
		ТекстОписанияОшибки = НСтр("ru='Сумма значений показателей в графах 4, 5, 6 строки 334 превышает значение показателя в графе 3 строки 334!';uk='Сумма значений показателей в графах 4, 5, 6 строки 334 превышает значение показателя в графе 3 строки 334!'");
		Если ДанныеРаздела.П000330033403 < СуммаПоСтроке334 Тогда
			СообщитьОбОшибкеЗаполнения(СтатусПроверки, ТекстОписанияОшибки, "Раздел33", "П000330033403");
		КонецЕсли;
	КонецЕсли;
	...
	Если ЭтоПервыйКвартал Тогда
		ТекстОписанияОшибки = НСтр("ru='Сумма значений показателей в графах 4, 5, 6 строки 335 не равна значению показателя в графе 3 строки 335 (расчет за 1-й квартал)!';uk='Сумма значений показателей в графах 4, 5, 6 строки 335 не равна значению показателя в графе 3 строки 335 (расчет за 1-й квартал)!'");
		...
		КонецЕсли;
	Иначе
		ТекстОписанияОшибки = НСтр("ru='Сумма значений показателей в графах 4, 5, 6 строки 335 превышает значение показателя в графе 3 строки 335!';uk='Сумма значений показателей в графах 4, 5, 6 строки 335 превышает значение показателя в графе 3 строки 335!'");
		Если ДанныеРаздела.П000330033503 < СуммаПоСтроке335 Тогда
			СообщитьОбОшибкеЗаполнения(СтатусПроверки, ТекстОписанияОшибки, "Раздел33", "П000330033503");
		КонецЕсли;
	КонецЕсли;
...
Процедура ПроверитьЗаполнениеРаздел34(ПараметрыВыгрузки, ДеревоВыгрузки, СтатусПроверки)
	...
	Для Графа = 3 По 4 Цикл
		...
		Если ДанныеРаздела[ИмяПоказателя341] = 0 Тогда
			Если ЗначениеЗаполнено(ДанныеРаздела[ИмяПоказателя342]) ИЛИ ЗначениеЗаполнено(ДанныеРаздела[ИмяПоказателя343]) Тогда
				ТекстОписанияОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Не указана сумма доходов в графе %1 строки 341 раздела 3.4!';uk='Не указана сумма доходов в графе %1 строки 341 раздела 3.4!'"), Графа);
				СообщитьОбОшибкеЗаполнения(СтатусПроверки, ТекстОписанияОшибки, "Раздел34", ИмяПоказателя341);
			КонецЕсли;
		Иначе
			ТекстОписанияОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Значение показателя в графе %1 строки 343 раздела 3.4 не равно отношению значений показателей строк 341 и 342, умноженному на 100!';uk='Значение показателя в графе %1 строки 343 раздела 3.4 не равно отношению значений показателей строк 341 и 342, умноженному на 100!'"), Графа);
		...
		ТекстОписанияОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Значение показателя в графе %1 строки 343 раздела 3.4 не может быть меньше 90!';uk='Значение показателя в графе %1 строки 343 раздела 3.4 не может быть меньше 90!'"), Графа);
	...
	ТекстОписанияОшибки = НСтр("ru='Не указана дата записи в реестре аккредитованных организаций в строке 345 раздела 3.4!';uk='Не указана дата записи в реестре аккредитованных организаций в строке 345 раздела 3.4!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Не указан номер записи в реестре аккредитованных организаций в строке 345 раздела 3.4!';uk='Не указан номер записи в реестре аккредитованных организаций в строке 345 раздела 3.4!'");
...
Процедура ПроверитьЗаполнениеРаздел35(ПараметрыВыгрузки, ДеревоВыгрузки, СтатусПроверки)
	...
	ТекстОписанияОшибки = НСтр("ru='В разделе 3.5 значение итога по графе 3 не равно сумме значений строк таблицы по графе 3!';uk='В разделе 3.5 значение итога по графе 3 не равно сумме значений строк таблицы по графе 3!'");
	...
	ТекстОписанияОшибки = НСтр("ru='В разделе 3.5 итог по графе 4 должен равняться 100!';uk='В разделе 3.5 итог по графе 4 должен равняться 100!'");
	...
	ТекстОписанияОшибки = НСтр("ru='В разделе 3.5 значение итога по графе 4 не равно сумме значений строк таблицы по графе 4!';uk='В разделе 3.5 значение итога по графе 4 не равно сумме значений строк таблицы по графе 4!'");
	Если ДанныеРаздела.П000350000204 <> СуммаДолейДоходов Тогда
		СообщитьОбОшибкеЗаполнения(СтатусПроверки, ТекстОписанияОшибки, "Раздел35", "П000350000204");
	КонецЕсли;
	
	ТекстОписанияОшибки = НСтр("ru='Не указана дата внесения в реестр СМИ в строке 351 раздела 3.5!';uk='Не указана дата внесения в реестр СМИ в строке 351 раздела 3.5!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Не указан номер записи в реестре аккредитованных организаций в строке 351 раздела 3.5!';uk='Не указан номер записи в реестре аккредитованных организаций в строке 351 раздела 3.5!'");
...
Процедура ПроверитьЗаполнениеРаздел36(ПараметрыВыгрузки, ДеревоВыгрузки, СтатусПроверки)
	...
	Если ДанныеРаздела[ИмяПоказателя361] = 0 Тогда
		Если ЗначениеЗаполнено(ДанныеРаздела[ИмяПоказателя362]) ИЛИ ЗначениеЗаполнено(ДанныеРаздела[ИмяПоказателя363]) Тогда
			ТекстОписанияОшибки = НСтр("ru='Не указана сумма доходов в графе 3 строки 361 раздела 3.6!';uk='Не указана сумма доходов в графе 3 строки 361 раздела 3.6!'");
			СообщитьОбОшибкеЗаполнения(СтатусПроверки, ТекстОписанияОшибки, "Раздел36", ИмяПоказателя361);
		КонецЕсли;
	Иначе
		ТекстОписанияОшибки = НСтр("ru='Значение показателя в графе 3 строки 363 раздела 3.6 не равно отношению значений показателей строк 361 и 362, умноженному на 100!';uk='Значение показателя в графе 3 строки 363 раздела 3.6 не равно отношению значений показателей строк 361 и 362, умноженному на 100!'");
...
Процедура ПроверитьЗаполнениеРаздел37(ПараметрыВыгрузки, ДеревоВыгрузки, СтатусПроверки)
	...
	Для Графа = 3 По 4 Цикл
		...
		ТекстОписанияОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='В разделе 3.7 сумма значений показателей в графе %1 по строкам 372, 373 и 374 превышает значение показателя в графе %2 строки 371!';uk='В разделе 3.7 сумма значений показателей в графе %1 по строкам 372, 373 и 374 превышает значение показателя в графе %2 строки 371!'"), Графа, Графа);
		...
		Если ДанныеРаздела[КонтрольныйПоказатель371] = 0 Тогда
			Если ЗначениеЗаполнено(ДанныеРаздела[КонтрольныйПоказатель372])
			 ...
			 ИЛИ ЗначениеЗаполнено(ДанныеРаздела[КонтрольныйПоказатель375]) Тогда
				ТекстОписанияОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Не указана сумма доходов в графе %1 строки 371 раздела 3.7!';uk='Не указана сумма доходов в графе %1 строки 371 раздела 3.7!'"), Графа);
				СообщитьОбОшибкеЗаполнения(СтатусПроверки, ТекстОписанияОшибки, "Раздел37", КонтрольныйПоказатель371);
			КонецЕсли;
		Иначе
			ТекстОписанияОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Значение показателя в графе %1 строки 363 раздела 3.7 не равно отношению суммы показателей строк 372, 373, 374 и значения показателя в строке 371, умноженному на 100!';uk='Значение показателя в графе %1 строки 363 раздела 3.7 не равно отношению суммы показателей строк 372, 373, 374 и значения показателя в строке 371, умноженному на 100!'"), Графа);
			ПроверяемоеЗначение = ДанныеРаздела[ПроверяемыйПоказатель];
		...
		ТекстОписанияОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Значение показателя в графе %1 строки 375 раздела 3.7 не может быть меньше 70!';uk='Значение показателя в графе %1 строки 375 раздела 3.7 не может быть меньше 70!'"), Графа);
...
Процедура ПроверитьЗаполнениеРаздел38(ПараметрыВыгрузки, ДеревоВыгрузки, СтатусПроверки)
	...
	Для Графа = 3 По 4 Цикл
		...
		ТекстОписанияОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='В разделе 3.8 значение показателя в графе %1 строки 382 превышает значение показателя в графе %2 строки 381!';uk='В разделе 3.8 значение показателя в графе %1 строки 382 превышает значение показателя в графе %2 строки 381!'"), Графа);
		...
		Если ДанныеРаздела[КонтрольныйПоказатель381] = 0 Тогда
			Если ЗначениеЗаполнено(ДанныеРаздела[КонтрольныйПоказатель382]) ИЛИ ЗначениеЗаполнено(ДанныеРаздела[КонтрольныйПоказатель383]) Тогда
				ТекстОписанияОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Не указана сумма доходов в графе %1 строки 381 раздела 3.8!';uk='Не указана сумма доходов в графе %1 строки 381 раздела 3.8!'"), Графа);
				СообщитьОбОшибкеЗаполнения(СтатусПроверки, ТекстОписанияОшибки, "Раздел38", КонтрольныйПоказатель381);
			КонецЕсли;
		Иначе
			ТекстОписанияОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Значение показателя в графе %1 строки 383 раздела 3.8 не равно отношению значений показателей строк 381 и 382, умноженному на 100!';uk='Значение показателя в графе %1 строки 383 раздела 3.8 не равно отношению значений показателей строк 381 и 382, умноженному на 100!'"), Графа);
			ПроверяемоеЗначение = ДанныеРаздела[ПроверяемыйПоказатель];
		...
		ТекстОписанияОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Значение показателя в графе %1 строки 383 раздела 3.8 не может быть меньше 90!';uk='Значение показателя в графе %1 строки 383 раздела 3.8 не может быть меньше 90!'"), Графа);
	...
	ТекстОписанияОшибки = НСтр("ru='Не указана дата получения положительного заключения в строке 385 раздела 3.8!';uk='Не указана дата получения положительного заключения в строке 385 раздела 3.8!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Не указан номер положительного заключения в строке 385 раздела 3.8!';uk='Не указан номер положительного заключения в строке 385 раздела 3.8!'");
...
Процедура ПроверитьЗаполнениеРаздел4(ПараметрыВыгрузки, ДеревоВыгрузки, СтатусПроверки)
	...
	ТекстОписанияОшибки = НСтр("ru='Значение итога по графе 4 раздела 4 не совпадает с суммой значений по строкам!';uk='Значение итога по графе 4 раздела 4 не совпадает с суммой значений по строкам!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Значение итога по графе 5 раздела 4 не совпадает с суммой значений по строкам!';uk='Значение итога по графе 5 раздела 4 не совпадает с суммой значений по строкам!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Значение итога по графе 6 раздела 4 не совпадает с суммой значений по строкам!';uk='Значение итога по графе 6 раздела 4 не совпадает с суммой значений по строкам!'");
...
Процедура ПроверитьЗаполнениеРаздел5(ПараметрыВыгрузки, ДеревоВыгрузки, СтатусПроверки)
	...
	ТекстОписанияОшибки = НСтр("ru='Значение итога по графе 5 раздела 5 не совпадает с суммой значений по строкам!';uk='Значение итога по графе 5 раздела 5 не совпадает с суммой значений по строкам!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Значение итога по графе 6 раздела 5 не совпадает с суммой значений по строкам!';uk='Значение итога по графе 6 раздела 5 не совпадает с суммой значений по строкам!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Значение итога по графе 7 раздела 5 не совпадает с суммой значений по строкам!';uk='Значение итога по графе 7 раздела 5 не совпадает с суммой значений по строкам!'");
	...
	ТекстОписанияОшибки = НСтр("ru='Значение итога по графе 8 раздела 5 не совпадает с суммой значений по строкам!';uk='Значение итога по графе 8 раздела 5 не совпадает с суммой значений по строкам!'");
	...
	ТекстОписанияОшибки = НСтр("ru='В разделе 5 не указана дата записи в реестре!';uk='В разделе 5 не указана дата записи в реестре!'");
	...
	ТекстОписанияОшибки = НСтр("ru='В разделе 5 не указан номер записи в реестре!';uk='В разделе 5 не указан номер записи в реестре!'");
	...
	ТекстОписанияОшибки = НСтр("ru='В разделе 5 не указаны сведения из реестра молодежных и детских общественных объединений, пользующихся государственной поддержкой!';uk='В разделе 5 не указаны сведения из реестра молодежных и детских общественных объединений, пользующихся государственной поддержкой!'");
...
Процедура ПроверитьЗаполнениеТитульный(ПараметрыВыгрузки, ДеревоВыгрузки, СтатусПроверки)
	...
	Если ПустаяСтрока(ПараметрыВыгрузки.ИНН) И НЕ РегламентированнаяОтчетностьПереопределяемый.ЭтоИностраннаяОрганизация(СтруктураРеквизитовФормы.Организация) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Не задан ИНН организации!';uk='Не задан ИНН организации!'"), "Титульный", "ИНН1");
		СтатусПроверки = Ложь;
	ИначеЕсли СтрДлина(ПараметрыВыгрузки.ИНН) <> 0 И СтрДлина(ПараметрыВыгрузки.ИНН) <> 10 И СтрДлина(ПараметрыВыгрузки.ИНН) <> 12 Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Неверно задан ИНН организации!';uk='Неверно задан ИНН организации!'"), "Титульный", "ИНН1");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ПараметрыВыгрузки.Свойство("КПП") И НЕ ПустаяСтрока(ПараметрыВыгрузки.КПП) И СтрДлина(ПараметрыВыгрузки.КПП) <> 9 Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Неверно задан КПП организации!';uk='Неверно задан КПП организации!'"), "Титульный", "КПП1");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ПараметрыВыгрузки.Свойство("ОГРН") Тогда
		Если ПустаяСтрока(ПараметрыВыгрузки.ОГРН) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Не задан ОГРН организации!';uk='Не задан ОГРН организации!'"), "Титульный", "ОГРН");
			СтатусПроверки = Ложь;
		ИначеЕсли СтрДлина(ПараметрыВыгрузки.ОГРН) <> 13 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Неверно задан ОГРН организации!';uk='Неверно задан ОГРН организации!'"), "Титульный", "ОГРН");
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЕсли;
	...
	Если ПараметрыВыгрузки.Свойство("ОГРНИП") Тогда
		Если ПустаяСтрока(ПараметрыВыгрузки.ОГРНИП) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Не задан ОГРН индивидуального предпринимателя!';uk='Не задан ОГРН индивидуального предпринимателя!'"), "Титульный", "ОГРН");
			СтатусПроверки = Ложь;
		ИначеЕсли СтрДлина(ПараметрыВыгрузки.ОГРНИП) <> 15 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Неверно задан ОГРН индивидуального предпринимателя!';uk='Неверно задан ОГРН индивидуального предпринимателя!'"), "Титульный", "ОГРН");
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЕсли;
	...
	Если (НЕ ПараметрыВыгрузки.ЭтоПБОЮЛ И ПустаяСтрока(ПараметрыВыгрузки.НаименованиеОрганизации)) ИЛИ (ПараметрыВыгрузки.ЭтоПБОЮЛ И ПустаяСтрока(ПараметрыВыгрузки.ФамилияИП)) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Не задан налогоплательщик!';uk='Не задан налогоплательщик!'"), "Титульный", "ОргНазв");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если НЕ РегНомерПФРСоответствуетТребованиям(ПараметрыВыгрузки.РегистрационныйНомерПФР) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Значение рег. номера в ПФР не соответствует шаблону:""XXX-XXX-XXXXXX"" (X - любая цифра)!';uk='Значення рег. номера в ПФР не відповідає шаблону:""XXX-XXX-XXXXXX"" (X - будь-яка цифра)!'"), "Титульный", "НомРег");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	ТекстОписанияОшибки = НСтр("ru='Признак прекращения деятельности должен указываться как ""Л"" !';uk='Признак прекращения деятельности должен указываться как ""Л"" !'");
	...
	Если ПустаяСтрока(ПараметрыВыгрузки.КодПоОКАТО) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Не указан код ОКАТО!';uk='Не указан код ОКАТО!'"), "Титульный", "ОКАТО");
		СтатусПроверки = Ложь;
	ИначеЕсли СтрДлина(ПараметрыВыгрузки.КодПоОКАТО) <> 11 Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Неверно указан код ОКАТО!';uk='Неверно указан код ОКАТО!'"), "Титульный", "ОКАТО");
		СтатусПроверки = Ложь;
	КонецЕсли;
	...
	Если ПустаяСтрока(СокрЛП(СтрЗаменить(ПараметрыВыгрузки.КодПоОКВЭД, ".", ""))) ИЛИ НЕ РегламентированнаяОтчетностьКлиентСервер.ОКВЭДСоответствуетТребованиям(ПараметрыВыгрузки.КодПоОКВЭД) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Некорректное значение кода вида деятельности по ОКВЭД!';uk='Некорректное значение кода вида деятельности по ОКВЭД!'"), "Титульный", "ОКВЭД");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ПустаяСтрока(ПараметрыВыгрузки.ЛицоПодтверждающееСведения) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Не указан тип подписанта!';uk='Не указан тип подписанта!'"), "Титульный", "ПрПодп");
		СтатусПроверки = Ложь;
	ИначеЕсли СтрНайти("1,2,3", ПараметрыВыгрузки.ЛицоПодтверждающееСведения) = 0 Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Неверно указан тип подписанта!';uk='Неверно указан тип подписанта!'"), "Титульный", "ПрПодп");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ПустаяСтрока(ПараметрыВыгрузки.ФамилияПодписанта) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Не указана фамилия подписанта!';uk='Не указана фамилия подписанта!'"), "Титульный", "ОргПодписантФамилия");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ПустаяСтрока(ПараметрыВыгрузки.ИмяПодписанта) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Не указано имя подписанта!';uk='Не указано имя подписанта!'"), "Титульный", "ОргПодписантФамилия");
		СтатусПроверки = Ложь;
	КонецЕсли;
	...
	Если ПараметрыВыгрузки.ЛицоПодтверждающееСведения = "2" ИЛИ ПараметрыВыгрузки.ЛицоПодтверждающееСведения = "3" Тогда
		Если ПустаяСтрока(ПараметрыВыгрузки.НаименованиеУдостоверяющего) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Не указано наименование документа, подтверждающего полномочия представителя!';uk='Не указано наименование документа, подтверждающего полномочия представителя!'"), "Титульный", "ДокУпПред");
			СтатусПроверки = Ложь;
		КонецЕсли;
		
		Если ПустаяСтрока(ПараметрыВыгрузки.ДатаВыдачи) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Не указана дата выдачи документа, подтверждающего полномочия представителя!';uk='Не указана дата выдачи документа, подтверждающего полномочия представителя!'"), "Титульный", "ДокУпПред");
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЕсли;
	
	Если ПустаяСтрока(ПараметрыВыгрузки.Индекс) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Не задан почтовый индекс адреса регистрации!';uk='Не задан почтовый индекс адреса регистрации!'"), "Титульный", "Адрес1");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ЛишьОдноИзЗначениеЗаполнено(ПараметрыВыгрузки.РегионНазвание, ПараметрыВыгрузки.РегионСокращение) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Регион не соответствует шаблону (Название Сокращение)!';uk='Регион не соответствует шаблону (Название Сокращение)!'"), "Титульный", "Адрес2");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ЛишьОдноИзЗначениеЗаполнено(ПараметрыВыгрузки.РайонНазвание, ПараметрыВыгрузки.РайонСокращение) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Район не соответствует шаблону (Название Сокращение)!';uk='Район не соответствует шаблону (Название Сокращение)!'"), "Титульный", "Адрес3");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ЛишьОдноИзЗначениеЗаполнено(ПараметрыВыгрузки.ГородНазвание, ПараметрыВыгрузки.ГородСокращение) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Город не соответствует шаблону (Название Сокращение)!';uk='Город не соответствует шаблону (Название Сокращение)!'"), "Титульный", "Адрес4");
		СтатусПроверки = Ложь;
	КонецЕсли;
	...
	Если ЛишьОдноИзЗначениеЗаполнено(ПараметрыВыгрузки.НаселенныйПунктНазвание, ПараметрыВыгрузки.НаселенныйПунктСокращение) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Населенный пункт не соответствует шаблону (Название Сокращение)!';uk='Населенный пункт не соответствует шаблону (Название Сокращение)!'"), "Титульный", "Адрес5");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ЛишьОдноИзЗначениеЗаполнено(ПараметрыВыгрузки.УлицаНазвание, ПараметрыВыгрузки.УлицаСокращение) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, НСтр("ru='Улица не соответствует шаблону (Название Сокращение)!';uk='Улица не соответствует шаблону (Название Сокращение)!'"), "Титульный", "Адрес6");
		СтатусПроверки = Ложь;
	КонецЕсли;
