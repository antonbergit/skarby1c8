...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.Новости") Тогда
		...
		МодульОбработкаНовостей.КонтекстныеНовости_ПриСозданииНаСервере(
			...
			"ОсновнаяФорма",
			,
			НСтр("ru='Новости: Расчет по страховым взносам в ПФР, ФФОМС, ТФОМС (форма РСВ-1 ПФР)';uk='Новости: Расчет по страховым взносам в ПФР, ФФОМС, ТФОМС (форма РСВ-1 ПФР)'"),
			Ложь,
