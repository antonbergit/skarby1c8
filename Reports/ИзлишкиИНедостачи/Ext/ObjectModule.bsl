...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСТР("ru='Излишки,Недостачи,Запасы,Закупки,Номенклатура,Товары';uk='Надлишки,Нестачі,Запаси,Закупівлі,Номенклатура,Товари'");
