...
Функция ПредставлениеРасшифровки(ПараметрыРасшифровки)
	...
	Возврат СтрШаблон(НСтр("ru='%1: %2, уровень воронки: %3';uk='%1: %2, уровень воронки: %3'"),
	?(ПараметрыРасшифровки.ЭтоПотери, НСтр("ru='Потери';uk='Потери'"), НСтр("ru='Заказы';uk='Замовлення'")),
