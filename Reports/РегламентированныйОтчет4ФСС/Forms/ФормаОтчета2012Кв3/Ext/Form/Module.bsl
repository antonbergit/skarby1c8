...
Процедура ПроверитьВероятностныеОшибкиЗаполнения()
	...
	Если ЗначениеЗаполнено(РегистрационныйНомерСтрахователя) Тогда
		Если РегистрационныйНомерСтрахователя = ИНН ИЛИ РегистрационныйНомерСтрахователя = КПП Тогда
			...
			Сообщение.Текст = НСтр("ru='Проверьте правильность указания регистрационного номера страхователя! Возможно, регистрационный номер страхователя указан неверно!';uk='Проверьте правильность указания регистрационного номера страхователя! Возможно, регистрационный номер страхователя указан неверно!'");
	...
	Если ЗначениеЗаполнено(ДополнительныйКод) Тогда
		Если ДополнительныйКод = ИНН ИЛИ ДополнительныйКод = КПП Тогда
			...
			Сообщение.Текст = НСтр("ru='Проверьте правильность указания дополнительного кода! Возможно, дополнительный код указан неверно!';uk='Проверьте правильность указания дополнительного кода! Возможно, дополнительный код указан неверно!'");
