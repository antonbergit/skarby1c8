...
"підпапок'");
		...
		ЗаголовокНастройкаПолученаОтГруппы = НСтр("ru='Настройка прав получена от группы';uk='Налаштування прав отримана від групи'");
...
Функция ВидыОграниченийПравОбъектовМетаданных()
	...
	Пока Индекс >= 0 Цикл
		...
		Если СвойстваВидаДоступа = Неопределено Тогда
			...
			Иначе
				Строка.Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Настройки прав на %1';uk='Налаштування прав на %1'"),
