...
Функция НаименованиеСостояния(Состояние)
	...
	Если Состояние = Перечисления.СостоянияСуществованияКонтрагента.КонтрагентОтсутствуетВБазеФНС Тогда
		Наименование = НСтр("ru='По данным ЕГРН сведения о контрагентах отсутствуют';uk='По данным ЕГРН сведения о контрагентах отсутствуют'");
	ИначеЕсли Состояние = Перечисления.СостоянияСуществованияКонтрагента.КППНеСоответствуетДаннымБазыФНС Тогда
		Наименование = НСтр("ru='По данным ЕГРН у контрагентов другой КПП';uk='По данным ЕГРН у контрагентов другой КПП'");
	ИначеЕсли Состояние = Перечисления.СостоянияСуществованияКонтрагента.НеДействуетИлиИзмененКПП Тогда
		Наименование = НСтр("ru='По данным ЕГРН контрагенты недействующие';uk='По данным ЕГРН контрагенты недействующие'");
	КонецЕсли;
