...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСтр("ru='Запасы,Закупки,Номенклатура,Заказы,Отгрузки,Резервы';uk='Запаси,Закупівлі,Номенклатура,Замовлення,Відвантаження,Резерви'");
