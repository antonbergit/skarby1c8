...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСТР("ru='Номенклатура,Заказы,Оплаты,Поступления,Запасы,Закупки,Резервы';uk='Номенклатура,Замовлення,Оплати,Надходження,Запаси,Закупівлі,Резерви'");
