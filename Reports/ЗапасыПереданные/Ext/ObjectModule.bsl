...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСтр("ru='Запасы,Закупки,Номенклатура,Передача,Комиссия,Продажи';uk='Запаси,Закупівлі,Номенклатура,Передача,Комісія,Продажі'");
	НастройкиВариантов["Остатки"].Теги = НСтр("ru='Запасы,Закупки,Номенклатура,Передача,Комиссия';uk='Запаси,Закупівлі,Номенклатура,Передача,Комісія'");
	НастройкиВариантов["ЗапасыВПереработке"].Теги = НСтр("ru='Запасы,Закупки,Номенклатура,Передача,Переработка';uk='Запаси,Закупівлі,Номенклатура,Передача,Переробка'");
	НастройкиВариантов["ЗапасыНаОтветхранении"].Теги = НСтр("ru='Запасы,Закупки,Номенклатура,Передача,Ответхранение';uk='Запаси,Закупівлі,Номенклатура,Передача,Відповідзберігання'");
