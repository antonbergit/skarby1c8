...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСтр("ru='Деньги,Запасы,Закупки,Контрагенты,Поставщики,Кредиторка';uk='Гроші,Запаси,Закупівлі,Контрагенти,Постачальники,Кредиторка'");
	НастройкиВариантов["Остатки"].Теги = НСтр("ru='Деньги,Запасы,Закупки,Контрагенты,Поставщики,Кредиторка';uk='Гроші,Запаси,Закупівлі,Контрагенти,Постачальники,Кредиторка'");
	НастройкиВариантов["ВедомостьВВалюте"].Теги = НСтр("ru='Деньги,Запасы,Закупки,Контрагенты,Поставщики,Кредиторка';uk='Гроші,Запаси,Закупівлі,Контрагенти,Постачальники,Кредиторка'");
	НастройкиВариантов["ОстаткиВВалюте"].Теги = НСтр("ru='Деньги,Запасы,Закупки,Контрагенты,Поставщики,Кредиторка';uk='Гроші,Запаси,Закупівлі,Контрагенти,Постачальники,Кредиторка'");
