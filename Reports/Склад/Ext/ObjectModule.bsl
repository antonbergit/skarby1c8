...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСтр("ru='Запасы,Закупки,Номенклатура,Товары,Ячейка';uk='Запаси,Закупівлі,Номенклатура,Товари,Комірка'");
	НастройкиВариантов["Остатки"].Теги = НСтр("ru='Запасы,Закупки,Номенклатура,Товары,Ячейка';uk='Запаси,Закупівлі,Номенклатура,Товари,Комірка'");
