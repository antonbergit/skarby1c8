...
Процедура УстановитьПериод(НазваниеПериода, Направление)
	...
	Результат.Область(2,2,2,2).Текст 		= Нстр("ru='Отчет не сформирован. Нажмите ""Сформировать"" для получения отчета.';uk='Звіт не сформований. Натисніть ""Сформувати"" для одержання звіту.'");
