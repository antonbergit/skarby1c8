...
Процедура ПриОпределенииНастроекОтчета(НастройкиОтчета, НастройкиВариантов) Экспорт
	...
	НастройкиВариантов["Основной"].Теги = НСтр("ru='Деньги';uk='Гроші'");
...
Функция ПодготовитьПараметрыОтчета(НастройкиОтчета)
	...
	Если ПараметрВалютаИтогов <> Неопределено
		...
		ПараметрВалютаИтогов.ПредставлениеПользовательскойНастройки = НСтр("ru='Валюта итогов';uk='Валюта підсумків'");
