...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСтр("ru='Запасы,Закупки,Номенклатура,Комиссия';uk='Запаси,Закупівлі,Номенклатура,Комісія'");
	НастройкиВариантов["Остатки"].Теги = НСтр("ru='Запасы,Закупки,Номенклатура,Комиссия';uk='Запаси,Закупівлі,Номенклатура,Комісія'");
	НастройкиВариантов["ЗапасыВПереработке"].Теги = НСтр("ru='Запасы,Закупки,Номенклатура,Переработка,Производство';uk='Запаси,Закупівлі,Номенклатура,Переробка,Виробництво'");
	НастройкиВариантов["ЗапасыНаОтветхранении"].Теги = НСтр("ru='Запасы,Закупки,Номенклатура,Ответхранение';uk='Запаси,Закупівлі,Номенклатура,Відповідзберігання'");
