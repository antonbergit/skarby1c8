...
Процедура ОбновитьНастройкиНаФорме(НастройкиОтчета, НастройкиСКД, Форма) Экспорт
	...
	Форма,
	"СостояниеОтгрузки",
	НСтр("ru='Состояние отгрузки';uk='Стан відвантаження'"),
	...
	Форма,
	"СостояниеОплаты",
	НСтр("ru='Состояние оплаты';uk='Стан оплати'"),
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСтр("ru='Заказы,Контрагенты,Покупатели,Номенклатура,Отгрузки,Оплаты,Продажи,CRM';uk='Замовлення,Контрагенти,Покупці,Номенклатура,Відвантаження,Оплати,Продажі,CRM'");
	НастройкиВариантов["ВыполнениеИОплатаЗаказНарядов"].Теги = НСтр("ru='Заказы,Контрагенты,Покупатели,Номенклатура,Отгрузки,Оплаты,Работы';uk='Замовлення,Контрагенти,Покупці,Номенклатура,Відвантаження,Оплати,Роботи'");
