...
Функция ПолучитьВнешниеНаборыДанных(ПараметрыОтчета, МакетКомпоновки) Экспорт
	...
	Запрос.Текст =
	"ВЫБРАТЬ РАЗРЕШЕННЫЕ
	|	ЕСТЬNULL(МИНИМУМ(РасчетыСПоставщиками.Период), 0) КАК НачалоПериода,
	|	ЕСТЬNULL(МАКСИМУМ(РасчетыСПоставщиками.Период), 0) КАК КонецПериода
	|ИЗ
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["ДинамикаЗадолженности"].Теги = НСТР("ru='Деньги,Долги,Авансы,Поставщики';uk='Гроші,Борги,Аванси,Постачальники'");
