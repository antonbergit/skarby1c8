...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	Для Каждого НастройкиТекВарианта Из НастройкиВариантов Цикл
		НастройкиТекВарианта.Значение.Теги = НСтр("ru='Деньги,Долги,Дебиторка,Контрагенты,Покупатели,Продажи,CRM,Работы';uk='Гроші,Борги,Дебіторка,Контрагенти,Покупці,Продажі,CRM,Роботи'");
	КонецЦикла;
