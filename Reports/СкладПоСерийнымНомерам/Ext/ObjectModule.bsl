...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСтр("ru='Запасы,Закупки,Номенклатура,Товары,Серийные номера';uk='Запасы,Закупки,Номенклатура,Товары,Серийные номера'");
	НастройкиВариантов["Остатки"].Теги = НСтр("ru='Запасы,Закупки,Номенклатура,Товары,Серийные номера';uk='Запасы,Закупки,Номенклатура,Товары,Серийные номера'");
