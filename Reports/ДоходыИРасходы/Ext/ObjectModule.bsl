...
Процедура ПриОпределенииНастроекОтчета(НастройкиОтчета, НастройкиВариантов) Экспорт
	...
	НастройкиВариантов["ДоходыИРасходыПоЗаказам"].Рекомендуемый = Истина;
...
Процедура ЗаполнитьПредопределенныеВариантыОформления(НастройкиВариантов)
	...
	МассивПолейСумм = СтроковыеФункцииКлиентСервер.РазложитьСтрокуВМассивПодстрок("СуммаДоходовОборот,СуммаРасходовОборот,ОперационнаяПрибыльУбыток"); 
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСТР("ru='Компания,Доходы,Расходы,Направление деятельности';uk='Компания,Доходы,Расходы,Направление деятельности'");
	НастройкиВариантов["ДоходыИРасходыПоЗаказам"].Теги = НСТР("ru='Компания,Доходы,Расходы,Заказы';uk='Компанія,Доходи,Витрати,Замовлення'");
	НастройкиВариантов["ДинамикаДоходовИРасходов"].Теги = НСТР("ru='Компания,Доходы,Расходы,Направление деятельности';uk='Компания,Доходы,Расходы,Направление деятельности'");
	
КонецПроцедуры

Процедура ДобавитьОписанияСвязанныхПолей(НастройкиВариантов)
	
	ОтчетыУНФ.ДобавитьОписаниеПривязки(НастройкиВариантов["ДоходыИРасходыПоЗаказам"].СвязанныеПоля, "ЗаказПокупателя", "Документ.ЗаказПокупателя");
