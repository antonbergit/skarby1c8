...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["КалендарьСобытий"].Теги = НСтр("ru='CRM,События';uk='CRM,Події'");
	НастройкиВариантов["КалендарьСобытийПоОтветственным"].Теги = НСтр("ru='CRM,События';uk='CRM,Події'");
	НастройкиВариантов["КалендарьСобытийПоКонтактам"].Теги = НСтр("ru='CRM,События';uk='CRM,Події'");
	НастройкиВариантов["КалендарьСобытийПоТемам"].Теги = НСтр("ru='CRM,События';uk='CRM,Події'");
