...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	Для Каждого НастройкиТекВарианта Из НастройкиВариантов Цикл
		НастройкиТекВарианта.Значение.Теги = НСтр("ru='Запасы,Закупки,Деньги,Долги,Кредиторка,Контрагенты,Поставщики';uk='Запаси,Закупівлі,Гроші,Борги,Кредиторка,Контрагенти,Постачальники'");
	КонецЦикла;
