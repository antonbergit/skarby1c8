...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если НЕ ЗначениеЗаполнено(Организация) Тогда
		ВызватьИсключение НСтр("ru='Не заполнено значение обязательного параметра ""Организация""';uk='Не заповнено значення обов`язкового параметра ""Організація""'");
	КонецЕсли;
	Если НЕ ЗначениеЗаполнено(Склад) Тогда
		ВызватьИсключение НСтр("ru='Не заполнено значение обязательного параметра ""Склад""';uk='Не заповнено значення обов`язкового параметра ""Склад""'");
	КонецЕсли;
			...
			Пока Выборка.Следующий() Цикл
				...
				Иначе
					...
					Если ТипЗнч(Выборка.Регистратор) = Тип("ДокументСсылка.ОтчетОРозничныхПродажах")
						...
						СодержаниеОперации = НСтр("ru='Проданная продукция';uk='Продана продукція'");
						
					ИначеЕсли ТипЗнч(Выборка.Регистратор) = Тип("ДокументСсылка.РасходнаяНакладная")
						И Выборка.ВидОперации = Перечисления.ВидыОперацийРасходнаяНакладная.ВозвратПоставщику Тогда
						
						СодержаниеОперации = НСтр("ru='Продукция, возвращенная поставщику';uk='Продукція, повернута постачальникові'");
					...
					ИначеЕсли ТипЗнч(Выборка.Регистратор) = Тип("ДокументСсылка.СписаниеЗапасов") Тогда
						...
						СодержаниеОперации = НСтр("ru='Недостачи продукции';uk='Недостачі продукції'");
					...
					ИначеЕсли ТипЗнч(Выборка.Регистратор) = Тип("ДокументСсылка.ПеремещениеЗапасов")
						...
						СодержаниеОперации = НСтр("ru='Продукция, переданная в другое подразделение';uk='Продукція, передана в інший підрозділ'");
						
					Иначе
						
						СодержаниеОперации = НСтр("ru='Списанная продукция';uk='Списана продукція'");
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСтр("ru='Продажи';uk='Продажі'");
