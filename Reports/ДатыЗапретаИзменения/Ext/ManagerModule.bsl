...
Функция ПервыйВариант()
	...
	СвойстваВарианта.Вставить("Заголовок",
		НСтр("ru='Даты запрета изменения данных по пользователям';uk='Дати заборони зміни даних за користувачами'"));
	
	СвойстваВарианта.Вставить("Описание",
		НСтр("ru='Выводит даты запрета изменения, сгруппированные по пользователям.';uk='Виводить дати заборони зміни, згруповані по користувачах.'"));
...
Функция ВторойВариант()
	...
	Если Свойства.ПоказыватьРазделы И НЕ Свойства.ВсеРазделыБезОбъектов Тогда
		...
		ОписаниеВарианта =
			НСтр("ru='Выводит даты запрета изменения, сгруппированные по разделам с объектами.';uk='Виводить дати заборони зміни, згруповані по розділах з об`єктами.'");
	...
	ИначеЕсли Свойства.ВсеРазделыБезОбъектов Тогда
		...
		ОписаниеВарианта =
			НСтр("ru='Выводит даты запрета изменения, сгруппированные по разделам.';uk='Виводить дати заборони зміни, згруповані по розділах.'");
	Иначе
