...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСтр("ru='Деньги,Платежная карта,Безнал,Эквайринг';uk='Гроші,Платіжна картка,Безнал,Еквайринг'");
	НастройкиВариантов["ОсновнойБезРазнесенияПоОперациямОплаты"].Теги = НСтр("ru='Деньги,Платежная карта,Безнал,Эквайринг';uk='Гроші,Платіжна картка,Безнал,Еквайринг'");
