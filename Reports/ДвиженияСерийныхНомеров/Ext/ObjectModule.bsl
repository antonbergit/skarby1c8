...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСТР("ru='Номенклатура,Отгрузки,Запасы,Закупки,Остатки,Продажи,Серийные номера';uk='Номенклатура,Отгрузки,Запасы,Закупки,Остатки,Продажи,Серийные номера'");
