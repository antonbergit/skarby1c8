...
Процедура СформироватьЗаголовкиФормы(Параметры)
	...
	Если Параметры.ИмяНабораДанных = "КиЗ" Тогда
		Заголовок = НСтр("ru='Несопоставленные документы поступления и ""Заявки на выпуски КиЗ""';uk='Несопоставленные документы поступления и ""Заявки на выпуски КиЗ""'");
	...
	ИначеЕсли Параметры.ИмяНабораДанных = "МаркированныеТовары" Тогда
		Заголовок = НСтр("ru='Несопоставленные документы поступления и ""Уведомления о поступлении""';uk='Несопоставленные документы поступления и ""Уведомления о поступлении""'");
...
Процедура СформириватьПредставлениеОтборы(Параметры)
	...
	ТекстПредставленияОтбора = НСтр("ru='Номер КиЗ: %1, Организация : %2, Контрагент: %3.';uk='Номер КиЗ: %1, Организация : %2, Контрагент: %3.'");
