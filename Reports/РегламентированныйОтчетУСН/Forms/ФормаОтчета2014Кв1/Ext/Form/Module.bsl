...
Процедура ОбновитьПользовательскиеНастройки()
	...
	Сообщение.Текст = НСтр("ru='Изменилась версия формы отчета. Выполняется обновление пользовательских настроек...';uk='Изменилась версия формы отчета. Выполняется обновление пользовательских настроек...'");
	Сообщение.Сообщить();
	...
	Если ЕстьИзмененияВариантыЗаполнения ИЛИ ЕстьИзмененияНастройкаСтраниц Тогда
		...
		Сообщение.Текст = НСтр("ru='Обновление пользовательских настроек успешно завершено!';uk='Оновлення користувальницьких налаштувань успішно завершене!'");
		Сообщение.Сообщить();
		
	Иначе
		
		Сообщение.Текст = НСтр("ru='Изменения в структуре пользовательских настроек не обнаружены!';uk='Зміни в структурі користувальницьких налаштувань не виявлені!'");
		Сообщение.Сообщить();			
...
Процедура ОткрытьФормуВыбораСтраницЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если ЗначениеАвторасчета <> СтруктураРеквизитовФормы.ФлажокОтклАвтоРасчет Тогда
		...
		Если СтруктураРеквизитовФормы.ФлажокОтклАвтоРасчет = Ложь Тогда
			...
			ТекстВопроса = НСтр("ru='Будет произведен перерасчет всех рассчитываемых показателей. Продолжить?';uk='Будет произведен перерасчет всех рассчитываемых показателей. Продолжить?'");
...
Процедура ПроверитьТочность()
	...
	Если СтруктураРеквизитовФормы.ЕдиницаИзмерения = ПорядкиОкругленияОтчетности.ПеречислениеПорядкиОкругленияОтчетностиОкр1 Тогда
		...
		Если СтруктураРеквизитовФормы.ТочностьЕдиницыИзмерения > 2 Тогда
			...
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='%1: при выводе сумм в рублях точность не может превышать 2 знака';uk='%1: при выводе сумм в рублях точность не может превышать 2 знака'"), ЭтаФорма.Заголовок);
			Сообщение.Сообщить();
	...
	ИначеЕсли СтруктураРеквизитовФормы.ЕдиницаИзмерения = ПорядкиОкругленияОтчетности.ПеречислениеПорядкиОкругленияОтчетностиОкр1000 Тогда
		...
		Если СтруктураРеквизитовФормы.ТочностьЕдиницыИзмерения > 3 Тогда
			...
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='%1: при выводе сумм в тысячах рублей точность не может превышать 3 знака';uk='%1: при выводе сумм в тысячах рублей точность не может превышать 3 знака'"), ЭтаФорма.Заголовок);
			Сообщение.Сообщить();
	...
	ИначеЕсли СтруктураРеквизитовФормы.ЕдиницаИзмерения = ПорядкиОкругленияОтчетности.ПеречислениеПорядкиОкругленияОтчетностиОкр1000000 Тогда
		...
		Если СтруктураРеквизитовФормы.ТочностьЕдиницыИзмерения > 6 Тогда
			...
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='%1: при выводе сумм в миллионах рублей точность не может превышать 6 знаков';uk='%1: при выводе сумм в миллионах рублей точность не может превышать 6 знаков'"), ЭтаФорма.Заголовок);
			Сообщение.Сообщить();
...
"более чем на %4. Исправить?';uk='Сумма страховых взносов, выплаченных работникам пособий по временной"
"нетрудоспособности и платежей (взносов) по договорам добровольного"
"личного страхования (нарастающим итогом) по код%1 стр. %2,"
"предусмотренных пунктом 3.1 статьи 346.21 Кодекса, уменьшает сумму"
"исчисленного налога (авансового платежа по налогу) по код%1 стр. %3"
...
Процедура ОбработкаВыбораИФНС()
	...
	ИначеЕсли НЕ ЗначениеЗаполнено(КодИМНС) Тогда
		...
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru='Код налогового органа необходимо задать в справочнике ""Организации"".';uk='Код налогового органа необходимо задать в справочнике ""Организации"".'");
		Сообщение.Сообщить();
		
	Иначе
		
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru='Для выбора инспекции, необходимо завести соответствующую запись в справочнике ""Регистрации в налоговом органе"".';uk='Для выбора инспекции, необходимо завести соответствующую запись в справочнике ""Регистрации в налоговом органе"".'");
		Сообщение.Сообщить();
...
Процедура ОбработкаИзмененияСодержимогоВПолеТабличногоДокумента(Элемент, Область)
	...
	Если ИмяПоказателя = "ОКВЭД" Тогда
		...
		Если НЕ ПустаяСтрока(Область.Значение) И НЕ РегламентированнаяОтчетностьКлиентСервер.ОКВЭДСоответствуетТребованиям(Область.Значение) Тогда
			...
			Сообщение.Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='На титульном листе задано некорректное значение кода вида деятельности по ОКВЭД!%1Допустимы значения, соответствующие следующим шаблонам:%2""XX"", ""XX.X"", ""XX.XX"", ""XX.XX.X"", ""XX.XX.XX"" (X - любая цифра)';uk='На титульном листе задано некорректное значение кода вида деятельности по ОКВЭД!%1Допустимы значения, соответствующие следующим шаблонам:%2""XX"", ""XX.X"", ""XX.XX"", ""XX.XX.X"", ""XX.XX.XX"" (X - любая цифра)'"), Символы.ПС, Символы.ПС);
			Сообщение.Сообщить();
	...
	Если ИмяПоказателя = "П000210012003" Тогда
		...
		Если ЗначПоказателя > 6 Тогда
			Область.Значение = 6;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ru='Значение ставки налога не может быть больше 6%';uk='Значение ставки налога не может быть больше 6%'");
			Сообщение.Сообщить();
		КонецЕсли;
	...
	Если ИмяПоказателя = "П000220026003" ИЛИ ИмяПоказателя = "П000220026103"
		...
		Если ЗначПоказателя < 5 И ЗначПоказателя <> 0 Тогда
			Область.Значение = 5;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ru='Значение ставки налога не может быть меньше 5%';uk='Значение ставки налога не может быть меньше 5%'");
			Сообщение.Сообщить();
		ИначеЕсли ЗначПоказателя > 15 Тогда
			Область.Значение = 15;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ru='Значение ставки налога не может быть больше 15%';uk='Значение ставки налога не может быть больше 15%'");
			Сообщение.Сообщить();
		КонецЕсли;
	КонецЕсли;
	...
	Если (ИмяПоказателя = "П000110001003"
	  ...
	  ИЛИ ИмяПоказателя = "П000120009003")
		...
		Если НЕ ДлинаЗначения = 8 И НЕ ДлинаЗначения = 11 Тогда
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ru='Код ОКТМО должен состоять из 8 или 11 цифр';uk='Код ОКТМО должен состоять из 8 или 11 цифр'");
			Сообщение.Сообщить();
		КонецЕсли;
	КонецЕсли;
	...
	Если ИмяПоказателя = "П000210010203" Тогда
		...
		Если НЕ (ЗначПоказателя = "1" ИЛИ ЗначПоказателя = "2") Тогда
			...
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='В разделе 2.1 задано некорректное значение признака налогоплательщика!%1Допустимы значения 1 или 2';uk='В разделе 2.1 задано некорректное значение признака налогоплательщика!%1Допустимы значения 1 или 2'"), Символы.ПС);
			Сообщение.Сообщить();
...
Процедура ИзмененитьФормуПриИзмененииСтавки(Форма, НовоеЗначение, СтароеЗначение)
	...
	Если НовоеЗначение < 6 И СтароеЗначение = 6 Тогда
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru='Для ставки налога отличной от 6% используется форма, рекомендованная письмом ФНС от 20.05.2015 № ГД-4-3/8533@. Внимание! Для этой формы не предусмотрена печать на бланках с двухмерным штрихкодом PDF417.';uk='Для ставки налога отличной от 6% используется форма, рекомендованная письмом ФНС от 20.05.2015 № ГД-4-3/8533@. Внимание! Для этой формы не предусмотрена печать на бланках с двухмерным штрихкодом PDF417.'");
		Сообщение.Сообщить();
	ИначеЕсли НовоеЗначение = 6 И СтароеЗначение < 6 Тогда
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru='Для ставки налога 6% используется форма, утвержденная приказом ФНС России от 04.07.2014 № ММВ-7-3/352@.';uk='Для ставки налога 6% используется форма, утвержденная приказом ФНС России от 04.07.2014 № ММВ-7-3/352@.'");
		Сообщение.Сообщить();
	КонецЕсли;
...
Функция ПечатьНаСервере(ВидПечати)
	...
	Если СтруктураРеквизитовФормы.ЕдиницаИзмерения <> ПорядкиОкругленияОтчетности.ПеречислениеПорядкиОкругленияОтчетностиОкр1 ИЛИ СтруктураРеквизитовФормы.ТочностьЕдиницыИзмерения <> 0 Тогда
		...
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru='Печать возможна только при установленной единице измерения ""в рублях"" и точности ""0"".';uk='Печать возможна только при установленной единице измерения ""в рублях"" и точности ""0"".'");
		Сообщение.Сообщить();
		...
		Если Область.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Прямоугольник Тогда
			...
			Если РезультатПоиска = Неопределено Тогда
				...
				Если НЕ ЗначениеВыведено Тогда
					Сообщение = Новый СообщениеПользователю;
					Сообщение.Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Не удалось заполнить область ""%1""!';uk='Не удалось заполнить область ""%1""!'"), ИмяОбласти);
					Сообщение.Сообщить();
				КонецЕсли;
			Иначе
...
Процедура ПроверитьКС_1(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 1.1 (КС 1)';uk='Проверка раздела 1.1 (КС 1)'");
	ОписаниеКС     = НСтр("ru='Сумма налога, подлежащая уплате за налоговый период (строка 100 Раздел 1.1) должна быть равна (строка 133 - строка 143) Раздела 2.1 - (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.1, если результат вычитания (строка 133 - строка 143) Раздела 2.1 - (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.1 больше либо равен 0';uk='Сумма налога, подлежащая уплате за налоговый период (строка 100 Раздел 1.1) должна быть равна (строка 133 - строка 143) Раздела 2.1 - (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.1, если результат вычитания (строка 133 - строка 143) Раздела 2.1 - (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.1 больше либо равен 0'");
	
	Нарушение       = НСтр("ru='п.3 ст. 346.21 НК РФ';uk='п.3 ст. 346.21 НК РФ'");
	ОписаниеОшибки1 = НСтр("ru='Неправильно исчислена сумма налога, подлежащая уплате за налоговый период';uk='Неправильно исчислена сумма налога, подлежащая уплате за налоговый период'");
...
Процедура ПроверитьКС_2(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 1.1 (КС 2)';uk='Проверка раздела 1.1 (КС 2)'");
	ОписаниеКС     = НСтр("ru='Сумма налога, подлежащая уплате за налоговый период (строка 100 Раздел 1.1) должна быть равна 0, если (строка 133 - строка 143) Раздела 2.1 - (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.1  < 0';uk='Сумма налога, подлежащая уплате за налоговый период (строка 100 Раздел 1.1) должна быть равна 0, если (строка 133 - строка 143) Раздела 2.1 - (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.1  < 0'");
...
Процедура ПроверитьКС_3(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 1.2 (КС 3)';uk='Проверка раздела 1.2 (КС 3)'");
	ОписаниеКС     = НСтр("ru='Сумма налога, подлежащая уплате за налоговый период (строка 100 Раздел 1.2) должна быть равна строке 273 Раздела 2.2 - (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.2, если результат вычитания строка 273 Раздела 2.2 - (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.2 больше либо равен 0 и строка 273 Раздела 2.2 больше либо равна строки 280 Раздела 2.2';uk='Сумма налога, подлежащая уплате за налоговый период (строка 100 Раздел 1.2) должна быть равна строке 273 Раздела 2.2 - (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.2, если результат вычитания строка 273 Раздела 2.2 - (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.2 больше либо равен 0 и строка 273 Раздела 2.2 больше либо равна строки 280 Раздела 2.2'");
	
	Нарушение       = НСтр("ru='п.4 ст. 346.21 НК РФ';uk='п.4 ст. 346.21 НК РФ'");
	ОписаниеОшибки1 = НСтр("ru='Неправильно исчислена сумма налога, подлежащая уплате за налоговый период';uk='Неправильно исчислена сумма налога, подлежащая уплате за налоговый период'");
...
Процедура ПроверитьКС_4(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 1.2 (КС 4)';uk='Проверка раздела 1.2 (КС 4)'");
	ОписаниеКС     = НСтр("ru='Сумма налога, подлежащая уплате за налоговый период (строка 100 Раздела 1.2) должна быть равна 0, если результат от вычитания (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.2 из строки 273 Раздела 2.2 < 0';uk='Сумма налога, подлежащая уплате за налоговый период (строка 100 Раздела 1.2) должна быть равна 0, если результат от вычитания (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.2 из строки 273 Раздела 2.2 < 0'");
...
Процедура ПроверитьКС_6(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 1.1 (КС 6)';uk='Проверка раздела 1.1 (КС 6)'");
	ОписаниеКС     = НСтр("ru='Сумма налога к уменьшению за налоговый период (строка 110 Раздела 1.1) должна быть равна 0, если результат вычитания значений (строка 133 - строка 143) Раздела 2.1 - (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.1 больше либо равен 0';uk='Сумма налога к уменьшению за налоговый период (строка 110 Раздела 1.1) должна быть равна 0, если результат вычитания значений (строка 133 - строка 143) Раздела 2.1 - (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.1 больше либо равен 0'");
...
Процедура ПроверитьКС_7(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 1.2 (КС 7)';uk='Проверка раздела 1.2 (КС 7)'");
	ОписаниеКС     = НСтр("ru='Сумма налога к уменьшению за налоговый период (строка 110 Раздел 1.2) должна быть равна (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.2 - строка 273 Раздела 2.2, если строка 273 Раздела 2.2 ≥ строка 280 Раздела 2.2 и Строка 273 Раздела 2.2 - (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.2 < 0';uk='Сумма налога к уменьшению за налоговый период (строка 110 Раздел 1.2) должна быть равна (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.2 - строка 273 Раздела 2.2, если строка 273 Раздела 2.2 ≥ строка 280 Раздела 2.2 и Строка 273 Раздела 2.2 - (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.2 < 0'");
...
Процедура ПроверитьКС_8(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 1.2 (КС 8)';uk='Проверка раздела 1.2 (КС 8)'");
	ОписаниеКС     = НСтр("ru='Сумма налога к уменьшению за налоговый период (строка 110 Раздел 1.2) должна быть равна (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.2 - строка 280 Раздела 2.2, если строка 273 Раздела 2.2 < строка 280 Раздела 2.2 и (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.2 > строки 280 Раздела 2.2';uk='Сумма налога к уменьшению за налоговый период (строка 110 Раздел 1.2) должна быть равна (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.2 - строка 280 Раздела 2.2, если строка 273 Раздела 2.2 < строка 280 Раздела 2.2 и (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.2 > строки 280 Раздела 2.2'");
...
Процедура ПроверитьКС_9(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 1.2 (КС 9)';uk='Проверка раздела 1.2 (КС 9)'");
	ОписаниеКС     = НСтр("ru='Сумма налога к уменьшению за налоговый период (строка 110 Раздел 1.2) должна быть равна 0, если строка 273 Раздела 2.2 < строка 280 Раздела 2.2 и Строка 273 Раздела 2.2 - (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.2 > 0 или строка 273 Раздела 2.2 > строка 280 Раздела 2.2 и (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.2 < строки 280 Раздела 2.2';uk='Сумма налога к уменьшению за налоговый период (строка 110 Раздел 1.2) должна быть равна 0, если строка 273 Раздела 2.2 < строка 280 Раздела 2.2 и Строка 273 Раздела 2.2 - (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.2 > 0 или строка 273 Раздела 2.2 > строка 280 Раздела 2.2 и (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.2 < строки 280 Раздела 2.2'");
...
Процедура ПроверитьКС_10(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 1.2 (КС 10)';uk='Проверка раздела 1.2 (КС 10)'");
	ОписаниеКС     = НСтр("ru='Сумма минимального налога, подлежащая уплате за налоговый период (строка 120 Раздел 1.2) должна быть равна значению по строке 280 Раздел 2.2 - (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.2, если значение по строке 280 Раздела 2.2 > строки 273 Раздела 2.2 и строка 280 Раздела 2.2 > (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.2';uk='Сумма минимального налога, подлежащая уплате за налоговый период (строка 120 Раздел 1.2) должна быть равна значению по строке 280 Раздел 2.2 - (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.2, если значение по строке 280 Раздела 2.2 > строки 273 Раздела 2.2 и строка 280 Раздела 2.2 > (строка 020 + строка 040 - строка 050 + строка 070 - строка 080) Раздела 1.2'");
	
	Нарушение      = НСтр("ru='п. 6 ст. 346.18 НК РФ';uk='п. 6 ст. 346.18 НК РФ'");
	ОписаниеОшибки1 = НСтр("ru='Не исчислена сумма минимального налога за налоговый период';uk='Не исчислена сумма минимального налога за налоговый период'");
...
Процедура ПроверитьКС_12_1(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 2.2 (КС 12.1)';uk='Проверка раздела 2.2 (КС 12.1)'");
	ОписаниеКС     = НСтр("ru='Ставка налога (строка 260 Раздел 2.2) должна быть больше либо равна 5%, но меньше либо равна 15%';uk='Ставка налога (строка 260 Раздел 2.2) должна быть больше либо равна 5%, но меньше либо равна 15%'");
	
	Нарушение       = НСтр("ru='п.2 ст. 346.20 НК РФ';uk='п.2 ст. 346.20 НК РФ'");
	ОписаниеОшибки1 = НСтр("ru='Неправильное применение налоговой ставки';uk='Неправильное применение налоговой ставки'");
	...
	ЭтоОшибка, ОписаниеОшибки1, Нарушение,
		НСтр("ru='Исключение: Налоговая ставка налога может быть понижена для отдельных категорий налогоплательщиков (пп.3, 4 ст.346.20)';uk='Исключение: Налоговая ставка налога может быть понижена для отдельных категорий налогоплательщиков (пп.3, 4 ст.346.20)'"));
...
Процедура ПроверитьКС_12_2(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 2.2 (КС 12.2)';uk='Проверка раздела 2.2 (КС 12.2)'");
	ОписаниеКС     = НСтр("ru='Ставка налога (строка 261 Раздел 2.2) должна быть больше либо равна 5%, но меньше либо равна 15%';uk='Ставка налога (строка 261 Раздел 2.2) должна быть больше либо равна 5%, но меньше либо равна 15%'");
...
Процедура ПроверитьКС_12_3(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 2.2 (КС 12.3)';uk='Проверка раздела 2.2 (КС 12.3)'");
	ОписаниеКС     = НСтр("ru='Ставка налога (строка 262 Раздел 2.2) должна быть больше либо равна 5%, но меньше либо равна 15%';uk='Ставка налога (строка 262 Раздел 2.2) должна быть больше либо равна 5%, но меньше либо равна 15%'");
...
Процедура ПроверитьКС_12_4(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 2.2 (КС 12.4)';uk='Проверка раздела 2.2 (КС 12.4)'");
	ОписаниеКС     = НСтр("ru='Ставка налога (строка 263 Раздел 2.2) должна быть больше либо равна 5%, но меньше либо равна 15%';uk='Ставка налога (строка 263 Раздел 2.2) должна быть больше либо равна 5%, но меньше либо равна 15%'");
...
Процедура ПроверитьКС_16_1(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 2.2 (КС 16.1)';uk='Проверка раздела 2.2 (КС 16.1)'");
	ОписаниеКС     = НСтр("ru='Налоговая база для исчисления налога за первый квартал (строка 240 Раздел 2.2) должна быть равна результату вычитания значения строки 220 Раздела 2.2 из величины по строке 210 Раздела 2.2, если результат этого вычитания больше нуля';uk='Налоговая база для исчисления налога за первый квартал (строка 240 Раздел 2.2) должна быть равна результату вычитания значения строки 220 Раздела 2.2 из величины по строке 210 Раздела 2.2, если результат этого вычитания больше нуля'");
	
	Нарушение       = НСтр("ru='п. 2 и п. 7 ст. 346.18 НК РФ';uk='п. 2 и п. 7 ст. 346.18 НК РФ'");
	ОписаниеОшибки1 = НСтр("ru='Неверно определена налоговая база за отчетный период';uk='Неверно определена налоговая база за отчетный период'");
...
Процедура ПроверитьКС_16_2(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 2.2 (КС 16.2)';uk='Проверка раздела 2.2 (КС 16.2)'");
	ОписаниеКС     = НСтр("ru='Налоговая база для исчисления налога за полугодие (строка 241 Раздел 2.2) должна быть равна результату вычитания значения строки 221 Раздела 2.2 из величины по строке 211 Раздела 2.2, если результат этого вычитания больше 0';uk='Налоговая база для исчисления налога за полугодие (строка 241 Раздел 2.2) должна быть равна результату вычитания значения строки 221 Раздела 2.2 из величины по строке 211 Раздела 2.2, если результат этого вычитания больше 0'");
...
Процедура ПроверитьКС_16_3(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 2.2 (КС 16.3)';uk='Проверка раздела 2.2 (КС 16.3)'");
	ОписаниеКС     = НСтр("ru='Налоговая база для исчисления налога за девять месяцев (строка 242 Раздел 2.2) должна быть равна результату вычитания значения строки 222 Раздела 2.2 из величины по строке 212 Раздела 2.2, если результат этого вычитания больше 0';uk='Налоговая база для исчисления налога за девять месяцев (строка 242 Раздел 2.2) должна быть равна результату вычитания значения строки 222 Раздела 2.2 из величины по строке 212 Раздела 2.2, если результат этого вычитания больше 0'");
...
Процедура ПроверитьКС_16_4(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 2.2 (КС 16.4)';uk='Проверка раздела 2.2 (КС 16.4)'");
	ОписаниеКС     = НСтр("ru='Налоговая база для исчисления налога за налоговый период (строка 243 Раздел 2.2) должна быть равна результату вычитания значения строки 223 и 230 Раздела 2.2 из величины по строке 213 Раздела 2.2, если результат этого вычитания больше 0';uk='Налоговая база для исчисления налога за налоговый период (строка 243 Раздел 2.2) должна быть равна результату вычитания значения строки 223 и 230 Раздела 2.2 из величины по строке 213 Раздела 2.2, если результат этого вычитания больше 0'");
...
Процедура ПроверитьКС_18_1(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 2.2 (КС 18.1)';uk='Проверка раздела 2.2 (КС 18.1)'");
	ОписаниеКС     = НСтр("ru='Сумма убытка, полученного за первый квартал (строка 250 Раздел 2.2) должна быть равна разнице значений по строкам 220 и 210 Раздела 2.2, если значение строки 210 Раздела 2.2 меньше значения по строке 220 Раздела 2.2';uk='Сумма убытка, полученного за первый квартал (строка 250 Раздел 2.2) должна быть равна разнице значений по строкам 220 и 210 Раздела 2.2, если значение строки 210 Раздела 2.2 меньше значения по строке 220 Раздела 2.2'");
...
Процедура ПроверитьКС_18_2(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 2.2 (КС 18.2)';uk='Проверка раздела 2.2 (КС 18.2)'");
	ОписаниеКС     = НСтр("ru='Сумма убытка, полученного за полугодие (строка 251 Раздел 2.2) должна быть равна разнице значений по строкам 221 и 211 Раздела 2.2, если значение строки 211 Раздела 2.2 меньше значения по строке 221 Раздела 2.2';uk='Сумма убытка, полученного за полугодие (строка 251 Раздел 2.2) должна быть равна разнице значений по строкам 221 и 211 Раздела 2.2, если значение строки 211 Раздела 2.2 меньше значения по строке 221 Раздела 2.2'");
...
Процедура ПроверитьКС_18_3(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 2.2 (КС 18.3)';uk='Проверка раздела 2.2 (КС 18.3)'");
	ОписаниеКС     = НСтр("ru='Сумма убытка, полученного за девять месяцев (строка 252 Раздел 2.2) должна быть равна разнице значений по строкам 222 и 212 Раздела 2.2, если значение строки 212 Раздела 2.2 меньше значения по строке 222 Раздела 2.2';uk='Сумма убытка, полученного за девять месяцев (строка 252 Раздел 2.2) должна быть равна разнице значений по строкам 222 и 212 Раздела 2.2, если значение строки 212 Раздела 2.2 меньше значения по строке 222 Раздела 2.2'");
...
Процедура ПроверитьКС_18_4(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 2.2 (КС 18.4)';uk='Проверка раздела 2.2 (КС 18.4)'");
	ОписаниеКС     = НСтр("ru='Сумма убытка, полученного за налоговый период (строка 253 Раздел 2.2) должна быть равна разнице значений по строкам 223 и 213 Раздела 2.2, если значение строки 213 Раздела 2.2 меньше значения по строке 223 Раздела 2.2';uk='Сумма убытка, полученного за налоговый период (строка 253 Раздел 2.2) должна быть равна разнице значений по строкам 223 и 213 Раздела 2.2, если значение строки 213 Раздела 2.2 меньше значения по строке 223 Раздела 2.2'");
...
Процедура ПроверитьКС_19_1(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 2.2 (КС 19.1)';uk='Проверка раздела 2.2 (КС 19.1)'");
	ОписаниеКС     = НСтр("ru='Сумма исчисленного налога за первый квартал (строка 270 Раздела 2.2) должна быть равна произведению налоговой базы (строка 240 Раздел 2.2) и налоговой ставки (строка 260 Раздел 2.2) деленной на 100';uk='Сумма исчисленного налога за первый квартал (строка 270 Раздела 2.2) должна быть равна произведению налоговой базы (строка 240 Раздел 2.2) и налоговой ставки (строка 260 Раздел 2.2) деленной на 100'");
	
	Нарушение       = НСтр("ru='п. 1 ст. 246.21 НК РФ';uk='п. 1 ст. 246.21 НК РФ'");
	ОписаниеОшибки1 = НСтр("ru='Неверно исчислена сумма налога за налоговый период';uk='Неверно исчислена сумма налога за налоговый период'");
...
Процедура ПроверитьКС_19_2(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 2.2 (КС 19.2)';uk='Проверка раздела 2.2 (КС 19.2)'");
	ОписаниеКС     = НСтр("ru='Сумма исчисленного налога за полугодие (строка 271 Раздела 2.2) должна быть равна произведению налоговой базы (строка 241 Раздел 2.2) и налоговой ставки (строка 261 Раздел 2.2) деленой на 100';uk='Сумма исчисленного налога за полугодие (строка 271 Раздела 2.2) должна быть равна произведению налоговой базы (строка 241 Раздел 2.2) и налоговой ставки (строка 261 Раздел 2.2) деленой на 100'");
...
Процедура ПроверитьКС_19_3(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 2.2 (КС 19.3)';uk='Проверка раздела 2.2 (КС 19.3)'");
	ОписаниеКС     = НСтр("ru='Сумма исчисленного налога за девять месяцев (строка 272 Раздела 2.2) должна быть равна произведению налоговой базы (строка 242 Раздел 2.2) и налоговой ставки (строка 262 Раздел 2.2) деленой на 100';uk='Сумма исчисленного налога за девять месяцев (строка 272 Раздела 2.2) должна быть равна произведению налоговой базы (строка 242 Раздел 2.2) и налоговой ставки (строка 262 Раздел 2.2) деленой на 100'");
...
Процедура ПроверитьКС_19_4(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 2.2 (КС 19.4)';uk='Проверка раздела 2.2 (КС 19.4)'");
	ОписаниеКС     = НСтр("ru='Сумма исчисленного налога за налоговый период (строка 273 Раздела 2.2) должна быть равна произведению налоговой базы (строка 243 Раздел 2.2) и налоговой ставки (строка 263 Раздел 2.2) деленой на 100';uk='Сумма исчисленного налога за налоговый период (строка 273 Раздела 2.2) должна быть равна произведению налоговой базы (строка 243 Раздел 2.2) и налоговой ставки (строка 263 Раздел 2.2) деленой на 100'");
...
Процедура ПроверитьКС_21(СтруктураРезультата)
	...
	ТекстФормулы   = НСтр("ru='Проверка раздела 2.2 (КС 21)';uk='Проверка раздела 2.2 (КС 21)'");
	ОписаниеКС     = НСтр("ru='Сумма исчисленного минимального налога за налоговый период (строка 280 Раздел 2.2) должна быть равна 1% от значения по строке 213 Раздела 2.2';uk='Сумма исчисленного минимального налога за налоговый период (строка 280 Раздел 2.2) должна быть равна 1% от значения по строке 213 Раздела 2.2'");
...
Функция ПоказательПоСтроке(УсловныйКодПоказателя)
	...
	Если УсловныйКодПоказателя = "Р11Стр020" Тогда // Раздел 1.1
		...
		Результат.Вставить("Представление", НСтр("ru='Сумма авансового платежа к уплате по сроку не позднее 25-го апреля отчетного года';uk='Сумма авансового платежа к уплате по сроку не позднее 25-го апреля отчетного года'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р11Стр040" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru='Сумма авансового платежа к уплате по сроку не позднее 25-го июля отчетного года';uk='Сумма авансового платежа к уплате по сроку не позднее 25-го июля отчетного года'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
		
	ИначеЕсли УсловныйКодПоказателя = "Р11Стр050" Тогда
		Результат.Вставить("Имя", "П000110005003");
		Результат.Вставить("Представление", НСтр("ru='Сумма авансового платежа к уменьшению';uk='Сумма авансового платежа к уменьшению'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
		
	ИначеЕсли УсловныйКодПоказателя = "Р11Стр070" Тогда
		Результат.Вставить("Имя", "П000110007003");
		Результат.Вставить("Представление", НСтр("ru='Сумма авансового платежа к уплате по сроку не позднее 25-го октября отчетного года';uk='Сумма авансового платежа к уплате по сроку не позднее 25-го октября отчетного года'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р11Стр100" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru='Сумма налога, подлежащая доплате за налоговый период';uk='Сумма налога, подлежащая доплате за налоговый период'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
		
	ИначеЕсли УсловныйКодПоказателя = "Р11Стр110" Тогда
		Результат.Вставить("Имя", "П000110011003");
		Результат.Вставить("Представление", НСтр("ru='Сумма налога к уменьшению';uk='Сумма налога к уменьшению'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р12Стр120" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru='Сумма минимального налога, подлежащая уплате за налоговый период';uk='Сумма минимального налога, подлежащая уплате за налоговый период'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
		
	ИначеЕсли УсловныйКодПоказателя = "Р21Стр133" Тогда // Раздел 2.1
		Результат.Вставить("Имя", "П000210013303");
		Результат.Вставить("Представление", НСтр("ru='Сумма исчисленного налога за налоговый период';uk='Сумма исчисленного налога за налоговый период'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
		
	ИначеЕсли УсловныйКодПоказателя = "Р21Стр143" Тогда
		Результат.Вставить("Имя", "П000210014303");
		Результат.Вставить("Представление", НСтр("ru='Строка 143 Раздел 2.1.';uk='Строка 143 Раздел 2.1.'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
		
	ИначеЕсли УсловныйКодПоказателя = "Р22Стр210" Тогда // Раздел 2.2
		Результат.Вставить("Имя", "П000220021003");
		Результат.Вставить("Представление", НСтр("ru='Сумма полученных доходов нарастающим итогом';uk='Сумма полученных доходов нарастающим итогом'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р22Стр220" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru='Сумма произведенных расходов нарастающим итогом';uk='Сумма произведенных расходов нарастающим итогом'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р22Стр230" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru='Сумма убытка, полученного в предыдущем налоговом периоде';uk='Сумма убытка, полученного в предыдущем налоговом периоде'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
		
	ИначеЕсли УсловныйКодПоказателя = "Р22Стр240" Тогда
		Результат.Вставить("Имя", "П000220024003");
		Результат.Вставить("Представление", НСтр("ru='Налоговая база для исчисления налога (авансового платежа по налогу)';uk='Налоговая база для исчисления налога (авансового платежа по налогу)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р22Стр250" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru='Сумма полученного убытка за истекший налоговый (отчетный) период';uk='Сумма полученного убытка за истекший налоговый (отчетный) период'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р22Стр260" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru='Ставка налога (%)';uk='Ставка податку (%)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р22Стр270" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru='Сумма исчисленного налога (авансового платежа по налогу)';uk='Сумма исчисленного налога (авансового платежа по налогу)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
	...
	ИначеЕсли УсловныйКодПоказателя = "Р22Стр280" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru='Сумма исчисленного минимального налога за налоговый период (ставка налога 1%)';uk='Сумма исчисленного минимального налога за налоговый период (ставка налога 1%)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
...
Процедура ДобавитьЭлементВСтруктуруОшибок(СтруктураОшибок, ТекстФормулы, ОписаниеКС, ОбщееЧислоОшибок, ОбщееЧислоБезОшибок, Расшифровка,
	...
	СтруктураОшибок.Вставить("Описание" + Формат(ОбщееЧислоОшибок + ОбщееЧислоБезОшибок, "ЧГ=0"), СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='%1';uk='%1'"), Описание));
	СтруктураОшибок.Вставить("Нарушение" + Формат(ОбщееЧислоОшибок + ОбщееЧислоБезОшибок, "ЧГ=0"), СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='%1';uk='%1'"), Нарушение));
	СтруктураОшибок.Вставить("Расшифровка" + Формат(ОбщееЧислоОшибок + ОбщееЧислоБезОшибок, "ЧГ=0"), СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='%1';uk='%1'"), Расшифровка));
	СтруктураОшибок.Вставить("ЭтоОшибка" + Формат(ОбщееЧислоОшибок + ОбщееЧислоБезОшибок, "ЧГ=0"), ЭтоОшибка);
	СтруктураОшибок.Вставить("ТекстовоеПредставлениеФормулы" + Формат(ОбщееЧислоОшибок + ОбщееЧислоБезОшибок, "ЧГ=0"), СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='%1';uk='%1'"), ТекстовоеПредставлениеФормулы));
