...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСТР("ru='Покупатели,Номенклатура,Заказы,Отгрузки,Запасы,Закупки,Резервы,Продажи';uk='Покупці,Номенклатура,Замовлення,Відвантаження,Запаси,Закупівлі,Резерви,Продажі'");
