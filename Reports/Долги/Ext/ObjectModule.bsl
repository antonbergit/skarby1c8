...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Долги"].Теги = НСТР("ru='Главное,Запасы,Закупки,Продажи,Взаиморасчеты,Долги,Авансы,Контрагенты,Покупатели,Поставщики';uk='Головне,Запаси,Закупівлі,Продажі,Взаєморозрахунки,Борги,Аванси,Контрагенти,Покупці,Постачальники'");
...
Процедура ОбработатьШапкуИПодвал(ТабличныйДокумент)
	...
	Для ИндексСтроки = 1 По ТабличныйДокумент.ВысотаТаблицы Цикл
		...
		Для ИндексКолонки = 1 По ТабличныйДокумент.ШиринаТаблицы Цикл
			...
			ОбработатьЗаголовокКолонки(ИмяОбластиНачОст, ИндексКолонки, ИндексСтроки, ТабличныйДокумент, ТекстЗаголовка, НСтр("ru='(нач. ост.)';uk='(поч. зал.)'"));
			
			ОбработатьЗаголовокКолонки(ИмяОбластиКонОст, ИндексКолонки, ИндексСтроки, ТабличныйДокумент, ТекстЗаголовка, НСтр("ru='(кон. ост.)';uk='(кін. зал.)'"));
