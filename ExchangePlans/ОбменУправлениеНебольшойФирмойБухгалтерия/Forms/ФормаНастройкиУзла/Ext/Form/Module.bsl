...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИмяПланаОбмена = Метаданные.ПланыОбмена.ОбменУправлениеНебольшойФирмойБухгалтерия.Имя;
...
Процедура ОткрытьФормуОтбораПоВидамДокументов(Команда)
	...
	ОткрытьФорму("ПланОбмена.ОбменУправлениеНебольшойФирмойБухгалтерия.Форма.ФормаВыбораВидовДокументов",
		ПараметрыФормы,
		ЭтаФорма);
...
Процедура ОбновитьНаименованиеКомандФормы()
	...
	Если Организации.Количество() > 0 Тогда
		...
		НовыйЗаголовокОрганизаций = ПланыОбмена.ОбменУправлениеНебольшойФирмойБухгалтерия.СокращенноеПредставлениеКоллекцииЗначений(ВыбранныеОрганизации);
	...
	Если ВидыДокументов.Количество() > 0 Тогда
		...
		НовыйЗаголовокВидовДокументов = ПланыОбмена.ОбменУправлениеНебольшойФирмойБухгалтерия.СокращенноеПредставлениеКоллекцииЗначений(ВыбранныеВидыДокументов);
