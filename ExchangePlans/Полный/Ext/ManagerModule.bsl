...
Функция ИмяФайлаНастроекДляПриемника() Экспорт
	...
	Возврат НСтр("ru='Настройки обмена автономного рабочего места';uk='Налаштування обміну автономного робочого місця'");
...
Функция ОписаниеОграниченийПередачиДанных(НастройкаОтборовНаУзле, ВерсияКорреспондента, ИдентификаторНастройки) Экспорт
	...
	Если НастройкаОтборовНаУзле.ИспользоватьОтборПоОрганизациям Тогда
		...
		Возврат НСтр("ru='В автономном рабочем месте доступна только часть данных.';uk='В автономному робочому місці доступна тільки частина даних.'");
