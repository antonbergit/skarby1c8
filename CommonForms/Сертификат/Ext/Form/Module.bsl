...
"т.к. он не найден в справочнике.';uk='Не вдалося відкрити сертифікат ""%1"","
...
"по отпечатку ""%1"".';uk='Не вдалося відкрити сертифікат, тому що він не знайдений"
...
Процедура ПроверитьЗавершение(Результат, Неопределен) Экспорт
	...
	ИначеЕсли Результат <> Неопределено Тогда
		ПоказатьПредупреждение(, НСтр("ru='Сертификат недействителен по причине:';uk='Сертифікат недійсний через:'")
...
Процедура ЗаполнитьСвойстваСубъекта(Сертификат)
	...
	ПредставленияСвойств.Добавить("ОГРН",             НСтр("ru='ОГРН';uk='ОДРН'"));
	ПредставленияСвойств.Добавить("ОГРНИП",           НСтр("ru='ОГРНИП';uk='ОДРНІП'"));
	ПредставленияСвойств.Добавить("СНИЛС",            НСтр("ru='СНИЛС';uk='СНІОР'"));
