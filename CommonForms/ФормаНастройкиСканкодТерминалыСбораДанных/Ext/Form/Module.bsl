...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокИсточникЗагрузки.Добавить("Документ", НСтр("ru='Документ терминала сбора данных';uk='Документ термінала збору даних'"));
	СписокИсточникЗагрузки.Добавить("База",     НСтр("ru='База терминала сбора данных';uk='База термінала збору даних'"));
