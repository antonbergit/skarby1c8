...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ПоказатьНастройкиВнешнихПользователей Тогда
		...
		АвтоЗаголовок = Ложь;
		Заголовок = НСтр("ru='Настройки входа внешних пользователей';uk='Налаштування входу зовнішніх користувачів'");
...
"чтобы корректно использовать настройки входа.';uk='Встановлена мінімальна довжина паролів %1 і вимога складності паролів в конфігураторі"
"у меню ""Адміністрування"" в пункті ""Параметри інформаційної бази ...""."
""
"Потрібно очистити мінімальну довжину і вимогу складнощі пароля, задані в конфігураторі,"
"щоб коректно використовувати налаштування входу.'"),
...
"чтобы корректно использовать настройки входа.';uk='Встановлена мінімальна довжина паролів %1 в конфігураторі"
"у меню ""Адміністрування"" в пункті ""Параметри інформаційної бази ...""."
""
"Потрібно очистити мінімальну довжину, задану в конфігураторі,"
"щоб коректно використати налаштування входу.'"),
			ПолучитьМинимальнуюДлинуПаролейПользователей());
	КонецЕсли;
