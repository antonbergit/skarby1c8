...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокМодель.Добавить("14", НСтр("ru='Масса-К серии ПВ';uk='Маса-К серії ПВ'"));
	СписокМодель.Добавить("15", НСтр("ru='Масса-К серий ВТ, ВТМ';uk='Маса-К серій ВТ, ВТМ'"));
	СписокМодель.Добавить("16", НСтр("ru='Масса-К серий MK-A, MK-T';uk='Маса-К серій MK-A, MK-T'"));
	...
	СписокМодель.Добавить("29", НСтр("ru='Масса-К серий МК-ТВ, МК-ТН, ТВ-А';uk='Маса-К серій МК-ТВ, МК-ТН, ТВ-А'"));
