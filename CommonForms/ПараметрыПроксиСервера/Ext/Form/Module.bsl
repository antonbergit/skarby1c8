...
""
"Налаштування проксі-сервера виконується адміністратором.'");
	КонецЕсли;
	...
	Иначе
		АвтоЗаголовок = Ложь;
		Заголовок = НСтр("ru='Параметры прокси-сервера на сервере 1С:Предприятия';uk='Параметри проксі-сервера на сервері 1С:Підприємства'");
...
#Если ВебКлиент Тогда
		ПоказатьПредупреждение(, НСтр("ru='В веб-клиенте параметры прокси-сервера необходимо задавать в настройках браузера.';uk='У веб-клієнтові параметри проксі-сервера необхідно задавати в налаштуваннях браузера.'"));
		Отказ = Истина;
		Возврат;
#КонецЕсли
