...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЧастиСтроки.Добавить(СтрШаблон(НСтр("ru='На вашем компьютере одновременно установлены %1 криптопровайдера: ';uk='На вашем компьютере одновременно установлены %1 криптопровайдера: '"), Количество));
