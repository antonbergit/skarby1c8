...
Функция СформироватьТекст()
	...
	ТекстПисьма = СтрШаблон(
		...
		ИспользуетсяАвтоматическаяОтправкаДокументовНаПочту + ?(ИспользуетсяАвтоматическаяОтправкаДокументовСчета, ", " + Элементы.ИспользуетсяАвтоматическаяОтправкаДокументовСчета.Заголовок, "")  + ?(ИспользуетсяАвтоматическаяОтправкаДокументовАкты, ", " + Элементы.ИспользуетсяАвтоматическаяОтправкаДокументовАкты.Заголовок, "")
	);
