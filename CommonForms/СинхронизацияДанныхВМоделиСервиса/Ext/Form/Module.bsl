...
"В менеджері сервісу скористайтеся командою ""Синхронізація "
"даних"".'"));
		Иначе
...
"В менеджере сервиса воспользуйтесь командой ""Синхронизация данных"".';uk='Для налаштування синхронізації даних перейдіть в менеджер сервісу."
"В менеджері сервісу скористайтеся командою ""Синхронізація "
"даних"".'"));
		Иначе
		...
		Если Настройка.СинхронизацияНастроена Тогда
			...
			Если СтатусСинхронизации <> Неопределено Тогда
				...
				ИначеЕсли СтатусСинхронизации.Статус = 3 Тогда
					...
					Настройка.Состояние = НСтр("ru='Синхронизация данных настроена';uk='Синхронізація даних налаштована'");
