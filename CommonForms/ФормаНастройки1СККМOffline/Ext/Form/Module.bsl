...
Процедура ЗаписатьИЗакрыть(Команда)
	...
	Если ПустаяСтрока(КаталогВыгрузки) Тогда
		...
		ТекстОшибкиОбщий = ТекстОшибкиОбщий + НСтр("ru='Каталог выгрузки не указан.';uk='Каталог вивантаження не зазначений.'"); 
	КонецЕсли;
	...
	Если ПустаяСтрока(ИмяЗагружаемогоФайла) Тогда
		Результат = Ложь;
		ТекстОшибкиОбщий = ТекстОшибкиОбщий + ?(ПустаяСтрока(ТекстОшибкиОбщий), "", Символы.ПС); 
		ТекстОшибкиОбщий = ТекстОшибкиОбщий + НСтр("ru='Имя файла загрузки не указано.';uk='Ім`я файлу завантаження не зазначене.'"); 
	КонецЕсли;
	...
	Если Не ПустаяСтрока(ИмяЗагружаемогоФайла) И Не ПустаяСтрока(ИмяФайлаПрайсЛиста) Тогда
		Если Лев(ИмяЗагружаемогоФайла, СтрДлина(ИмяФайлаПрайсЛиста)) = ИмяФайлаПрайсЛиста Тогда
			Результат = Ложь;
			ТекстОшибкиОбщий = ТекстОшибкиОбщий + ?(ПустаяСтрока(ТекстОшибкиОбщий), "", Символы.ПС); 
			ТекстОшибкиОбщий = ТекстОшибкиОбщий + НСтр("ru='Имена файлов не должны пересекаться.';uk='Імена файлів не повинні перетинатися.'"); 
		КонецЕсли;
	КонецЕсли;
