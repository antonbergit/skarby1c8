...
""
"%1';uk='Не вдалося відкрити форму зміни пароля з причини:"
""
"%1'"),
...
Процедура УстановитьПароль(Команда)
	...
	Если Не ПоказыватьНовыйПароль И НовыйПароль <> Подтверждение Тогда
		...
		ПоказатьПредупреждение(, НСтр("ru='Подтверждение пароля указано некорректно.';uk='Підтвердження пароля зазначене некоректно.'"));
		Возврат;
	КонецЕсли;
