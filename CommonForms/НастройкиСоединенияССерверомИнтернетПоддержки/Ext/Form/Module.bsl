...
""
"Настройка параметров подключения к серверу Интернет-поддержки пользователей доступна только администратору системы.';uk='Недостатньо прав доступу."
""
"Налаштування параметрів підключення до сервера Інтернет-підтримки користувачів доступне тільки адміністраторові системи.'");
	КонецЕсли;
