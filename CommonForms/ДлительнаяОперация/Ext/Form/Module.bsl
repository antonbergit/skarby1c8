...
Процедура Подключаемый_ПроверитьВыполнениеЗадания()
	...
	ИначеЕсли Статус = "Ошибка" Тогда
		...
		Если ВозвращатьРезультатВОбработкуВыбора() Тогда
			...
			ПараметрыПредупреждения.Вставить("Заголовок", НСтр("ru='Не удалось выполнить запрошенное действие';uk='Не вдалося виконати запрошену дію'"));
...
Процедура ПоказатьОповещение()
	...
	ПоказатьОповещениеПользователя(?(Оповещение.Текст <> Неопределено, Оповещение.Текст, НСтр("ru='Действие выполнено';uk='Дію виконано'")), 
