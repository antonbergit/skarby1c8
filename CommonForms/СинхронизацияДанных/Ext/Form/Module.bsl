...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если СписокПлановОбмена.Количество() = 0 Тогда
		ТекстСообщения = НСтр("ru='Возможность настройки синхронизации данных не предусмотрена.';uk='Можливість налаштування синхронізації даних не передбачена.'");
...
"Остання спроба: %ДатаПопытки%'");
	...
	Иначе
		...
		РасписаниеСинхронизацииДанных = НСтр("ru='Расписание синхронизации не настроено';uk='Розклад синхронізації не налаштован'");;
