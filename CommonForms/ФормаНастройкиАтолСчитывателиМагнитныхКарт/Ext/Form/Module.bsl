...
Процедура ЗаписатьИЗакрытьВыполнить()
	...
	ИначеЕсли ДорожкаСПустымСуффиксом Тогда
		ТекстСообщения = НСтр("ru='Для каждой используемой дорожки должен быть указан не пустой суффикс.';uk='Для кожної використовуваної доріжки повинен бути зазначений не порожній суфікс.'");
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстСообщения);
	КонецЕсли;
