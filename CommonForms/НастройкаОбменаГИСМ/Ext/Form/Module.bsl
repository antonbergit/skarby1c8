	...
	Если СохраненныеНастройки <> Неопределено Тогда
		...
		Для Каждого СтрокаТЧ Из Настройки Цикл
			...
			Если ПарольУстановлен(СтрокаТЧ.Сертификат) Тогда
				СтрокаТЧ.Пароль = НСтр("ru='Установлен';uk='Встановлений'");
			Иначе
				СтрокаТЧ.Пароль = НСтр("ru='Не установлен';uk='Не встановлений'");
			КонецЕсли;
...
Процедура НастройкиПриИзменении(Элемент)
	...
	Если ПарольУстановлен(ТекущиеДанные.Сертификат) Тогда
		ТекущиеДанные.Пароль = НСтр("ru='Установлен';uk='Встановлений'");
	Иначе
		ТекущиеДанные.Пароль = НСтр("ru='Не установлен';uk='Не встановлений'");
	КонецЕсли;
