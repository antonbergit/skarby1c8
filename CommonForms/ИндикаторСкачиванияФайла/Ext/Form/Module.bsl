...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		ПоясняющийТекст = НСтр("ru='Загрузка файла...';uk='Завантаження файлу...'");
	КонецЕсли;
...
Процедура Подключаемый_ПроверитьВыполнениеЗадания()
	...
	Иначе
		...
		Элементы.Индикатор.Подсказка = СтрШаблон(НСтр("ru='Загружено %1 из %2';uk='Завантажене %1 з %2'"), Загружено, ОсталосьЗагрузить);
...
Процедура НачатьЗагрузкуФайла()
	...
	Результат = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
		...
		ПараметрыЗадания, НСтр("ru='Скачивание файла из Интернет';uk='Завантаження  файлу з Інтернет'"), Истина);
