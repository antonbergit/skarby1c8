...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтатусОтправки = НСтр("ru='Сообщение отправляется...';uk='Сообщение отправляется...'");
	...
	Заголовок = НСтр("ru='Отправка SMS на телефон';uk='Отправка SMS на телефон'") + " " + НомераПолучателей;
КонецПроцедуры
...
Процедура Отправить(Команда)
	...
	Если СтрДлина(ТекстСообщения) = 0 Тогда
		ПоказатьПредупреждение(, НСтр("ru='Необходимо ввести текст сообщения';uk='Необходимо ввести текст сообщения'"));
		Возврат;
	КонецЕсли;
...
"%1"
"Подробности см. в журнале регистрации.';uk='Сообщение не было отправлено:"
"%1"
...
"%1.';uk='Отправка сообщения выполнена. Состояние доставки:"
"%1.'");
...
Функция СтатусДоставки(ИдентификаторСообщения)
	...
	СтатусыДоставки.Вставить("Ошибка", НСтр("ru='произошла ошибка при подключении к провайдеру SMS';uk='произошла ошибка при подключении к провайдеру SMS'"));
	СтатусыДоставки.Вставить("НеОтправлялось", НСтр("ru='сообщение не отправлялось провайдером';uk='сообщение не отправлялось провайдером'"));
	СтатусыДоставки.Вставить("Отправляется", НСтр("ru='выполняется отправка провайдером';uk='выполняется отправка провайдером'"));
	СтатусыДоставки.Вставить("Отправлено", НСтр("ru='отправлено провайдером';uk='отправлено провайдером'"));
	СтатусыДоставки.Вставить("НеОтправлено", НСтр("ru='сообщение не отправлено провайдером';uk='сообщение не отправлено провайдером'"));
	СтатусыДоставки.Вставить("Доставлено", НСтр("ru='сообщение доставлено';uk='сообщение доставлено'"));
	СтатусыДоставки.Вставить("НеДоставлено", НСтр("ru='сообщение не доставлено';uk='сообщение не доставлено'"));
