...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокМодель.Добавить("3"  , НСтр("ru='Cipher CPT-711 (соединение с ПК через кабель)';uk='Cipher CPT-711 (з`єднання із ПК через кабель)'"));
	СписокМодель.Добавить("03" , НСтр("ru='Cipher CPT-720 (соединение с ПК через кабель)';uk='Cipher CPT-720 (з`єднання із ПК через кабель)'"));
	СписокМодель.Добавить("003", НСтр("ru='Cipher CPT-8300 (соединение с ПК через кабель)';uk='Cipher CPT-8300 (з`єднання із ПК через кабель)'"));
	СписокМодель.Добавить("4"  , НСтр("ru='Cipher CPT-800х (соединение с ПК через IR подставку)';uk='Cipher CPT-800х (з`єднання із ПК через IR підставку)'"));
	СписокМодель.Добавить("04" , НСтр("ru='Cipher CPT-8300 (соединение с ПК через IR подставку)';uk='Cipher CPT-8300 (з`єднання із ПК через IR підставку)'"));
	...
	СписокМодель.Добавить("07" , НСтр("ru='Терминалы Symbol SPT-1800 с установленным ПО АТОЛ:Mobile Logistics';uk='Термінали Symbol SPT-1800 із установленим ПЗ АТОЛ:Mobile Logistics'"));
	СписокМодель.Добавить("007", НСтр("ru='Терминалы Symbol SPT-1550 с установленным ПО АТОЛ:Mobile Logistics';uk='Термінали Symbol SPT-1550 із установленим ПЗ АТОЛ:Mobile Logistics'"));
	СписокМодель.Добавить("8"  , НСтр("ru='Cipher CPT-8x00 (соединение с ПК через подставку)';uk='Cipher CPT-8x00 (з`єднання із ПК через підставку)'"));
	СписокМодель.Добавить("9"  , НСтр("ru='Casio DT-900/DT-930';uk='Casio DT-900/DT-930'"));
	СписокМодель.Добавить("09" , НСтр("ru='Cipher CPT-800x/8300 (соединение с ПК через провод)';uk='Cipher CPT-800x/8300 (з`єднання із ПК через дріт)'"));
