...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокКодировка.Добавить(860, НСтр("ru='860 (OEM - португальский)';uk='860 (OEM - португальський)'"));
	СписокКодировка.Добавить(863, НСтр("ru='863 (OEM - франко-канадский)';uk='863 (OEM - франко-канадський)'"));
	СписокКодировка.Добавить(865, НСтр("ru='865 (OEM - скандинавский)';uk='865 (OEM - скандинавський)'"));
	СписокКодировка.Добавить(866, НСтр("ru='866 (OEM - русский)';uk='866 (OEM - російський)'"));
	СписокКодировка.Добавить(932, НСтр("ru='932 (ANSI/OEM - японский Shift-JIS)';uk='932 (ANSI/OEM - японський Shift-JIS)'"));
