...
Процедура ПроверитьЗаполнениеРеквизитовФормы(Отказ)
	...
	Для каждого СтрокаСписокОтобранныеАвансыИДолги Из СписокОтобранныеАвансыИДолги Цикл
		...
		И НЕ ЗначениеЗаполнено(СтрокаСписокОтобранныеАвансыИДолги.Курс) Тогда
			...
			Сообщение.Текст = НСтр("ru='Не заполнена колонка ""Курс"" в строке ';uk='Не заповнений стовпчик ""Курс"" у рядку'")
				+ Строка(НомерСтроки)
				+ НСтр("ru=' списка ""Отобранные авансы и долги"".';uk=' списку ""Відібрані аванси й борги"".'");
		...
		И НЕ ЗначениеЗаполнено(СтрокаСписокОтобранныеАвансыИДолги.Кратность) Тогда
			Сообщение = Новый СообщениеПользователю();
			Сообщение.Текст = НСтр("ru='Не заполнена колонка ""Кратность"" в строке ';uk='Не заповнений стовпчик ""Кратність"" у рядку'")
				+ Строка(НомерСтроки)
				+ НСтр("ru=' списка ""Отобранные авансы и долги"".';uk=' списку ""Відібрані аванси й борги"".'");
			Сообщение.Поле = "Документ";
			Сообщение.Сообщить();
		...
		Если НЕ ЗначениеЗаполнено(СтрокаСписокОтобранныеАвансыИДолги.СуммаРасчетов) Тогда
			Сообщение = Новый СообщениеПользователю();
			Сообщение.Текст = НСтр("ru='Не заполнена колонка ""Сумма расчетов"" в строке ';uk='Не заповнений стовпчик ""Сума розрахунків"" у рядку'")
				+ Строка(НомерСтроки)
				+ НСтр("ru=' списка ""Отобранные авансы и долги"".';uk=' списку ""Відібрані аванси й борги"".'");
			Сообщение.Поле = "Документ";
			Сообщение.Сообщить();
		...
		И НЕ ЗначениеЗаполнено(СтрокаСписокОтобранныеАвансыИДолги.СуммаУчета) Тогда
			Сообщение = Новый СообщениеПользователю();
			Сообщение.Текст = НСтр("ru='Не заполнена колонка ""Сумма учета"" в строке ';uk='Не заповнений стовпчик ""Сума обліку"" у рядку'")
				+ Строка(НомерСтроки)
				+ НСтр("ru=' списка ""Отобранные авансы и долги"".';uk=' списку ""Відібрані аванси й борги"".'");
			Сообщение.Поле = "Документ";
			Сообщение.Сообщить();
...
Процедура ДобавитьСтрокуВОтобранные(ТекущаяСтрока)
	...
	Если ЗапрашиватьСумму Тогда
		...
		ПоказатьВводЧисла(ОписаниеОповещения, СуммаРасчетов, НСтр("ru='Введите сумму расчетов';uk='Введіть суму розрахунків'"));
