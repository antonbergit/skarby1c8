...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокМодель.Добавить(0 , НСтр("ru='Штрих-М: ЭЛВЕС-МИКРО-Ф';uk='Штрих-М: ЭЛВЕС-МІКРО-Ф'"));
	СписокМодель.Добавить(13, НСтр("ru='АТОЛ: Триум-Ф версия 01';uk='АТОЛ: Триум-Ф версія 01'"));
	СписокМодель.Добавить(14, НСтр("ru='АТОЛ: ФЕЛИКС-РФ версия 02';uk='АТОЛ: ФЕЛІКС-РФ версія 02'"));
	СписокМодель.Добавить(15, НСтр("ru='АТОЛ: ФЕЛИКС-02К/ЕНВД версия 01';uk='АТОЛ: ФЕЛІКС-02 ДО/ЕНВД версія 01'"));
	СписокМодель.Добавить(16, НСтр("ru='АТОЛ: МЕРКУРИЙ-140Ф версия 02';uk='АТОЛ: МЕРКУРІЙ-140Ф версія 02'"));
	СписокМодель.Добавить(16, НСтр("ru='АТОЛ: МЕРКУРИЙ-140Ф версия 03';uk='АТОЛ: МЕРКУРІЙ-140Ф версія 03'"));
	СписокМодель.Добавить(17, НСтр("ru='Инкотекс: МЕРКУРИЙ 114.1Ф версия 01';uk='Інкотекс: МЕРКУРІЙ 114.1Ф версія 01'"));
	СписокМодель.Добавить(17, НСтр("ru='Инкотекс: МЕРКУРИЙ 114.1Ф версия 02';uk='Інкотекс: МЕРКУРІЙ 114.1Ф версія 02'"));
	СписокМодель.Добавить(18, НСтр("ru='Штрих-М: ШТРИХ-ФР-Ф версия 03';uk='Штрих-М: ШТРИХ-ФР-Ф версія 03'"));
	СписокМодель.Добавить(18, НСтр("ru='Штрих-М: ШТРИХ-ФР-Ф версия 04';uk='Штрих-М: ШТРИХ-ФР-Ф версія 04'"));
	СписокМодель.Добавить(19, НСтр("ru='Штрих-М: ЭЛВЕС-МИНИ-ФР-Ф версия 02';uk='Штрих-М: ЭЛВЕС-МІНІ-ФР-Ф версія 02'"));
	СписокМодель.Добавить(20, НСтр("ru='АТОЛ: ТОРНАДО (МЕРКУРИЙ-114.1 Ф версия 04)';uk='АТОЛ: ТОРНАДО (МЕРКУРІЙ-114.1 Ф версія 04)'"));
	СписокМодель.Добавить(23, НСтр("ru='АТОЛ: ТОРНАДО-К (МЕРКУРИЙ MS-K версия 02)';uk='АТОЛ: ТОРНАДО- ДО (МЕРКУРІЙ MS-K версія 02)'"));
	СписокМодель.Добавить(24, НСтр("ru='АТОЛ: ФЕЛИКС-РК/ЕНВД версия 01';uk='АТОЛ: ФЕЛІКС-РК/ЕНВД версія 01'"));
	СписокМодель.Добавить(25, НСтр("ru='Штрих-М: ШТРИХ-ФР-К версия 01';uk='Штрих-М: ШТРИХ-ФР-К версія 01'"));
	СписокМодель.Добавить(26, НСтр("ru='Штрих-М: ЭЛВЕС-ФР-К версия 01';uk='Штрих-М: ЭЛВЕС-ФР-К версія 01'"));
	СписокМодель.Добавить(27, НСтр("ru='АТОЛ: ФЕЛИКС-3СК версия 01';uk='АТОЛ: ФЕЛІКС-3СК версія 01'"));
	СписокМодель.Добавить(28, НСтр("ru='Штрих-М: ШТРИХ-МИНИ-ФР-К версия 01';uk='Штрих-М: ШТРИХ-МІНІ-ФР-К версія 01'"));
	СписокМодель.Добавить(30, НСтр("ru='АТОЛ: FPrint-02K/ЕНВД';uk='АТОЛ: Fprint-02K/ЕНВД'"));
	СписокМодель.Добавить(31, НСтр("ru='АТОЛ: FPrint-03K/ЕНВД';uk='АТОЛ: Fprint-03K/ЕНВД'"));
	СписокМодель.Добавить(32, НСтр("ru='АТОЛ: FPrint-88K/ЕНВД';uk='АТОЛ: Fprint-88K/ЕНВД'"));
	СписокМодель.Добавить(33, НСтр("ru='АТОЛ: BIXOLON-01K';uk='АТОЛ: BIXOLON-01K'"));
	СписокМодель.Добавить(35, НСтр("ru='АТОЛ: FPrint-5200K/ЕНВД';uk='АТОЛ: Fprint-5200K/ЕНВД'"));
	СписокМодель.Добавить(41, НСтр("ru='АТОЛ: PayVKP-80K';uk='АТОЛ: Payvkp-80K'"));
	СписокМодель.Добавить(42, НСтр("ru='АТОЛ: Аура-01ФРKZ';uk='АТОЛ: Аура-01ФРKZ'"));
	СписокМодель.Добавить(43, НСтр("ru='АТОЛ: PayVKP-80KZ';uk='АТОЛ: Payvkp-80KZ'"));
	СписокМодель.Добавить(45, НСтр("ru='АТОЛ: PayPPU-700K';uk='АТОЛ: Payppu-700K'"));
	СписокМодель.Добавить(46, НСтр("ru='АТОЛ: PayCTS-2000K';uk='АТОЛ: Paycts-2000K'"));   
	СписокМодель.Добавить(47, НСтр("ru='АТОЛ: FPrint-55K/ЕНВД';uk='АТОЛ: Fprint-55K/ЕНВД'"));
	СписокМодель.Добавить(50, НСтр("ru='АТОЛ: Wincor Nixdorf TH-230K';uk='АТОЛ: Wincor Nixdorf TH-230K'"));
	СписокМодель.Добавить(51, НСтр("ru='АТОЛ: FPrint-11K/ПТК/ЕНВД';uk='АТОЛ: Fprint-11K/ПТК/ЕНВД'"));
	СписокМодель.Добавить(52, НСтр("ru='АТОЛ: FPrint-22K/ПТК/ЕНВД';uk='АТОЛ: Fprint-22K/ПТК/ЕНВД'"));
	СписокМодель.Добавить(53, НСтр("ru='АТОЛ: FPrint-77ПТК/ЕНВД';uk='АТОЛ: Fprint-77ПТК/ЕНВД'"));
	СписокМодель.Добавить(101, НСтр("ru='ПИЛОТ: POSPrint FP410K';uk='ПІЛОТ: POSPrint FP410K'"));
	СписокМодель.Добавить(102, НСтр("ru='МультиСофт: MSTAR-Ф';uk='МультиСофт: MSTAR-Ф'"));
	СписокМодель.Добавить(103, НСтр("ru='Мария-301 МТМ Т7';uk='Марія-301 МТМ Т7'"));
	СписокМодель.Добавить(104, НСтр("ru='Искра: ПРИМ-88ТК';uk='Іскра: ПРИМ-88ТК'"));
	СписокМодель.Добавить(105, НСтр("ru='Искра: ПРИМ-08ТК';uk='Іскра: ПРИМ-08ТК'"));
	СписокМодель.Добавить(106, НСтр("ru='СЕРВИС ПЛЮС: СП101ФР-К';uk='СЕРВІС ПЛЮС: СП101ФР-К'"));
	СписокМодель.Добавить(107, НСтр("ru='Штрих-М: ШТРИХ-КОМБО-ФР-К';uk='Штрих-М: ШТРИХ-КОМБО-ФР-К'"));
	СписокМодель.Добавить(108, НСтр("ru='Искра: ПРИМ-07К';uk='Іскра: ПРИМ-07 ДО'"));
	СписокМодель.Добавить(109, НСтр("ru='Юнисистем: МИНИ-ФП6';uk='Юнісістем: МІНІ-ФП6'"));
	СписокМодель.Добавить(110, НСтр("ru='Штрих-М: ШТРИХ-М-ФР-К';uk='Штрих-М: ШТРИХ-М-ФР-К'"));
	СписокМодель.Добавить(111, НСтр("ru='МультиСофт: MSTAR-TK.1';uk='МультиСофт: MSTAR-TK.1'"));
	СписокМодель.Добавить(113, НСтр("ru='Штрих-М: ШТРИХ-LIGHT-ФР-К';uk='Штрих-М: ШТРИХ-LIGHT-ФР-К'"));
	СписокМодель.Добавить(114, НСтр("ru='КристаллСервис: ПИРИТ ФР01К';uk='КристалСервіс: ПІРІТ ФР01К'"));
	СписокМодель.Добавить(115, НСтр("ru='Штрих-М: NCR-001К';uk='Штрих-М: NCR-001К'"));
	СписокМодель.Добавить(118, НСтр("ru='Штрих-М: ШТРИХ-ФР-К (БЕЛАРУСЬ)';uk='Штрих-М: ШТРИХ-ФР-К (БІЛОРУСЬ)'"));
...
"Перейти на сайт поставщика для скачивания?';uk='Установка проводиться засобами дистрибутива постачальника."
"Перейти на сайт постачальника для завантаження?'");
