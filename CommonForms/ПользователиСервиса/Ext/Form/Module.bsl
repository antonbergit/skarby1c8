...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если РежимРаботы = Перечисления.РежимыИспользованияИнформационнойБазы.Демонстрационный Тогда
		ВызватьИсключение(НСтр("ru='В демонстрационном режиме не доступно добавление новых пользователей';uk='У демонстраційному режимі не доступно додавання нових "
"користувачів'"));
	КонецЕсли;
