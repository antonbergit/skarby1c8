...
Функция ВыполнитьПроверку()
	...
	Если ПредставительЯвляетсяЮЛ Тогда
		...
		Если ЗначениеЗаполнено(ПредставительЮЛ_ИНН) И НЕ РегламентированнаяОтчетностьВызовСервера.ИННСоответствуетТребованиямНаСервере(ПредставительЮЛ_ИНН, Ложь) Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru='Некорректно задан ИНН организации-представителя';uk='Некорректно задан ИНН организации-представителя'"), , "ПредставительЮЛ_ИНН", , );
			ВсеОК = Ложь;
		КонецЕсли;
		...
		Если ЗначениеЗаполнено(ПредставительЮЛ_КПП) И НЕ РегламентированнаяОтчетностьКлиентСервер.КППСоответствуетТребованиям(ПредставительЮЛ_КПП) Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru='Некорректно задан КПП организации-представителя';uk='Некорректно задан КПП организации-представителя'"), , "ПредставительЮЛ_КПП", , );
			ВсеОК = Ложь;
		КонецЕсли;
		...
		Если ЗначениеЗаполнено(ПредставительЮЛ_ОГРН) И СтрДлина(СокрЛП(ПредставительЮЛ_ОГРН)) <> 13 Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru='Некорректно задан ОГРН организации-представителя';uk='Некорректно задан ОГРН организации-представителя'"), , "ПредставительЮЛ_ОГРН", , );
			ВсеОК = Ложь;
		КонецЕсли;
	...
	Если ЗначениеЗаполнено(ПредставительФЛ_ИНН) И НЕ РегламентированнаяОтчетностьВызовСервера.ИННСоответствуетТребованиямНаСервере(ПредставительФЛ_ИНН, Истина) Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru='Некорректно задан ИНН физлица-представителя';uk='Некорректно задан ИНН физлица-представителя'"), , "ПредставительФЛ_ИНН", , );
		ВсеОК = Ложь;
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(ПредставительФЛ_ОГРН) И СтрДлина(СокрЛП(ПредставительФЛ_ОГРН)) <> 15 Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru='Некорректно задан ОГРН физлица-представителя';uk='Некорректно задан ОГРН физлица-представителя'"), , "ПредставительФЛ_ОГРН", , );
		ВсеОК = Ложь;
	КонецЕсли;
	Возврат ВсеОК;
