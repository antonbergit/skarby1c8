...
Функция ИнформацияОСервисе()
	...
	ЧастиСтроки.Добавить(НСтр("ru='В программе имеется возможность использовать веб-сервис ФНС для проверки регистрации контрагентов в ЕГРН';uk='В программе имеется возможность использовать веб-сервис ФНС для проверки регистрации контрагентов в ЕГРН'"));
	Если ЭтоЗапускПроверкиПослеЗаполнения Тогда
		ЧастиСтроки.Добавить(НСтр("ru=' после заполнения декларации';uk=' после заполнения декларации'"));
	КонецЕсли;
	ЧастиСтроки.Добавить(НСтр("ru=' (требуется доступ в интернет).';uk=' (требуется доступ в интернет).'"));
