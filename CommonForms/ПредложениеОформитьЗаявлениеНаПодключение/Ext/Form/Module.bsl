...
Процедура ПриОткрытии(Отказ)
	...
	ИначеЕсли ЗначениеЗаполнено(НастройкаЭДО) Тогда
		...
		ОткрытьФорму("Справочник.СоглашенияОбИспользованииЭД.Форма.ФормаПриглашения",
			ПараметрыФормы, ЭтаФорма, , ВариантОткрытияОкна.ОтдельноеОкно, , , РежимОткрытияОкнаФормы.Независимый);
...
Процедура УстановитьВидимостьЭлементов()
	...
	Элементы.ДекорацияПроверка.Заголовок = НСтр("ru='Из этой программы можно обмениваться электронными документами с контрагентами.';uk='Из этой программы можно обмениваться электронными документами с контрагентами.'");
	
	Если КонтрагентВ1СЭДО Тогда
		ШаблонТекстаДекорации = НСтр("ru='С контрагентом ""%1"" можно обмениваться электронными документами"
"из этой программы.';uk='С контрагентом ""%1"" можно обмениваться электронными документами"
"из этой программы.'");
