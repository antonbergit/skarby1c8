...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Валюта) Тогда
		...
		СтрокаНовогоЗаголовка 						= Нстр("ru='Товаров подобрано на сумму (%ВВалюте%)';uk='Товарів підібране на суму (%ВВалюте%)'");
...
Процедура ОрганизацияПриИзменении(Элемент)
	...
	Иначе
		...
		Сообщение.Текст 		= НСтр("ru='Для обновление данных формы заполните организацию';uk='Для відновлення даних форми заповните організацію'");
