...
"и использования в режиме сервиса.';uk='Дані з локальної версії будуть вивантажені в файл для "
"подальшого їх завантаження"
...
""
"Розширена інформація для служби підтримки записана в журнал реєстрації. Якщо Вам невідома причина помилки - рекомендується звернутися в службу технічної підтримки, надавши для "
"розслідування інформаційну базу і вивантаження журналу реєстрації.'");
