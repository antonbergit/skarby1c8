...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Гунько 2020-12-06
	гвУстановитьВидимостьЭлементов();
...
// Гунько 2020-12-06
&НаСервере
Процедура гвУстановитьВидимостьЭлементов()
	Элементы.ОперацииСпецификация.Видимость = Ложь;
	Элементы.ОперацииЗаказ.Видимость = Ложь;
	Элементы.ОперацииКоличествоПлан.Видимость = Ложь;
	Элементы.ОперацииНормаВремени.Видимость = Ложь;
	Элементы.ОперацииНормочасы.Видимость = Ложь;
КонецПроцедуры	

&НаКлиенте
Процедура ОперацииПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	Если НоваяСтрока И НЕ Копирование Тогда
		Элемент.ТекущиеДанные.КоличествоФакт = 1;
		Элемент.ТекущиеДанные.Период = ТекущаяДата();
	КонецЕсли;
	Если Копирование Тогда
		Элемент.ТекущиеДанные.гвСерийныйНомер = ПредопределенноеЗначение("Справочник.СерийныеНомера.ПустаяСсылка");
	КонецЕсли;
КонецПроцедуры
// ...Гунько 2020-12-06
