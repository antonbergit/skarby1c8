...
Процедура ЗаполнитьПоЗаказуНаПроизводство(ДокументСсылкаЗаказНаПроизводство) Экспорт
	...
	Если ДокументСсылкаЗаказНаПроизводство.СтруктурнаяЕдиница.ТипСтруктурнойЕдиницы = Перечисления.ТипыСтруктурныхЕдиниц.Склад Тогда
		ВызватьИсключение НСтр("ru='Сдельный наряд не может быть введен на основании заказа на производство по складу!';uk='Відрядний наряд не може бути введений на підставі замовлення на виробництво по складу!'");
	КонецЕсли;
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	// Гунько 2020-12-06
	УправлениеНебольшойФирмойСервер.гвОтразитьСдельныеНарядыПоСерийныхНомерах(ДополнительныеСвойства, Движения, Отказ);
	// ...Гунько 2020-12-06
