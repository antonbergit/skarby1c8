...
Процедура Перезаполнить(Команда)
	...
	спсОтвет.Добавить(КодВозвратаДиалога.Да,НСтр("ru='Перезаполнить';uk='Перезаповнити'"));
	...
	Если Объект.ПоказателиЕНВД.Количество() > 0 Тогда
		...
		ПоказатьВопрос(оп,НСтр("ru='Табличная часть будет очищена';uk='Таблична частина буде очищена'"),спсОтвет);
		Возврат;
	КонецЕсли;
...
Процедура НастроитьФорму()
	...
	Элементы.ПоказателиЕНВДЗаголовок1.Заголовок = 
		...
		+ Объект.ДнейВсего1 
		+ " "
		+ ПодобратьСловоПодЧисло(Объект.ДнейВсего1, НСтр("ru='день';uk='день'"),НСтр("ru='дня';uk='дні'"),НСтр("ru='дней';uk='днів'"))
		+ ")";
	...
	Элементы.ПоказателиЕНВДЗаголовок2.Заголовок = 
		...
		+ Объект.ДнейВсего2 
		+ " "
		+ ПодобратьСловоПодЧисло(Объект.ДнейВсего2, НСтр("ru='день';uk='день'"),НСтр("ru='дня';uk='дні'"),НСтр("ru='дней';uk='днів'"))
		+ ")";
	...
	Элементы.ПоказателиЕНВДЗаголовок3.Заголовок = 
		...
		+ Объект.ДнейВсего3 
		+ " "
		+ ПодобратьСловоПодЧисло(Объект.ДнейВсего3, НСтр("ru='день';uk='день'"),НСтр("ru='дня';uk='дні'"),НСтр("ru='дней';uk='днів'"))
		+ ")";
