		...
		Для каждого СтрокаЗапасы Из Запасы Цикл
			Если СтрокаЗапасы.Номенклатура.ИспользоватьСерийныеНомера Тогда
				...
				Если ОтборСерийныеНомера.Количество() <> СтрокаЗапасыКоличество Тогда
					ТекстСообщения = НСтр("ru='Число серийных номеров отличается от количества единиц в строке %Номер%.';uk='Число серійних номерів відрізняється від кількості одиниць в рядку %Номер%.'");
