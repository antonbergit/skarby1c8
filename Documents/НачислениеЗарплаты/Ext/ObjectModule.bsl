...
Функция ПолучитьСуммуДокумента() Экспорт
    ...
    Массив = Новый Массив;
	СтруктураВозврата = Новый Структура("СуммаНачислено, СуммаУдержано, СуммаДокумента, СуммаПогашено, СуммаВзносов, СуммаВзносовФОТ", 0, 0, 0, 0, 0, 0);
	
	СтруктураВозврата.СуммаВзносов = Взносы.Итог("Сумма");
	СтруктураВозврата.СуммаВзносовФОТ = ВзносыФОТ.Итог("Сумма");
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Сотрудники.ОтразитьДвиженияПоВзаиморасчетыПоНДФЛ(ДополнительныеСвойства, Движения, Отказ);
