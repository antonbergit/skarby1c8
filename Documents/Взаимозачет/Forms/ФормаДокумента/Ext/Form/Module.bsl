...
Процедура ПодборРасчетыСПокупателем(Команда)
	...
	Если НЕ ЗначениеЗаполнено(Объект.КонтрагентИсточник) Тогда
		ПоказатьПредупреждение(, НСтр("ru='Укажите вначале покупателя!';uk='Вкажіть спочатку покупця!'"));
		Возврат;
	КонецЕсли;
...
Процедура ПодборРасчетыСПоставщиком(Команда)
	...
	Если НЕ ЗначениеЗаполнено(Объект.Контрагент) Тогда
		ПоказатьПредупреждение(, НСтр("ru='Укажите вначале поставщика!';uk='Вкажіть спочатку постачальника!'"));
		Возврат;
	КонецЕсли;
...
Процедура ЗаполнитьПоДокументуОснованию(Команда)
	...
	Если НЕ ЗначениеЗаполнено(Объект.ДокументОснование) Тогда
		...
		Сообщение.Текст			= НСтр("ru='Выберите документ основание.';uk='Виберіть документ підставу.'");
	...
	ТекстВопроса 	= НСтр("ru='Документ будит очищен и заполнен по документу-основанию. Продолжить?';uk='Документ буде очищений і заповнений по документу-підставі. Продовжити?'");
	Ответ = Неопределено;
...
""
"Продолжить запись документа?';uk='Документ оформлений у декількох валютах не буде перенесений в ""Бухгалтерію підприємства""."
""
"Продовжити запис документа?'");
...
""
"Продолжить запись документа?';uk='Документ, у якого сума авансів у табличній частині ""Розрахунки з покупцем"" не відповідає"
"сумі авансів у табличній частині ""Розрахунки з постачальником"" не буде перенесений в ""Бухгалтерію підприємства""."
""
"Продовжити запис документа?'");
