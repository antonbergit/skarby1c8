...
Процедура СоздатьПриходнуюНакладную(Команда)
	...
	Иначе
		...
		Если СтруктураДанных.СформироватьНесколькоЗаказов Тогда
			...
			ТекстСообщения = НСтр("ru='Заказы отличаются данными (%ПредставлениеДанных%) шапки документов! Сформировать несколько приходных накладных?';uk='Замовлення відрізняються даними (%ПредставлениеДанных%) шапки документів! Сформувати декілька прибуткових накладних?'");
