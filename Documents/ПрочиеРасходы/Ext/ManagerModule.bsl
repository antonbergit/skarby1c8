...
Процедура СформироватьТаблицаРасчетыСПрочимиКонтрагентами(ДокументСсылкаПрочиеРасходы, СтруктураДополнительныеСвойства)
	...
	Запрос.УстановитьПараметр("КомментарийПриход", НСтр("ru='Увеличение долга контрагента';uk='Збільшення боргу контрагента'"));
	Запрос.УстановитьПараметр("КомментарийРасход", НСтр("ru='Уменьшение долга контрагента';uk='Зменшення боргу контрагента'"));
...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылкаПрочиеРасходы, СтруктураДополнительныеСвойства) Экспорт
	...
	Запрос.УстановитьПараметр("ПоступлениеДоходов", НСтр("ru='Прочие доходы';uk='Інші доходи'"));
	Запрос.УстановитьПараметр("ПрочееОприходование", НСтр("ru='Прочих затраты (расходы)';uk='Інших витрати'"));
