...
Процедура ДокументОснованиеНадписьОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "выбрать" Тогда
		...
		СписокОснований.Добавить("Документ.ОприходованиеЗапасов.ФормаВыбора", НСтр("ru='Оприходование запасов';uk='Оприбуткування запасів'"));
		...
		СписокОснований.Добавить("Документ.СборкаЗапасов.ФормаВыбора", НСтр("ru='Производство';uk='Виробництво'"));
		СписокОснований.Добавить("Документ.РасходныйОрдер.ФормаВыбора", НСтр("ru='Расходный ордер';uk='Видатковий ордер'"));
