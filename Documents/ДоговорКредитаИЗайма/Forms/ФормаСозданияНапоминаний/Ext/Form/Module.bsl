...
Процедура Создать(Команда)
	...
	Если Пользователь.Пустая() Тогда
		ПоказатьПредупреждение(Неопределено, НСтр("ru='Выберите пользователя!';uk='Виберіть користувача!'"));
		Возврат;
	КонецЕсли;
	
	Если Не ЗначениеЗаполнено(Время) Тогда
		ПоказатьПредупреждение(Неопределено, НСтр("ru='Установите время напоминания!';uk='Встановіть час нагадування!'"));
		Возврат;
	КонецЕсли;
