...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтаФорма.Заголовок		= НСтр("ru='Список договоров контрагента: ';uk='Список договоров контрагента: '") + Строка(Контрагент);
	...
	Если ПроверитьЗаполнениеДоговоров Тогда
		...
		Для каждого Договор Из ДоговорыКонтрагентов Цикл
			...
			Если НЕ ЗначениеЗаполнено(Договор.Договор) Тогда
				...
				ТекстСообщения = НСтр("ru='В таблице присутствуют строки с незаполненным договором контрагента';uk='У таблиці присутні рядки з незаповненим договором контрагенту'");
