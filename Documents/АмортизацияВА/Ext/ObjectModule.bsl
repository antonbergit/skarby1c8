...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если ДополнительныеСвойства.ТаблицыДляДвижений.ТаблицаОшибкиЗакрытияМесяца.Количество() > 0 Тогда
		ТекстСообщения = НСтр("ru='При начислении амортизации были сформированы предупреждения! Подробнее см. в отчете о закрытии месяца.';uk='При нарахуванні амортизації були сформовані попередження! Докладніше див. у звіті про закриття місяця.'");
