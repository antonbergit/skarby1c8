...
"Запустите 1С:Предприятие в указанном режиме и повторите попытку.';uk='Ви намагаєтеся відкрити архівний регламентований звіт, "
"створений у попередній редакції конфігурації ЗОВНІШНІМ "
"(підключеним) звітом."
"Дану дію можна виконати запустивши 1С:Підприємство в "
