...
Процедура ВалютаДокументаПриИзменении(Элемент)
	...
	Если Валюта <> Объект.ВалютаДокумента Тогда
		...
		Если Объект.СуммаДокумента <> 0 Тогда
			...
			ПоказатьВопрос(Новый ОписаниеОповещения("ВалютаДокументаПриИзмененииЗавершение", ЭтотОбъект, Новый Структура("СтруктураДанные", СтруктураДанные)), НСтр("ru='Изменилась валюта документа. Пересчитать сумму документа?';uk='Змінилася валюта документа. Перерахувати суму документа?'"), Режим);
            Возврат;
		КонецЕсли;
