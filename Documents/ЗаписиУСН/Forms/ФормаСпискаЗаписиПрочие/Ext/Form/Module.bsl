...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтаФорма.Заголовок = ЭтаФорма.Заголовок + ?(ПустаяСтрока(ЭтаФорма.Заголовок),"",": ")+НСтр("ru='Записи Книги учета доходов и расходов';uk='Записи Книги обліку доходів і витрат'");
...
Процедура ПересчитатьСДаты(Команда)
	...
	ПоказатьВводДаты(Оповещение, ТекущаяДата(), НСтр("ru='Пересчитать с даты';uk='Пересчитать с даты'"), ЧастиДаты.Дата);
...
Функция ЗапуститьОбновлениеДанныхНаСервере()
	...
	Результат = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
		...
		ПараметрыФункции, 
		НСтр("ru='Обновление списка записей КУДиР';uk='Оновлення списку записів КОДіВ'"));
