...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	Если Объект.Ссылка.Пустая() Тогда
		//Если Объект.ВидЗаписей = ПредопределенноеЗначение("Перечисление.ВидыЗаписейФормированийКУДиР.РучныеЗаписи") Тогда
		//	РаботаСДокументамиКлиент.КонтрольДатыДокумента(ЭтаФорма, "ДатаПервичногоДокумента", ДатаПервичногоДокумента, ДокументыЗаПериод, Отказ);
		//Иначе
		//	РаботаСДокументамиКлиент.КонтрольДатыДокумента(ЭтаФорма, "Дата", Объект.Дата, ДокументыЗаПериод, Отказ);
		//КонецЕсли;
	КонецЕсли;
КонецПроцедуры
...
"Для включения возможности исправлений, нажмите  «Включить режим редактирования»';uk='Дані записи згенеровані автоматично. "
"Робити ручну зміну даного документа не рекомендується. "
"При повторнім автоматичнім формуванні ручні коригування будуть загублені."
"Для включення можливості виправлень, натисніть  «Включити режим редагування»'"));
...
Процедура СтрокиДатаПервичногоДокументаПриИзменении(Элемент)
	...
	ТекстПредупреждения = НСтр("ru='Дата должны быть в интервале ';uk='Дата повинні бути в інтервалі'")+ПредставлениеПериода;
