...
Процедура СформироватьТаблицаДоходыИРасходы(ДокументСсылкаПередачаВА, СтруктураДополнительныеСвойства)
	...
	Запрос.УстановитьПараметр("НачислениеАмортизации", НСтр("ru='Начисление амортизации';uk='Нарахування амортизації'"));
	Запрос.УстановитьПараметр("ПрочиеДоходы", НСтр("ru='Прочие доходы';uk='Інші доходи'"));
	Запрос.УстановитьПараметр("ПрочиеРасходы", НСтр("ru='Прочие расходы';uk='Інші витрати'"));
...
Процедура СформироватьТаблицаВнеоборотныеАктивы(ДокументСсылкаПередачаВА, СтруктураДополнительныеСвойства)
	...
	Запрос.УстановитьПараметр("НачислениеАмортизации", НСтр("ru='Начисление амортизации';uk='Нарахування амортизації'"));
	Запрос.УстановитьПараметр("СписаниеАмортизации", НСтр("ru='Списание амортизации';uk='Списання амортизації'"));
	Запрос.УстановитьПараметр("СписаниеВнеоборотногоАктиваСУчета", НСтр("ru='Списание имущества с учета';uk='Списання майна з обліку'"));
