...
Процедура ЗаполнитьВидыОпераций()
	...
	Для каждого ВидОперации Из Метаданные.Перечисления.ВидыОперацийПриложение2КНалоговойНакладной.ЗначенияПеречисления Цикл
		СписокОпераций.Добавить(Перечисления.ВидыОперацийПриложение2КНалоговойНакладной[ВидОперации.Имя]);
	КонецЦикла;
