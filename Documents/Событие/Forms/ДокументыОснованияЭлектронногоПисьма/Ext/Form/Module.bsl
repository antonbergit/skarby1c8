...
Процедура ПроверитьЗаполнениеРеквизитовФормы(Отказ)
	...
	Для каждого СтрокаДокументыОснования Из ДокументыОснования Цикл
		...
		Если НЕ ЗначениеЗаполнено(СтрокаДокументыОснования.ДокументОснование) Тогда
			...
			Сообщение.Текст = НСтр("ru='Не заполнена колонка ""Документ основание"" в строке ';uk='Не заповнений стовпчик ""Документ підстава"" у рядку'")
				+ Строка(НомерСтроки)
				+ НСтр("ru=' списка ""Документы основания"".';uk=' списку ""Документи підстави"".'");
