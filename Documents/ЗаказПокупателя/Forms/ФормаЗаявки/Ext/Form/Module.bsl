...
Процедура КонтрагентПриИзмененииФрагмент1(Знач ВалютаРасчетовПередИзменением, Знач ДоговорПередИзменением, Знач СтруктураДанные)
    ...
    Если (ЗначениеЗаполнено(Объект.Договор)
        ...
        ПоказатьПредупреждение(Новый ОписаниеОповещения("КонтрагентПриИзмененииЗавершение", ЭтотОбъект, Новый Структура("ВалютаРасчетовПередИзменением, СтруктураДанные", ВалютаРасчетовПередИзменением, СтруктураДанные)), НСтр("ru='Изменилась валюта расчетов по договору с контрагентом! Необходимо проверить валюту документа!';uk='Змінилася валюта розрахунків за договором з контрагентом! Необхідно перевірити валюту документа!'"));
        Возврат;
...
Процедура ДоговорПриИзмененииФрагмент(Знач ВалютаРасчетовПередИзменением, Знач ДоговорПередИзменением, Знач СтруктураДанные)
    ...
    Если (ЗначениеЗаполнено(Объект.Договор)
        ...
        Объект.ВалютаДокумента = СтруктураДанные.ВалютаРасчетов;
        ПоказатьПредупреждение(Новый ОписаниеОповещения("ДоговорПриИзмененииЗавершение", ЭтотОбъект, Новый Структура("ВалютаРасчетовПередИзменением", ВалютаРасчетовПередИзменением)), НСтр("ru='Изменилась валюта расчетов по договору с контрагентом! Необходимо проверить валюту документа!';uk='Змінилася валюта розрахунків за договором з контрагентом! Необхідно перевірити валюту документа!'"));
