...
Процедура УстановитьВидимостьВкладок()
	...
	Если Объект.Организация.ИспользуетсяОтчетность Тогда
		...
		Элементы.СтраницаЛьготыСотрудников.Видимость = Истина;
	Иначе
		Элементы.СтраницаНалоги.Видимость = Истина;
		Элементы.СтраницаЛьготыСотрудников.Видимость = Ложь;
	КонецЕсли;
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ УчетНалогов Тогда
		...
		Элементы.Сотрудники.РасширеннаяПодсказка.Заголовок = 
			НСтр("ru='Начисления и удержания указываются на соответствующей странице для каждого сотрудника в отдельности.';uk='Нарахування й утримання вказуються на відповідній сторінці для кожного співробітника окремо.'");
