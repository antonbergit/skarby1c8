...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ДниНеделиПредст.Вставить(1, НСтр("ru='Понедельник';uk='Понеділок'"));
	ДниНеделиПредст.Вставить(2, НСтр("ru='Вторник';uk='Вівторок'"));
	ДниНеделиПредст.Вставить(3, НСтр("ru='Среда';uk='Середа'"));
	ДниНеделиПредст.Вставить(4, НСтр("ru='Четверг';uk='Четвер'"));
	ДниНеделиПредст.Вставить(5, НСтр("ru='Пятница';uk='П`ятниця'"));
	ДниНеделиПредст.Вставить(6, НСтр("ru='Суббота';uk='Субота'"));
	ДниНеделиПредст.Вставить(7, НСтр("ru='Воскресенье';uk='Неділя'"));
	...
	Для каждого СтрокаТЧ Из Операции Цикл
		...
		Для Счетчик = 1 По 7 Цикл
			...
			Если (ЗначениеЗаполнено(СтрокаТЧ[ДниНедели.Получить(Счетчик) + "ВремяНачала"]) 
				...
				ТекстСообщения = НСтр("ru='Не корректно заполнена колонка ""%ДеньНедели%"" в строке %НомерСтроки%!';uk='Не коректно заповнений стовпчик ""%ДеньНедели%"" у рядку %НомерСтроки%!'");
