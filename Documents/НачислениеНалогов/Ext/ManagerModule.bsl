...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылкаНачислениеНалогов, СтруктураДополнительныеСвойства) Экспорт
	...
	Запрос.УстановитьПараметр("ВозмещенНалог", НСтр("ru='Возмещен налог';uk='Відшкодований податок'"));
	Запрос.УстановитьПараметр("Доходы", НСтр("ru='Доходы';uk='Доходи'")); 
	Запрос.УстановитьПараметр("Расходы", НСтр("ru='Расходы';uk='Витрати'")); 
