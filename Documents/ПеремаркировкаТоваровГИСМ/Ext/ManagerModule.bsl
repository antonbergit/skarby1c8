...
Функция МаркировкаТоваровXML(ДокументСсылка)
	...
	Исключение
		ИнтеграцияГИСМКлиентСервер.ДобавитьТекстОшибки(СообщениеXML, СтрШаблон(НСтр("ru='Не заполнен GLN организации %1.';uk='Не заполнен GLN организации %1.'"), Шапка.Организация));
	КонецПопытки;
