		...
		Для каждого СтрокаТЧ Из Товары Цикл
			...
			Если ЗначениеЗаполнено(СтрокаТЧ.КодТаможенногоОргана)
				...
				Если Не ЗначениеЗаполнено(СтрокаТЧ.КодТаможенногоОргана) Тогда
					ТекстОшибки = НСтр("ru='В строке %НомерСтроки% списка ""Товары"" не указан ""Код таможенного органа"".';uk='В строке %НомерСтроки% списка ""Товары"" не указан ""Код таможенного органа"".'");
				...
				Если Не ЗначениеЗаполнено(СтрокаТЧ.ДатаРегистрацииДекларации) Тогда
					ТекстОшибки = НСтр("ru='В строке %НомерСтроки% списка ""Товары"" не указана ""Дата регистрации декларации"".';uk='В строке %НомерСтроки% списка ""Товары"" не указана ""Дата регистрации декларации"".'");
					ТекстОшибки =  СтрЗаменить(ТекстОшибки, "%НомерСтроки%", НомерСтроки);
				...
				Если Не ЗначениеЗаполнено(СтрокаТЧ.РегистрационныйНомерДекларации) Тогда
					ТекстОшибки = НСтр("ru='В строке %НомерСтроки% списка ""Товары"" не указан ""Регистрационный номер декларации"".';uk='В строке %НомерСтроки% списка ""Товары"" не указан ""Регистрационный номер декларации"".'");
					ТекстОшибки =  СтрЗаменить(ТекстОшибки, "%НомерСтроки%", НомерСтроки);
