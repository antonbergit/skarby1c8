...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Для каждого ДокументПоступления Из МассивВыбранныхДокументов Цикл
		...
		Если МассивНайденныхДокументов.Количество() > 0 Тогда
			...
			ТекстСообщения = НСтр("ru='Документ %ПредставлениеДокумента% уже присутствует в списке выбранных документов.';uk='Документ %ПредставлениеДокумента% вже є присутнім у списку обраних документів.'");
...
Процедура МножественныйПодборДокументов(Команда)
	...
	СписокТиповДокументов.Добавить("АвансовыйОтчет", НСтр("ru='Авансовый отчет';uk='Авансовий звіт'"));
	СписокТиповДокументов.Добавить("ПриходнаяНакладная", НСтр("ru='Приходная накладная';uk='Прибуткова накладна'"));
	
	Оповещение = Новый ОписаниеОповещения("МножественныйПодборДокументовЗавершение", ЭтаФорма);
	СписокТиповДокументов.ПоказатьВыборЭлемента(Оповещение, НСтр("ru='Выберите тип документа для добавления';uk='Виберіть тип документа для додавання'"));
...
Процедура ЗаполнитьПоОтобраннымДокументам(Команда)
	...
	Если ОтобранныеЗапасы.Количество() > 0 Тогда
		...
		ТекстВопроса = Нстр("ru='Табличная часть будит очищена и повторно заполнена. Продолжить?';uk='Таблична частина будить очищена й повторно заповнена. Продовжити?'");
...
Процедура ЗаполнитьПоТекущемуДокументу(Команда)
	...
	Если ТекущаяСтрокаДокументовПоступлений = Неопределено Тогда
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			Нстр("ru='Выделите строку с документом и повторите попытку заполнить';uk='Виділіть рядок з документом і повторіть спробу заповнити'"),
			,
			"ОтобранныеДокументы",
			,
			);
