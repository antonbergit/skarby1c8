...
Функция УведомлениеОВвозеМаркированныхТоваровИзЕАЭСXML2_40(ДокументСсылка)
	...
	Для Каждого СтрокаТЧ Из Товары Цикл
		...
		Исключение
			ИнтеграцияГИСМКлиентСервер.ДобавитьТекстОшибки(
				СообщениеXML,
				СтрШаблон(НСтр("ru='В строке %1 указана некорректная стоимость ""%2"".';uk='В строке %1 указана некорректная стоимость ""%2"".'"),
					СтрокаТЧ.НомерСтроки,
...
Функция УведомлениеОВвозеМаркированныхТоваровИзЕАЭСXML2_41(ДокументСсылка)
	...
	Исключение
		ИнтеграцияГИСМКлиентСервер.ДобавитьТекстОшибки(
			СообщениеXML,
			СтрШаблон(
				НСтр("ru='Не указан или указан неверно номер документа-основания.';uk='Не указан или указан неверно номер документа-основания.'"), Шапка.Контрагент));
	КонецПопытки;
	...
	Исключение
		ИнтеграцияГИСМКлиентСервер.ДобавитьТекстОшибки(
			СообщениеXML,
			СтрШаблон(
				НСтр("ru='Не указана или указана неверно дата документа-основания.';uk='Не указана или указана неверно дата документа-основания.'"), Шапка.Контрагент));
	КонецПопытки;
	...
	Исключение
		...
		СообщениеXML,
			СтрШаблон(
				НСтр("ru='Не удалось определить наименование документа-основания.';uk='Не удалось определить наименование документа-основания.'"), Шапка.Контрагент));
	КонецПопытки;
