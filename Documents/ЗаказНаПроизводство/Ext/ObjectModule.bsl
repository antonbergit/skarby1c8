...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если (Запасы.Итог("Резерв") > 0 ИЛИ Продукция.Итог("Резерв") > 0)
		...
		ТекстСообщения = НСтр("ru='Не указан склад резерва!';uk='Не зазначений склад резерву!'");
		...
		Если ВидОперации = Перечисления.ВидыОперацийЗаказНаПроизводство.Сборка Тогда
			...
			Для каждого СтрокаЗапасы Из Запасы Цикл
				...
				Если СтрокаЗапасы.Резерв > СтрокаЗапасы.Количество Тогда
					...
					ТекстСообщения = НСтр("ru='В строке №%Номер% табл. части ""Материалы"" количество резервируемых позиций превышает общее количество материалов.';uk='У рядку №%Номер% табл. частини ""Матеріали"" кількість позицій, що резервуються, перевищує загальну кількість матеріалів.'");
		...
		Иначе
			...
			Для каждого СтрокаПродукция Из Продукция Цикл
				...
				Если СтрокаПродукция.Резерв > СтрокаПродукция.Количество Тогда
					...
					ТекстСообщения = НСтр("ru='В строке №%Номер% табл. части ""Продукция"" количество резервируемых позиций превышает общее количество продукции.';uk='У рядку №%Номер% табл. частини ""Продукція"" кількість позицій, що резервуються, перевищує загальну кількість продукції.'");
...
"В табличной части ""Продукция"" указаны только услуги. Необходимо очистить табличную часть ""Материалы"".';uk='Планування потреб у матеріалах не виконується для послуг!"
"У табличній частині ""Продукція"" зазначені тільки послуги. Необхідно очистити табличну частину ""Матеріали"".'");
