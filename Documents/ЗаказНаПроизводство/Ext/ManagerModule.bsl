...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru='Требование на склад';uk='Вимога на склад'");
...
Функция ПечатнаяФорма(МассивОбъектов, ОбъектыПечати, ИмяМакета = "")
	...
	Запрос.УстановитьПараметр("Характеристика", НСтр("ru='Характеристика:';uk='Характеристика:'"));
	Запрос.Текст = 
	"ВЫБРАТЬ
	...
	Пока Шапка.Следующий() Цикл
		...
		ОбластьМакета.Параметры.ТекстЗаголовка = НСтр("ru='Требование на склад № ';uk='Вимога до складу № '", КодЯзыкаПечать)
												+ НомерДокумента
...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	ГруппаДел	= НСтр("ru='Заказы на производство';uk='Замовлення на виробництво'");
