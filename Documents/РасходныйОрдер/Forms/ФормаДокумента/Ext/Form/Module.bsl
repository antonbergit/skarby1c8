...
Процедура ДокументОснованиеНадписьОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "выбрать" Тогда
		...
		СписокОснований.Добавить("Документ.ПеремещениеЗапасов.ФормаВыбора", НСтр("ru='Перемещение запасов';uk='Переміщення запасів'"));
		СписокОснований.Добавить("Документ.ПриходныйОрдер.ФормаВыбора", НСтр("ru='Приходный ордер';uk='Прибутковий ордер'"));
		СписокОснований.Добавить("Документ.ПринятиеКУчетуВА.ФормаВыбора", НСтр("ru='Принятие к учету';uk='Прийняття до обліку'"));
		СписокОснований.Добавить("Документ.РасходнаяНакладная.ФормаВыбора", НСтр("ru='Расходная накладная';uk='Видаткова накладна'"));
		СписокОснований.Добавить("Документ.СписаниеЗапасов.ФормаВыбора", НСтр("ru='Списание запасов';uk='Списання запасів'"));
