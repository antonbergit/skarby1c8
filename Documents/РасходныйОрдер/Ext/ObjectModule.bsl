	...
	Если ЗначенияРеквизитов.Свойство("ВидОперации") Тогда
		Если ЗначениеЗаполнено(ЗначенияРеквизитов.ВидОперации)
			И НЕ ДанныеЗаполнения.ВидОперации = Перечисления.ВидыОперацийЗаказПокупателя.ЗаказНаряд Тогда
				ТекстИсключения = НСтр("ru='Расходный ордер можно ввести только на основании заказ-наряда!';uk='Видатковий ордер можна ввести тільки на підставі замовлення-наряду!'");
...
"Документ ""%ДокументСсылка"" не имеет ордерного склада!';uk='Неможливе введення операції ""Витрата з ордерного складу""."
