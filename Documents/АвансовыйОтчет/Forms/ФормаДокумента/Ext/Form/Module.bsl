...
Процедура ВыданныеАвансыДокументНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если НЕ ЗначениеЗаполнено(Объект.Сотрудник) Тогда
		ТекстСообщения = НСтр("ru='Укажите вначале сотрудника!';uk='Вкажіть спочатку співробітника!'");
...
Процедура ДокументОснованиеНадписьОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "выбрать" Тогда
		...
		СписокОснований.Добавить("Документ.РасходСоСчета.ФормаВыбора", НСтр("ru='Расход со счета';uk='Витрата з рахунку'"));
		СписокОснований.Добавить("Документ.РасходИзКассы.ФормаВыбора", НСтр("ru='Расход из кассы';uk='Витрата з каси'"));
		СписокОснований.Добавить("Документ.ПриходныйОрдер.ФормаВыбора", НСтр("ru='Приходный ордер';uk='Прибутковий ордер'"));
