...
Функция ПрибавитьКОтработанномуВремени(ВидВремени)
	...
	Если ВидВремени = Справочники.ВидыРабочегоВремени.РаботаВыходныеИПраздничные
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru='Табель учета рабочего времени';uk='Табель обліку робочого часу'");
