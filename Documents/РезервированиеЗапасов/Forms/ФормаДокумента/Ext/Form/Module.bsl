...
Процедура ЗаполнитьПоОснованию(Команда)
	...
	ТекстВопроса = НСтр("ru='Документ будет полностью перезаполнен по ""Заказу покупателя""! Продолжить выполнение операции?';uk='Документ буде повністю перезаповнений по ""Замовленню покупця""! Продовжити виконання операції?'");
	Ответ = Неопределено;
