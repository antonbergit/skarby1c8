...
Процедура ЗаполнитьПоЗаказуПоставщику(ДанныеЗаполнения) Экспорт
	...
	ПоДокументу = "Замовлення постачальникові № " + ДанныеЗаполнения.НомерВходящегоДокумента + " вiд " + Формат(ДанныеЗаполнения.ДатаВходящегоДокумента , "ДФ=dd.MM.yyyy");
...
Процедура ЗаполнитьПоСчетуНаОплатуПоставщика(ДанныеЗаполнения) Экспорт
	...
	ПоДокументу = "Рахунок на оплату № " + ДанныеЗаполнения.НомерВходящегоДокумента + " вiд " + Формат(ДанныеЗаполнения.ДатаВходящегоДокумента , "ДФ=dd.MM.yyyy");
