...
Функция ПечатнаяФорма(МассивОбъектов, ОбъектыПечати, ИмяМакета = "")
	...
	Для каждого ТекущийДокумент Из МассивОбъектов Цикл
		...
		ОбластьШапка.Параметры.НомерДата = "№" + Шапка.Номер + НСтр("ru=' от ';uk=' від '", КодЯзыкаПечать) + Формат(Шапка.Дата, "Л="+КодЯзыкаПечать+"; ДЛФ=DD");
		
		СведенияОбОрганизации = УправлениеНебольшойФирмойСервер.СведенияОЮрФизЛице(Шапка.Организация, Шапка.Дата, , ,КодЯзыкаПечать);
		ОбластьШапка.Параметры.ПредставлениеОрганизации = УправлениеНебольшойФирмойСервер.ОписаниеОрганизации(СведенияОбОрганизации, "ПолноеНаименование,ИНН,ФактическийАдрес,Телефоны,НомерСчета,Банк,МФО,КоррСчет");
		
		ТабличныйДокумент.Вывести(ОбластьШапка);
		
		ОбластьШапкаТаблицы.Параметры.ТекстВидаЗадания = НСтр("ru='Задание является';uk='Завдання є'", КодЯзыкаПечать) + ?(Шапка.ВидОперации = Перечисления.ВидыОперацийЗаданиеНаРаботу.Внешнее, НСтр("ru=' внешним';uk=' зовнішнім'", КодЯзыкаПечать), НСтр("ru=' внутренним';uk=' внутрішнім'", КодЯзыкаПечать));
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru='Задание на работу';uk='Завдання на роботу'");
...
Процедура ПриЗаполненииРасширенногоВводаЗаписиКалендаря(ТаблицаОписаний) Экспорт
	...
	НоваяСтрока.Представление = НСтр("ru='Задание на работу: внутреннее';uk='Завдання на роботу: внутрішнє'");
	...
	НоваяСтрока.Представление = НСтр("ru='Задание на работу: внешнее';uk='Завдання на роботу: зовнішнє'");
...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	ГруппаДел	= НСтр("ru='Задания на работу';uk='Завдання на роботу'");
	...
	Дело.Важное			= Ложь;
	Дело.Представление	= НСтр("ru='В работе';uk='В роботі'");
	...
	Дело.Важное			= Ложь;
	Дело.Представление	= НСтр("ru='На контроле';uk='На контролі'");
