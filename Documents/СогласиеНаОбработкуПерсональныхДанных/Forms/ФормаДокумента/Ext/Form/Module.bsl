...
Процедура УстановитьСведенияДействующегоСогласия()
	...
	ЧастиСообщения.Добавить(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='У субъекта %1 уже было получено';uk='У суб`єкта %1 вже було отримане'"), Формат(Согласие.ДатаПолучения, "ДЛФ=D")) + " ");
