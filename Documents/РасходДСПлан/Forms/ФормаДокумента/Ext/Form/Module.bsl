...
Процедура ЗаполнитьПоОснованию(Команда)
	...
	Если НЕ ЗначениеЗаполнено(Объект.ДокументОснование) Тогда
		...
		ТекстСообщения	= НСтр("ru='Требуется заполнить документ-основание.';uk='Потрібно заповнити документ-підставу.'");
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстСообщения, , "Объект.ДокументОснование");
		Возврат;
		
	КонецЕсли;
	
	ТекстВопроса 	= НСтр("ru='Документ будет полностью перезаполнен по ""Основанию""! Продолжить выполнение операции?';uk='Документ буде повністю перезаповнений по ""Підставі""! Продовжити виконання операції?'");
...
Функция ПолучитьСписокДляВыбораДокументаОснования()
	...
	СписокОснований.Добавить("Документ.АвансовыйОтчет.ФормаВыбора", НСтр("ru='Авансовый отчет';uk='Авансовий звіт'"));
	СписокОснований.Добавить("Документ.ОтчетПереработчика.ФормаВыбора", НСтр("ru='Отчет переработчика';uk='Звіт переробника'"));
