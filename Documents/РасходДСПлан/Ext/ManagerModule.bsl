...
Процедура СформироватьПланированиеРасходаДС(ТабличныйДокумент, МассивОбъектов, ОбъектыПечати)
	...
	Для Каждого ТекущийДокумент Из МассивОбъектов Цикл
		...
		ДатаДокумента = Формат(ДанныеДокумента.ДатаДокумента, "Л="+КодЯзыкаПечать+";ДФ='дд ММММ гггг'");
		Заголовок = НСтр("ru='Планирование расхода денежных средств № ';uk='Планування витрат коштів № '", КодЯзыкаПечать) + НомерДокумента + НСтр("ru=' от ';uk=' від '", КодЯзыкаПечать) + ДатаДокумента;
		...
		СтруктураЗаполненияСекции.Вставить("СуммаПрописью", РаботаСКурсамиВалют.СформироватьСуммуПрописью(ДанныеДокумента.Сумма, ДанныеДокумента.Валюта, , КодЯзыкаПечать));
		...
		Если ДанныеДокумента.ТипДС = Перечисления.ТипыДенежныхСредств.Безналичные Тогда
			...
			ОписаниеИсточникаФинансирования = НСтр("ru='расчетный счет организации № ';uk='розрахунковий рахунок організації № '") + ДанныеДокумента.НомерРС;
			
		ИначеЕсли ДанныеДокумента.ТипДС = Перечисления.ТипыДенежныхСредств.Безналичные Тогда
			
			ОписаниеИсточникаФинансирования = НСтр("ru='касса организации ';uk='каса організації '") + ДанныеДокумента.Касса;
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru='Планирование расходов ДС';uk='Планування витрат ГК'");
