...
Процедура ЗаполнитьВидыОпераций()
	...
	Для каждого ВидОперации Из Метаданные.Перечисления.ВидыОперацийРегистрацияВходящегоНалоговогоДокумента.ЗначенияПеречисления Цикл
		СписокОпераций.Добавить(Перечисления.ВидыОперацийРегистрацияВходящегоНалоговогоДокумента[ВидОперации.Имя]);
	КонецЦикла;
