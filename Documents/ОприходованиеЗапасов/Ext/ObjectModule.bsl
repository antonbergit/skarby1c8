...
Процедура ЗаполнитьПоИнвентаризацииЗапасов(ДокументСсылкаИнвентаризацияЗапасов) Экспорт
	...
	Если Не Константы.ФункциональнаяОпцияИспользоватьПодсистемуПроизводство.Получить()
		...
		ВызватьИсключение НСтр("ru='Нельзя ввести Оприходование запасов на основании инвентеризации запасов, т.к. недоступен вид деятельности Производство!';uk='Не можна ввести Оприбуткування запасів на підставі інвентаризації запасів, тому що недоступний вид діяльності Виробництво!'");
	КонецЕсли;
	...
	Если РезультатЗапроса.Пустой() Тогда
		ВызватьИсключение НСтр("ru='Нет данных для оформления оприходования!';uk='Немає даних для оформлення оприбуткування!'");
	КонецЕсли;
