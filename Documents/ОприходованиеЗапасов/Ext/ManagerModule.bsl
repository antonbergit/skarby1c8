...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылкаОприходованиеЗапасов, СтруктураДополнительныеСвойства) Экспорт
	...
	Запрос.УстановитьПараметр("ПоступлениеДоходов", НСтр("ru='Поступление прочих доходов';uk='Надходження інших доходів'"));
	Запрос.УстановитьПараметр("ПрочееОприходование", НСтр("ru='Прочее оприходование запасов';uk='Інше оприбуткування запасів'"));
	...
	Для каждого ТекущийДокумент Из МассивОбъектов Цикл
		...
		Если ИмяМакета = "ПФ_MXL_АктОбОприходованиеЗапасов" Тогда
			...
			ОбластьМакета.Параметры.ТекстЗаголовка =
				НСтр("ru='Акт об оприходовании запасов № ';uk='Акт про оприбуткування запасів № '", КодЯзыкаПечать)
			  + НомерДокумента
			...
			ОбластьМакета.Параметры.ВремяПечати =
				НСтр("ru='Дата и время печати: ';uk='Дата та час друку: '", КодЯзыкаПечать)
			  + ТекущаяДата()
			...
			ОбластьМакета.Параметры.СуммаПрописью = РаботаСКурсамиВалют.СформироватьСуммуПрописью(СуммаВсего, ВалютаУчета, , КодЯзыкаПечать);
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru='Акт об оприходовании запасов';uk='Акт про оприбуткування запасів'");
