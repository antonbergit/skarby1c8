...
Функция ТабличныеДокументыФормСЗВ_6_2(МассивОбъектов, ОбъектыПечати = Неопределено) Экспорт
	...
	//ТабДок = СформироватьПечатнуюФормуСЗВ_6_2(МассивОбъектов[0], ОбъектыПечати);
	
	Результаты = Новый Массив;
	
	//Справочники.КомплектыОтчетностиПерсучета.ДобавитьТабличныйДокументВКоллекциюПечатуемыхОбъектов(Результаты, ТабДок, ОбъектыПечати[0]);
