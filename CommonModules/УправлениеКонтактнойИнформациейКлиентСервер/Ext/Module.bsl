...
//
Функция ТипыОбъектовАдресацииАдресаУкраины() Экспорт
	...
	Результат.Добавить(СтрокаОбъектаАдресации("1010", НСтр("ru='Дом';uk='Будинок'", КодЯзыка),          1, 1, 2));
	Результат.Добавить(СтрокаОбъектаАдресации("1020", НСтр("ru='Владение';uk='Володіння'", КодЯзыка),     1, 2, 1));
	Результат.Добавить(СтрокаОбъектаАдресации("1030", НСтр("ru='Домовладение';uk='Домоволодіння'", КодЯзыка), 1, 3, 3));
	
	Результат.Добавить(СтрокаОбъектаАдресации("1050", НСтр("ru='Корпус';uk='Корпус'", КодЯзыка),     2, 1));
	Результат.Добавить(СтрокаОбъектаАдресации("1060", НСтр("ru='Строение';uk='Будова'", КодЯзыка),   2, 2, 1));
	Результат.Добавить(СтрокаОбъектаАдресации("1080", НСтр("ru='Литера';uk='Літера'", КодЯзыка),     2, 3, 3));
	Результат.Добавить(СтрокаОбъектаАдресации("1070", НСтр("ru='Сооружение';uk='Споруда'", КодЯзыка), 2, 4, 2));
	Результат.Добавить(СтрокаОбъектаАдресации("1040", НСтр("ru='Участок';uk='Ділянка'", КодЯзыка),    2, 5));
	
	Результат.Добавить(СтрокаОбъектаАдресации("2010", НСтр("ru='Квартира';uk='Квартира'", КодЯзыка),  3, 1));
	Результат.Добавить(СтрокаОбъектаАдресации("2030", НСтр("ru='Офис';uk='Офіс'", КодЯзыка),      3, 2));
	Результат.Добавить(СтрокаОбъектаАдресации("2040", НСтр("ru='Бокс';uk='Бокс'", КодЯзыка),      3, 3));
	Результат.Добавить(СтрокаОбъектаАдресации("2020", НСтр("ru='Помещение';uk='Приміщення'", КодЯзыка), 3, 4));
	Результат.Добавить(СтрокаОбъектаАдресации("2050", НСтр("ru='Комната';uk='Кімната'", КодЯзыка),   3, 5));
	Результат.Добавить(СтрокаОбъектаАдресации("2060", НСтр("ru='Этаж';uk='Поверх'", КодЯзыка),   3, 6));
	//  Наши сокращения для поддержки обратной совместимости при парсинге.
	Результат.Добавить(СтрокаОбъектаАдресации("2010", НСтр("ru='кв.';uk='кв.'", КодЯзыка),       3, 6));
	Результат.Добавить(СтрокаОбъектаАдресации("2030", НСтр("ru='оф.';uk='оф.'", КодЯзыка),       3, 7));
...
Функция КодСериализацииОбъектаАдресации(СтрокаЗначения) Экспорт
	...
	Для Каждого Элемент Из ТипыОбъектовАдресацииАдресаУкраины() Цикл
...
Функция СокращенияОбъектовАдресацииАдресаРФ() Экспорт
	...
	Результат.Вставить(НСтр("ru='Строение';uk='Будова'"), НСтр("ru='Стр.';uk='Стор.'"));
	Результат.Вставить(НСтр("ru='Литера';uk='Літера'"), НСтр("ru='Лит.';uk='Літ.'"));
	Результат.Вставить(НСтр("ru='Сооружение';uk='Споруда'"), НСтр("ru='Сооруж.';uk='Споруд.'"));
	Результат.Вставить(НСтр("ru='Участок';uk='Ділянка'"), НСтр("ru='Уч.';uk='Об.'"));
...
Функция СтруктураЧастейАдресаНаселенногоПункта(ВариантКлассификатора = "ФИАС") Экспорт
	...
	Результат.Вставить("ПодчиненныйЭлемент", ЭлементАдреснойСтруктуры(НСтр("ru='Подчиненный элемент';uk='Підлеглий елемент'"),
