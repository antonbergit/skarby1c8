...
Функция НайтиПеречисление(Знач ИмяПеречисления, ПредставлениеПеречисления) Экспорт
	...
	Если ИмяПрикладногоПеречисления = Неопределено Тогда // не задано соответствие
		ШаблонСообщения = НСтр("ru='В коде прикладного решения необходимо указать соответствие для перечисления %1.';uk='В коде прикладного решения необходимо указать соответствие для перечисления %1.'");
...
Функция СтавкаНДСИзПредставления(ПредставлениеСтавкиНДС) Экспорт
	...
	Если СтрСтавкаНДС = Неопределено ИЛИ СтрНайти(НСтр("ru='БЕЗ НДС';uk='БЕЗ НДС'"), ВРег(СтрСтавкаНДС)) > 0 Тогда
		ЗначениеНДС = НСтр("ru='без НДС';uk='без ПДВ'");
	Иначе
...
Функция ПредставлениеОснованияДляВидаЭД(ВидЭД) Экспорт
	...
	СоответствиеВидовЭДДокументамИБ.Вставить(Перечисления.ВидыЭД.ПроизвольныйЭД, НСтр("ru='Исходящий произвольный документ';uk='Исходящий произвольный документ'"));
	...
	Если ПредставлениеОснования = Неопределено Тогда // не задано соответствие
		ШаблонСообщения = НСтр("ru='В переопределяемом модуле прикладного решения необходимо указать представление документаИБ(основания) и хоз. операции для вида ЭД %1.';uk='В переопределяемом модуле прикладного решения необходимо указать представление документаИБ(основания) и хоз. операции для вида ЭД %1.'");
...
Функция ТЗСопоставленияПолейАдресаФНС_CML()
	...
	НоваяСтрока.ПредставлениеCML = НСтр("ru='Почтовый индекс';uk='Поштовий індекс'");
	
	НоваяСтрока = ТЗ.Добавить();
	НоваяСтрока.ПредставлениеФНС = "КодРегион";
	НоваяСтрока.ПредставлениеCML = НСтр("ru='Регион';uk='Регіон'");
	
	НоваяСтрока = ТЗ.Добавить();
	НоваяСтрока.ПредставлениеФНС = "НаселПункт";
	НоваяСтрока.ПредставлениеCML = НСтр("ru='Населенный пункт';uk='Населений пункт'");
	
	НоваяСтрока = ТЗ.Добавить();
	НоваяСтрока.ПредставлениеФНС = "Город";
	НоваяСтрока.ПредставлениеCML = НСтр("ru='Город';uk='Місто'");
	
	НоваяСтрока = ТЗ.Добавить();
	НоваяСтрока.ПредставлениеФНС = "Улица";
	НоваяСтрока.ПредставлениеCML = НСтр("ru='Улица';uk='Вулиця'");
	
	НоваяСтрока = ТЗ.Добавить();
	НоваяСтрока.ПредставлениеФНС = "Дом";
	НоваяСтрока.ПредставлениеCML = НСтр("ru='Дом';uk='Будинок'");
	
	НоваяСтрока = ТЗ.Добавить();
	НоваяСтрока.ПредставлениеФНС = "Корпус";
	НоваяСтрока.ПредставлениеCML = НСтр("ru='Корпус';uk='Корпус'");
	
	НоваяСтрока = ТЗ.Добавить();
	НоваяСтрока.ПредставлениеФНС = "Кварт";
	НоваяСтрока.ПредставлениеCML = НСтр("ru='Квартира';uk='Квартира'");
	
	НоваяСтрока = ТЗ.Добавить();
	НоваяСтрока.ПредставлениеФНС = "КодСтр";
	НоваяСтрока.ПредставлениеCML = НСтр("ru='Страна';uk='Країна'");
