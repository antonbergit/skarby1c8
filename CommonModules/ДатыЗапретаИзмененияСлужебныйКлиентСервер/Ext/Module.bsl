...
"за период с %3 по %4, истекла %5.';uk='Заборонено введення і редагування даних за всі минулі періоди"
"по %1 включно (%2)."
"Відстрочка, що дозволяла введення і редагування даних"
"за період з %3 по %4, минула %5. '"),
...
"  за все прошлые периоды по %5 (%3).';uk='• По %1 включно заборонено введення і редагування даних"
"  за всі минулі періоди по %2"
"  і діє відстрочка, дозволяюча введення і редагування даних"
"  за період з %4 по %5;"
...
"по %1 (%2)';uk='Заборонено введення і редагування даних за всі минулі періоди"
"по %1 (%2) '"),
				Формат(Контекст.ДатаЗапрета, "ДЛФ=Д"), НРег(ОписанияДатЗапрета()[Контекст.ОписаниеДатыЗапрета]));
		КонецЕсли;
