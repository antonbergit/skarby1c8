...
Функция ДанныеКэшаВерсий(Знач Идентификатор, Знач ТипДанных, Знач ПараметрыПолучения, Знач ИспользоватьУстаревшиеДанные = Истина) Экспорт
	...
	Если ТребуетсяВыполнитьОбновление Тогда
		...
		Иначе
			...
			НаименованиеЗадания = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Обновление кэша версий. Идентификатор записи %1. Тип данных %2.';uk='Відновлення кеша версій. Ідентифікатор запису %1. Тип даних %2.'"),
				Идентификатор,
				ТипДанных);
...
"Тип данных: %2';uk='Помилка при відновленні кеша версій. Дані не отримані."
...
Функция ОпцииИнтерфейса() Экспорт
	...
	Исключение
		...
		ИмяСобытия = НСтр("ru='Настройка интерфейса';uk='Налаштування інтерфейсу'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
