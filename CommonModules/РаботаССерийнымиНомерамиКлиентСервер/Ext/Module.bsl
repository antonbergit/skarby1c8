...
Процедура УдалитьСерийныеНомераПоКлючуСвязи(ТабличнаяЧастьСН, СтрокаТабличнойЧасти, ИмяПоляКлючСвязи = "КлючСвязи", ИспользоватьСерийныеНомераОстатки) Экспорт
