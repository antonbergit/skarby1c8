...
Функция СписокКонтролируемыхСобытий152ФЗ() Экспорт
	...
	СписокСобытий.Добавить("_$Access$_.Access",					НСтр("ru='Доступ. Доступ';uk='Доступ. Доступ'"));
	СписокСобытий.Добавить("_$Access$_.AccessDenied",			НСтр("ru='Доступ. Отказ в доступе';uk='Доступ. Відмова в доступі'"));
	СписокСобытий.Добавить("_$Session$_.Authentication",		НСтр("ru='Сеанс. Аутентификация';uk='Сеанс. Аутентифікація'"));
	СписокСобытий.Добавить("_$Session$_.AuthenticationError",	НСтр("ru='Сеанс. Ошибка аутентификации';uk='Сеанс. Помилка аутентифікації'"));
	СписокСобытий.Добавить("_$Session$_.Start",					НСтр("ru='Сеанс. Начало';uk='Сеанс. Початок'"));
	СписокСобытий.Добавить("_$Session$_.Finish",				НСтр("ru='Сеанс. Завершение';uk='Сеанс. Завершення'"));
