...
Процедура ПриОпределенииПорядкаРазделовКомандногоИнтерфейса(Разделы) Экспорт
	...
	// УНФ Начало
	Разделы.Добавить(НСтр("ru='Начало работы';uk='Початок роботи'"));
	Разделы.Добавить(НСтр("ru='События';uk='Події'"));
	Разделы.Добавить(НСтр("ru='Задания на работу';uk='Завдання на роботу'"));
	Разделы.Добавить(НСтр("ru='Заказы покупателей';uk='Замовлення покупців'"));
	Разделы.Добавить(НСтр("ru='Заказ наряды';uk='Замовлення наряди'"));
	Разделы.Добавить(НСтр("ru='Заказы поставщикам';uk='Замовлення постачальникам'"));
	Разделы.Добавить(НСтр("ru='Заказы на производство';uk='Замовлення на виробництво'"));
	Разделы.Добавить(НСтр("ru='Закрытие месяца';uk='Закриття місяця'"));
	Разделы.Добавить(НСтр("ru='Напоминания';uk='Нагадування'"));
	// УНФ Конец
	
	// ЭДО
	Разделы.Добавить(НСтр("ru='ЭДО';uk='ЕДО'"));
	// Конец ЭДО
