...
Процедура УстановитьПараметрыЗадания(Задание, Использование, Параметры, Расписание) Экспорт
	...
	Если Не Константы.РазрешитьВыполнениеДОИОРегламентнымиЗаданиямиВМоделиСервиса.Получить() Тогда
		ВызватьИсключение НСтр("ru='Периодическое выполнение команд дополнительных обработок в качестве заданий запрещено администрацией сервиса!';uk='Періодичне виконання команд додаткових обробок в "
"якості завдань заборонено адміністрацією сервісу!'");
	КонецЕсли;
