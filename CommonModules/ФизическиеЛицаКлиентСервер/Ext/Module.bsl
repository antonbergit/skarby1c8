...
Функция ЧастиИмени(ФамилияИмяОтчество) Экспорт
	...
	Если ЧастиИмени.Количество() > 3 Тогда
		...
		ДополнительныеЧастиОтчества.Добавить(НСтр("ru='оглы';uk='оглы'"));
		ДополнительныеЧастиОтчества.Добавить(НСтр("ru='улы';uk='улы'"));
		ДополнительныеЧастиОтчества.Добавить(НСтр("ru='уулу';uk='уулу'"));
		ДополнительныеЧастиОтчества.Добавить(НСтр("ru='кызы';uk='кызы'"));
		ДополнительныеЧастиОтчества.Добавить(НСтр("ru='гызы';uk='гызы'"));
