...
Функция ОплатитьПлатежнойКартой(ОбъектДрайвера, Параметры, ПараметрыПодключения,
	...
	Если Не ПустаяСтрока(НомерКарты) Тогда
		...
		Иначе
			ВыходныеПараметры.Добавить(999);
			ВыходныеПараметры.Добавить(НСтр("ru='Указан неверный номер карты.';uk='Зазначений невірний номер картки.'"));
	...
	Если ПараметрыПодключения.ТипТранзакции = НСтр("ru='Оплатить';uk='Оплатити'")
	 ...
	 Или ПараметрыПодключения.ТипТранзакции = НСтр("ru='Отменить преавторизацию';uk='Скасувати преавторизацію'") Тогда
		...
		Если ПараметрыПодключения.ТипТранзакции = НСтр("ru='Оплатить';uk='Оплатити'") Тогда
			ОбластьПараметры.Вставить("Операция", НСтр("ru='ОПЛАТА ТОВАРА';uk='ОПЛАТА ТОВАРУ'"));
		ИначеЕсли ПараметрыПодключения.ТипТранзакции = НСтр("ru='Вернуть платеж';uk='Повернути платіж'") Тогда
			ОбластьПараметры.Вставить("Операция", НСтр("ru='ВОЗВРАТ ТОВАРА';uk='ПОВЕРНЕННЯ ТОВАРУ'"));
		ИначеЕсли ПараметрыПодключения.ТипТранзакции = НСтр("ru='Отменить платеж';uk='Скасувати платіж'") Тогда
			ОбластьПараметры.Вставить("Операция", НСтр("ru='ОТМЕНА ОПЛАТЫ ТОВАРА';uk='СКАСУВАННЯ ОПЛАТИ ТОВАРУ'"));
