...
Функция ТекущаяНастройкаРезервногоКопирования() Экспорт
	...
	Если НастройкиРезервногоКопирования = Неопределено Тогда
		Возврат НСтр("ru='Для настройки резервного копирования необходимо обратиться к администратору.';uk='Для налаштування резервного копіювання необхідно звернутися до адміністратора.'");
	КонецЕсли;
...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	Для Каждого Раздел Из Разделы Цикл
		...
		Если Не ОтключеноУведомлениеОВыполненииРезервногоКопирования Тогда
			...
			Дело.Представление  = НСтр("ru='Резервное копирование не выполнено';uk='Резервне копіювання не виконане'");
			Дело.Важное         = Истина;
