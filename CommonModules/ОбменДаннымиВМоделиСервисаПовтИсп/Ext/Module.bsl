...
Функция ПолучитьWSПроксиСервисаОбмена() Экспорт
	...
	Если Результат = Неопределено Тогда
		ВызватьИсключение НСтр("ru='Ошибка получения web-сервиса обмена данными управляющего приложения.';uk='Помилка отримання web-сервісу обміну даними керуючого "
"додатку.'");
	КонецЕсли;
