...
"Поиск мест использования может занять длительное время.';uk='Для того щоб не допустити неузгодженості даних у програмі"
"слідуючі реквізити не доступні для редагування:"
"%1."
""
...
""
"Перед тим, як дозволити його редагування, рекомендується оцінити наслідки,"
"перевіривши всі місця використання обраних елементів (%2) у програмі."
"Пошук місць використання може зайняти тривалий час.'"),
