...
Функция XSLT_ПреобразованиеXSL() Экспорт
	...
	Для Каждого ДополнительныйАдресныйЭлемент Из УправлениеКонтактнойИнформациейКлиентСервер.ТипыОбъектовАдресацииАдресаУкраины() Цикл
	...
	Преобразователь.ЗагрузитьИзСтроки("
		...
		|    <xsl:element name=""Состав"">
		|      <xsl:attribute name=""xsi:type"">АдресУкраина</xsl:attribute>
		|    
