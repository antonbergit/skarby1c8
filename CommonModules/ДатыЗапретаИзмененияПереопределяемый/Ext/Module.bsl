...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.НалоговаяНакладная", 			"Дата", "УправленческийУчет", "Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.Приложение1КНалоговойНакладной", "Дата", "УправленческийУчет", "Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.Приложение2КНалоговойНакладной", "Дата", "УправленческийУчет", "Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.РегистрацияВходящегоНалоговогоДокумента", "Дата", "УправленческийУчет", "Организация");
...
Процедура ОбновлениеРазделовДатЗапретаИзменений(ОбработкаЗавершена) Экспорт
	...
	Попытка
		...
		Пока Выборка.Следующий() Цикл
			...
			Комментарий = НСтр("ru='Раздел добавлен автоматически при обновлении УНФ до версии 1.5.3.6';uk='Розділ доданий автоматично при відновленні УНФ до версії 1.5.3.6'");
