...
Функция РасширенныеОписанияПричинБлокировки() Экспорт
	...
	Результат.Вставить(Причины.БлокировкаАдминистраторомСервиса, НСтр("ru='Использование дополнительной обработки запрещено из-за нарушений правил сервиса!';uk='Використання додаткової обробки заборонене через порушеня "
"правил сервісу!'"));
	Результат.Вставить(Причины.БлокировкаВладельцем, НСтр("ru='Использование дополнительной обработки запрещено владельцем обработки!';uk='Використання додаткової обробки заборонене власником "
"обробки!'"));
	Результат.Вставить(Причины.ОбновлениеВерсииКонфигурации, НСтр("ru='Использование дополнительной обработки временно недоступно по причине выполнения обновления приложения. Данный процесс может занять несколько минут. Приносим извинения на доставленные неудобства.';uk='Використання додаткової обробки тимчасово недоступне через виконання оновлення програми. Даний процес може "
"зайняти кілька хвилин. Приносимо вибачення за доставлені "
"незручності.'"));
