...
"запустить программу от его имени и открыть нужный отчет или форму.';uk='Для перегляду налаштувань іншого користувача необхідно"
"запустити програму від його імені й відкрити потрібний звіт або форму.'");
...
"""Рабочий стол"" в командном интерфейсе программы.';uk='Для перегляду налаштувань робочого стола перейдіть до розділу"
...
"выберите нужный раздел командного интерфейса программы.';uk='Для перегляду налаштувань командного інтерфейсу"
...
"и затем перейти к форме ""%2"".';uk='Для перегляду даного налаштування необхідно відкрити ""%1"" "
"і потім перейти до форми ""%2"".'");
		...
		ПоказатьПредупреждение(,НСтр("ru='Данную настройку невозможно просмотреть.';uk='Дане налаштування неможливо переглянути.'"));
		Возврат;
	...
	ПоказатьПредупреждение(,НСтр("ru='Выберите настройку для просмотра.';uk='Виберіть налаштування для перегляду.'"));
