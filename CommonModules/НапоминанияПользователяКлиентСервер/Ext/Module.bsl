...
Функция ЗаменитьЕдиницуИзмеренияНаМножитель(Знач Единица)
	...
	Если ПервыеТриСимвола = НСтр("ru='нед';uk='тижд'") Или ПервыеТриСимвола = НСтр("ru='н';uk='н'") Тогда
	...
	ИначеЕсли ПервыеТриСимвола = НСтр("ru='ден';uk='ден'") 
		...
		Результат = 60*60*24;
	ИначеЕсли ПервыеТриСимвола = НСтр("ru='час';uk='година'") Или ПервыеТриСимвола = НСтр("ru='ч';uk='г'") Тогда
		Результат = 60*60;
