...
Функция ИнформацияОДоступномОбновленииВызовОперации(
	...
	Если ИмяТекущейПрограммы = "Unknown" Тогда
		...
		Результат.Сообщение = НСтр("ru='Неверные параметры подключения к сервису.';uk='Невірні параметри підключення до сервісу.'");
		Результат.ИнформацияОбОшибке =
			НСтр("ru='Не удалось получить информацию о доступном обновлении."
"Не определено имя программы в методе ПриОпределенииИмениПрограммы() общего модуля ИнтернетПоддержкаПользователейПереопределяемый.';uk='Не вдалося отримати інформацію про доступне оновлення."
...
"Причина:"
"%2';uk='Не вдалося отримати інформацію про доступне оновлення."
...
"%1';uk='Помилка при отриманні інформації про доступне оновлення."
"%1'"),
		...
		Результат.Сообщение = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Не удалось получить информацию о доступном обновлении."
"%1';uk='Не вдалося отримати інформацію про доступне оновлення."
"%1'"),
...
"%1"
"Тело ответа: %2';uk='Не вдалося перевірити наявність оновлень програми."
...
"Тіло відповіді : %2'"),
		...
		Результат.Сообщение =
			НСтр("ru='Не удалось проверить наличие обновлений программы."
"Некорректный ответ сервиса.';uk='Не вдалося перевірити наявність оновлень програми."
"Некоректна відповідь сервісу.'");
...
""
"Ответ сервиса: %1';uk='Не вдалося перевірити наявність оновлень програми."
""
...
"%1';uk='Отримана інформація про доступне оновлення."
"%1'"),
...
"Не удалось проверить доступность сервиса автоматического обновления программы: %1."
"Причина:"
"%2';uk='Не вдалося отримати інформацію про файли оновлення."
"Не вдалося перевірити доступність сервісу автоматичного оновлення програми: %1."
"Причина:"
"%2'"),
			URLОперацииPing,
...
"%1';uk='Помилка при отриманні інформації про файли оновлення."
"%1'"),
			РезультатОтправки.ИнформацияОбОшибке);
		ПолучениеОбновленийПрограммыВызовСервера.ЗаписатьОшибкуВЖурналРегистрации(
			Результат.ИнформацияОбОшибке);
		...
		Результат.Сообщение = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Не удалось получить информацию о файлах обновления."
"%1';uk='Не вдалося отримати інформацію про файли оновлення."
"%1'"),
			РезультатОтправки.СообщениеОбОшибке);
...
"Некорректный ответ сервиса."
"%1"
"Тело ответа: %2';uk='Не вдалося отримати інформацію про оновлення програми."
"Помилка при обробці відповіді сервісу."
"Некоректна відповідь сервісу."
"%1"
"Тіло відповіді : %2'"),
		...
		Результат.Сообщение =
			НСтр("ru='Не удалось получить информацию об обновлении программы."
"Некорректный ответ сервиса.';uk='Не вдалося отримати інформацію про оновлення програми."
"Некоректна відповідь сервісу.'");
...
"Сервис сообщил об ошибке."
""
"Ответ сервиса: %1';uk='Не вдалося отримати інформацію про оновлення програми."
""
"Сервіс повідомив про помилку."
""
"Відповідь сервісу: %1'"),
...
"%1';uk='Отримана інформація про файли оновлення."
"%1'"),
			РезультатОтправки.Содержимое));
...
"Не совпадает количество запрошенных и возвращенных файлов (%1 и %2).';uk='Повернена неповна інформація про оновлення конфігурації."
"Не збігається кількість запитаних і повернутих файлів (%1 і %2). '"),
...
Функция ИмяСобытияЖурналаРегистрации() Экспорт
	...
	Возврат НСтр("ru='Получение обновлений программы';uk='Одержання оновлень програми'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
