...
// Выполняет движения по регистру накопления ВзаиморасчетыПоВзносамВФонды
// 
Процедура ОтразитьДвиженияПоВзаиморасчетыПоВзносамВФонды(ДополнительныеСвойства, Движения, Отказ) Экспорт
	
	Таблица= ДополнительныеСвойства.ТаблицыДляДвижений.ТаблицаВзносы;
	...
	Движения.ВзаиморасчетыПоВзносамВФонды.Загрузить(Таблица);

КонецПроцедуры

// Выполняет движения по регистру накопления ВзаиморасчетыПоВзносамВФонды
// 
Процедура ОтразитьДвиженияПоВзаиморасчетыПоВзносамВФОТ(ДополнительныеСвойства, Движения, Отказ) Экспорт
	
	Таблица= ДополнительныеСвойства.ТаблицыДляДвижений.ТаблицаВзносыФОТ;
...
// Выполняет движения по регистру накопления ВзаиморасчетыПоВзносамВФонды
// 
Процедура ОтразитьДвиженияПоВзаиморасчетыПоВзносамВФондыНДФЛ(ДополнительныеСвойства, Движения, Отказ) Экспорт
	
	Таблица= ДополнительныеСвойства.ТаблицыДляДвижений.ТаблицаВзносыНДФЛ;
...
// Выполняет движения по регистру накопления ВзаиморасчетыПоНДФЛ
// 
Процедура ОтразитьДвиженияПоВзаиморасчетыПоНДФЛ(ДополнительныеСвойства, Движения, Отказ) Экспорт
	
	Таблица= ДополнительныеСвойства.ТаблицыДляДвижений.ТаблицаНДФЛ;
	...
	Движения.ВзаиморасчетыПоНДФЛ.Загрузить(Таблица);

КонецПроцедуры

// Выполняет движения по регистру накопления УчетЕСВ
// 
Процедура ОтразитьУчетЕСВ(ДополнительныеСвойства, Движения, Отказ) Экспорт
	
	Таблица= ДополнительныеСвойства.ТаблицыДляДвижений.ТаблицаУчетЕСВ;
	
	Если Отказ ИЛИ Таблица.Количество() = 0 Тогда
		Возврат;
	КонецЕсли;

	Движения.УчетЕСВ.Записывать = Истина;
	Движения.УчетЕСВ.Загрузить(Таблица);
