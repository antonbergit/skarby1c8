...
Функция СтрокаТаблицыРазрешений(Знач ТаблицаРазрешений, Знач Отбор, Знач ДобавитьПриОтсутствии = Истина) Экспорт
	...
	Иначе
		...
		ВызватьИсключение СтрШаблон(НСтр("ru='Нарушение уникальности строк в таблице разрешений по отбору %1';uk='Порушення унікальності рядків у таблиці дозволів по відбору %1'"),
...
"- КлючРазрешения: %5.';uk='Дублювання дозволів по ключових полях:"
"- ТипПрограммногоМодуля: %1"
"- ИдентификаторПрограммногоМодуля: %2"
"- ТипВладельца: %3"
"- ИдентификаторВладельца: %4"
...
"- ТипВладельца: %3"
"- ИдентификаторВладельца: %4"
"- КлючРазрешения: %5.';uk='Колізія дозволів по ключах:"
"- ТипПрограммногоМодуля: %1"
"- ИдентификаторПрограммногоМодуля: %2"
"- ТипВладельца: %3"
"- ИдентификаторВладельца: %4"
...
"- ТипВладельца: %3"
"- ИдентификаторВладельца: %4"
"- КлючРазрешения: %5.';uk='Спроба видалення неіснуючого дозволу:"
"- ТипПрограммногоМодуля: %1"
"- ИдентификаторПрограммногоМодуля: %2"
"- ТипВладельца: %3"
"- ИдентификаторВладельца: %4"
...
Функция РезультатОбработкиПакета(Знач ИдентификаторПакета) Экспорт
	...
	Иначе
		...
		ВызватьИсключение СтрШаблон(
			НСтр("ru='Не найден пакет запросов %1';uk='Не знайдений пакет запитів %1'"), ИдентификаторПакета);
...
Функция СостояниеОбработкиПакета(Знач ИдентификаторПакета)
	...
	Иначе
		...
		ВызватьИсключение СтрШаблон(НСтр("ru='Не найден пакет запросов %1';uk='Не знайдений пакет запитів %1'"), ИдентификаторПакета);
...
"- Тип: %1"
"- Идентификатор: %2';uk='Не серіалізован програмний модуль по ключу:"
"- Тип: %1"
"- Ідентифікатор: %2'"),
					Выборка.ТипПрограммногоМодуля,
					Выборка.ИдентификаторПрограммногоМодуля);
