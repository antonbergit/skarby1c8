...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru='Выполняет обновление информации в форме 1С-Отчетность в разделе Отчеты. До завершения выполнения данные в форме 1С-Отчетность могут отображаться некорректно';uk='Выполняет обновление информации в форме 1С-Отчетность в разделе Отчеты. До завершения выполнения данные в форме 1С-Отчетность могут отображаться некорректно'");
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор();
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Комментарий = НСтр("ru='Выполняет изменение наименований бухгалтерских регламентированных отчетов.';uk='Выполняет изменение наименований бухгалтерских регламентированных отчетов.'");
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор();
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Комментарий = НСтр("ru='Выполняет изменение представлений отчетного периода.';uk='Выполняет изменение представлений отчетного периода.'");
	...
	//Обработчик.Идентификатор = Новый УникальныйИдентификатор();
	//Обработчик.РежимВыполнения = "Отложенно";
	//Обработчик.Комментарий = НСтр("ru='Выполняет изменение наименований деклараций по алкоголю.';uk='Выполняет изменение наименований деклараций по алкоголю.'");
	...
	//Обработчик.Идентификатор = Новый УникальныйИдентификатор();
	//Обработчик.РежимВыполнения = "Отложенно";
	//Обработчик.Комментарий = НСтр("ru='Выполняет изменение наименований реестров по НДС.';uk='Выполняет изменение наименований реестров по НДС.'");
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор();
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Комментарий = НСтр("ru='Выполняет заполнение индекса картинки регламентированных отчетов.';uk='Выполняет заполнение индекса картинки регламентированных отчетов.'");
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор();
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Комментарий = НСтр("ru='Выполняет изменение реквизитов отправки справок о рублевых и валютных счетах.';uk='Выполняет изменение реквизитов отправки справок о рублевых и валютных счетах.'");
	                          	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.9.25";
	Обработчик.Процедура = "Справочники.РегламентированныеОтчеты.ОчиститьВнешниеРеглОтчеты";
	Обработчик.ОбщиеДанные = Истина;
