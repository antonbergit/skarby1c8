...
"следует использовать одноименную процедуре в общем модуле ОбновлениеИнформационнойБазы<ИмяПодсистемы>.';uk='У підсистемі %1 замість підписки на службову подію ПриДобавленииОбработчиковОбновления"
"слід використовувати однойменну процедуру в загальному модулі ОбновлениеИнформационнойБазы<ИмяПодсистемы>. '"),
