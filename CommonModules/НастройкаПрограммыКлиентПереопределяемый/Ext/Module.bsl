...
"наведений до часового поясу клієнта.'"),
	...
	ИначеЕсли Идентификатор = "ДополнительныеОбработкиПоАдминистрированию" Тогда
		...
		ПараметрыФормы.Вставить("Заголовок", НСтр("ru='Дополнительные обработки по администрированию';uk='Додаткові обробки з адміністрування'"));
