...
Функция ПолучитьСтруктуруПрямогоОбмена() Экспорт
	...
	СтруктураПрямогоОбмена = Новый Структура("БанковскийСчет, БанковскийСчетОрганизации, Организация, СоглашениеПрямогоОбменаСБанками, РежимПоУмолчанию");
	
	СтруктураПрямогоОбмена.Вставить("РежимПоУмолчанию", "Загрузки");
...
Функция ПолучитьСтруктуруОбмена(ПараметрБанковскийСчет) Экспорт
	...
	СтруктураОбмена = Новый Структура("ПрямойОбмен, БанковскийСчет, БанковскийСчетОрганизации, Организация, СоглашениеПрямогоОбменаСБанками, РежимПоУмолчанию", Ложь);
	
	СтруктураОбмена.Вставить("РежимПоУмолчанию", "Загрузки");
