...
Функция ДвоичныеДанныеСертификата(ИсходныйСертификат) Экспорт
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Хранилище сертификатов в модели сервиса.Ошибка при удалении файла';uk='Хранилище сертификатов в модели сервиса.Ошибка при удалении файла'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
