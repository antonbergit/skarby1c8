...
Функция ВерсияПрограммыКлиентаДляБанка(КоличествоСимволов = 100) Экспорт
	...
	ВерсияПрограммы = СтрШаблон(НСтр("ru='1С - БЭД: %1; %2: %3';uk='1С - БЭД: %1; %2: %3'"),
	...
	Иначе
		...
		Иначе
			...
			Исключение
				...
				ВидОперации = НСтр("ru='Чтение списка банков сервиса 1С:ДиректБанк из скачанного файла.';uk='Чтение списка банков сервиса 1С:ДиректБанк из скачанного файла.'");
...
Функция ВнешниеКомпонентыИнформационнойБазы() Экспорт
	...
	Для Каждого Элемент Из ВнешниеКомпоненты Цикл
