...
Функция ПолучитьЗначениеПараметра(Объект, Документ = Неопределено, Параметр, ПараметрПредставление = Неопределено) Экспорт
	...
	ИначеЕсли Параметр = Параметры.КОАТУУОрганизации Тогда
		
		ЗначениеПараметра = ?(Организация.КодКОАТУУ <> "",
					Организация.КодКОАТУУ, "");
		
	ИначеЕсли Параметр = Параметры.ЕДРПОУКонтрагента Тогда
		
		ЗначениеПараметра = ?(Объект.Владелец.КодПоЕДРПОУ <> "",
					Объект.Владелец.КодПоЕДРПОУ, "");
		
	ИначеЕсли Параметр = Параметры.ЕДРПОУОрганизации Тогда
		
		ЗначениеПараметра = ?(Организация.КодПоЕДРПОУ <> "",
					Организация.КодПоЕДРПОУ, "");
		
	ИначеЕсли Параметр = Параметры.КВЭДОрганизации Тогда
		
		ЗначениеПараметра = ?(Организация.КодКВЭД <> "",
					Организация.КодКВЭД, "");
	...
	ИначеЕсли Параметр = Параметры.МфоКонтрагента Тогда
	...
	ИначеЕсли Параметр = Параметры.МфоОрганизации Тогда
...
Функция ПустоеПолеДокумента()
	...
	|<body>
	|</br>
	|<p align='center'><font color='grey'>"+НСтр("ru='Укажите бланк договора';uk='Вкажіть бланк договору'")+"</font></p>
	|</body>
	|</html>";
