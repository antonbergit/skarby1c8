...
Процедура ПриСозданииКонтекстаВзаимодействия(Контекст) Экспорт
	...
	Контекст.Вставить("СообщениеОНедоступностиДействия",
		НСтр("ru='Отображение монитора Интернет-поддержки недоступно для этой конфигурации.';uk='Відображення монітора Інтернет-підтримки недоступно для цієї конфігурації.'"));
