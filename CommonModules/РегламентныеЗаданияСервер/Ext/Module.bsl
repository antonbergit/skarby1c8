...
Процедура УдалитьЗадание(Знач Идентификатор) Экспорт
	...
	Иначе
		Если ТипЗнч(Идентификатор) = Тип("ОбъектМетаданных") И Идентификатор.Предопределенное Тогда
			ВызватьИсключение( НСтр("ru='Предопределенное регламентное задание удалить невозможно.';uk='Визначене регламентне завдання видалити неможливо.'") );
...
"Возможно, оно удалено другим пользователем.';uk='Регламентний задача не знайдений."
