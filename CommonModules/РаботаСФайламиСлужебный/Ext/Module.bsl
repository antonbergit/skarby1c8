...
Процедура ВыполнитьОчисткуДанныхОФайле(ФайлСсылка) Экспорт
	...
	Попытка
		...
		ТекстКомментария = НСтр("ru='Файл удален при очистке ненужных файлов.';uk='Файл видалений при очищенні непотрібних файлів.'")
...
"пометка удаления папок файлов';uk='Додавання, зміна й"
"позначка видалення папок файлів'");
...
"видалення'");
	Право.Подсказка     = НСтр("ru='Пометка удаления файлов в папке';uk='Позначка видалення файлів у папці'");
	// Права, требуемые для этого права.
	Право.ТребуемыеПрава.Добавить("ИзменениеФайлов");
