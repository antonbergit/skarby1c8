...
"приложении сервиса и провести синхронизацию данных автономного рабочего места с сервисом.';uk='Додатковий звіт або обробка %1 був завантажений з сервісу і не "
"може бути відключений з автономного робочого місця!"
"Для видалення додаткового звіту або обробки необхідно "
"виконати операцію відключення в"
"додатку сервісу та провести синхронізацію даних автономного "
"робочого місця з сервісом.'"),
