...
Функция ПолучитьСведенияОбОрганизации(Знач Организация, Знач ДатаЗначения = Неопределено, Знач СписокПоказателей = Неопределено) Экспорт
	...
	УкраинскийАдрес = Новый Соответствие;
	УкраинскийАдрес.Вставить("Индекс",          "");
	УкраинскийАдрес.Вставить("Регион",          "");
	УкраинскийАдрес.Вставить("КодРегиона",      "");
	УкраинскийАдрес.Вставить("Район",           "");
	УкраинскийАдрес.Вставить("Город",           "");
	УкраинскийАдрес.Вставить("НаселенныйПункт", "");
	УкраинскийАдрес.Вставить("Улица",           "");
	УкраинскийАдрес.Вставить("Дом",             "");
	УкраинскийАдрес.Вставить("Корпус",          "");
	УкраинскийАдрес.Вставить("Квартира",        "");
	...
	Для Каждого Показатель Из СписокПоказателей Цикл
		...
		ИначеЕсли Имяпоказателя = "ОснВидДеят" Тогда
			...
			Значение = Организация.ВЭД;
			
		ИначеЕсли Имяпоказателя = "КВЭД" Тогда
			
			Значение = Организация.КодКВЭД;
		...
		ИначеЕсли ИмяПоказателя = "ОКАТО" Тогда
			...
			Значение = СокрЛП(Организация.КодКОАТУУ);
			
		ИначеЕсли ИмяПоказателя = "ДатаНачалаИспользованияЗвит1С" Тогда
			
			Значение = Организация.ДатаНачалаИспользованияЗвит1С;
			
		ИначеЕсли ИмяПоказателя = "НалоговаяИнспекция" Тогда
			
			Значение = Организация.НалоговаяИнспекция;
		...
		ИначеЕсли ИмяПоказателя = "ЕДРПОУ" Тогда
		...
		ИначеЕсли ИмяПоказателя = "ОргИндекс" Тогда
			...
			Если Результат <> Неопределено Тогда
				...
				РегламентированнаяОтчетностьВызовСервера.СформироватьАдрес(Результат.ЗначенияПолей, УкраинскийАдрес);
				
				Значение = УкраинскийАдрес["Индекс"];
		...
		ИначеЕсли ИмяПоказателя = "ОргСубъект" Тогда
			...
			Если Результат <> Неопределено Тогда
				...
				Значение = УкраинскийАдрес["Регион"];				
		...
		ИначеЕсли ИмяПоказателя = "ОргКодСубъект" Тогда
			...
			Если Результат <> Неопределено Тогда
				...
				Значение = УкраинскийАдрес["КодРегиона"];
		...
		ИначеЕсли ИмяПоказателя = "ОргРайон" Тогда
			...
			Если Результат <> Неопределено Тогда
				...
				Значение = УкраинскийАдрес["Район"];
		...
		ИначеЕсли ИмяПоказателя = "ОргГород" Тогда
			...
			Если Результат <> Неопределено Тогда
				...
				Значение = УкраинскийАдрес["Город"];
		...
		ИначеЕсли ИмяПоказателя = "ОргНПункт" Тогда
			...
			Если Результат <> Неопределено Тогда
				...
				Значение = УкраинскийАдрес["НаселенныйПункт"];
		...
		ИначеЕсли ИмяПоказателя = "ОргУлица" Тогда
			...
			Если Результат <> Неопределено Тогда
				...
				Значение = УкраинскийАдрес["Улица"];
		...
		ИначеЕсли ИмяПоказателя = "ОргКорпус" Тогда
			...
			Если Результат <> Неопределено Тогда
				...
				Значение = УкраинскийАдрес["Корпус"];
		...
		ИначеЕсли ИмяПоказателя = "ОргКвартира" Тогда
			...
			Если Результат <> Неопределено Тогда
				...
				Значение = УкраинскийАдрес["Квартира"];
			...
			Если Результат <> Неопределено И Результат.Количество() > 0 Тогда
				...
				Иначе
					...
					Если Результат2 <> Неопределено Тогда
						...
						РегламентированнаяОтчетностьВызовСервера.СформироватьАдрес(Результат2.ЗначенияПолей, УкраинскийАдрес);
...
Функция ПолучитьСУчетомКэша(Кэш, Параметр, ФизЛицо = Неопределено)
	...
	ИначеЕсли Параметр = "СведенияОбИндивидуальномПредпринимателеГражданство" 
		...
		Результат = Справочники.СтраныМира.Украина;
	...
	Если ИДОтчета = "РегламентированныйОтчетУСН" Тогда
		Если ИДРедакцииОтчета = "ФормаОтчета2009Кв1" Тогда
			Если Не ЗначениеЗаполнено(ПараметрыОтчета.Организация) Тогда
				ВызватьИсключение НСтр("ru='Не заполнен реквизит отчета Организация при авторасчете декларации по УСН';uk='Не заполнен реквизит отчета Организация при авторасчете декларации по УСН'");
			КонецЕсли;
...
//
// Пример:
//  Возврат "Бухгалтерия для Украины";
//
...
Функция ПолучитьСписокРегламентированныхОтчетов() Экспорт
	...
	СписокРегламентированныхОтчетов.Добавить("РегламентированныйОтчетДекларацияНДФЛ");
	СписокРегламентированныхОтчетов.Добавить("РегламентированныйОтчетНачислениеЕСВДодаток4");
	СписокРегламентированныхОтчетов.Добавить("РегламентированныйОтчетРасчетЕдиногоНалогаФизЛиц");
	СписокРегламентированныхОтчетов.Добавить("РегламентированныйОтчетФорма1ДФ");
	...
	// Первичные налоговые дкументы
	СписокРегламентированныхОтчетов.Добавить("РегламентированныйОтчетНалоговаяНакладная");
	СписокРегламентированныхОтчетов.Добавить("РегламентированныйОтчетПриложение2КНалоговойНакладной");
	
	// Прочее
	СписокРегламентированныхОтчетов.Добавить("РегламентированныйОтчетМенеджерЗвит1С");
	...
	Если ДокументыПерсУчета.Количество() > 0 Тогда
		...
		Пока Выборка.Следующий() Цикл
			...
			Если ТипЗнч(ЗапрашиваемыеДанные.Ссылка) = Тип("СправочникСсылка.КомплектыОтчетностиПерсучета") Тогда
				...
				ЗапрашиваемыеДанные.Наименование = НСтр("ru='Комплект форм квартальной отчетности в ПФР';uk='Комплект форм квартальной отчетности в ПФР'");
			КонецЕсли;
		КонецЦикла;
	КонецЕсли;
...
Процедура ОпределитьТаблицуОписанияОбъектовРегламентированнойОтчетности(ТаблицаОписания) Экспорт
	...
	ОписаниеДокументаОтчетности.ГруппаВДереве = НСтр("ru='Отчетность по физлицам';uk='Звітність по фізособам'");
...
//  Команда.Подсказка = НСтр("ru='Показать дополнительную информацию';uk='Показать дополнительную информацию'");
...
//  Кнопка.Заголовок = НСтр("ru='Инфо';uk='Инфо'");
...
Процедура ЗначенияПоказателей_РСВ1_2013Кв1(ПараметрыОтчета, Контейнер) Экспорт
	...
	//Выборка = МассивРезультатов[ВсегоЗапросов-5].Выбрать();
	//Если Выборка.Следующий() Тогда
	//	ЗаполнитьЗначенияСвойств(Контейнер.Раздел22, Выборка);
	//КонецЕсли;
	//
	//Выборка = МассивРезультатов[ВсегоЗапросов-6].Выбрать();
	//Если Выборка.Следующий() Тогда
	//	ЗаполнитьЗначенияСвойств(Контейнер.Раздел22, Выборка);
	//КонецЕсли;
...
Процедура РасчетПоказателей_РСВ1_2013Кв1(НачалоПериода, ОкончаниеПериода, Организация, ОписаниеТаблиц, ПодробныеДанные = Ложь)
	...
	//Если Год(ОкончаниеПериода) > 2013 Тогда
	//	РасчетПоказателей_РСВ1_2014(НачалоПериода, ОкончаниеПериода, Организация, ОписаниеТаблиц, ПодробныеДанные);
	//	Возврат
	//КонецЕсли;
...
Процедура ЗначенияПоказателей_РСВ1_2015Кв1(ПараметрыОтчета, Контейнер) Экспорт
	...
	//ВсеОснования = ОписаниеТаблиц.Раздел24Основания2014;
	//ТаблицаДоходов = ОписаниеТаблиц.Раздел24Доходы2014;
	//ТаблицаКоличеств = ОписаниеТаблиц.Раздел24Численность2014;
	//ТаблицаВзносов = ОписаниеТаблиц.Раздел24Взносы2014;
	...
	//	
	//	СтрокаДоходов = ТаблицаДоходов.Найти(СтрокаРезультата.Основание,"Основание");
	//	СтрокаКоличеств = ТаблицаКоличеств.Найти(СтрокаРезультата.Основание,"Основание");
	//	СтрокаВзносов = ТаблицаВзносов.Найти(СтрокаРезультата.Основание,"Основание");
	//	
	//	ДанныеРаздела24.П000240001001 = СтрокаРезультата.Основание;
	//	
	//	Если СтрокаДоходов = Неопределено и СтрокаВзносов = Неопределено Тогда // по текущему тарифу нет данных
	//		Если КоличествоОснований > 1 И ВсеОснования.Индекс(СтрокаРезультата) = ИндексПоследнейСтроки Тогда
	//			Контейнер.Раздел24.Удалить(СтраницаРаздела2);
	//		КонецЕсли;
	//		Продолжить;
	//	КонецЕсли;
	//	
	//	Если СтрокаДоходов <> Неопределено Тогда
	//		ЗаполнитьЗначенияСвойств(ДанныеРаздела24,СтрокаДоходов);
	//	КонецЕсли;
	//	Если СтрокаКоличеств <> Неопределено Тогда
	//		ЗаполнитьЗначенияСвойств(ДанныеРаздела24,СтрокаКоличеств);
	//	КонецЕсли;
	//	Если СтрокаВзносов <> Неопределено Тогда
	//		ЗаполнитьЗначенияСвойств(ДанныеРаздела24,СтрокаВзносов);
	//	КонецЕсли;
	//	
	//	// если применяемых в орг. списков больше 1, тогда создадим еще одну страницу для раздела 2.4
	//	Если ВсеОснования.Индекс(СтрокаРезультата) < ИндексПоследнейСтроки Тогда  
	//		ДанныеРаздела24 = ОбщегоНазначенияКлиентСервер.СкопироватьРекурсивно(СтруктураПолейРаздела24);
	//		СтраницаРаздела24 = Контейнер.Раздел24.Добавить();
	//		СтраницаРаздела24.Данные.Добавить(ДанныеРаздела24);
	//	КонецЕсли;
	//	
	//КонецЦикла;
...
Процедура ЗначенияПоказателей_4ФСС_2012Кв1(ПараметрыОтчета, Контейнер) Экспорт
	...
	//			Контейнер.Раздел1_1.П000010016311 = Выборка.Дата;
	//			Контейнер.Раздел1_1.П000010016321 = ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(
	//				Выборка.Номер,
	//				Истина, 
	//				Истина);
	//		ИначеЕсли Выборка.ФССНесчастныеСлучаи Тогда
	//			Контейнер.Раздел2_6_7.П000070012104 = Выборка.Дата;
	//			Контейнер.Раздел2_6_7.П000070012105 = ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(
	//				Выборка.Номер,
	//				Истина, 
	//				Истина);
	//		КонецЕсли;
	...
	//		Если Выборка.ФСС Тогда
	//			Контейнер.Раздел1_1.П000010016411 = Выборка.Дата;
	//			Контейнер.Раздел1_1.П000010016421 = ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(
	//				Выборка.Номер,
	//				Истина, 
	//				Истина);
	//		ИначеЕсли Выборка.ФССНесчастныеСлучаи Тогда
	//			Контейнер.Раздел2_6_7.П000070012204 = Выборка.Дата;
	//			Контейнер.Раздел2_6_7.П000070012205 = ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(
	//				Выборка.Номер,
	//				Истина, 
	//				Истина);
	//		КонецЕсли;
	...
	//		Если Выборка.ФСС Тогда
	//			Контейнер.Раздел1_1.П000010016511 = Выборка.Дата;
	//			Контейнер.Раздел1_1.П000010016521 = ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(
	//				Выборка.Номер,
	//				Истина, 
	//				Истина);
	//		ИначеЕсли Выборка.ФССНесчастныеСлучаи Тогда
	//			Контейнер.Раздел2_6_7.П000070012304 = Выборка.Дата;
	//			Контейнер.Раздел2_6_7.П000070012305 = ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(
	//				Выборка.Номер,
	//				Истина, 
	//				Истина);
	//		КонецЕсли;
