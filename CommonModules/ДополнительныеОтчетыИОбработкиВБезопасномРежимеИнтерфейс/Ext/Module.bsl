...
"Для использования COM-класса требуется переработать дополнительную обработку для работы без режима обратной совместимости.';uk='Дозвіл на використання COM-класу ""%1"" не може бути наданий додатковій обробці, що"
"працює в режимі зворотної сумісності з механізмом дозволів, реалізованим у версії БСП 2.1.3."
