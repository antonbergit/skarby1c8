...
Функция ОписанияОбластейДоступаКалендарь() Экспорт
	...
	Календарь.Представление = НСтр("ru='Календарь';uk='Календар'");
...
Функция ОписанияОбластейДоступаКонтакты() Экспорт
	...
	Контакты.Представление = НСтр("ru='Контакты';uk='Контакти'");
...
Функция ОписанияОбластейДоступаПочта() Экспорт
	...
	Почта.Представление = НСтр("ru='Почта';uk='Пошта'");
	...
	Профиль.Представление = НСтр("ru='Профиль';uk='Профіль'");
