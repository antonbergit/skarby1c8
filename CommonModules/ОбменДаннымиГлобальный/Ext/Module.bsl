...
"Необходимо установить обновление программы, после чего синхронизация данных будет продолжена.';uk='Отримано відновлення програми з ""%1""."
"Необхідно встановити відновлення програми, після чого синхронізація даних буде продовжена.'");
		...
		ПоказатьОповещениеПользователя(НСтр("ru='Установить обновление';uk='Встановити відновлення'"), "e1cib/app/Обработка.ВыполнениеОбменаДанными",
