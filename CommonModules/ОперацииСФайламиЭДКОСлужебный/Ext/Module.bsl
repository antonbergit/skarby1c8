...
Функция ПолучитьРазмерФайла(Знач Соединение, Знач ПутьНаСервере)
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(НСтр("ru='Электронный документооборот с контролирующими органами. Скачивание файла';uk='Електронний документообіг з контролюючими органами. Завантаження файлу'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
