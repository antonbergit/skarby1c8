...
Процедура ПроверитьКонтрагентовВОтчете(Форма, ДополнительныеПараметры) Экспорт
	...
	НаименованиеЗадания = НСтр("ru='Проверка контрагентов в отчетах по НДС';uk='Проверка контрагентов в отчетах по НДС'");
...
Функция СсылкаНаИнструкцию() Экспорт
	...
	// Предлагаем заменить стандартное поведение
	Результат = Новый ФорматированнаяСтрока(НСтр("ru='Подробнее о проверке';uk='Подробнее о проверке'"),,,, "e1cib/app/Обработка.ИнструкцияПоИспользованиюПроверкиКонтрагента");
