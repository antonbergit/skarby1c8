...
"не предусмотрены ни для одного плана обмена.';uk='Дати заборони завантаження даних минулих періодів з інших програм"
...
"""%1"".';uk='Для перевірки заборони зміни "
"в джерелі даних невірно зазначена таблиця"
" ""%1"".'"),
				Строка.Таблица);
		КонецЕсли;
...
"не задано поле заданной табличной части ""%2"".';uk='Для перевірки заборони зміни "
"в джерелі даних для таблиці ""%1"""
"невірно задане поле дати:"
"не задане поле заданої табличної частини ""%2"".'"),
...
"в источнике данных для таблицы ""%1"""
"неверно задано поле даты:"
"неверно задано поле заданной табличной части ""%2"".';uk='Для перевірки заборони зміни "
"в джерелі даних для таблиці ""%1"""
"невірно задане поле дати:"
"невірно задане поле заданої табличної частини ""%2"".'"),
				Источник.Таблица, Поля[0]);
		Иначе
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Для проверки запрета изменения "
