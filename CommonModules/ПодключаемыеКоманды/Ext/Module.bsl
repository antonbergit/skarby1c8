...
"Подробнее см. документацию БСП.';uk='Не впроваджена обов`язкова підсистема ""Підключаємі звіти і обробки""."
"Детальніше див. документацію БСП.'");
	КонецЕсли;
...
"%2';uk='При визначенні команд, підключених до форми ""%1"", виникла помилка:"
"%2'"),
				ИмяФормы,
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
			ЗаписьЖурналаРегистрации(
				НСтр("ru='Подключаемые команды';uk='Команди, що підключаються'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
