...
// 
// Параметры:
//   ТипХранилища - Строка, ПеречислениеСсылка.ТипХранилищаСертификатов - тип хранилища, из которого необходимо получить сертификаты.
...
Функция ИмяСобытияУдалениеФайла()
	...
	Возврат НСтр("ru='Хранилище сертификатов.Удаление файла';uk='Хранилище сертификатов.Удаление файла'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
...
Процедура ДобавитьПроверкаВходящихПараметров(Сертификат, ТипХранилища)
	...
	Если ТипЗнч(Сертификат) = Тип("Строка") Тогда
		ОбщегоНазначенияКлиентСервер.Проверить(
			...
			НСтр("ru='Недопустимое значение параметра Сертификат (указан адрес, который не является адресом временного хранилища)';uk='Недопустимое значение параметра Сертификат (указан адрес, который не является адресом временного хранилища)'"), 
			"ХранилищеСертификатов.Добавить");
	КонецЕсли;
