...
"- Для компьютеров с ОС Linux требуется установить пакет 1c-enterprise83-server*.';uk='Неможливо виконати операцію адміністрування кластера серверів з причини: файл %1 не знайдений!"
""
...
"- Для комп`ютерів з ОС Windows потрібно перевстановити платформу, встановивши компонент ""Адміністрування сервера 1С:Підприємства"";"
