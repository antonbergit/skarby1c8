...
Процедура ЗагрузитьХранилищеЗначения(Контейнер, ХранилищеЗначения, Артефакт)
	...
	Иначе
		...
		ВызватьИсключение СтрШаблон(НСтр("ru='Неожиданный тип размещения данных хранилища значений в контейнере выгрузки: {%1}%2!';uk='Неочікуваний тип розміщення даних сховища значень в "
"контейнері вивантаження: {%1}%2!'"),
