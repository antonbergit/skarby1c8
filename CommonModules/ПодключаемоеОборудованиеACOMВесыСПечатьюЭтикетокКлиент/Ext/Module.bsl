...
" данных в весы и нажмите кнопку ""Очистить PLU в весах""';uk='Дані ваги не підтримують автоматичне очищення товарів."
"Для очищення товарів у вагах запустіть додаток завантаження "
"даних у ваги й натисніть кнопку ""Очистити PLU у вагах""'"));
	Результат = Ложь;
...
Функция ТестУстройства(ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры) 
	...
	Если ПустаяСтрока(ВремБазаТоваров) Тогда
		Результат = Ложь;
		ТекстОшибки = НСтр("ru='Файл базы товаров не указан.';uk='Файл бази товарів не зазначений.'");
	КонецЕсли;
