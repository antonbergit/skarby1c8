...
//
Функция ХешированиеДанных(Данные, АлгоритмХеширования = "GOST R 34.11-94") Экспорт
	
	Возврат СервисКриптографииСлужебный.ХешированиеДанных(Данные, АлгоритмХеширования);
