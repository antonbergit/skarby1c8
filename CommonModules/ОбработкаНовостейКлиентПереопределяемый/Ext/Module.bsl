	...
	Если НайденноеДействие <> Неопределено Тогда
		...
		Если НайденноеДействие.Значение = "ПодключитьЭДО" Тогда
			...
			Если УправлениеНебольшойФирмойВызовСервера.ПолучитьФункциональнуюОпциюСервер("ИспользоватьОбменЭД") Тогда
				...
				Иначе
					ТекстПредупреждения = НСтр("ru='Недостаточно прав для настройки обмена электронными документами. Обратитесь к администратору.';uk='Недостатньо прав для налаштування обміну електронними документами. Зверніться до адміністратора.'");
			...
			Иначе
				...
				ТекстПредупреждения = НСтр("ru='Для включения возможности обмена электронными документами с контрагентами обратитесь к администратору.';uk='Для включення можливості обміну електронними документами з контрагентами зверніться до адміністратора.'");
				ПоказатьПредупреждение(,ТекстПредупреждения);
		...
		ИначеЕсли НайденноеДействие.Значение = "Отписаться" Тогда
			...
			Если Результат.Успешно Тогда
				ПоказатьОповещениеПользователя(
					НСтр("ru='Отказ получения новостей';uk='Отказ получения новостей'"),
					,
					СтрШаблон(НСтр("ru='Лента новостей ""%1"" отключена';uk='Лента новостей ""%1"" отключена'"), Результат.ПредставлениеЛентыНовостей),
