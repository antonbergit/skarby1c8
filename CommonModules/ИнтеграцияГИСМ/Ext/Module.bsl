...
Функция ПодготовитьСообщениеПолученияКвитанцииКПередаче(КонвертSOAP, Реквизиты) Экспорт
	...
	Исключение
		...
		ЗаголовокТекстаОшибки = СтрШаблон(
			НСтр("ru='Ошибка при подготовке к передаче сообщения по документу %1';uk='Ошибка при подготовке к передаче сообщения по документу %1'"),
			Реквизиты.Документ);
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru='ГИСМ';uk='ГИСМ'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
...
Функция ОписаниеОперации(Описание, ДокументСсылка, НомерВерсии = Неопределено) Экспорт
	...
	ИначеЕсли НомерВерсии = Неопределено И ДокументСсылка <> Неопределено Тогда
		Возврат СтрШаблон(НСтр("ru='%1 по документу ""%2""';uk='%1 по документу ""%2""'"), Описание, ДокументСсылка);
	ИначеЕсли НомерВерсии <> Неопределено И ДокументСсылка = Неопределено Тогда
		Возврат СтрШаблон(НСтр("ru='%1. Версия %2';uk='%1. Версия %2'"), Описание, НомерВерсии);
	Иначе
		Возврат СтрШаблон(НСтр("ru='%1 по документу ""%2"". Версия %3';uk='%1 по документу ""%2"". Версия %3'"), Описание, ДокументСсылка, НомерВерсии);
	КонецЕсли;
...
Функция КатегорииОпераций() Экспорт
	...
	ПолучениеСпискаВходящихДокументов.Вставить(
		...
		НСтр("ru='Получение списка входящих документов';uk='Получение списка входящих документов'"));
	
	ПередачаДанных = Новый Соответствие;
	ПередачаДанных.Вставить(
		Перечисления.ОперацииОбменаГИСМ.ПередачаДанных,
		НСтр("ru='Передача данных';uk='Передача данных'"));
	ПередачаДанных.Вставить(
		Перечисления.ОперацииОбменаГИСМ.ПередачаДанныхОтгрузкаМаркированныхТоваров,
		НСтр("ru='Передача сведений об отгрузке маркированных товаров';uk='Передача сведений об отгрузке маркированных товаров'"));
	ПередачаДанных.Вставить(
		Перечисления.ОперацииОбменаГИСМ.ПередачаДанныхИмпортМаркированнойПродукции,
		НСтр("ru='Передача сведений об импорте маркированной продукции на территорию РФ';uk='Передача сведений об импорте маркированной продукции на территорию РФ'"));
	ПередачаДанных.Вставить(
		Перечисления.ОперацииОбменаГИСМ.ПередачаАннулирования,
		НСтр("ru='Передача аннулирования';uk='Передача аннулирования'"));
	ПередачаДанных.Вставить(
		Перечисления.ОперацииОбменаГИСМ.ПередачаЗакрытияЗаявки,
		НСтр("ru='Передача запрос на закрытие заявки';uk='Передача запрос на закрытие заявки'"));
	ПередачаДанных.Вставить(
		Перечисления.ОперацииОбменаГИСМ.ПередачаПодтверждения, 
		НСтр("ru='Передача подтверждения поступления КиЗ';uk='Передача подтверждения поступления КиЗ'"));
	
	ПередачаДанных.Вставить(
		Перечисления.ОперацииОбменаГИСМ.ПередачаДанныхЗаявкаНаВыпускКиЗ,
		НСтр("ru='Передача заявки на выпуск КиЗ';uk='Передача заявки на выпуск КиЗ'"));
	ПередачаДанных.Вставить(
		Перечисления.ОперацииОбменаГИСМ.ПередачаДанныхВозвратОтРозничногоПокупателя,
		НСтр("ru='Передача сведений о возврате товара от розничного покупателя';uk='Передача сведений о возврате товара от розничного покупателя'"));
	ПередачаДанных.Вставить(
		Перечисления.ОперацииОбменаГИСМ.ПередачаДанныхРозничнаяПродажа,
		НСтр("ru='Передача сведений о КиЗ, реализованных в розницу';uk='Передача сведений о КиЗ, реализованных в розницу'"));
	ПередачаДанных.Вставить(
		Перечисления.ОперацииОбменаГИСМ.ПередачаДанныхВыбраковкаКиЗ,
		НСтр("ru='Передача сведений о выбраковке неиндивидуализированных КиЗ';uk='Передача сведений о выбраковке неиндивидуализированных КиЗ'"));
	ПередачаДанных.Вставить(
		Перечисления.ОперацииОбменаГИСМ.ПередачаДанныхСписаниеКиЗ,
		НСтр("ru='Передача сведений о списанных КиЗ';uk='Передача сведений о списанных КиЗ'"));
		
	ПередачаДанных.Вставить(
		Перечисления.ОперацииОбменаГИСМ.ПередачаДанныхСписаниеТоваров,
		НСтр("ru='Передача сведений о списании маркированной продукции';uk='Передача сведений о списании маркированной продукции'"));
	ПередачаДанных.Вставить(
		Перечисления.ОперацииОбменаГИСМ.ПередачаДанныхМаркировкаТоваров,
		НСтр("ru='Передача сведений о маркированной продукции';uk='Передача сведений о маркированной продукции'"));
	ПередачаДанных.Вставить(
		Перечисления.ОперацииОбменаГИСМ.ПередачаДанныхПеремаркировкаТоваров,
		НСтр("ru='Передача сведений о перемаркированной продукции';uk='Передача сведений о перемаркированной продукции'"));
	ПередачаДанных.Вставить(
		Перечисления.ОперацииОбменаГИСМ.ПередачаДанныхВозвратФизическомуЛицуКомиссия,
		НСтр("ru='Передача сведений о возврате маркированной продукции физическому лицу (комиссия)';uk='Передача сведений о возврате маркированной продукции физическому лицу (комиссия)'"));
	ПередачаДанных.Вставить(
		Перечисления.ОперацииОбменаГИСМ.ПередачаДанныхОтгрузкаЗаПределыЕАЭС,
		НСтр("ru='Передача сведений об экспорте маркированной продукции за пределы ЕАЭС';uk='Передача сведений об экспорте маркированной продукции за пределы ЕАЭС'"));
	ПередачаДанных.Вставить(
		Перечисления.ОперацииОбменаГИСМ.ПередачаДанныхОтгрузкаЭкспортЕАЭС,
		НСтр("ru='Передача сведений об экспорте маркированной продукции в страны ЕАЭС';uk='Передача сведений об экспорте маркированной продукции в страны ЕАЭС'"));
	ПередачаДанных.Вставить(
		Перечисления.ОперацииОбменаГИСМ.ПередачаДанныхВвозМаркированнойПродукцииИзЕАЭС,
		НСтр("ru='Передача сведений о ввозе маркированной продукции из стран ЕАЭС на территорию РФ';uk='Передача сведений о ввозе маркированной продукции из стран ЕАЭС на территорию РФ'"));
	
	ТекстПолучениеКвитанции = НСтр("ru='Получение квитанции';uk='Получение квитанции'");
...
Функция ПоддерживаемыеТипыДокументов() Экспорт
	...
	ОписаниеТипаДокумента.Вставить("Описание", НСтр("ru='Уведомление об изменении статуса заявки на выпуск КиЗ';uk='Уведомление об изменении статуса заявки на выпуск КиЗ'"));
	...
	ОписаниеТипаДокумента.Вставить("Описание", НСтр("ru='Уведомление о выпущенных КиЗ';uk='Уведомление о выпущенных КиЗ'"));
	ПоддерживаемыеТипыДокументов.Вставить(12, ОписаниеТипаДокумента);
	
	ОписаниеТипаДокумента = Новый Структура;
	ОписаниеТипаДокумента.Вставить("Операция", Перечисления.ОперацииОбменаГИСМ.ПолучениеТоваров);
	ОписаниеТипаДокумента.Вставить("Описание", НСтр("ru='Уведомление о поступлении маркированных товаров';uk='Уведомление о поступлении маркированных товаров'"));
	...
	ОписаниеТипаДокумента.Вставить("Описание", НСтр("ru='Аннулирование уведомления об отгрузке маркированных товаров';uk='Аннулирование уведомления об отгрузке маркированных товаров'"));
	...
	ОписаниеТипаДокумента.Вставить("Описание", НСтр("ru='Подтверждение получения маркированных товаров';uk='Подтверждение получения маркированных товаров'"));
	...
	ОписаниеТипаДокумента.Вставить("Описание", НСтр("ru='Закрытие уведомления об отгрузке маркированных товаров';uk='Закрытие уведомления об отгрузке маркированных товаров'"));
	ПоддерживаемыеТипыДокументов.Вставить(33, ОписаниеТипаДокумента);
	
	ОписаниеТипаДокумента = Новый Структура;
	ОписаниеТипаДокумента.Вставить("Операция", Перечисления.ОперацииОбменаГИСМ.ПолучениеТоваров);
	ОписаниеТипаДокумента.Вставить("Описание", НСтр("ru='Уведомление о поступлении маркированных товаров незарегистрированному покупателю';uk='Уведомление о поступлении маркированных товаров незарегистрированному покупателю'"));
...
"До выполнения обновления загрузка данных из ГИСМ будет выполнятся не в полном объеме.';uk='Поточна версія конфігурації не підтримує актуальний формат обміну з ГІСМ (%1)."
"Необхідно оновити програмне забезпечення конфігурації."
"До завершення оновлення завантаження даних з ГІСМ буде виконуватися не в повному обсязі.'"), НоваяВерсияСхемОбмена);
	...
	Если ВерсииСхемОбмена.Клиент <> НоваяВерсияСхемОбмена
		...
		Если СоответствиеВерсийСхемОбмена().Получить(НоваяВерсияСхемОбмена) <> Неопределено Тогда
			...
			ВозвращаемоеЗначение.ТекстСообщения = СтрШаблон(
				НСтр("ru='Версия Формата обмена с ГИСМ обновлена до %2.';uk='Версія Формату обміну з ГІСМ оновлена до %2.'"),
...
Функция ПроизвольныйОбъектXDTOПоТекстуСообщенияXML(ТекстСообщенияXML) Экспорт
	...
	ТекстСообщенияXML2 = СтрЗаменить(ТекстСообщенияXML,"commits","details");
	
	ЧтениеXML = Новый ЧтениеXML;
	ЧтениеXML.УстановитьСтроку(ТекстСообщенияXML2);
...
Функция ОбъектXDTOПоИмениСвойства(ОбъектXDTOРодитель, ИмяСвойства, Версия = Неопределено) Экспорт
	...
	Если СвойствоXDTO = Неопределено Тогда
		ВызватьИсключение СтрШаблон(НСтр("ru='Свойство %1 отсутствует в составе типов информационной системы маркировки.';uk='Свойство %1 отсутствует в составе типов информационной системы маркировки.'"), ИмяСвойства);
	Иначе
...
Процедура ЗаполнитьСписокВыбораДальнейшееДействие(СписокВыбора, ВсеТребующиеДействия, ВсеТребующиеОжидания) Экспорт
	...
	СписокВыбора.Добавить("ВсеТребующиеДействия", НСтр("ru='Все требующие действия';uk='Все требующие действия'"));
	СписокВыбора.Добавить("ВсеТребующиеОжидания", НСтр("ru='Все требующие ожидания';uk='Все требующие ожидания'"));
	СписокВыбора.Добавить("ВсеТребующиеДействияИлиОжидания", НСтр("ru='Все требующие действия или ожидания';uk='Все требующие действия или ожидания'"));
...
Процедура УстановитьУсловноеОформлениеПоляДата(Форма, ИмяСписка = "Список", ИмяПоляДата = "Дата") Экспорт
	...
	ПредставлениеЭлемента = НСтр("ru='Представление даты до начала этого дня: ""10.06.2012""';uk='Представление даты до начала этого дня: ""10.06.2012""'");
	ЭлементУсловногоОформления.Представление = ПредставлениеЭлемента;
	...
	ПредставлениеЭлемента = НСтр("ru='Представление даты после начала этого дня: ""10.06.2012""';uk='Представление даты после начала этого дня: ""10.06.2012""'");
	ЭлементУсловногоОформления.Представление = ПредставлениеЭлемента;
...
Процедура ОтразитьНеЗаказаннуюНоменклатуруВСтроке(Выборка, Объект) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Для Каждого НайденнаяСтрока Из НайденныеСтроки Цикл
			...
			ТекстОписанияПроблемы = НСтр("ru='""%1"" отстуствует в списке заказанных КиЗ.';uk='""%1"" отстуствует в списке заказанных КиЗ.'");
...
Процедура ОтразитьНеНайденнуюНоменклатуруВСтроке(Выборка, Объект) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Для Каждого НайденнаяСтрока Из НайденныеСтроки Цикл
			НайденнаяСтрока.ЕстьПроблема = Истина;
			НайденнаяСтрока.ОписаниеПроблемы = НСтр("ru='Для данной строки в информационной базе не найдена позиция номенклатуры.';uk='Для данной строки в информационной базе не найдена позиция номенклатуры.'");
		КонецЦикла;
...
Функция ПолноеИмяСсылочногоТипаПоДаннымОпределяемогоТипа(ИмяОпределяемогоТипа, ДолженБытьУказанТолькоОдинТип = Истина) Экспорт
	...
	Если ДолженБытьУказанТолькоОдинТип И ТипыЗаданныеВОпределяемомТипе.Количество() > 1 Тогда
		ВызватьИсключение(СтрШаблон(НСтр("ru='В определяемом типе ""%1"" должен быть указан только один тип.';uk='В определяемом типе ""%1"" должен быть указан только один тип.'"), МетаданныеОпределяемогоТипа.Имя));
	КонецЕсли;
	...
	Если МетаданныеНоменклатура = Неопределено Тогда
		ВызватьИсключение(СтрШаблон(НСтр("ru='В определяемом типе ""%1"" должен быть указан ссылочный тип.';uk='В определяемом типе ""%1"" должен быть указан ссылочный тип.'"), МетаданныеОпределяемогоТипа.Имя));
	Иначе
...
Процедура УстановитьУсловноеОформлениеСтатусДальнейшееДействиеГИСМ(УсловноеОформление,
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='<не требуется>';uk='<не требуется>'"));
...
Процедура УстановитьУсловноеОформлениеНомерГИСМ(УсловноеОформление,
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='<не получен>';uk='<не получен>'"));
	Элемент.Оформление.УстановитьЗначениеПараметра("ЦветТекста", ЦветаСтиля.ЦветТекстаНеТребуетВниманияГИСМ);
...
Функция ОбработатьЗагрузкуДокумента(ТекстВходящегоСообщенияXML, ТекстИсходящегоСообщенияXML, ДанныеДляПолученияДокумента, ВозвращаемоеЗначение = Неопределено) Экспорт
	...
	Иначе
		...
		Попытка
			...
			Иначе
				ВызватьИсключение СтрШаблон(НСтр("ru='Неизвестный тип загружаемого документа action_id %1';uk='Неизвестный тип загружаемого документа action_id %1'"), action_id);
			КонецЕсли;
		...
		Исключение
			...
			Иначе
				НаименованиеДокумента = НСтр("ru='Неподдерживаемый документ';uk='Неподдерживаемый документ'");
			КонецЕсли;
...
"%4';uk='При загрузке документа %5 (action_id=%1) с output_id=%2 возникла ошибка:"
"Текст ошибки: %3"
"Данные документа доступны для просмотра и повторной загрузке в списке ""Очередь получения данных из ГИСМ"""
"Текст сообщения SOAP:"
"%4'"),
...
"%2';uk='При загрузке уведомления об изменении состояния обработки эмитентом заявки на выпуск КиЗ возникла ошибка:"
"Не найдена заявка с id %1."
"Текст входящего сообщения SOAP:"
"%2'"),
	...
	Иначе
		ВызватьИсключение СтрШаблон(НСтр("ru='Статус обработки %1 не поддерживается в данной версии';uk='Статус обработки %1 не поддерживается в данной версии'"), ДанныеДокумента.order_status);
	КонецЕсли;
	
	Если ДанныеДокумента.reason = 1 Тогда
		Описание = НСтр("ru='Отсутствуют ИНН/КПП';uk='Отсутствуют ИНН/КПП'");
	ИначеЕсли ДанныеДокумента.reason = 2 Тогда
		Описание = НСтр("ru='По указанным ИНН/КПП не найден контрагент';uk='По указанным ИНН/КПП не найден контрагент'");
	ИначеЕсли ДанныеДокумента.reason = 3 Тогда
		Описание = НСтр("ru='Отсутствуют реквизиты договора';uk='Отсутствуют реквизиты договора'");
	ИначеЕсли ДанныеДокумента.reason = 4 Тогда
		Описание = НСтр("ru='Истекли 5 рабочих дней для исправления некорректных реквизитов заявления';uk='Истекли 5 рабочих дней для исправления некорректных реквизитов заявления'");
	ИначеЕсли ДанныеДокумента.reason = 5 Тогда
		Описание = НСтр("ru='Не заполнен реквизит заявления (с указанием конкретного реквизита)';uk='Не заполнен реквизит заявления (с указанием конкретного реквизита)'");
	ИначеЕсли ДанныеДокумента.reason = 6 Тогда
		Описание = НСтр("ru='Значение реквизита заявления не найдено в справочнике (с указанием конкретного реквизита)';uk='Значение реквизита заявления не найдено в справочнике (с указанием конкретного реквизита)'");
	ИначеЕсли ДанныеДокумента.reason = 7 Тогда
		Описание = НСтр("ru='Не найден договор с указанными реквизитами';uk='Не найден договор с указанными реквизитами'");
	ИначеЕсли ДанныеДокумента.reason = 8 Тогда
		Описание = НСтр("ru='Возвращено грузоперевозчиком';uk='Возвращено грузоперевозчиком'");
	ИначеЕсли ДанныеДокумента.reason = 9 Тогда
		Описание = НСтр("ru='Возвращено заказчиком';uk='Возвращено заказчиком'");
	ИначеЕсли ДанныеДокумента.reason = Неопределено Тогда
		Описание = "";
	Иначе
		ВызватьИсключение СтрШаблон(НСтр("ru='Причина изменения статуса %1 не поддерживается в данной версии';uk='Причина изменения статуса %1 не поддерживается в данной версии'"), ДанныеДокумента.reason);
	КонецЕсли;
...
"Не найдена заявка с id %1."
"Текст входящего сообщения SOAP:"
"%2';uk='При загрузке уведомления о выпуске КиЗ эмитентом возникла ошибка:"
"Не найдена заявка с id %1."
"Текст входящего сообщения SOAP:"
"%2'"),
			ДанныеДокумента.emit_order_id,
	...
	Если ДанныеДокумента.emits.by_sign_type.Количество() = 0 Тогда
		ВызватьИсключение НСтр("ru='Данные о выпущенных КиЗ не загружены';uk='Данные о выпущенных КиЗ не загружены'");
	КонецЕсли;
...
Функция ЗагрузитьУведомлениеОПоступленииМаркированныхТоваров(ДанныеДокумента, ДанныеОтправителя, НомерДокумента, Сообщения)
	...
	Если ВерсияНеМенееТребуемой(Сообщения.ВерсияВходящегоСообщенияXML, "2.41") Тогда
		...
		Если ДанныеДокумента.order_details.sign.Количество() = 0 Тогда
			ВызватьИсключение НСтр("ru='Данные о поступивших КиЗ не загружены';uk='Данные о поступивших КиЗ не загружены'");
		КонецЕсли;
...
"Не найдена заявка с id %1."
"Текст входящего сообщения SOAP:"
"%2';uk='При загрузке аннулирования клиентом уведомления об отгрузке возникла ошибка:"
"Не найдена заявка с id %1."
"Текст входящего сообщения SOAP:"
"%2'"),
...
Функция ЗагрузитьПодтверждениеПолученияМаркированныхТоваров(ДанныеДокумента, Сообщения)
	...
	ЗаголовокТекстаОшибки = НСтр("ru='Ошибка при загрузке подтверждения клиентом получения маркированных товаров:';uk='Ошибка при загрузке подтверждения клиентом получения маркированных товаров:'");
...
"Не найдена заявка с id %1."
"Текст входящего сообщения SOAP:"
"%2';uk='При загрузке подтверждения клиентом получения маркированных товаров возникла ошибка:"
"Не найдена заявка с id %1."
"Текст входящего сообщения SOAP:"
"%2'"),
			ДанныеДокумента.move_order_id,
	...
	Если ВерсияНеМенееТребуемой(Сообщения.ВерсияВходящегоСообщенияXML, "2.41") Тогда
		...
		Если ДанныеДокумента.details.sign.Количество() = 0 Тогда
			ВызватьИсключение НСтр("ru='Номера КиЗ для подтверждения не загружены';uk='Номера КиЗ для подтверждения не загружены'");
		КонецЕсли;
...
"Текст входящего сообщения SOAP:"
"%4';uk='При загрузке подтверждения клиентом получения маркированных товаров по заявке %1 возникла ошибка:"
"В документе %2 в табличной части ""Товары"" не найден товар с номером КиЗ %3."
"Текст входящего сообщения SOAP:"
"%4'"),
					ДанныеДокумента.move_order_id,
...
"Не найдена заявка с id %1."
"Текст входящего сообщения SOAP:"
"%2';uk='При загрузке закрытия клиентом уведомления об отгрузке возникла ошибка:"
"Не найдена заявка с id %1."
"Текст входящего сообщения SOAP:"
"%2'"),
			ДанныеДокумента.move_order_id,
...
"Текст входящего сообщения SOAP:"
"%3';uk='При загрузке номера уведомления об отгрузке незарегистрированному покупателю возникла ошибка:"
"Не найден документ-основание с номером документа %1 для контрагента с ИНН %2"
"Текст входящего сообщения SOAP:"
"%3'"),
...
"Текст ошибки: %1';uk='При выполнении обмена с ГИСМ возникла ошибка:"
