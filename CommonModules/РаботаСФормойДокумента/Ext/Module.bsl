...
Процедура УдалитьНедоступныеВидыОперацийДокументов(Операции) Экспорт
	...
	Если НЕ ПолучитьФункциональнуюОпцию("ИспользоватьКорректировкиРеализаций") Тогда
		УдалитьОперацию(Операции, Перечисления.ВидыОперацийНалоговаяНакладная.Корректировка);
	КонецЕсли;
...
Функция ПолучитьСерийныеНомераИзХранилища(Объект, АдресЗапасовВХранилище, КлючСвязи, ИмяТЧЗапасов="Запасы", ИмяТЧСерийныхНомеров="СерийныеНомера", ИмяПоляКлючСвязи = "КлючСвязи") Экспорт
	...
	МассивУдалитьСтроки = Новый ФиксированныйМассив(Объект[ИмяТЧСерийныхНомеров].НайтиСтроки(ОтборСерийныеНомераТекущейСтроки));
	Для каждого СтрокаУдалить Из МассивУдалитьСтроки Цикл
		Объект[ИмяТЧСерийныхНомеров].Удалить(СтрокаУдалить);	
	КонецЦикла;
	...
	Для каждого СтрокаЗагрузки Из ТаблицаДляЗагрузки Цикл
		...
		НоваяСтрока = Объект[ИмяТЧСерийныхНомеров].Добавить();
		//+ ГИСМ
		...
		Если НоваяСтрока.Свойство("СерийныйНомер") Тогда
			КолонкаСерийныйНомер = "СерийныйНомер";
		Иначе
	...
	СтрокиЗапасов = Объект[ИмяТЧЗапасов].НайтиСтроки(ОтборСерийныеНомераТЧ);
...
Функция ПараметрыПодбораСерийныхНомеров(ДокОбъект, УИДФормы, ИДСтроки, РежимПодбора = Неопределено, ИмяТЧ="Запасы", ИмяТЧСерийныхНомеров="СерийныеНомера", ИмяПоляКлючСвязи = "КлючСвязи") Экспорт
	...
	ПараметрыСерийныхНомеров = РаботаСФормойДокумента.ПодготовитьПараметрыСерийныхНомеров(ДокОбъект, ТекСтрокаДанные, УИДФормы, ИмяТЧ, ИмяТЧСерийныхНомеров, ИмяПоляКлючСвязи);
...
Функция ПодготовитьПараметрыСерийныхНомеров(ДокОбъект, ТекСтрокаДанные, УИДФормы, ИмяТЧ = "Запасы", ИмяТЧСерийныхНомеров="СерийныеНомера", ИмяПоляКлючСвязи = "КлючСвязи") Экспорт
