...
Процедура НастроитьОбменШаг1(Сообщение, Отправитель)
	...
	Попытка
		...
		Если Отказ Тогда
			ВызватьИсключение СтрШаблон(НСтр("ru='Возникли ошибки в процессе выгрузки справочников для корреспондента %1.';uk='Виникли помилки у процесі вивантаження довідників для "
"кореспондента %1.'"),
