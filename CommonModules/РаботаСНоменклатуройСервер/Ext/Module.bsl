...
"Документ %1."
"В документе нет товаров с опцией <Выписывать гарантийный талон>';uk='__________________"
"Документ %1."
"В документі немає товарів з опцією <Виписувати гарантійний талон>'");
	...
	ОбластьМакета.Параметры.ТекстЗаголовка = НСтр("ru='Гарантийный талон № ';uk='Гарантійний талон № '")
		+ НомерДокумента
		+ НСтр("ru=' от ';uk=' від '")
...
"В документі немає товарів з опцією <Виписувати гарантійний талон>'");
	...
	ОбластьМакета.Параметры.ТекстЗаголовка = НСтр("ru='Гарантийный талон';uk='Гарантійний талон'")+" № "+НомерДокумента+НСтр("ru=' от';uk=' від'")+" ___________________";
...
Функция ПечатьГарантийныйТалон(МассивОбъектов, ОбъектыПечати, ИмяМакета) Экспорт
