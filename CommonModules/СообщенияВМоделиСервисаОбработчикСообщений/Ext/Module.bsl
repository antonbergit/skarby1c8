	...
	Попытка
		...
		Иначе
			...
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Не удалось определить обработчик канала сообщений в модели сервиса %1';uk='Не вдалося визначити обробник каналу повідомлень в моделі "
"сервісу %1'"), КаналСообщений);
