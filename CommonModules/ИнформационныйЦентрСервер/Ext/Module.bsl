...
Функция ПолучитьОбщиеМакетыИнформационныхСсылок() Экспорт
	...
	//ИмяМакета = ?(ТекущийЯзык().КодЯзыка = "ru", "ИнформационныеСсылки_Общие", "ИнформационныеСсылки_Общие_uk");
	ИмяМакета = ?(ИнтернетПоддержкаПользователей.КодЯзыкаИнтерфейсаКонфигурации() = "ru", "ИнформационныеСсылки_Общие", "ИнформационныеСсылки_Общие_uk");
...
"Пожалуйста, повторите попытку позже.';uk='Центр ідей тимчасово не доступний."
...
Функция СформироватьДатуОтклонения(Знач ПредставлениеИдеи) Экспорт
	...
	Возврат СтрШаблон(НСтр("ru='Отклонено: %1';uk='Відхилене: %1'"), Формат(ПредставлениеИдеи.ClosingDate, "ДЛФ=DD"));
...
Функция СформироватьДатуРеализации(Знач ПредставлениеИдеи) Экспорт
	...
	Возврат СтрШаблон(НСтр("ru='Реализовано: %1';uk='Реалізоване: %1'"), Формат(ПредставлениеИдеи.ClosingDate, "ДЛФ=DD"));
...
"Пожалуйста, повторите попытку позже.';uk='Служба підтримки тимчасово не доступна."
"Будь ласка, повторіть спробу пізніше.'")
...
Функция СформироватьXMLСТехническимиПараметрами(ДополнительныеПараметры = Неопределено) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(НСтр("ru='Информационный центр.Отправка сообщения в техподдержку.Не удалось удалить временный файл технических параметров.';uk='Інформаційний центр.Відправка повідомлення в техпідтримку.Не вдалося видалити тимчасовий файл технічних параметрів.'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
