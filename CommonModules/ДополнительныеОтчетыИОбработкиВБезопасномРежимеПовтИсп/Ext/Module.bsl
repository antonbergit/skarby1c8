...
Функция Словарь() Экспорт
	...
	ДобавитьПараметр(Параметры, "Host", НСтр("ru='с сервера %1';uk='з сервера %1'"), НСтр("ru='с любого сервера';uk='с будь-якого сервера'"));
...
"її розроблювачеві й контролюйте обмеження (сервер, протокол і порт), що накладаються на"
"видані дозволи.'");
...
""
"Використовуйте даний додатковий звіт або обробку тільки в тому випадку, якщо Ви довіряєте"
"її розроблювачеві й контролюйте обмеження (адреса підключення), що накладаються на"
"видані дозволи.'");
...
""
"Використовуйте даний додатковий звіт або обробку тільки в тому випадку, якщо Ви довіряєте"
"її розроблювачеві й контролюйте обмеження (програмний ідентифікатор), що накладаються на"
"видані дозволи.'");
...
""
"Використовуйте даний додатковий звіт або обробку тільки в тому випадку, якщо Ви довіряєте"
"її розроблювачеві й контролюйте обмеження (ім`я макета, з якого виконується підключення зовнішньої"
