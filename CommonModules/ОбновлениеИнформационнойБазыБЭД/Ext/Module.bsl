...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Если ЕстьОбменСКонтрагентами Тогда
		...
		Обработчик.Комментарий = НСтр("ru='Изменяет состояние документов с ""Ожидается извещение"" на ""Ожидается извещение о получении""';uk='Изменяет состояние документов с ""Ожидается извещение"" на ""Ожидается извещение о получении""'");
		Обработчик.НачальноеЗаполнение = Ложь;
		...
		Обработчик.Комментарий = НСтр("ru='Проверяет контрагентов на подключение к сервису 1С-ЭДО.';uk='Проверяет контрагентов на подключение к сервису 1С-ЭДО.'");
		...
		Обработчик.Процедура = "ОбменСКонтрагентамиОбработчикиОбновления.ДобавитьНовыеВидыЭДУПД_УКД";
		Обработчик.РежимВыполнения = "Монопольно";
		
		Обработчик = Обработчики.Добавить();
		Обработчик.Версия = "1.3.6.2";
		Обработчик.Процедура = "ОбменСКонтрагентамиОбработчикиОбновления.ПеренестиПаролиВБезопасноеХранилище";
		Обработчик.РежимВыполнения = "Монопольно";
		Обработчик.НачальноеЗаполнение = Ложь;
		
		Обработчик = Обработчики.Добавить();
		Обработчик.Версия = "1.3.6.4";
		Обработчик.Процедура = "ОбменСКонтрагентамиОбработчикиОбновления.ЗаполнитьВходящиеДокументыНастроек";
		Обработчик.РежимВыполнения = "Монопольно";
		Обработчик.НачальноеЗаполнение = Ложь;
		
		Обработчик = Обработчики.Добавить();
		Обработчик.Версия = "1.3.6.4";
		Обработчик.Процедура = "ОбменСКонтрагентамиОбработчикиОбновления.ПеревестиНаНовуюАрхитектуруЭДО";
		Обработчик.РежимВыполнения = "Монопольно";
		Обработчик.НачальноеЗаполнение = Ложь;
		Обработчик.РежимВыполнения = "Отложенно";
		Обработчик.Идентификатор = Новый УникальныйИдентификатор("e2bf49f3-cca8-4a44-9dad-21b0f1d153f1");
		Обработчик.Комментарий = НСтр("ru='Обмен с контрагентами: Создает входящие и исходящие ЭД';uk='Обмен с контрагентами: Создает входящие и исходящие ЭД'");
		
		Обработчик = Обработчики.Добавить();
		Обработчик.Версия = "1.3.6.4";
		Обработчик.Процедура = "ОбменСКонтрагентамиОбработчикиОбновления.ПеревестиНаНовуюАрхитектуруПроизвольныхЭД";
		Обработчик.РежимВыполнения = "Монопольно";
		Обработчик.НачальноеЗаполнение = Ложь;
		Обработчик.РежимВыполнения = "Отложенно";
		Обработчик.Идентификатор = Новый УникальныйИдентификатор("e2bf49f3-cca8-4a44-9dad-21b0f1d153f2");
		Обработчик.Комментарий = НСтр("ru='Обмен с контрагентами: Создает входящие и исходящие ЭД для произвольных ЭД';uk='Обмен с контрагентами: Создает входящие и исходящие ЭД для произвольных ЭД'");
		
		Обработчик = Обработчики.Добавить();
		Обработчик.Версия = "1.3.6.4";
		Обработчик.Процедура = "ОбменСКонтрагентамиОбработчикиОбновления.ПеревестиНаНовуюАрхитектуруПакетыЭД";
		Обработчик.РежимВыполнения = "Монопольно";
		Обработчик.НачальноеЗаполнение = Ложь;
		Обработчик.РежимВыполнения = "Отложенно";
		Обработчик.Идентификатор = Новый УникальныйИдентификатор("e2bf49f3-cca8-4a44-9dad-21b0f1d153f3");
		Обработчик.Комментарий = НСтр("ru='Обмен с контрагентами: Удаляет полученные и отправленные пакеты ЭД';uk='Обмен с контрагентами: Удаляет полученные и отправленные пакеты ЭД'");
		
		Обработчик = Обработчики.Добавить();
		Обработчик.Версия = "1.3.6.7";
		Обработчик.Процедура = "ОбменСКонтрагентамиОбработчикиОбновления.УдалитьНовыеВидыЭДУПД_УКД";
		Обработчик.РежимВыполнения = "Монопольно";
	...
	Если ЕстьОбменСБанками И ЕстьОбменСКонтрагентами Тогда
		...
		Обработчик.Процедура = "ОбменСБанкамиОбработчикиОбновления.ПеренестиДанныеОбменаСБанками";
		Обработчик.РежимВыполнения = "Отложенно";
		...
		Обработчик = Обработчики.Добавить();
		Обработчик.Версия = "1.3.1.1";
		Обработчик.Процедура = "ОбменСБанкамиОбработчикиОбновления.ОбработатьРегистрПодписываемыеВидыЭД";
		Обработчик.РежимВыполнения = "Отложенно";
	...
	Если ЕстьОбменСБанками Тогда
		...
		Обработчик.Процедура = "ОбменСБанкамиОбработчикиОбновления.ПеренестиДанныеДополнительныхОбработокВКонстанту";
		Обработчик.РежимВыполнения = "Отложенно";
		Обработчик.Идентификатор = Новый УникальныйИдентификатор("c008fa2f-33a5-4c51-b00f-25fbe916fb1a");
		Обработчик.Комментарий = НСтр("ru='1С:ДиректБанк: Переносит данные дополнительных обработок в константу';uk='1С:ДиректБанк: Переносит данные дополнительных обработок в константу'");
		
		Обработчик = Обработчики.Добавить();
		Обработчик.Версия = "1.3.2.3";
		Обработчик.Процедура = "ОбменСБанкамиОбработчикиОбновления.ПеренестиСтатусыЭлектронныхПодписей";
		Обработчик.РежимВыполнения = "Отложенно";
		...
		Обработчик = Обработчики.Добавить();
		Обработчик.Версия = "1.3.4.8";
		Обработчик.Процедура = "ОбменСБанкамиОбработчикиОбновления.ВключитьАвтоматическоеОбновлениеСпискаБанков";
		Обработчик.РежимВыполнения = "Отложенно";
