...
"%1';uk='Ошибка при использовании Windows Script Host:"
"%1'"),
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке));
			ИнтернетПоддержкаПользователейВызовСервера.ЗаписатьСообщениеВЖурналРегистрации(
				НСтр("ru='БИП:ОблачныйАрхив.Отладка';uk='БИП:ОблачныйАрхив.Отладка'"), // ИмяСобытия
				НСтр("ru='Облачный архив. Отладка. Работа с Windows Script Host';uk='Облачный архив. Отладка. Работа с Windows Script Host'"), // ИдентификаторШага
