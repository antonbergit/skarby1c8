...
Процедура ДобавитьПрефиксыНалоговогоДокумента(ДокументОбъект, Префикс) Экспорт
	...
	ВестиРаздельнуюНумерациюНалоговыхДокументов = Константы.ВестиРаздельнуюНумерациюНалоговыхДокументов.Получить();
	
	Если ВестиРаздельнуюНумерациюНалоговыхДокументов Тогда
	...
	ВестиМесячнуюНумерациюНалоговыхДокументов = Константы.ВестиМесячнуюНумерациюНалоговыхДокументов.Получить();
	
	Если ВестиМесячнуюНумерациюНалоговыхДокументов Тогда
	...
	ПрефиксНалоговых = Лев(ПрефиксНалоговых + "0000", 2);
