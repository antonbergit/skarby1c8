...
Функция ЗафиксироватьДлительностьКлючевыхОпераций(АдресХранилища) Экспорт
	...
	Если НаборЗаписей.Количество() > 0 Тогда
		...
		Исключение
			ЗаписьЖурналаРегистрации(НСтр("ru='Не удалось сохранить замеры производительности';uk='Не вдалося зберегти виміри продуктивності'", Метаданные.ОсновнойЯзык.КодЯзыка),
	...
	Если НаборЗаписейТехнологический.Количество() > 0 Тогда
		...
		Исключение
			ЗаписьЖурналаРегистрации(НСтр("ru='Не удалось сохранить технологические замеры производительности';uk='Не вдалося зберегти технологічні виміри продуктивності'", Метаданные.ОсновнойЯзык.КодЯзыка),
				УровеньЖурналаРегистрации.Ошибка,,,ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		КонецПопытки;
	КонецЕсли;
