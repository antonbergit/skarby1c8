...
Функция ПриЗагрузкеОтчетаОРозничныхПродажах(Устройство, МассивДанных, РасширеннаяЗагрузка = Ложь) Экспорт
	...
	Если РасширеннаяЗагрузка Тогда
		...
		Для Каждого ОтчетОПродажах Из МассивДанных Цикл
			...
			Комментарий = НСтр("ru='Загружено из %ТипОборудования%:%Устройство%';uk='Завантажене з %ТипОборудования%:%Устройство%'");
	...
	Иначе
		...
		Комментарий = НСтр("ru='Загружено из ККМ Offline:';uk='Завантажене із ККМ Offline:'") + Символы.НПП + Устройство;
...
Процедура РегламентноеЗаданиеОбновитьКодыТоваров() Экспорт
	...
	ЗаписьЖурналаРегистрации(НСтр("ru='Обновление кодов товаров подключаемого оборудования Offline';uk='Оновлення кодів товарів підключаємого обладнання Offline'"),
	                         УровеньЖурналаРегистрации.Информация, , ,
	                         НСтр("ru='Начато регламентное обновление кодов товаров подключаемого оборудования Offline.';uk='Почате регламентне оновлення кодів товарів підключаємого обладнання Offline.'"));
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			ЗаписьЖурналаРегистрации(НСтр("ru='Обновление кодов товаров подключаемого оборудования Offline';uk='Оновлення кодів товарів підключаємого обладнання Offline'"),
			                         ...
			                         НСтр("ru='Во время регламентного обновления кодов товаров подключаемого оборудования Offline произошла ошибка.';uk='Під час регламентного оновлення кодів товарів підключаємого обладнання Offline відбулася помилка.'")
	...
	ЗаписьЖурналаРегистрации(НСтр("ru='Обновление кодов товаров подключаемого оборудования Offline';uk='Оновлення кодів товарів підключаємого обладнання Offline'"),
	                         УровеньЖурналаРегистрации.Информация, , ,
	                         НСтр("ru='Закончено регламентное обновление кодов товаров подключаемого оборудования Offline.';uk='Закінчене регламентне відновлення кодів товарів підключаємого обладнання Offline.'"));
