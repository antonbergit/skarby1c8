...
"Адрес должен начинаться с префикса Интернет протокола %2 (например: ""http://myserver.com/service"").';uk='Невірний формат адреси ""%1""."
"Адреса повинна розпочинатися з префікса Інтернет протоколу %2 (наприклад: ""http://myserver.com/service"").'");
