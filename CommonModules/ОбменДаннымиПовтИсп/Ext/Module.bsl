...
"Объект этой информационной базы был заменен версией объекта из второй информационной базы.';uk='Виникла колізія змін об`єктів."
...
"Объект из второй информационной базы не принят. Объект этой информационной базы не изменен.';uk='Виникла колізія змін об`єктів."
"Об`єкт із другої інформаційної бази не прийнято. Об`єкт цієї інформаційної бази не змінено.'"));
	...
	СообщенияОбОшибках.Вставить(178, НСтр("ru='Получатель из сообщения обмена не соответствует ожидаемому.';uk='Одержувач із повідомлення обміну не відповідає очікуваному.'"));
...
"Необхідно переконатися, що в налаштуваннях програми задане правильне значення параметра"
"""%1"".'");
