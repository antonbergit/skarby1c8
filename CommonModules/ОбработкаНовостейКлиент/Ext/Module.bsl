...
"%3';uk='Произошла ошибка при обработке действия %1 с параметрами %2."
"Подробная информация об ошибке:"
"%3'"),
						Действие,
						СписокПараметров,
...
"%3'"),
	...
	Иначе
		ТекстСообщения = СтрШаблон(
			НСтр("ru='Действие %1 с параметрами %2 не обрабатывается.';uk='Действие %1 с параметрами %2 не обрабатывается.'"),
			Действие,
			СписокПараметров);
		ИнтернетПоддержкаПользователейВызовСервера.ЗаписатьСообщениеВЖурналРегистрации(
			НСтр("ru='БИП:Новости.Клиент';uk='БІП:Новини.Клієнт'"), // ИмяСобытия
...
"Подробная информация об ошибке:"
"%2';uk='Произошла ошибка при переходе по ссылке %1."
"Подробная информация об ошибке:"
"%2'"),
			ИнтернетСсылка,
			ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
