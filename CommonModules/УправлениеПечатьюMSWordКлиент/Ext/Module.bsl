...
#Если ВебКлиент Тогда
	ТекстУточнения = НСтр("ru='При работе через веб требуется браузер Internet Explorer под управлением операционной системы Windows. См. также главу документации ""Настройка веб-браузеров для работы в веб-клиенте""';uk='При роботі через веб потрібен браузер Internet Explorer під керуванням операційної системи Windows. Див. також главу документації ""Налаштування веб-браузерів для роботи у веб-клиєнті""'");
#Иначе		
	ТекстУточнения = "";	
#КонецЕсли
