...
"годовой бухгалтерской отчетности в Росстат.';uk='В соответствии со ст. 18 Федерального закона ""О бухгалтерском учете"" "
"№ 402-ФЗ от 06.12.2011 организации, обязанные составлять "
"бухгалтерскую (финансовую) отчетность, обязаны представлять экземпляр "
	...
	Если Не ЗначениеЗаполнено(ОтчетностьВРосстат) Тогда
		...
		Если ЗначениеЗаполнено(ИмяОтчетаРегламентированныйОтчетСтатистикаБухОтчетность) Тогда
			...
			Исключение
				...
				Сообщение.Текст = НСтр("ru='Не удалось открыть форму отчета ""Бухгалтерская отчетность в Росстат"".';uk='Не удалось открыть форму отчета ""Бухгалтерская отчетность в Росстат"".'");
				Сообщение.Сообщить();

			КонецПопытки;
		Иначе
			ТекстСообщения = НСтр("ru='Форма отчета ""Бухгалтерская отчетность в Росстат"" не поддерживается.';uk='Форма отчета ""Бухгалтерская отчетность в Росстат"" не поддерживается.'");
...
""
"Подготовить отчет для отправки в Росстат сейчас?';uk='В соответствии со ст. 18 Федерального закона ""О бухгалтерском учете"" "
"№ 402-ФЗ от 06.12.2011 данный отчет должен быть отправлен и в Росстат. "
""
"Подготовить отчет для отправки в Росстат сейчас?'");
	...
	ЗаголовокВопроса = НСтр("ru='Отправка отчета в Росстат';uk='Отправка отчета в Росстат'");
	
	Кнопки = Новый СписокЗначений;
	Кнопки.Добавить("ПодготовитьСейчас", НСтр("ru='Подготовить сейчас';uk='Подготовить сейчас'"));
	Кнопки.Добавить("Позже", НСтр("ru='Позже';uk='Позже'"));
