...
Процедура ЗаполнитьКурсыВалютНа_01_01_2008(Валюта) Экспорт
	...
	Если РегистрКурсыВалют.Валюта.Код = "980" Тогда
		РегистрКурсыВалют.Курс = 1;
	ИначеЕсли РегистрКурсыВалют.Валюта.Код = "978" Тогда
		РегистрКурсыВалют.Курс = 7.42;
	ИначеЕсли РегистрКурсыВалют.Валюта.Код = "840" Тогда
		РегистрКурсыВалют.Курс = 5.05;
	ИначеЕсли РегистрКурсыВалют.Валюта.Код = "643" Тогда
		РегистрКурсыВалют.Курс = 0.2;
	КонецЕсли;
