	...
	Если ТипЗнч(ТипыСчетов) = Тип("ФиксированныйМассив") Тогда
		Для каждого ТекТипСчета Из ТипыСчетов Цикл
			...
			Если ТекТипСчета = Перечисления.ТипыСчетов.Расходы Тогда
				ЗаголовокСчета = НСтр("ru='Расходы, распределяемые на финансовый результат (Косвенные)';uk='Витрати, що розподіляються на фінансовий результат (Непрямі)'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.ПрочиеРасходы Тогда
				ЗаголовокСчета = НСтр("ru='Прочие расходы, распределяемые на финансовый результат';uk='Інші витрати, які розподіляються на фінансовий результат'");
			ИначеЕсли  ТекТипСчета = Перечисления.ТипыСчетов.Доходы Тогда
				ЗаголовокСчета = НСтр("ru='Доходы, распределяемые на финансовый результат';uk='Доходи, що розподіляються на фінансовий результат'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.ПрочиеДоходы Тогда
				ЗаголовокСчета = НСтр("ru='Прочие доходы, распределяемые на финансовый результат';uk='Інші доходи, що розподіляються на фінансовий результат'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.Дебиторы Тогда
				ЗаголовокСчета = НСтр("ru='Прочие дебиторы (задолженность перед нами)';uk='Інші дебітори (заборгованість перед нами)'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.Кредиторы Тогда
				ЗаголовокСчета = НСтр("ru='Прочие кредиторы (наша задолженность)';uk='Інші кредитори (наша заборгованість)'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.ДенежныеСредства Тогда
				ЗаголовокСчета = НСтр("ru='Перемещения денег';uk='Переміщення грошей'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.ДолгосрочныеОбязательства Тогда
				ЗаголовокСчета = НСтр("ru='Долгосрочные обязательства';uk='Довгострокові зобов`язання'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.Капитал Тогда
				ЗаголовокСчета = НСтр("ru='Капитал';uk='Капітал'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.КредитыИЗаймы Тогда
				ЗаголовокСчета = НСтр("ru='Кредиты и займы';uk='Кредити й позики'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.НезавершенноеПроизводство Тогда
				ЗаголовокСчета = НСтр("ru='Затраты, относящиеся к выпуску продукции (Прямые)';uk='Витрати, що ставляться до випуску продукції (Прямі)'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.КосвенныеЗатраты Тогда
				ЗаголовокСчета = НСтр("ru='Затраты, распределяемые на себестоимость выпуска продукции (Косвенные)';uk='Витрати, що розподіляються на собівартість випуску продукції (Непрямі)'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.ПрочиеОборотныеАктивы Тогда
				ЗаголовокСчета = НСтр("ru='Прочие оборотные активы';uk='Інші оборотні активи'");
			КонецЕсли;
