...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Текст = НСтр("ru='Отказаться от обновления данных классификатора?';uk='Отказаться от обновления данных классификатора?'");
...
Процедура Отмена(Команда)
	...
	Если ЗначениеЗаполнено(ИдентификаторФоновогоЗадания) Тогда
		...
		ПоказатьОповещениеПользователя(,, НСтр("ru='Обновление адресного классификатора не завершено.';uk='Обновление адресного классификатора не завершено.'"));
	КонецЕсли;
...
Процедура АктуализироватьАдресныйКлассификаторКлиент()
	...
	Иначе 
		Если Результат = "Выполнено" Тогда
			...
			ПоказатьОповещениеПользователя(,, НСтр("ru='Обновление адресного классификатора успешно завершено.';uk='Обновление адресного классификатора успешно завершено.'"));
		Иначе
			ПоказатьОповещениеПользователя(,, НСтр("ru='Обновление адресного классификатора не завершено.';uk='Обновление адресного классификатора не завершено.'"));
		КонецЕсли;
	КонецЕсли;
...
Процедура Подключаемый_ПроверитьВыполнениеЗадания()
	...
	Исключение
		ЖурналРегистрацииКлиент.ДобавитьСообщениеДляЖурналаРегистрации(НСтр("ru='Обновление адресного классификатора';uk='Обновление адресного классификатора'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
			"Ошибка", ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()), , Истина);
		ТекстОбОшибке = НСтр("ru='Обновление адресного классификатора прервана.|Подробности см. в журнале регистрации.';uk='Обновление адресного классификатора прервана.|Подробности см. в журнале регистрации.'");
	...
	Если ЗаданиеВыполнено Тогда
		ЖурналРегистрацииКлиент.ДобавитьСообщениеДляЖурналаРегистрации(НСтр("ru='Обновление адресного классификатора';uk='Обновление адресного классификатора'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
			"Информация", НСтр("ru='Обновление адресного классификатора успешно завершено.';uk='Обновление адресного классификатора успешно завершено.'"), , Истина);
		ПоказатьОповещениеПользователя(,, НСтр("ru='Обновление адресного классификатора успешно завершено.';uk='Обновление адресного классификатора успешно завершено.'"));
		ОбновитьПовторноИспользуемыеЗначения(); 
		Оповестить("АдресныйКлассификаторАктуализирован", , ЭтотОбъект);
		ПодтверждениеЗакрытияФормы = Истина;
...
Процедура АктуализироватьАдресныйКлассификатор(Результат, ФоновоеЗадание = Ложь)
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru='Подсистема Адресный классификатор: актуализация данных';uk='Подсистема Адресный классификатор: актуализация данных'");
