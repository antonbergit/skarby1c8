...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Текст = НСтр("ru='Прервать очистку адресного классификатора?';uk='Прервать очистку адресного классификатора?'");
...
Процедура ОбновитьИнтерфейсПоКоличествуОчищаемых()
	...
	// Страница загрузки
	ТекстОписанияОчистки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Очищаются данные выбранных регионов (%1)';uk='Очищаются данные выбранных регионов (%1)'"), ВыбраноРегионовДляОчистки);
...
Процедура ОчиститьКлассификатор()
	...
	ТекстСостоянияОчистки = НСтр("ru='Очистка адресного классификатора ...';uk='Очистка адресного классификатора ...'");
...
Процедура ПослеФоновойОчистки(Задание, ДополнительныеПараметры) Экспорт
	Если Задание.Статус = "Выполнено" Тогда
		...
		ТекстОписанияОчистки = НСтр("ru='Адресный классификатор успешно очищен.';uk='Адресный классификатор успешно очищен.'");
	...
	ИначеЕсли Задание.Статус = "Ошибка" Тогда
		...
		ТекстОшибки = НСтр("ru='Не удается очистить адресный классификатор.';uk='Не удается очистить адресный классификатор.'");
...
Функция ЗапуститьФоновуюОчисткуНаСервере(Знач КодыРегионов, Знач УникальныйИдентификатор)
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru='Очистка адресного классификатора';uk='Очистка адресного классификатора'");
