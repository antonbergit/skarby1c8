...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.СуммаЕдиногоНалога.Видимость = Запись.ПлательщикЕНВД;
	Элементы.ПроцентЕСВ.Видимость = Запись.ПлательщикЕНВД;
	Элементы.ГруппаПлательщикаЕдиногоНалога.Видимость = Запись.ПлательщикЕНВД;
	Элементы.ГруппаОграниченияЕН.Видимость = Запись.ПлательщикЕНВД;
...
Процедура ПлательщикЕНВДПриИзменении(Элемент)
	ПлательщикЕНВДПриИзмененииНаСервере();
КонецПроцедуры

&НаСервере
Процедура ПлательщикЕНВДПриИзмененииНаСервере()
