	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			ТекстСообщения = СтрШаблон(
				НСтр("ru='Не удалось обработать сообщение: %1 из очереди получения квитанций по причине: %2';uk='Не удалось обработать сообщение: %1 из очереди получения квитанций по причине: %2'"),
				Выборка.Сообщение,
