	...
	Если Не Запись.ИсходныйКлючЗаписи.Пустой() Тогда
		...
		Если Выборка.Следующий() Тогда
			...
			Иначе
				...
				ТекстовыйДокументКонвертSOAP.УстановитьТекст(НСтр("ru='<SOAP-конверт не загружен>';uk='<SOAP-конверт не загружен>'"));
				ТекстовыйДокументТекстСообщенияXML.УстановитьТекст(НСтр("ru='<SOAP-конверт не загружен>';uk='<SOAP-конверт не загружен>'"));
