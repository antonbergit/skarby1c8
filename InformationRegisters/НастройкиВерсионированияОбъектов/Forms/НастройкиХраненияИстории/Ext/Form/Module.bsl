...
Процедура УстановитьВариантВерсионированияПриПроведении(Команда)
	...
	Если ВыбранТипДокументовБезВозможностиПроведения() Тогда
		ПоказатьПредупреждение(, НСтр("ru='Документам, которые не могут быть проведены, установлен режим версионирования ""Версионировать при записи"".';uk='Документам, які не можуть бути проведені, установлений режим версіонування ""Версіонування при записі"".'"));
	КонецЕсли;
