...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(Параметры.Правило) Тогда
		ВызватьИсключение НСтр("ru='Не указано правило рабочего процесса';uk='Не вказано правило робочого процесу'")
	КонецЕсли;
	
	Список.Параметры.УстановитьЗначениеПараметра("Правило", Параметры.Правило);
	
	Заголовок = СтрШаблон(НСтр("ru='Выполнение правила рабочего процесса: ""%1""';uk='Виконання правила робочого процесу: ""%1""'"), Параметры.Правило);
