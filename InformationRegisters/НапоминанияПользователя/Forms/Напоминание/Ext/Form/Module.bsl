...
Процедура Удалить(Команда)
	...
	КнопкиДиалога.Добавить(КодВозвратаДиалога.Да, НСтр("ru='Удалить';uk='Видалити'"));
	...
	ПоказатьВопрос(ОписаниеОповещения, НСтр("ru='Удалить напоминание?';uk='Видалити нагадування?'"), КнопкиДиалога);
...
Функция ПолучитьПредопределенныеСпособыОповещения()
	...
	Результат.Вставить(НСтр("ru='относительно предмета';uk='щодо предмета'"), ПредопределенноеЗначение("Перечисление.СпособыУстановкиВремениНапоминания.ОтносительноВремениПредмета"));
...
Процедура ОткрытьДиалогНастройкиРасписанияЗавершение(ВыбранноеРасписание, ДополнительныеПараметры) Экспорт
	...
	Если Не РасписаниеСоответствуетТребованиям(Расписание) Тогда 
		ПоказатьПредупреждение(, НСтр("ru='Периодичность в течение дня не поддерживается, соответствующие настройки очищены.';uk='Періодичність протягом дня не підтримується, що відповідають настроювання очищені.'"));
	КонецЕсли;
