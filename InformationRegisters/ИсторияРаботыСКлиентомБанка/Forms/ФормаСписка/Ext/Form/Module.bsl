...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	//ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(Список, "Организация", ПолучениеУчетныхДанныхПовтИсп.ПолучитьТекущуюОрганизацию());
	...
	Список.Параметры.УстановитьЗначениеПараметра("ФайлОбменаТекстЗагрузка",НСтр("ru='Загрузить снова';uk='Загрузить снова'"));
...
Процедура ЗагрузитьСнова(ПараметрыОткрытияФормы)
	...
	// Сначала поищем, может уже есть открытая обработка. Если найдём, то вызовем оповещение, иначе откроем снова.
	//Если ОкноОбработки = Неопределено Тогда
		ОткрытьФорму("Обработка.КлиентБанк.Форма.ФормаЗагрузка", ПараметрыОткрытияФормы);
	//Иначе
	//	Оповестить("ПовторнаяЗагрузкаФайлаИзКлиентаБанка", ПараметрыОткрытияФормы);
	//КонецЕсли;
...
Процедура СохранитьНаДиск(ТекущиеДанные, ПараметрыОткрытияФормы)
	...
	Если ПараметрыЗаписи = Неопределено Тогда
		ТекстСообщения = НСтр("ru='Не удалось получить данные из информационной базы!';uk='Не удалось получить данные из информационной базы!'");
	...
	Исключение
		ТекстСообщения = НСтр("ru='Не удалось записать данные в файл. Возможно, диск защищен от записи.';uk='Не удалось записать данные в файл. Возможно, диск защищен от записи.'");
