...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Отбор") И Параметры.Отбор.Свойство("Номенклатура") Тогда
		...
		Если Номенклатура.ТипНоменклатуры <> Перечисления.ТипыНоменклатуры.Запас Тогда
			...
			АвтоЗаголовок = Ложь;
			Заголовок = НСтр("ru='Цены контрагентов можно вводить только для номенклатуры с типом Запас';uk='Ціни контрагентів можна вводити тільки для номенклатури з типом Запас'");
