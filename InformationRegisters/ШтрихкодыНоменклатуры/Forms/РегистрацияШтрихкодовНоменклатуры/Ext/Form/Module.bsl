...
"Отложите их в сторону как неотсканированные.';uk='Не для всіх нових штрихкодів зазначена відповідна номенклатура."
"Ці товари не будуть перенесені в документ."
"Відкладіть їх убік як неотскановані.'"
			);
...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если Выборка.Следующий() Тогда // Штрихкод уже записан в БД
		...
		ОписаниеОшибки = СтрЗаменить(ОписаниеОшибки, "%Номенклатура%", """" + Выборка.НоменклатураПредставление + """"
						...
						+ ?(ЗначениеЗаполнено(Выборка.Партия), " """ + НСтр("ru='в партии';uk='у партії'") + " " + Выборка.ПартияПредставление + """", "")
						);
...
"Отложите их в сторону как неотсканированные.';uk='Всі товари не будуть перенесені в документ."
"Відкладіть їх убік як неотскановані.'"
		);
