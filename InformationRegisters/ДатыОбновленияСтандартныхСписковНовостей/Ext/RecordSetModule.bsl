	...
	Для каждого ТекущаяЗапись Из ЭтотОбъект Цикл
		Если ТипЗнч(ТекущаяЗапись.Список) = ТипКатегорияНовостей Тогда
			Если ТекущаяЗапись.Список.Пустая() Тогда
				...
				Сообщение.Текст = НСтр("ru='Значение обновляемой категории должно быть заполнено.';uk='Значення оновлюваної категорії повинне бути заповнене.'");
				Сообщение.Сообщить();
			КонецЕсли;
...
"- Код категории новостей (начинается с [Значения категории новостей:])';uk='Неправильное значение %1."
"Разрешено только:"
"- Список категорий новостей"
"- Список лент новостей"
...
"- Список лент новостей"
"- Код категории новостей (начинается с [Значения категории новостей:])"
"- Ссылка на план видов характеристик КатегорииНовостей';uk='Неправильное значение %1."
"Разрешено только:"
"- Список категорий новостей"
"- Список лент новостей"
"- Код категории новостей (начинается с [Значения категории новостей:])"
