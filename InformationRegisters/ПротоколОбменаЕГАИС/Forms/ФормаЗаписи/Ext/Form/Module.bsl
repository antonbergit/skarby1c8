...
Процедура ЗаполнитьСтраницыСессийОбмена()
	...
	Пока Выборка.Следующий() Цикл
		...
		Реквизит = Новый РеквизитФормы("ДатаЗапроса" + ТекИдентификатор, Новый ОписаниеТипов("Дата"), "", НСтр("ru='Дата запроса';uk='Дата запроса'"));
		ДобавляемыеРеквизиты.Добавить(Реквизит);
		
		Реквизит = Новый РеквизитФормы("Комментарий" + ТекИдентификатор, Новый ОписаниеТипов("Строка"), "", НСтр("ru='Комментарий';uk='Коментар'"));
		ДобавляемыеРеквизиты.Добавить(Реквизит);
		
		Реквизит = Новый РеквизитФормы("ТекстXML" + ТекИдентификатор, Новый ОписаниеТипов("Строка"), "", НСтр("ru='Текст XML';uk='Текст XML'"));
		ДобавляемыеРеквизиты.Добавить(Реквизит);
	КонецЦикла;
	...
	Пока Выборка.Следующий() Цикл
		...
		Если СтраницаОсновное = Неопределено Тогда
			...
			СтраницаОсновное.Заголовок = НСтр("ru='Основное';uk='Основне'");
		КонецЕсли;
		...
		Если СтраницаТекстXML = Неопределено Тогда
			...
			СтраницаТекстXML.Заголовок = НСтр("ru='Текст XML';uk='Текст XML'");
		КонецЕсли;
