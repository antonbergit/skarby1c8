...
Процедура ОбработкаОтветовИзЕГАИС_Завершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru='Обработка ответов из ЕГАИС завершена.';uk='Обработка ответов из ЕГАИС завершена.'"));
...
Процедура УстановитьУсловноеОформление()
	...
	ПредставлениеЭлемента = НСтр("ru='Получен отказ из УТМ';uk='Получен отказ из УТМ'");
