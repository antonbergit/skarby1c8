...
Процедура УстановитьЗаголовокФормы()
	...
	Иначе
		АвтоЗаголовок = Ложь;
		Заголовок = НСтр("ru='Настройки обмена с ЕГАИС:';uk='Настройки обмена с ЕГАИС:'") + " " + Строка(РабочееМесто);
	КонецЕсли;
...
Процедура УстановитьОтборПоРабочемуМесту()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(
		...
		НСтр("ru='Доступная настройка обмена';uk='Доступная настройка обмена'"),
		Истина);
...
Процедура ДобавитьУсловноеОформлениеПоТекущемуРабочемуМесту()
	...
	ПредставлениеЭлемента = НСтр("ru='Доступная настройка обмена';uk='Доступная настройка обмена'");
...
Процедура УстановитьУсловноеОформление()
	...
	ЭлементУсловногоОформления = УсловноеОформление.Элементы.Добавить();
	ЭлементУсловногоОформления.Представление = НСтр("ru='Представление рабочего места';uk='Представление рабочего места'");
	ЭлементУсловногоОформления.Использование = Истина;
	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='<Все>';uk='<Все>'"));
	...
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(
		...
		НСтр("ru='Пустое рабочее место';uk='Пустое рабочее место'"),
		Истина);
