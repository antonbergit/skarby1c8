...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если СравниваемыеВерсии.Количество() > 1 Тогда
		...
		Для Каждого Версия Из СравниваемыеВерсии Цикл
			...
			ТабличныеДокументыВерсии = Неопределено;
			ВерсияОбъекта.Свойство("ТабличныеДокументы", ТабличныеДокументыВерсии);
			ТабличныеДокументы.Добавить(ТабличныеДокументыВерсии);
		КонецЦикла;
