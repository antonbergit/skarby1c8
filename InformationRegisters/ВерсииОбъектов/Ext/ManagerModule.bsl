	...
	Для Каждого текСтрока Из ТаблицаИзмененийТабличныхДокументов Цикл
		...
		Для Индекс = 0 По ВГраница Цикл
			...
			Если ТекСтрока[ИмяКолонки] = "И" Тогда
				...
				ШаблонТекста = НСтр("ru='сравнить версию №%1 с версией №%2';uk='зрівняти версію №%1 з версією №%2'");
			...
			ИначеЕсли текСтрока[ИмяКолонки] = "У" Тогда
				...
				Область.Текст = НСтр("ru='Сохранение изменений табличного документа отключено';uk='Збереження змін табличного документа відключене'");
