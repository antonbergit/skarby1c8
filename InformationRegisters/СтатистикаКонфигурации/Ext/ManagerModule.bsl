	...
	Пока Выборка.Следующий() Цикл
		...
		Если РегистрыСведений.ОбластиСтатистики.СобиратьСтатистикуКонфигурации(ОбластьДанныхСтрока) Тогда
			...
			Исключение
				...
				,,
				НСтр("ru='Не удалось установить разделение сеанса. Область данных';uk='Не вдалося встановити розділення сеансу. Область даних'") + " = " + Формат(Выборка.ОбластьДанных, "ЧГ=0")
