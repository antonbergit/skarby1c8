...
Процедура УстановитьУсловноеОформление()
	...
	// 1. Версия платформы, скрыта
		...
		Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='Скрыта';uk='Схована'"));
	...
	// 3. Версия платформы, отбор не настроен - видна
		...
		// Оформление
		Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='Отбор не настроен, видна';uk='Відбір не налаштован, видна'"));
