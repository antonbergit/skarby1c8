...
"або знайти в %2'");
	...
	ШаблонПользовательскийСайт = НСтр("ru='сайта поддержки пользователей системы ""1С:Предприятие 8""';uk='сайту підтримки користувачів системи ""1С:Підприємство 8""'");
...
Процедура ЗагрузитьПравила(Команда)
	...
	ПараметрыДиалога.Вставить("Заголовок", НСтр("ru='Укажите архив с правилами обмена';uk='Вкажіть архів із правилами обміну'"));
...
Процедура ВыгрузитьПравила(Команда)
	...
	ПараметрыДиалога.Вставить("Заголовок", НСтр("ru='Укажите в какой файл выгрузить правила';uk='Вкажіть у який файл вивантажити правила'") );
...
"RegistrationRules.xml - правила регистрации для текущей программы.';uk='Некоректний формат файлу комплекту правил. Очікується zip архів, "
"що містить три файли:"
