...
"изменилось имя или версия конфигурации - требуется перезапуск сеанса.';uk='Не вдалося відновити усі параметри роботи розширень, оскільки"
...
"так как указанный состав расширений отличается от текущего.';uk='Не вдалося відновити усі параметри роботи розширень,"
"оскільки вказаний склад розширень відрізняється від поточного.'");
	КонецЕсли;
