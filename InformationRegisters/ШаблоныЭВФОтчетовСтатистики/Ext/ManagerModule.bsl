...
Процедура ЗагрузитьРекомендуемыеЭлектронныеПредставления(Параметры = Неопределено) Экспорт
	...
	Исключение
		СтрОш = НСтр("ru='Не удалось получить шаблоны для обновления';uk='Не удалось получить шаблоны для обновления'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	...
	Исключение
		СтрОш = НСтр("ru='Не удалось распаковать шаблоны для обновления';uk='Не удалось распаковать шаблоны для обновления'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
		ЗаписьЖурналаРегистрации(СтрОш, УровеньЖурналаРегистрации.Ошибка,,, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		Возврат;
	КонецПопытки;
...
Процедура ДобавитьШаблоныИзКонфигурации(АдресВременногоХранилища, КоличествоНезагруженныхШаблонов)
	...
	Исключение
		СтрОш = НСтр("ru='Не удалось удалить временные файлы';uk='Не удалось удалить временные файлы'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
