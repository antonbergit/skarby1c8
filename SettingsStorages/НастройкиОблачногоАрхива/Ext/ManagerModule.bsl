...
Процедура ОбработкаЗагрузки(КлючОбъекта, КлючНастроек, Настройки, ОписаниеНастроек, ИмяПользователяИБ)
	...
	УстановитьПривилегированныйРежим(Истина);
		...
		Иначе
			...
			Результат = СтрШаблон(
				НСтр("ru='ХранилищаНастроек.НастройкиОблачногоАрхива.ОбработкаЗагрузки: не найден ключ объекта %1';uk='ХранилищаНастроек.НастройкиОблачногоАрхива.ОбработкаЗагрузки: не найден ключ объекта %1'"),
				КлючОбъекта);
...
Процедура ОбработкаСохранения(КлючОбъекта, КлючНастроек, Настройки, ОписаниеНастроек, ИмяПользователяИБ)
	...
	Иначе
		...
		Результат = СтрШаблон(
			НСтр("ru='ХранилищаНастроек.НастройкиОблачногоАрхива.ОбработкаСохранения: не найден ключ объекта %1';uk='ХранилищаНастроек.НастройкиОблачногоАрхива.ОбработкаСохранения: не найден ключ объекта %1'"),
			КлючОбъекта);
		ВызватьИсключение Результат;
