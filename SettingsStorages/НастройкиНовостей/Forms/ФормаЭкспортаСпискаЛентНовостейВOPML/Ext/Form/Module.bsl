...
Процедура ИмяФайлаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Фильтр = НСтр("en='XML file';ru='Файл xml';uk='Файл xml'")
		+ "(*.xml)|*.xml";
	ДиалогОткрытияФайла.Фильтр = Фильтр;
	ДиалогОткрытияФайла.МножественныйВыбор = Ложь;
	ДиалогОткрытияФайла.Заголовок = НСтр("ru='Укажите файл, в который надо экспортировать список лент новостей';uk='Укажите файл, в который надо экспортировать список лент новостей'");
...
Процедура КомандаЭкспорт(Команда)
	...
	ПоказатьОповещениеПользователя(
		НСтр("ru='Экспорт завершен';uk='Експорт завершений'"),
		,
		НСтр("ru='Список лент новостей успешно экспортирован в файл."
"Теперь в стороннем rss-агрегаторе можно выбрать из меню [Импортировать список лент новостей из OPML файла] и указать полученный файл (при условии, что rss-агрегатор поддерживает эту возможность).';uk='Список стрічок новин успішно експортований у файл."
"Тепер у сторонньому rss-агрегаторе можна вибрати з меню [Импортировать список лент новостей из OPML файла] і вказати отриманий файл (за умови, що rss-агрегатор підтримує цю можливість).'"),
	...
	ЗаписьХМЛ.ЗаписатьАтрибут("version", "1.1");
		ЗаписьХМЛ.ЗаписатьНачалоЭлемента("head");
			ЗаписьХМЛ.ЗаписатьНачалоЭлемента("title");
				ЗаписьХМЛ.ЗаписатьТекст(НСтр("ru='Список лент новостей (1С)';uk='Список лент новостей (1С)'"));
		...
		ЗаписьХМЛ.ЗаписатьНачалоЭлемента("body");
			ЗаписьХМЛ.ЗаписатьНачалоЭлемента("outline");
				ЗаписьХМЛ.ЗаписатьАтрибут("text", НСтр("ru='Новости 1С';uk='Новини 1С'"));
