...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Некорректное значение параметра ""Расположение"": ""%1"".';uk='Некоректне значення параметра ""Розташування"": ""%1"".'"), Строка(Расположение));
	КонецЕсли;
КонецПроцедуры
