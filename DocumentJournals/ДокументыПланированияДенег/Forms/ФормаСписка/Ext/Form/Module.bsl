...
Процедура ЗаполнитьТаблицуИтогов()
	...
	СтрокаИтогов.Показатель = НСтр("ru='Приход';uk='Прихід'");
	СтрокаИтогов.Значение = 0;
	
	СтрокаИтогов = ТаблицаИтогов.Добавить();
	СтрокаИтогов.Показатель = НСтр("ru='Расход';uk='Витрата'");
	СтрокаИтогов.Значение = 0;
	
	СтрокаИтогов = ТаблицаИтогов.Добавить();
	СтрокаИтогов.Показатель = НСтр("ru='В том числе';uk='У тому числі'");
	СтрокаИтогов.Значение = 0;
	
	СтрокаИтогов = ТаблицаИтогов.Добавить();
	СтрокаИтогов.Показатель = НСтр("ru='перемещения';uk='переміщення'");
	СтрокаИтогов.Значение = 0;
...
Функция ПолучитьДанныеПоБанковскомуСчету(СсылкаНаДокумент)
	...
	Иначе
		ПредставлениеВалюты = НСтр("ru='<валюта пустая>';uk='<валюта порожня>'");
	КонецЕсли;
