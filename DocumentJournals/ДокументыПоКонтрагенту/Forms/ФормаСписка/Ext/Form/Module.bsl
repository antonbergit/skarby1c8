...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Контрагент.Пустая() Тогда
		ВызватьИсключение НСтр("ru='Журнал документов по контрагенту открывается из карточки контрагента.';uk='Журнал документів по контрагенту відкривається з картки контрагента.'");
	КонецЕсли;
	
	Заголовок = НСтр("ru='Документы по';uk='Документи по'") + " """ + Параметры.Контрагент + """";
