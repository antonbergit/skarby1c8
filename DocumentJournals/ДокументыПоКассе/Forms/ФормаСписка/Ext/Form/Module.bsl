...
Процедура Подключаемый_ОбработатьАктивизациюСтрокиСписка()
	...
	Если ТекущаяСтрока <> Неопределено
		...
		И ТекущаяСтрока.Свойство("Касса")
		И ТекущаяСтрока.Свойство("Валюта") Тогда
		
		СтруктураДанные = ПолучитьДанныеПоКассе(ТекущаяСтрока.Дата, ТекущаяСтрока.Касса, ТекущаяСтрока.Валюта);
...
Процедура ОтборСчетИКассаОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	УстановитьМеткуИОтборСписка("ДокументыПоКассе", "Касса", Элемент.Родитель.Имя, ВыбранноеЗначение);
	//Элемент.ОбновитьТекстРедактирования();
