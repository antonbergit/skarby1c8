...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Для каждого Стр Из УчетНоменклатуры Цикл
		Если Стр.ФормированиеЦены = Перечисления.БиллингФормированиеЦеныНоменклатуры.ФиксированноеЗначение
			...
			ТекстСообщения = СтрШаблон(
				НСтр("ru='Не заполнена колонка ""Цена"" в строке %1 списка ""Номенклатура"".';uk='Не заповнена колонка ""Ціна"" в рядку %1 списку ""Номенклатура"".'"),
				Стр.НомерСтроки
			);
	...
	Для каждого Стр Из УчетЗатрат Цикл
		...
		Если Стр.ФормированиеЦены = Перечисления.БиллингФормированиеЦеныЗатрат.ФиксированноеЗначение
			...
			ТекстСообщения = СтрШаблон(
				НСтр("ru='Не заполнена колонка ""Цена"" в строке %1 списка ""Затраты"".';uk='Не заповнена колонка ""Ціна"" в рядку %1 списку ""Витрати"".'"),
				Стр.НомерСтроки
			);
