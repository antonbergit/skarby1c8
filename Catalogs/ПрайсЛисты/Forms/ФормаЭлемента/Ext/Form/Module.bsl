...
Процедура ЗаполнитьПредставлениеНоменклатуры()
	...
	Если Объект.ПечатьПрайсЛиста = КэшЗначений.Диафильм Тогда
		...
		СоставРеквизитов = СоставРеквизитов + НСтр("ru=', Колонок: ';uk=', Колонок:'") + Объект.КоличествоКолонок + НСтр("ru=', Размер: ';uk=', Розмір:'") + Объект.КартинкаШирина + НСтр("ru=' х ';uk=' х '") + Объект.КартинкаВысота;
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ПустаяСтрока(Объект.Наименование) Тогда
		...
		Объект.Наименование = Нстр("ru='Прайс-лист';uk='Прайс-лист'");
	...
	Если НЕ ПолучитьФункциональнуюОпцию("УчетВалютныхОпераций") Тогда
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ГруппаИерархияВалюта", "Заголовок", НСтр("ru='Группировка прайс-листа';uk='Угруповання прайс-листа'"));
