...
Процедура ОК(Команда)
	...
	Если Отказ Тогда
		...
		ТекстОшибки = НСтр("ru='Необходимо выбрать минимум одно поле...';uk='Необхідно вибрати мінімум одне поле...'");
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	МассивСтрок[0].Использование = ФОИспользоватьХарактеристики;
