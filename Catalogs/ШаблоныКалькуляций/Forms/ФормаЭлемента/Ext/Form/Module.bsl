...
Процедура ОбновитьЗаголовкиСтраниц()
	...
	Элементы.СтраницаЗапасы.Заголовок = НСтр("ru='Запасы';uk='Запаси'")+?(Объект.Запасы.Количество()=0, "", " ("+Объект.Запасы.Количество()+")");	
	Элементы.СтраницаРасходы.Заголовок = НСтр("ru='Расходы';uk='Витрати'")+?(Объект.Расходы.Количество()=0, "", " ("+Объект.Расходы.Количество()+")");	
...
Процедура ЗагрузкаИзФайлаЗапасы(Команда)
	...
	НастройкиЗагрузкиДанныхЗапасы.Вставить("Заголовок", НСтр("ru='Загрузка запасов из файла';uk='Завантаження запасів з файлу'"));
...
Процедура ЗагрузкаИзФайлаРасходы(Команда)
	...
	НастройкиЗагрузкиДанныхРасходы.Вставить("Заголовок", НСтр("ru='Загрузка расходов из файла';uk='Завантаження витрат з файлу'"));
