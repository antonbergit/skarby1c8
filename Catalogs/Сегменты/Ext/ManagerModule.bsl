...
Функция ПолучитьДоступныеПравилаОтбора() Экспорт
	...
	ГруппаСвойстваКонтрагента.Представление = НСтр("ru='Реквизиты (основные, дополнительные)';uk='Реквізити (основні, додаткові)'");
	ГруппаСвойстваКонтрагента.ЭтоГруппа = Истина;
	
	НовоеПравило = ГруппаСвойстваКонтрагента.Строки.Добавить();
	НовоеПравило.Имя = "Тег";
	НовоеПравило.Представление = НСтр("ru='Тег';uk='Тег'");
	...
	НовоеПравило.Представление = НСтр("ru='Вид контрагента';uk='Вид контрагента'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	...
	НовоеПравило.Представление = НСтр("ru='Покупатель';uk='Покупець'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	...
	НовоеПравило.Представление = НСтр("ru='Поставщик';uk='Постачальник'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", Новый ОписаниеТипов("Булево"));
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	НовоеПравило.Представление = НСтр("ru='Прочие отношения';uk='Інші відносини'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", Новый ОписаниеТипов("Булево"));
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	ГруппаКонтактнаяИнформация.Представление = НСтр("ru='Адреса (география)';uk='Адреси (географія)'");
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Выборка.Тип = Перечисления.ТипыКонтактнойИнформации.Адрес Тогда
			...
			НовоеПравило.ЭтоГруппа = Ложь;
			НовоеПравило.МножественноеИспользование = Ложь;
			НовоеПравило.Представление = НСтр("ru='Страна';uk='Країна'") + " (" + НРег(ПравилоАдрес.Представление) + ")";
			НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеТипаСтрока);
			НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
			ДобавитьВидыСравнений(НовоеПравило, "НачинаетсяС,НеНачинаетсяС,Содержит,НеСодержит", 3);
			...
			НовоеПравило.ЭтоГруппа = Ложь;
			НовоеПравило.МножественноеИспользование = Ложь;
			НовоеПравило.Представление = НСтр("ru='Регион';uk='Регіон'") + " (" + НРег(ПравилоАдрес.Представление) + ")";
			НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеТипаСтрока);
			НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
			ДобавитьВидыСравнений(НовоеПравило, "НачинаетсяС,НеНачинаетсяС,Содержит,НеСодержит", 3);
			...
			НовоеПравило.ЭтоГруппа = Ложь;
			НовоеПравило.МножественноеИспользование = Ложь;
			НовоеПравило.Представление = НСтр("ru='Город';uk='Місто'") + " (" + НРег(ПравилоАдрес.Представление) + ")";
			НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеТипаСтрока);
			НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
			ДобавитьВидыСравнений(НовоеПравило, "НачинаетсяС,НеНачинаетсяС,Содержит,НеСодержит", 3);
	...
	ГруппаСобытия.Представление = НСтр("ru='События (давность, количество)';uk='Події (давнина, кількість)'");
	ГруппаСобытия.ЭтоГруппа = Истина;
	
	НовоеПравило = ГруппаСобытия.Строки.Добавить();
	НовоеПравило.Имя = "СобытияДатаПоследнего";
	НовоеПравило.Представление = НСтр("ru='Дата последнего события';uk='Дата останньої події'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Истина;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеТипаСтандартнаяДата);
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	ПравилоКоличествоСобытий.Представление = НСтр("ru='Количество событий';uk='Кількість подій'");
	...
	НовоеПравило.Представление = НСтр("ru='За период';uk='За період'") + " (" + НРег(ПравилоКоличествоСобытий.Представление) + ")";
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	...
	ГруппаДополнительно.Представление = НСтр("ru='Уточнения событий';uk='Уточнення подій'");
	ГруппаДополнительно.ЭтоГруппа = Истина;
	
	НовоеПравило = ГруппаДополнительно.Строки.Добавить();
	НовоеПравило.Имя = "СобытияСостояние";
	НовоеПравило.Представление = НСтр("ru='Состояние событий';uk='Стан подій'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	...
	НовоеПравило.Представление = НСтр("ru='Тип событий';uk='Тип подій'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	...
	ГруппаЗаказы.Представление = НСтр("ru='Заказы покупателей (давность, количество)';uk='Замовлення покупців (давнина, кількість)'");
	ГруппаЗаказы.ЭтоГруппа = Истина;
	
	НовоеПравило = ГруппаЗаказы.Строки.Добавить();
	НовоеПравило.Имя = "ЗаказыПокупателейДатаПоследнего";
	НовоеПравило.Представление = НСтр("ru='Дата последнего заказа';uk='Дата останнього замовлення'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Истина;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеТипаСтандартнаяДата);
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	ПравилоКоличествоЗаказов.Представление = НСтр("ru='Количество заказов';uk='Кількість замовлень'");
	...
	НовоеПравило.Представление = НСтр("ru='За период';uk='За період'") + " (" + НРег(ПравилоКоличествоЗаказов.Представление) + ")";
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеТипаСтандартныйПериод);
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	ГруппаДополнительно.Представление = НСтр("ru='Уточнения заказов покупателей';uk='Уточнення замовлень покупців'");
	ГруппаДополнительно.ЭтоГруппа = Истина;
	
	НовоеПравило = ГруппаДополнительно.Строки.Добавить();
	НовоеПравило.Имя = "ЗаказыПокупателейСостояниеЗаказа";
	НовоеПравило.Представление = НСтр("ru='Состояние заказов покупателя';uk='Стан замовлень покупця'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	...
	ГруппаСчета.Представление = НСтр("ru='Счета на оплату (давность, количество)';uk='Рахунки на оплату (давнина, кількість)'");
	ГруппаСчета.ЭтоГруппа = Истина;
	
	НовоеПравило = ГруппаСчета.Строки.Добавить();
	НовоеПравило.Имя = "СчетаНаОплатуДатаПоследнего";
	НовоеПравило.Представление = НСтр("ru='Дата последнего счета';uk='Дата останнього рахунку'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Истина;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеТипаСтандартнаяДата);
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	ПравилоКоличествоСчетов.Представление = НСтр("ru='Количество счетов';uk='Кількість рахунків'");
	...
	НовоеПравило.Представление = НСтр("ru='За период';uk='За період'") + " (" + НРег(ПравилоКоличествоСчетов.Представление) + ")";
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеТипаСтандартныйПериод);
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	ГруппаПродажиНоменклатура.Представление = НСтр("ru='Продажи (номенклатура)';uk='Продажі (номенклатура)'");
	...
	НовоеПравило.Представление = НСтр("ru='Номенклатура';uk='Номенклатура'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	...
	НовоеПравило.Представление = НСтр("ru='Группа номенклатуры';uk='Група номенклатури'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", Новый ОписаниеТипов("СправочникСсылка.Номенклатура"));
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Группы);
	...
	НовоеПравило.Представление = НСтр("ru='Категория номенклатуры';uk='Категорія номенклатури'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	...
	ГруппаДополнительно.Представление = НСтр("ru='Уточнения продаж по номенклатуре';uk='Уточнення продажів по номенклатурі'");
	ГруппаДополнительно.ЭтоГруппа = Истина;
	
	НовоеПравило = ГруппаДополнительно.Строки.Добавить();
	НовоеПравило.Имя = "ПродажиНоменклатураПериод";
	НовоеПравило.Представление = НСтр("ru='За период (продажи по номенклатуре)';uk='За період (продажі по номенклатурі)'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеТипаСтандартныйПериод);
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	ГруппаПродажиВыручка.Представление = НСтр("ru='Продажи (выручка, прибыль)';uk='Продажі (виторг, прибуток)'");
	...
	НовоеПравило.Представление = НСтр("ru='Выручка (упр. валюта)';uk='Виторг (упр. валюта)'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Истина;
	...
	НовоеПравило.Представление = НСтр("ru='Валовая прибыль (упр. валюта)';uk='Валовий прибуток (упр. валюта)'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Истина;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеДенежногоТипа);
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	ГруппаДополнительно.Представление = НСтр("ru='Уточнения выручки от продаж';uk='Уточнення виторгу від продажів'");
	ГруппаДополнительно.ЭтоГруппа = Истина;
	
	НовоеПравило = ГруппаДополнительно.Строки.Добавить();
	НовоеПравило.Имя = "ПродажиВыручкаПериод";
	НовоеПравило.Представление = НСтр("ru='За период (выручка от продаж)';uk='За період (виторг від продажів)'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеТипаСтандартныйПериод);
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	ГруппаЗадолженность.Представление = НСтр("ru='Задолженность (долг, просрочка)';uk='Заборгованість (борг, прострочення)'");
	...
	НовоеПравило.Представление = НСтр("ru='Сумма долга покупателя (упр. валюта)';uk='Сума боргу покупця (упр. валюта)'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Истина;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеДенежногоТипа);
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	НовоеПравило.Представление = НСтр("ru='Срок просрочки покупателя (дней)';uk='Термін прострочення покупця (днів)'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Истина;
	...
	НовоеПравило.Представление = НСтр("ru='Сумма долга поставщику (упр. валюта)';uk='Сума боргу постачальникові (упр. валюта)'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Истина;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеДенежногоТипа);
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	НовоеПравило.Представление = НСтр("ru='Срок просрочки поставщику (дней)';uk='Термін прострочення постачальникові (днів)'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Истина;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", Новый ОписаниеТипов("Число"));
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
...
Процедура ДобавитьВидыСравнений(Правило, ДобавляемыеВидыСравнений, НомерВидаПоУмолчанию = 1)
	...
	Для Каждого ВидСтрокой Из МассивВидов Цикл
		Если ВидСтрокой = "Равно" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.Равно,			 НСтр("ru='Равно';uk='Рівно'"));
		ИначеЕсли ВидСтрокой = "НеРавно" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.НеРавно,		 НСтр("ru='Не равно';uk='Не рівно'"));
		ИначеЕсли ВидСтрокой = "Больше" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.Больше,		 НСтр("ru='Больше';uk='Більше'"));
		ИначеЕсли ВидСтрокой = "БольшеИлиРавно" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.БольшеИлиРавно, НСтр("ru='Больше или равно';uk='Більше або рівно'"));
		ИначеЕсли ВидСтрокой = "Меньше" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.Меньше,		 НСтр("ru='Меньше';uk='Менше'"));
		ИначеЕсли ВидСтрокой = "МеньшеИлиРавно" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.МеньшеИлиРавно, НСтр("ru='Меньше или равно';uk='Менше або рівно'"));
		ИначеЕсли ВидСтрокой = "ВСписке" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.ВСписке,		 НСтр("ru='В списке';uk='У списку'"));
		ИначеЕсли ВидСтрокой = "НеВСписке" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.НеВСписке,		 НСтр("ru='Не в списке';uk='Не в списку'"));
		ИначеЕсли ВидСтрокой = "ВИерархии" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.ВИерархии,		 НСтр("ru='В группе';uk='В групі'"));
		ИначеЕсли ВидСтрокой = "НеВИерархии" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.НеВИерархии,	 НСтр("ru='Не в группе';uk='Не в групі'"));
		ИначеЕсли ВидСтрокой = "Заполнено" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.Заполнено,		 НСтр("ru='Заполнено';uk='Заповнене'"));
		ИначеЕсли ВидСтрокой = "НеЗаполнено" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.НеЗаполнено,	 НСтр("ru='Не заполнено';uk='Не заповнено'"));
		ИначеЕсли ВидСтрокой = "НачинаетсяС" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.НачинаетсяС,	 НСтр("ru='Начинается с';uk='Починається з'"));
		ИначеЕсли ВидСтрокой = "НеНачинаетсяС" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.НеНачинаетсяС,	 НСтр("ru='Не начинается с';uk='Не починається з'"));
		ИначеЕсли ВидСтрокой = "Содержит" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.Содержит,		 НСтр("ru='Содержит';uk='Містить'"));
		ИначеЕсли ВидСтрокой = "НеСодержит" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.НеСодержит,	 НСтр("ru='Не содержит';uk='Не містить'"));
		КонецЕсли;
	КонецЦикла;
...
Процедура ЗаполнитьПоставляемыеСегменты() Экспорт
	...
	Сегмент.Наименование = НСтр("ru='Новые за неделю';uk='Нові за тиждень'");
	Сегмент.Комментарий = НСтр("ru='# Сегмент создан автоматически';uk='# Сегмент створений автоматично'");
	...
	Сегмент = Справочники.Сегменты.СоздатьЭлемент();
	Сегмент.УстановитьНовыйКод();
	Сегмент.Наименование = НСтр("ru='Не связывались больше месяца';uk='Не зв`язувалися більше місяця'");
	Сегмент.Комментарий = НСтр("ru='# Сегмент создан автоматически';uk='# Сегмент створений автоматично'");
	...
	Сегмент = Справочники.Сегменты.СоздатьЭлемент();
	Сегмент.УстановитьНовыйКод();
	Сегмент.Наименование = НСтр("ru='Есть заказы за последний месяц';uk='Є замовлення за останній місяць'");
	Сегмент.Комментарий = НСтр("ru='# Сегмент создан автоматически';uk='# Сегмент створений автоматично'");
