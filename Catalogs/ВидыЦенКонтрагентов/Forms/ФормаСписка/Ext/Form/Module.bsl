...
Процедура ПоказатьПомощникЗагрузкиДанныхИзВнешнегоИсточника()
	...
	Если ДанныеТекущейСтроки = Неопределено Тогда
		...
		ТекстСообщения = НСтр("ru='Необходимо выделить вид цен контрагента, для которого планируется загрузить цены';uk='Необхідно виділити вид цін контрагента, для якого планується завантажити ціни'");
