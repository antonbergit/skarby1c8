...
Процедура ЗаписатьНаборыЗаписей()
	...
	Если ОбщегоНазначенияПовтИсп.РазделениеВключено()
		...
		ЦенообразованиеСервер.ДобавитьЗаданиеРасчетаОчередиЦен(Истина);
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ИначеЕсли ТипВидаЦен = Перечисления.ТипыВидовЦен.ДинамическийПроцент Тогда
		...
		Если БазовыйВидЦен = Ссылка Тогда
			...
			ТекстОшибки = НСтр("ru='Базовый вид цены не может быть равен текущему виду цены';uk='Базовий вид ціни не може дорівнювати поточному виду ціни'");
