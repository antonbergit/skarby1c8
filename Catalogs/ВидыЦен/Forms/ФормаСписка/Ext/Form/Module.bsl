...
Процедура СформироватьЦены(ВидЦен)
	...
	ИначеЕсли НЕ ДанныеВидаЦен.РассчитыватьАвтоматически Тогда
		...
		Если ДанныеВидаЦен.ЦеныАктуальны Тогда
			...
			ТекстСообщения = НСтр("ru='Цены по колонке прайс-листа актуальны. Расчет не требуется.';uk='Ціни по стовпчикові прайс-листа актуальні. Розрахунок не потрібен.'");
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Список.Параметры.УстановитьЗначениеПараметра("Статическая", НСтр("ru='Статическая';uk='Статична'"));
	Список.Параметры.УстановитьЗначениеПараметра("Процент", НСтр("ru='Процент';uk='Процент'"));
	Список.Параметры.УстановитьЗначениеПараметра("Формула", НСтр("ru='Формула';uk='Формула'"));
	Список.Параметры.УстановитьЗначениеПараметра("СформироватьЦены", НСтр("ru='Сформировать цены';uk='Сформувати ціни'"));
