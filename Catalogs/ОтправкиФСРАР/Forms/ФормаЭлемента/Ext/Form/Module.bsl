...
Процедура ОбновитьФорму()
	...
	Если Объект.СтатусОтправки = Перечисления.СтатусыОтправки.Отправлен Тогда
		Если Объект.СтатусОтправкиНаРегиональныйСервер = Перечисления.СтатусыОтправки.Сдан Тогда
			...
			Элементы.НадписьСтатусОтправки.Заголовок = НСтр("ru='Промежуточный протокол обработки региональным сервером получен';uk='Промежуточный протокол обработки региональным сервером получен'");
