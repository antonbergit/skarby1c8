...
"откройте сертификат и укажите программу вручную.';uk='В обраного сертифіката не зазначена програма для закритого ключа."
"Виберіть сертифікат повторно з повного списку або"
