...
"Выберите другой сертификат.';uk='В обраного сертифіката минув термін дії."
...
"Выберите другой сертификат.';uk='В обраного сертифіката не зазначена програма для закритого ключа."
"Виберіть інший сертифікат.'"));
		ПоказатьОшибку(Контекст.ОшибкаНаКлиенте, Контекст.ОшибкаНаСервере);
		ВыполнитьОбработкуОповещения(Контекст.Оповещение, Ложь);
		Возврат;
