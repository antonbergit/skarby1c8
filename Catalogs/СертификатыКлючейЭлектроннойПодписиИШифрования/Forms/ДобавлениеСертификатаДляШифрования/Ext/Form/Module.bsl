...
Процедура ДалееПослеПоискаСертификата(Результат, Неопределен) Экспорт
	...
	Если Результат.Свойство("СертификатНеНайден") Тогда
		Контекст.Вставить("ОписаниеОшибки", НСтр("ru='Сертификат не найден на компьютере (возможно удален).';uk='Сертифікат не знайдений на комп`ютері (можливо видалений).'"));
	Иначе
...
Процедура ДалееПослеПоискаСертификатаВОблачномСервисе(Результат, Неопределен) Экспорт
	...
	Если Не Результат.Выполнено Тогда
		Контекст.Вставить("ОписаниеОшибки", НСтр("ru='Сертификат не найден в облачном сервисе (возможно удален).';uk='Сертификат не найден в облачном сервисе (возможно удален).'"));
	Иначе
		Контекст.Вставить("ОписаниеОшибки", Результат.ОписаниеОшибки);
	КонецЕсли;
