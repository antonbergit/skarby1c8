...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.КлючНазначенияИспользования = "Просроченные" Тогда
		ЭтаФорма.Заголовок = ЭтаФорма.Заголовок + НСтр("ru=': просроченные';uk=': прострочені'");
	...
	ИначеЕсли Параметры.КлючНазначенияИспользования = "ОжидаютВыполнения" Тогда
		...
		ЭтаФорма.Заголовок = ЭтаФорма.Заголовок + НСтр("ru=': ожидают выполнения';uk=': очікують виконання'");
	КонецЕсли;
...
Функция НастройкиОформленияСпискаЗадач()
	...
	ДобавитьЭлементУсловногоОформленияСпискаЗадач(НастройкиКомпоновкиДанных,
		Неопределено, -1, НСтр("ru='Просрочено';uk='Прострочено'"), ЦветаСтиля.ПросроченныеДанныеЦвет);
	
	ДобавитьЭлементУсловногоОформленияСпискаЗадач(НастройкиКомпоновкиДанных,
		0, 0, НСтр("ru='Сегодня';uk='Сьогодні'"), ЦветаСтиля.ПросроченныеДанныеЦвет);
	
	ДобавитьЭлементУсловногоОформленияСпискаЗадач(НастройкиКомпоновкиДанных,
		1, 1, НСтр("ru='Завтра';uk='Завтра'"));
	...
	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='Отчет не сдан';uk='Звіт не зданий'"));
	...
	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='Отчет сдан!';uk='Звіт зданий!'"));
