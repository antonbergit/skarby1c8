...
"Установите флаг ""Использовать характеристики"" в карточке номенклатуры';uk='Для номенклатури не ведеться облік по характеристиках!"
"Встановіть прапорець ""Використовувати характеристики"" у картці номенклатури'");
		Сообщение.Сообщить();
		Отказ = Истина;
...
"Установите флаг ""Использовать характеристики"" в карточке категории';uk='Для категорії не ведеться облік по характеристиках!"
"Встановіть прапорець ""Використовувати характеристики"" у картці категорії'");
		Сообщение.Сообщить();
		Отказ = Истина;
...
&НаКлиенте
// Процедура - обработчик события ПриИзменении поля ОтечественныйНеподакцизныйТовар.
//
Процедура ОтечественныйНеподакцизныйТоварПриИзменении(Элемент)
	ОчиститьРеквизитНоменклатураГТД(Объект.ОтечественныйНеподакцизныйТовар);
	УстановитьВидимостьЭлементов();
КонецПроцедуры

&НаКлиенте
// Процедура - обработчик события ПриИзменении поля КодУКТВЭД.
//
...
&НаКлиенте
// Процедура - обработчик события Очистка поля КодУКТВЭД.
//
Процедура НоменклатураГТДОчистка(Элемент, СтандартнаяОбработка)
	УстановитьВидимостьЭлементов();
КонецПроцедуры
...
&НаСервере
// Процедура очищает реквизит НоменклатураГТД в зависимости от признака ОтечественныйНеподакцизныйТовар.
//
Процедура ОчиститьРеквизитНоменклатураГТД(ОтечественныйНеподакцизныйТовар)
	Если ОтечественныйНеподакцизныйТовар Тогда
		Объект.НоменклатураГТД = Справочники.НоменклатураГТД.ПустаяСсылка();
	КонецЕсли;
КонецПроцедуры
...
Процедура УстановитьВидимостьЭлементов()
	...
	Элементы.ГруппаКодУКТВЭД.Доступность = НЕ Объект.ОтечественныйНеподакцизныйТовар;	
    Элементы.НадписьОКодеУКТВЭД.Заголовок = ?(НЕ ЗначениеЗаполнено(Объект.НоменклатураГТД)
												   И НЕ Объект.ОтечественныйНеподакцизныйТовар,
												   НСтр("ru='код и номер - из карточки номенклатуры';uk='код і номер - з картки номенклатури'"),
												   "");
