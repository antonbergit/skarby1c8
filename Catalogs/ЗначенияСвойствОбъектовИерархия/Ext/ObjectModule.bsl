...
"по образцу свойства ""%2"" нужно создавать для свойства-образца.';uk='Додаткові значення для властивості ""%1"", створеної за зразком властивості ""%2"" потрібно створювати для властивості-зразка.'"),
				Владелец,
				ВладелецДополнительныхЗначений);
