...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для каждого СтрокаФайлДокумента Из ТЗФайлыДокумента Цикл
		...
		НСтр("ru='%1 (%2)';uk='%1 (%2)'"), НоваяСтрока.Имя, ЭлектронныйДокументооборотСКонтролирующимиОрганамиКлиентСервер.ТекстовоеПредставлениеРазмераФайла(НоваяСтрока.Размер));
