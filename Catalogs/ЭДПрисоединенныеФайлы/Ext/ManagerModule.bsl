...
Процедура ЗаполнитьНаименованиеФайла() Экспорт
	...
	Пока ЭлементСсылка.Следующий() Цикл
		...
		Исключение
			Операция = НСтр("ru='Запись присоединенного файла';uk='Запись присоединенного файла'");
...
Процедура СообщитьОбОшибке(Знач Описание)
	...
	ЗаписьЖурналаРегистрации(
		НСтр("ru='Сертификаты электронной подписи.Перенос настроек в новый объект метаданных';uk='Сертификаты электронной подписи.Перенос настроек в новый объект метаданных'",
