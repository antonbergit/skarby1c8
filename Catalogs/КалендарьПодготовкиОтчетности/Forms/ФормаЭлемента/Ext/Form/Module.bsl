...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	Если Не Объект.ПрименяетсяДляИП И Не Объект.ПрименяетсяДляООО Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru='Событие должно быть применено для ИП или ООО!';uk='Подія повинна бути застосована для ІП або ТОВ!'"));
		Отказ = Истина;
	КонецЕсли;
КонецПроцедуры
