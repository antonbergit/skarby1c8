...
"%1';uk='Не удалось скачать вложение"
"%1'"), ИмяФайла));
		Иначе
...
Функция ЗаполнитьВложенияИзТекстаПисьма(ТекстПисьма, Вложения, Ссылка)
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Электронный документооборот с контролирующими органами.Анализ текста письма рассылки';uk='Электронный документооборот с контролирующими органами.Анализ текста письма рассылки'", 
