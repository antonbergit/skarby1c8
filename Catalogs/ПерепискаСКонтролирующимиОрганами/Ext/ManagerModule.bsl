...
Процедура ЗаполнитьНаименованиеИКодКонтролирующегоОргана(Письмо, Бланк, ОбластьНаименований)
	...
	Иначе
		ОбластьНаименований.Параметры["Наименование" + Постфикс] = НСтр("ru='в ';uk='в '")  + НаименованиеОргана;
	КонецЕсли;
...
Процедура ЗаполнитьКонтактыОрганизации(Письмо, ТабДокумент, Бланк)
	...
	Если ЗначениеЗаполнено(СведенияОбОрганизации.ИННЮЛ) Тогда
		...
		НадписьИННиКПП = НСтр("ru='ИНН ';uk='ІПН '") + СведенияОбОрганизации.ИННЮЛ;
		Если ЗначениеЗаполнено(СведенияОбОрганизации.КППЮЛ) Тогда 
			 НадписьИННиКПП = НадписьИННиКПП + НСтр("ru=' КПП ';uk=' КПП '") + СведенияОбОрганизации.КППЮЛ;
		КонецЕсли;
	...
	Если ЗначениеЗаполнено(СведенияОбОрганизации.ТелОрганизации)
		...
		ОбластьТелефон.Параметры["Телефон" + Постфикс] = НСтр("ru='тел:';uk='тел:'") + СведенияОбОрганизации.ТелОрганизации;
