...
Процедура ВыполнитьАвтоматическуюНастройку()
	...
	Если ПроверкаЗавершиласьСОшибками Тогда
		ВызватьИсключение НСтр("ru='Не удалось подобрать настройки для подключения. Настройте вручную.';uk='Не вдалося підібрати налаштування для підключення. Налаштуйте вручну.'");
...
Процедура ПроверитьВыполнениеФоновогоЗадания()
	...
	Если РезультатФоновогоЗадания.ЗаданиеВыполнено Тогда
		...
		Если ПроверкаЗавершиласьСОшибками Тогда
			ПоказатьОповещениеПользователя(НСтр("ru='Не удалось подобрать настройки для подключения. Настройте вручную.';uk='Не вдалося підібрати налаштування для підключення. Налаштуйте вручну.'"));
		Иначе
			ПоказатьОповещениеПользователя(НСтр("ru='Автоматическая настройка выполнена успешно!';uk='Автоматичне налаштування виконане успішно!'"));
