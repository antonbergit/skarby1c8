...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОтказИзменитьСчетУчета(Ссылка) Тогда
		Элементы.ГруппаСчетовУчета.Подсказка = НСтр("ru='В базе есть движения по этому виду налога! Изменение счета учета запрещено!';uk='У базі є рухи по цьому виду податку! Зміна рахунку обліку заборонена!'");
