...
"или закройте окно вручную, до выхода из программы.';uk='Необходим пересчет служебных данных."
"Нажмите кнопку [Пересчет служебных данных]"
...
"Пользователю с ролью РедактированиеНовостей можно редактировать разрешенные Администратором локальные ленты новостей.';uk='Не можна додавати новини, якщо немає ні однієї локальної стрічки новин, де дозволене редагування."
"Користувачеві з ролями АдминистраторСистемы й ПолныеПрава можна редагувати всі локальні стрічки новин."
...
"Пользователю с ролями АдминистраторСистемы и ПолныеПрава можно редактировать все локальные ленты новостей."
"Пользователю с ролью РедактированиеНовостей можно редактировать разрешенные Администратором локальные ленты новостей.';uk='Можна змінювати новини тільки в локальній стрічці новин, де дозволене редагування."
"Користувачеві з ролями АдминистраторСистемы й ПолныеПрава можна редагувати всі локальні стрічки новин."
"Користувачеві з роллю РедактированиеНовостей можна редагувати дозволені Адміністратором локальні стрічки новин.'");
		Сообщение = Новый СообщениеПользователю();
		Сообщение.Текст = ТекстСообщения;
