...
"Используйте загрузку новостей из лент новостей.';uk='У довіднику новин не можна створювати новини вручну."
"Використовуйте завантаження новин зі стрічок новин.'");
		Сообщение.Сообщить();
		Отказ = Истина;
		Возврат;
	КонецЕсли;
...
Процедура УправлениеФормой()
	...
	Если ЭтаФорма.Пометка = 0 Тогда
		...
		Элементы.Пометка.Подсказка = НСтр("ru='Новость не отмечена';uk='Новость не отмечена'");
	Иначе
		Элементы.Пометка.Рамка = Новый Рамка(ТипРамкиЭлементаУправления.Вдавленная);
		Элементы.Пометка.Подсказка = НСтр("ru='Новость отмечена';uk='Новость отмечена'");
	КонецЕсли;
