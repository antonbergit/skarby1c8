...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если ПустаяСтрока(ЭтаФорма.Действие) Тогда
		...
		Сообщение.Текст = НСтр("ru='Не заполнено поле Действие';uk='Не заповнене поле Дія'");
	...
	Если ПустаяСтрока(ЭтаФорма.УИНДействия) Тогда
		Отказ = Истина;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru='Не заполнен идентификатор гиперссылки (должен заполниться автоматически после выбора Действия)';uk='Не заповнений ідентифікатор гіперпосилання (повинен заповнитися автоматично після вибору Дії)'");
	...
	Если ЭтаФорма.Действие = "Переход по навигационной ссылке" Тогда
		Если ПустаяСтрока(ЭтаФорма.ПараметрДействия_НавигационнаяСсылка) Тогда
			Отказ = Истина;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ru='Не заполнена навигационная ссылка';uk='Не заповнене навігаційне посилання'");
	...
	ИначеЕсли ЭтаФорма.Действие = "Переход по интернет ссылке" Тогда
		Если ПустаяСтрока(ЭтаФорма.ПараметрДействия_ИнтернетСсылка) Тогда
			Отказ = Истина;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ru='Не заполнена интернет-ссылка';uk='Не заповнене інтернет-посилання'");
