...
"Не найдена лента новостей с таким идентификатором.';uk='Помилка завантаження стандартних значень новин з макета %ТекущийМакет.Имя%."
...
"%2';uk='Ошибка загрузки дополнительных стандартных значений новостей по причине:"
"%1"
"Первые 2000 символов дополнительного содержимого:"
"%2'"),
								...
								ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
									НСтр("ru='БИП:Новости.Сервис и регламент';uk='БІП:Новини.Сервіс і регламент'"), // ИмяСобытия
									НСтр("ru='Новости. Сервис и регламент. Загрузка стандартных значений. Новости. Ошибки записи из дополнительных источников';uk='Новости. Сервис и регламент. Загрузка стандартных значений. Новости. Ошибки записи из дополнительных источников'"), // ИдентификаторШага
									УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
									Метаданные.Справочники.Новости, // ОбъектМетаданных
									, // Данные
									ТекстСообщения, // Комментарий
...
"У текущего пользователя (имя ИБ: %ТекущийПользователь%) нет прав на изменение справочника новостей.';uk='Помилка завантаження стандартних значень новин з макетів."
"У поточного користувача (ім`я ІБ: %ТекущийПользователь%) немає прав на зміну довідника новин.'");
