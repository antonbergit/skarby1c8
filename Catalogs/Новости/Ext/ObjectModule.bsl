...
"Данные новости:"
"УИН: %УИННовости%"
"Текст новости: %ТекстНовости%';uk='Перед записом новини про системну помилку в неї була встановлена властивість СкрыватьВОбщемСпискеНовостей, щоб вона не відображалася користувачеві."
"Дані новини:"
"УІН: %УИННовости%"
"Текст новини: %ТекстНовости%'");
