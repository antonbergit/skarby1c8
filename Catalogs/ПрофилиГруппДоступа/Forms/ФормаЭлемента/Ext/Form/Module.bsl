...
"группы доступа профиля обновлены.';uk='Профіль ""%1"" відновлений по вмісту початкового заповнення,"
"групи доступу профілю оновлені.'");
	Иначе
		Текст =
			НСтр("ru='Профиль ""%1"" восстановлен по содержимому начального заполнения,"
"группы доступа профиля не обновлены.';uk='Профіль ""%1"" відновлений по вмісту початкового заповнення,"
...
""
"Будуть видалені зайві види доступу з визначеними для них"
