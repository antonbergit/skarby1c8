...
"повинна бути встановлена Хибність.'");
	...
	ОписаниеПрофиляАдминистратор.Описание =
		НСтр("ru='Профиль предназначен для работы управленческого персонала и выполнения сервисных функций. "
"Предоставляет неограниченный доступ ко всем данным информационной системы. "
""
"Под профилем осуществляется работа со всеми разделами: "
"- Продажи, Закупки, Сервис, Производство, Деньги, Зарплата, Компания, Анализ и Настройки.';uk='Профіль призначений для роботи управлінського персоналу й виконання сервісних функцій. "
"Надає необмежений доступ до всіх даних інформаційної системи. "
""
"Під профілем здійснюється робота з усіма розділами: "
"- Продажі, Закупівлі, Сервіс, Виробництво, Гроші, Зарплата, Компанія, Аналіз і Налаштування.'");
	//Конец УНФ.
...
"(кроме типа СправочникСсылка.Пользователи).';uk='В описі профілю ""%1"""
"зазначене неприпустиме призначення ""%2 (%3)""."
"Очікується призначення, як значення типу ""Тип"" для посилання,"
"зазначене в обумовленому типі Пользователь і"
"зазначене в обумовленому типі ВнешнийПользователь"
...
"""%3"".';uk='В описі профілю ""%1"""
"для виду доступу ""%2"""
"не існує тип зазначеного значення доступу"
"""%3"".'"),
					?(ЗначениеЗаполнено(ОписаниеПрофиля.Имя),
					  ОписаниеПрофиля.Имя,
					  ОписаниеПрофиля.Идентификатор),
