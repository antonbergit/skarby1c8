...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если Модифицированность Тогда
		...
		Если ЗавершениеРаботы Тогда
			ТекстПредупреждения = НСтр("ru='Изменения состава печати не сохранены.';uk='Зміни складу друку не збережені.'");
			Возврат;
		КонецЕсли;
		
		ТекстВопроса = НСтр("ru='Состав контактной информации был изменен."
"Сохранить изменения?';uk='Склад контактної інформації був змінений."
"Зберегти зміни?'");
		
		Оповещение = Новый ОписаниеОповещения("ПередЗакрытиемСохранениеПредложено", ЭтотОбъект);
		ПоказатьВопрос(Оповещение, ТекстВопроса, РежимДиалогаВопрос.ДаНетОтмена, , КодВозвратаДиалога.Отмена, НСтр("ru='Редактирование состава контактной информации';uk='Редагування складу контактної інформації'"));
