...
Процедура ОбновитьИнформациюВСлужебномРегистреСведений(Отказ)
	...
	ЗаписьЖурналаРегистрации(
			НСтр("ru='Автоматические скидки. Служебная информация по автоматическим скидкам';uk='Автоматичні знижки. Службова інформація з автоматичних знижок'",
...
"Подробности в журнале регистрации.';uk='Не вдалося записати службову інформацію з автоматичних знижок, націнок."
