...
Процедура ВыполнитьОперацию(Команда)
	...
	Если ПоказыватьНомерКарты И Не ЗначениеЗаполнено(НомерКарты) Тогда
		Ошибки = Ошибки + ?(ПустаяСтрока(Ошибки),"",Символы.ПС) + НСтр("ru='Платеж не может быть осуществлен без номера карты.';uk='Платіж не може бути здійснений без номера картки.'");
	КонецЕсли;
...
"Значение будет изменено на максимально возможное.';uk='Сума оплати по картці перевищує необхідну безготівкову оплату."
