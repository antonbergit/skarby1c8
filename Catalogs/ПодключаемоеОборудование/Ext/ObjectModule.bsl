...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.WebСервисОборудование Тогда
		...
		Если ЗначениеЗаполнено(ИдентификаторWebСервисОборудования) Тогда
			...
			Если Не Запрос.Выполнить().Пустой() Тогда
				ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru='Указан неуникальный идентификатор активного оборудования элемента. Укажите уникальный идентификатор.';uk='Зазначений неунікальний ідентифікатор активного обладнання елемента. Вкажіть унікальний ідентифікатор.'"), ЭтотОбъект, , , Отказ);
			КонецЕсли;
		КонецЕсли;
