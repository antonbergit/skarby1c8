...
Функция ПолучитьНастройки(Организация, ОрганПФР) Экспорт
	...
	Если ЗначениеЗаполнено(Организация)
		...
		Если Организация.УчетнаяЗаписьОбмена.СпецоператорСвязи = Перечисления.СпецоператорыСвязи.Такском Тогда
			ВызватьИсключение(НСтр("ru='Для абонентов оператора ""Такском"" в настоящее время не предусмотрена возможность отправки макетов пенсионных дел';uk='Для абонентов оператора ""Такском"" в настоящее время не предусмотрена возможность отправки макетов пенсионных дел'"));
		КонецЕсли;
