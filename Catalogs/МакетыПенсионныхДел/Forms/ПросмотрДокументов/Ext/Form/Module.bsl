...
Процедура КомандаОК(Команда)
	...
	Если ВсегоЯчеек > 1 И ВсегоЯчеек <> КоличествоЗаполненныхСтраниц Тогда
		ТекстСообщения = НСтр("ru='Не заполнены номера страниц';uk='Не заполнены номера страниц'");
...
Процедура ДобавитьФайлы(Ячейка)
	...
	ОперацииСФайламиЭДКОКлиент.ДобавитьФайлы(Оповещение, Идентификатор,
		СтрШаблон(НСтр("ru='Выберите сканы документа <%1> ';uk='Выберите сканы документа <%1> '"), Документ), ПараметрыДобавления);
