...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не Запрос.Выполнить().Пустой() Тогда
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ru='Программа с указанным именем и типом уже добавлена в список.';uk='Програма із зазначеним іменем і типом уже додана в список.'"),
			,
			"Объект.ИмяПрограммы");
	КонецЕсли;
...
"Записать данные?';uk='Для встановлення відмітки видалення необхідно записати внесені Вами зміни."
