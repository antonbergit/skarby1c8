...
Процедура ПроверитьНастройки(Команда)
	...
	Если Объект.Ссылка.Пустая() Или Модифицированность Тогда
		...
		ТекстВопроса = НСтр("ru='Для проверки настроек необходимо записать данные учетной записи. Продолжить?';uk='Для перевірки налаштувань необхідно записати дані облікового запису. Продовжити?'");
...
""
"%1';uk='Перевірка параметрів облікового запису завершилася з помилками."
...
"%1';uk='Перевірка параметрів облікового запису завершилася успішно. "
"%1'"),
			РезультатТекст),,
			НСтр("ru='Проверка учетной записи';uk='Перевірка облікового запису'"));
	КонецЕсли;
