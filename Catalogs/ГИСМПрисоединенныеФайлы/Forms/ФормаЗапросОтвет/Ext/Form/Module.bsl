...
Процедура ДобавлениеРеквизитов(Сообщение, ДобавляемыеРеквизиты)
	...
	Реквизит = Новый РеквизитФормы("Сообщение" + Идентификатор, Новый ОписаниеТипов("СправочникСсылка.ГИСМПрисоединенныеФайлы"), "", НСтр("ru='Сообщение';uk='Повідомлення'"));
	ДобавляемыеРеквизиты.Добавить(Реквизит);
	
	Реквизит = Новый РеквизитФормы("Подпись" + Идентификатор, Новый ОписаниеТипов("ФорматированнаяСтрока"), "", НСтр("ru='Подпись';uk='Підпис'"));
	ДобавляемыеРеквизиты.Добавить(Реквизит);
	
	Реквизит = Новый РеквизитФормы("ДатаСоздания" + Идентификатор, Новый ОписаниеТипов("Дата"), "", НСтр("ru='Дата запроса';uk='Дата запроса'"));
	ДобавляемыеРеквизиты.Добавить(Реквизит);
	
	Реквизит = Новый РеквизитФормы("ТекстSOAP" + Идентификатор, Новый ОписаниеТипов("Строка"), "", НСтр("ru='Текст SOAP';uk='Текст SOAP'"));
	ДобавляемыеРеквизиты.Добавить(Реквизит);
	
	Реквизит = Новый РеквизитФормы("ТекстXML" + Идентификатор, Новый ОписаниеТипов("Строка"), "", НСтр("ru='Текст XML';uk='Текст XML'"));
	ДобавляемыеРеквизиты.Добавить(Реквизит);
...
Процедура ДобавлениеЭлементов(СтрокаТЧ, РеквизитыСообщений)
	...
	СтраницаТекстXML  = ДобавитьСтраницу("СтраницаТекстXML",  НСтр("ru='Текст XML';uk='Текст XML'"),  ВложенныеСтраницы, Идентификатор);
	СтраницаТекстSOAP = ДобавитьСтраницу("СтраницаТекстSOAP", НСтр("ru='Текст SOAP';uk='Текст SOAP'"), ВложенныеСтраницы, Идентификатор);
	СтраницаПрочее    = ДобавитьСтраницу("СтраницаПрочее",    НСтр("ru='Прочее';uk='Інше'"),     ВложенныеСтраницы, Идентификатор);
	...
	ДобавитьПолеВвода("Сообщение", НСтр("ru='Сообщение';uk='Повідомлення'"), РеквизитыСообщения.Ссылка, СтраницаПрочее, Идентификатор);
	ДобавитьПолеВвода("ДатаСоздания", НСтр("ru='Дата создания';uk='Дата створення'"), РеквизитыСообщения.ДатаСоздания, СтраницаПрочее, Идентификатор);
	ДобавитьНадпись("Подпись", НСтр("ru='Подпись';uk='Підпис'"), Подпись, Страница, Идентификатор);
	...
	Для Каждого СтрокаТЧ Из Данные Цикл
		Для Каждого Колонка Из Колонки Цикл
			Если ПоследовательностьСообщений.Найти(СтрокаТЧ[Колонка.Имя]) = Неопределено Тогда
				...
				Иначе
					НоваяСтрока.Заголовок = НСтр("ru='Получение квитанции';uk='Получение квитанции'");
					НоваяСтрока.Подсказка = Операция;
				КонецЕсли;
