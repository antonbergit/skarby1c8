...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЕстьПользовательскиеНастройки(Параметры.МассивВариантов) Тогда
		ТекстОшибки = НСтр("ru='Пользовательские настройки выбранных вариантов отчетов (%1 шт) не заданы или уже сброшены.';uk='Користувацькі налаштування обраних варіантів звітів (%1 шт) не задані або вже скинуті.'");
...
Процедура КомандаСбросить(Команда)
	...
	Если КоличествоВариантов = 1 Тогда
		...
		ОповещениеЗаголовок = НСтр("ru='Сброшены пользовательские настройки варианта отчета';uk='Скинуто користувальницькі налаштування варіанта звіту'");
...
"вариантов отчетов (%1 шт.).';uk='Скинуто користувальницькі налаштування"
