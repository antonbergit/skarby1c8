...
Процедура КомандаСбросить(Команда)
	...
	Если КоличествоВариантов = 1 И КоличествоВыбранныхВариантов = 1 Тогда
		...
		ОповещениеЗаголовок = НСтр("ru='Сброшены настройки размещения варианта отчета';uk='Скинуто налаштування розміщення варіанта звіту'");
...
"вариантов отчетов (%1 шт.).';uk='Скинуто налаштування розміщення"
...
"- Выбраны варианты дополнительных или внешних отчетов.';uk='Скидання налаштувань розміщення вибраних варіантів звітів не потрібно по одній або кількох причинах:"
"- Обрані власні варіанти звітів."
"- Обрані позначені на видалення варіанти звітів."
