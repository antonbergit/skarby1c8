...
Процедура СоставНоменклатураОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	Если ВыбранноеЗначение = Объект.Владелец Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru='В состав спецификации не может входить продукция.';uk='До складу специфікації не може входити продукція.'"));
