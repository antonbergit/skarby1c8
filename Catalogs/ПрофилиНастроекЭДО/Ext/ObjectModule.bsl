...
Процедура ПередЗаписью(Отказ)
	...
	Если ПометкаУдаления Тогда
		...
		Если Не Запрос.Выполнить().Пустой() Тогда
			ТекстСообщения = НСтр("ru='Операция отменена. Текущий профиль настроек ЭДО используется в действующих настройках ЭДО.';uk='Операция отменена. Текущий профиль настроек ЭДО используется в действующих настройках ЭДО.'");
...
"Способ обмена - %3;';uk='В информационной базе уже существует профиль настроек с реквизитами:"
"Организация - %1;"
"Идентификатор организации - %2;"
"Способ обмена - %3;'");
