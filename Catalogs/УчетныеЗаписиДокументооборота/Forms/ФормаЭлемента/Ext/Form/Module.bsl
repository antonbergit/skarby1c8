...
Функция ПараметрыДоступаВерны()
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Электронный документооборот с КО.Проверка параметров подключения';uk='Электронный документооборот с КО.Проверка параметров подключения'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
			УровеньЖурналаРегистрации.Ошибка,,,
			ПодробноеПредставлениеОшибки(Инф));
			
		ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='При проверке настроек учетной записи произошли ошибки:"
"%1';uk='При проверке настроек учетной записи произошли ошибки:"
...
""
"Продолжить?';uk='Текущий пользователь был удален из списка пользователей учетных записей."
"Форма учетной записи будет закрыта."
""
"Продолжить?'");
