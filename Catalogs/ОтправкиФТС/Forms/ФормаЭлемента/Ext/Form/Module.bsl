...
Процедура НадписьПервичноеСообщениеНажатие(Элемент)
	...
	ПолучитьФайл(Адрес, НСтр("ru='Подпись';uk='Підпис'") + Объект.ИмяФайлаВыгрузки);
...
Процедура ВыгрузитьПротокол(Команда)
	...
	ПолучитьФайл(Адрес, НСтр("ru='Протокол';uk='Протокол'") + ИмяФайлаВыгрузкиДоТочки + ".html");
...
Процедура ВыгрузитьКвитанцию(Команда)
	...
	ПолучитьФайл(Адрес, НСтр("ru='Квитанция';uk='Квитанція'") + ИмяФайлаВыгрузкиДоТочки + ".xml");
...
Процедура ОбновитьФорму()
	...
	Если Объект.СтатусОтправки = Перечисления.СтатусыОтправки.Отправлен Тогда
		...
		Элементы.НадписьСтатусОтправки.Заголовок = НСтр("ru='Протокол обработки отчета отсутствует';uk='Протокол обробки звіту відсутній'");
	...
	Иначе
		...
		Если Объект.НаКонтроле Тогда
			...
			Элементы.НадписьСтатусОтправки.Заголовок = НСтр("ru='Протокол получен';uk='Протокол отриманий'");
