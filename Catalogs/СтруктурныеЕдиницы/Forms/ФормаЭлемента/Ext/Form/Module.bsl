...
Процедура РозничныйВидЦенПриИзменении(Элемент)
	...
	Если НЕ СтруктураДанных.ВалютаЦены = СтруктураДанных.НациональнаяВалюта Тогда
		...
		ТекстСообщения = НСтр("ru='У вида цен ""%ВидЦен%"", для розничной структурной единицы, должна быть задана национальная валюта (%НацВалюта%).';uk='У виду цін ""%ВидЦен%"", для роздрібної структурної одиниці, повинна бути задана національна валюта (%НацВалюта%).'");
