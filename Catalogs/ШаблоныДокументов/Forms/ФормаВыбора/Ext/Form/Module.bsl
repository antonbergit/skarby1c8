...
Процедура НастроитьФорму()
	...
	Если Запрос.Выполнить().Пустой() Тогда
		...
		Заголовок = НСтр("ru='Шаблоны для документов отсутствуют.';uk='Шаблони для документів відсутні.'");
	Иначе
		Элементы.Список.Видимость = Истина;
		Заголовок = НСтр("ru='Выберите шаблон для создания документа';uk='Виберіть шаблон для створення документа'");
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(ДокументСсылка) Тогда
		...
		Элементы.ДекорацияПустойШаблон.Заголовок = НСтр("ru='или';uk='або'");
	Иначе
		Элементы.ГруппаШаблонПоДокументу.Видимость = Ложь;
		Элементы.ДекорацияПустойШаблон.Заголовок = НСтр("ru='Вы можете';uk='Ви можете'");
	КонецЕсли;
