...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОтказИзменитьСчетаУчета(НаправлениеДеятельности) Тогда
		Элементы.ГруппаСчетовУчета.Подсказка = НСтр("ru='В базе есть доходы или расходы по этому направлению деятельности! Изменение счета учета выручки от продаж запрещено!';uk='У базі є доходи або витрати по цьому напрямку діяльності! Зміна рахунку обліку виторгу від продажів заборонена!'");
