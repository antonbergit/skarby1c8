...
Процедура ОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка)
	...
	Если Параметры.Отбор.Свойство("Владелец")
		...
		Сообщение.Текст = НСтр("ru='Для структурной единицы данного типа нельзя использовать ячейки!';uk='Для структурної одиниці даного типу не можна використовувати комірки!'");
		Сообщение.Сообщить();
