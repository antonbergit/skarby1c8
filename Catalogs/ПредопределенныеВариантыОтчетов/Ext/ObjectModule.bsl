...
Процедура ПередЗаписью(Отказ)
	...
	Если Не ДополнительныеСвойства.Свойство("ЗаполнениеПредопределенных") Тогда
		ВызватьИсключение НСтр("ru='Справочник ""Предопределенные варианты отчетов"" изменяется только при автоматическом заполнении его данных.';uk='Довідник ""Визначені варіанти звітів"" змінюється тільки при автоматичному заповненні його даних.'");
	КонецЕсли;
КонецПроцедуры
