...
Процедура Реквизит1Выбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	//ОткрытьФорму(
	//	"Справочник.ОКУН.ФормаОбъекта",
	//	Новый Структура("Ключ,ОткрытаИзПодбора",
	//		Элементы.Реквизит1.ТекущиеДанные.Ссылка,
	//		Истина),
	//	ЭтаФорма);
	...
	Если Стр.Количество() > 0 Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru='Такой код уже выбран';uk='Такий код вже обраний'"));
	Иначе
