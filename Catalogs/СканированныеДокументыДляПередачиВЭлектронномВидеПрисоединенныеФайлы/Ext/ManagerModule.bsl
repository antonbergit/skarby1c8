...
Процедура ВыполнитьНачальноеЗаполнение(Параметры) Экспорт
	...
	Пока ВыборкаДокумент.Следующий() Цикл
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(НСтр("ru='Заполнение справочника СканированныеДокументыДляПередачиВЭлектронномВидеПрисоединенныеФайлы';uk='Заполнение справочника СканированныеДокументыДляПередачиВЭлектронномВидеПрисоединенныеФайлы'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
