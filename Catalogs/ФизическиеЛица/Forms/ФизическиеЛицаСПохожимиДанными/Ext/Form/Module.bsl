...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Запрос.Текст = 
		...
		|	ФизическиеЛица.КодПоДРФО КАК ИНН,
		|	ФизическиеЛица.СтраховойНомерПФ КАК СтраховойНомерПФ,
	...
	Пока Выборка.Следующий() Цикл
		...
		Если НЕ ЗначениеЗаполнено(НоваяСтрокаДанных.ИНН) Тогда
			НоваяСтрокаДанных.ИНН = "<" + НСтр("ru='Не заполнен';uk='Не заповнений'") + ">";
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(НоваяСтрокаДанных.СтраховойНомерПФ) Тогда
			НоваяСтрокаДанных.СтраховойНомерПФ = "<" + НСтр("ru='Не заполнен';uk='Не заповнений'") + ">";
		КонецЕсли;
