...
Процедура ЗаполнитьФактическийСценарий() Экспорт
	...
	СценарийОбъект.Наименование		= НСтр("ru='Фактический';uk='Фактичний'");
...
Процедура ЗаполнитьПоставляемыеСценарии() Экспорт
	...
	Сценарий.Наименование			= НСтр("ru='Продажи категорий номенклатуры (помесячно)';uk='Продажі категорій номенклатури (щомісячно)'");
	...
	Сценарий.Комментарий			= НСтр("ru='#Создан автоматически для быстрого старта';uk='#Створено автоматично для швидкого старту'");
	...
	Сценарий = Справочники.СценарииПланирования.СоздатьЭлемент();
	Сценарий.УстановитьНовыйКод();
	Сценарий.Наименование			= НСтр("ru='План продаж менеджеров (помесячно)';uk='План продажів менеджерів (щомісячний)'");
