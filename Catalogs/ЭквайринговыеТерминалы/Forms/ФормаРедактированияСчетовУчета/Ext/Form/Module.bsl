...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОтказИзменитьСчетУчета(Параметры.Ссылка) Тогда
		Элементы.ГруппаСчетовУчета.Подсказка = НСтр("ru='В базе есть движения по этому эквайринговому терминалу! Изменение счета учета запрещено!';uk='У базі є рухи по цьому еквайринговому терміналу! Зміна рахунку обліку заборонена!'");
