...
Процедура ПриЗаписи(Отказ)
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			ТекстСообщения = НСтр("ru='Не удалось записать информацию о виде платежной карты (%1) в справочнке ""Виды платежных карт""';uk='Не вдалося записати інформацію про вид платіжної картки (%1) у довіднику ""Види платіжних карт""'");
