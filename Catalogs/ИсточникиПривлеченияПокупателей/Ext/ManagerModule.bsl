...
Процедура ЗаполнитьПоставляемыеИсточникиПривлеченияПокупателей() Экспорт
	...
	Источник.Наименование = НСтр("ru='Сайт';uk='Сайт'");
	...
	Источник = Справочники.ИсточникиПривлеченияПокупателей.СоздатьЭлемент();
	Источник.УстановитьНовыйКод();
	Источник.Наименование = НСтр("ru='E-mail';uk='E-mail'");
	...
	Источник = Справочники.ИсточникиПривлеченияПокупателей.СоздатьЭлемент();
	Источник.УстановитьНовыйКод();
	Источник.Наименование = НСтр("ru='Звонок';uk='Дзвінок'");
	...
	Источник = Справочники.ИсточникиПривлеченияПокупателей.СоздатьЭлемент();
	Источник.УстановитьНовыйКод();
	Источник.Наименование = НСтр("ru='Выставка';uk='Вистава'");
	...
	Источник = Справочники.ИсточникиПривлеченияПокупателей.СоздатьЭлемент();
	Источник.УстановитьНовыйКод();
	Источник.Наименование = НСтр("ru='Рекламная кампания';uk='Рекламна кампанія'");
