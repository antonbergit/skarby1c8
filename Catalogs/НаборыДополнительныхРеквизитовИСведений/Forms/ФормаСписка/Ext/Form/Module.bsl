...
Процедура НастроитьОтображениеНаборов()
	...
	Если ЭтоНаборыДополнительныхСведений Тогда
		...
		КомандаПометитьНаУдаление.Подсказка = НСтр("ru='Пометить текущее сведение на удаление (Del)';uk='Позначити поточну відомість на видалення (Del)'");
...
"декількох наборах додаткових відомостей.'");
	Иначе
		...
		КомандаПометитьНаУдаление.Подсказка = НСтр("ru='Пометить текущий реквизит на удаление (Del)';uk='Позначити поточний реквізит на видалення (Del)'");
	...
	Если Элементы.Свойства.ТекущиеДанные <> Неопределено Тогда
		...
		Если ЭтоНаборыДополнительныхСведений Тогда
			...
			ИначеЕсли Элементы.Свойства.ТекущиеДанные.ПометкаУдаления Тогда
				ТекстВопроса = НСтр("ru='Снять с текущего сведения пометку на удаление?';uk='Зняти з поточної відомості позначку на видалення?'");
			Иначе
				ТекстВопроса = НСтр("ru='Пометить текущее сведение на удаление?';uk='Позначити поточну відомість на видалення?'");
			КонецЕсли;
		Иначе
			Если Элементы.Свойства.ТекущиеДанные.Общее Тогда
			...
			ИначеЕсли Элементы.Свойства.ТекущиеДанные.ПометкаУдаления Тогда
				ТекстВопроса = НСтр("ru='Снять с текущего реквизита пометку на удаление?';uk='Зняти з поточного реквізиту позначку на видалення?'");
			Иначе
				ТекстВопроса = НСтр("ru='Пометить текущий реквизит на удаление?';uk='Позначити поточний реквізит на видалення?'");
			КонецЕсли;
		КонецЕсли;
