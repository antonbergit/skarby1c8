...
&НаКлиенте
Процедура ВставитьКОАТУУОрганизации(Команда)
	ВставитьПараметрИнфобазы(ПредопределенноеЗначение("Перечисление.ПараметрыБланковДоговоровСКонтрагентами.КОАТУУОрганизации"));
КонецПроцедуры

&НаКлиенте
Процедура ВставитьЕДРПОУКонтрагента(Команда)
	ВставитьПараметрИнфобазы(ПредопределенноеЗначение("Перечисление.ПараметрыБланковДоговоровСКонтрагентами.ЕДРПОУКонтрагента"));
КонецПроцедуры

&НаКлиенте
Процедура ВставитьЕДРПОУОрганизации(Команда)
	ВставитьПараметрИнфобазы(ПредопределенноеЗначение("Перечисление.ПараметрыБланковДоговоровСКонтрагентами.ЕДРПОУОрганизации"));
КонецПроцедуры
...
&НаКлиенте
Процедура ВставитьМфоОрганизации(Команда)
	ВставитьПараметрИнфобазы(ПредопределенноеЗначение("Перечисление.ПараметрыБланковДоговоровСКонтрагентами.МфоОрганизации"));
КонецПроцедуры
...
&НаКлиенте
Процедура ВставитьМфоКонтрагента(Команда)
	ВставитьПараметрИнфобазы(ПредопределенноеЗначение("Перечисление.ПараметрыБланковДоговоровСКонтрагентами.МфоКонтрагента"));
КонецПроцедуры
...
&НаКлиенте
Процедура ВставитьКВЭДОрганизации(Команда)
	ВставитьПараметрИнфобазы(ПредопределенноеЗначение("Перечисление.ПараметрыБланковДоговоровСКонтрагентами.КВЭДОрганизации"));
КонецПроцедуры
