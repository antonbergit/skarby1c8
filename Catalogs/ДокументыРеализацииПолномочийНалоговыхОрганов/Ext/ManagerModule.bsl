...
Функция НаименованиеДокументаРеализацииПолномочий(Знач Требование, ПриложенияТребования = Неопределено) Экспорт
	...
	Если Требование.ВидДокумента = Перечисления.ВидыНалоговыхДокументов.ТребованиеОПредставленииПоясненийКДекларацииНДС Тогда
		...
		Иначе 
			...
			Наименование = НСтр("ru='Требование %Номер% от %Дата% о представлении пояснений к декларации по НДС %ПредставлениеДекларации%';uk='Требование %Номер% от %Дата% о представлении пояснений к декларации по НДС %ПредставлениеДекларации%'");
...
Функция ПредставлениеДекларации(Требование, ПриложенияТребования = Неопределено) Экспорт
	...
	Если СвойстваДекларации <> Неопределено Тогда
		...
		Представление = НСтр("ru='за %Период% %Год% г.%Уточнение%';uk='за %Период% %Год% г.%Уточнение%'");
		...
		Если СвойстваДекларации.НомерКорректировки = 0 Тогда
			Уточнение = "";
		Иначе
			Уточнение = НСтр("ru=' (К/%НомерУточнения%)';uk=' (К/%НомерУточнения%)'");
