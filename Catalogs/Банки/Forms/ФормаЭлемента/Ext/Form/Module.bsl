...
"Продолжить с изменением?';uk='Дані, що поставляються, оновлюються автоматично."
"Після ручної зміни автоматичне оновлення цього елементу проводитися не буде."
"Продовжити зі зміною?'");
