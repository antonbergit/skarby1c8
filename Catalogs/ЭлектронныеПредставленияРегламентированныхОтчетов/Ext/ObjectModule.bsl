...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ЗначениеЗаполнено(ВидОтчета) 
		...
		Если Не ЗначениеЗаполнено(ДатаНачала) ИЛИ Не ЗначениеЗаполнено(ДатаОкончания) ИЛИ Не ЗначениеЗаполнено(Периодичность) Тогда
			ТекстСообщения = НСтр("ru='Поле ""Период"" не заполнено';uk='Поле ""Период"" не заполнено'"); 
...
""
"Дата начала периода больше, чем дата его окончания.';uk='Поле ""Период"" заполнено некорректно."
""
