...
Процедура ЗаполнитьСписокВыбораИнтервал(Форма)
	...
	Если Форма.ВидПериода = ПредопределенноеЗначение("Перечисление.Периодичность.Полугодие") Тогда
		СписокВыбора.Добавить(1, НСтр("ru='1 полугодие';uk='1 півріччя'"));
		СписокВыбора.Добавить(2, НСтр("ru='2 полугодие';uk='2 півріччя'"));
	ИначеЕсли Форма.ВидПериода = ПредопределенноеЗначение("Перечисление.Периодичность.Квартал") Тогда
		СписокВыбора.Добавить(1, НСтр("ru='1 квартал';uk='1 квартал'"));
		СписокВыбора.Добавить(2, НСтр("ru='2 квартал';uk='2 квартал'"));
		СписокВыбора.Добавить(3, НСтр("ru='3 квартал';uk='3 квартал'"));
		СписокВыбора.Добавить(4, НСтр("ru='4 квартал';uk='4 квартал'"));
	ИначеЕсли Форма.ВидПериода = ПредопределенноеЗначение("Перечисление.Периодичность.Месяц") Тогда
		СписокВыбора.Добавить(1, НСтр("ru='Январь';uk='Січень'"));
		СписокВыбора.Добавить(2, НСтр("ru='Февраль';uk='Лютий'"));
		СписокВыбора.Добавить(3, НСтр("ru='Март';uk='Березень'"));
		СписокВыбора.Добавить(4, НСтр("ru='Апрель';uk='Квітень'"));
		СписокВыбора.Добавить(5, НСтр("ru='Май';uk='Травень'"));
		СписокВыбора.Добавить(6, НСтр("ru='Июнь';uk='Червень'"));
		СписокВыбора.Добавить(7, НСтр("ru='Июль';uk='Липень'"));
		СписокВыбора.Добавить(8, НСтр("ru='Август';uk='Серпень'"));
		СписокВыбора.Добавить(9, НСтр("ru='Сентябрь';uk='Вересень'"));
		СписокВыбора.Добавить(10, НСтр("ru='Октябрь';uk='Жовтень'"));
		СписокВыбора.Добавить(11, НСтр("ru='Ноябрь';uk='Листопад'"));
		СписокВыбора.Добавить(12, НСтр("ru='Декабрь';uk='Грудень'"));
	КонецЕсли;
