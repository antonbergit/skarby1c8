...
"Установите флаг ""Использовать партии"" в карточке номенклатуры';uk='Для номенклатури не ведеться облік по партіях!"
"Встановіть прапорець ""Використовувати партії"" у картці номенклатури'");
		Сообщение.Сообщить();
		Отказ = Истина;
