...
Процедура ОбработкаПолученияФормы(ВидФормы, Параметры, ВыбраннаяФорма, ДополнительнаяИнформация, СтандартнаяОбработка)
	...
	Если ИспользоватьВидыЗаказов Тогда
		Если Параметры.РежимВыбора И Параметры.Свойство("ВидЗаказа") И ЗначениеЗаполнено(Параметры.ВидЗаказа) Тогда
...
Процедура ЗаполнитьПоставляемыеСостояния() Экспорт
	...
	Попытка
		...
		Состояние.Наименование	= НСтр("ru='В работе';uk='В роботі'");
...
"%1';uk='Не вдалося заповнити довідник ""Стан замовлень покупців"" за замовчуванням з причини:"
"%1'"), 
