...
"Воспользуйтесь командой ""Загрузить классификатор""';uk='Інтерактивне додавання в класифікатор не підтримується."
"Скористайтеся командою ""Завантажити класифікатор""'"));
