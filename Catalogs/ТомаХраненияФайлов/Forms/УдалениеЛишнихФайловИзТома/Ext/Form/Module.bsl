...
Процедура УдалитьЛишниеФайлы(Команда)
	...
	Если ЧислоУдаленныхФайлов <> 0 Тогда
		ТекстОповещения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Удалено файлов: %1';uk='Видалено файлів: %1'"),
			ЧислоУдаленныхФайлов);
		ПоказатьОповещениеПользователя(
			НСтр("ru='Завершено удаление лишних файлов.';uk='Завершене видалення зайвих файлів.'"),
			,
			ТекстОповещения,
...
""
"%1';uk='Шлях каталогу для копіювання некоректний."
"Можливо обліковий запис, від імені якої працює"
"сервер 1С:Підприємства, не має прав доступу до зазначеного каталогу."
""
"%1'");
...
Процедура ОбработатьСообщениеОбОшибке(ИмяФайла, ИнформацияОбОшибке)
	...
	ЗаписьЖурналаРегистрации(НСтр("ru='Файлы.Ошибка удаления лишних файлов';uk='Файли.Помилка видалення зайвих файлів'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
		УровеньЖурналаРегистрации.Информация,,,
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='При удалении файла с диска"
"""%1"""
"возникла ошибка:"
"""%2"".';uk='При видаленні файлу з диска"
"""%1"""
"виникла помилка:"
"""%2"".'"),
			ИмяФайла,
