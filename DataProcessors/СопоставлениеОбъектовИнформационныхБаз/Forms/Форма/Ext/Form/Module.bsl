...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='Нет соответствия, объект будет скопирован';uk='Немає відповідності, об`єкт буде скопійований'"));
...
Функция ФоновоеЗаданиеЗапуститьНаСервере(Отказ)
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru='Сопоставление объектов';uk='Зіставлення об`єктів'");
