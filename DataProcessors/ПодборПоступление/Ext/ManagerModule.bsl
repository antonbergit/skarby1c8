...
Процедура СтруктураСведенийОДокументе(СтруктураПараметров) Экспорт
	...
	Для каждого РеквизитОбработки Из Метаданные.Обработки.ПодборПоступление.Реквизиты Цикл
...
Функция ПолноеИмяФормыПодбора() Экспорт
	...
	Возврат "Обработка.ПодборПоступление.Форма.КорзинаЦенаОстатокРезервХарактеристика";
