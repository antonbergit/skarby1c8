...
Функция ПолучитьДанныеПродаж(Организация, ДатаРасчета, НастройкаВиджета)
	...
	Запрос.Текст = 
		...
		|					УПОРЯДОЧИТЬ ПО
		|						ПродажиОбороты.СуммаОборот УБЫВ)) КАК ПродажиОбороты
		|
		|УПОРЯДОЧИТЬ ПО
		|	Период,
		|	Выручка УБЫВ
	...
	Результат.Вставить("ДиаграммаРейтингТоваров",	МассивРезультатов[2]);
	Результат.Вставить("ДиаграммаРейтингМенеджеров",МассивРезультатов[3]);
	Результат.Вставить("ДиаграммаПрибыль",			МассивРезультатов[4]);
