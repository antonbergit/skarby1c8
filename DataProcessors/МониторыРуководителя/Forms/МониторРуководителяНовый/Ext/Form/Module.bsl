...
Процедура ЗапуститьФоновоеЗаданиеНаСервере()
	...
	НаименованиеЗадания = НСтр("ru='Обновление виджетов монитора руководителя';uk='Оновлення виджетів монітора керівника'");
...
Процедура ОбновитьВиджетПродажи(ДанныеПродажи, НастройкаВиджета)
	...
	Если Выборка.Следующий() Тогда
		Элементы.ДанныеПродажи.Заголовок = СформироватьЗаголовокВарианта(НСтр("ru='Продажи';uk='Продажі'"), Выборка.Выручка, , Выборка.ПредставлениеВалютыУчета);
		Элементы.ДанныеПрибыль.Заголовок = СформироватьЗаголовокВарианта(НСтр("ru='Прибыль';uk='Прибуток'"), Выборка.Прибыль, Истина, Выборка.ПредставлениеВалютыУчета);
	Иначе
		Элементы.ДанныеПродажи.Заголовок = "";
		Элементы.ДанныеПрибыль.Заголовок = "";
	КонецЕсли;
	Элементы.ДанныеРейтингТоваров.Заголовок = СформироватьЗаголовокВарианта(НСтр("ru='Рейтинг товаров';uk='Рейтинг товарів'"),
		НастройкаВиджета.ПервыеТовары, , НСтр("ru='лучших';uk='кращих'"));
	Элементы.ДанныеРейтингМенеджеров.Заголовок = СформироватьЗаголовокВарианта(НСтр("ru='Рейтинг менеджеров';uk='Рейтинг менеджерів'"),
		НастройкаВиджета.ПервыеМенеджеры, , НСтр("ru='лучших';uk='кращих'"));
	...
	СерияСебестоимость = ДиаграммаПродажи.Серии.Добавить(НСтр("ru='Себестоимость';uk='Собівартість'"));
	СерияСебестоимость.Маркер = ТипМаркераДиаграммы.Круг;
	СерияСебестоимость.Индикатор = Истина;
	СерияВаловаяПрибыль = ДиаграммаПродажи.Серии.Добавить(НСтр("ru='Валовая прибыль';uk='Валовий прибуток'"));
	СерияВаловаяПрибыль.Маркер = ТипМаркераДиаграммы.Круг;
	СерияВыручка = ДиаграммаПродажи.Серии.Добавить(НСтр("ru='Выручка';uk='Виторг'"));
	...
	Пока Выборка.Следующий() Цикл
		...
		Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Выручка: %1 на %2';uk='Виторг: %1 на %2'"),
		...
		Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Себестоимость: %1 на %2';uk='Собівартість: %1 на %2'"),
		...
		Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Валовая прибыль: %1 на %2';uk='Валовий прибуток: %1 на %2'"),
	...
	Пока ВыборкаПериод.Следующий() Цикл
		...
		Если НЕ ЕстьДанныеДляОтображения Тогда
			...
			Если ДиаграммаРейтингТоваров.Серии.Количество() = 0 Тогда
				...
				Серия.Текст = НСтр("ru='Лучший товар';uk='Кращий товар'");
			Иначе
		...
		Пока ВыборкаНоменклатура.Следующий() Цикл
			...
			Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Выручка: %1 за номенклатуру: ""%2"" на %3';uk='Виторг: %1 за номенклатуру: ""%2"" на %3'"),
				Формат(Выручка, ФорматСуммы),
	...
	Пока ВыборкаПериод.Следующий() Цикл
		...
		Если НЕ ЕстьДанныеДляОтображения Тогда
			...
			Если ДиаграммаРейтингМенеджеров.Серии.Количество() = 0 Тогда
				...
				Серия.Текст = НСтр("ru='Лучший менеджер';uk='Кращий менеджер'");
			Иначе
		...
		Пока ВыборкаМенеджеры.Следующий() Цикл
			...
			Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Выручка: %1 по менеджеру: %2, на %3';uk='Виторг: %1 по менеджері: %2, на %3'"),
				Формат(Выручка, ФорматСуммы),
	...
	СерияРасходы = ДиаграммаПрибыль.Серии.Добавить(НСтр("ru='Расходы';uk='Витрати'"));
	СерияРасходы.Маркер = ТипМаркераДиаграммы.Круг;
	СерияРасходы.Индикатор = Истина;
	СерияПрибыль = ДиаграммаПрибыль.Серии.Добавить(НСтр("ru='Прибыль';uk='Прибуток'"));
	СерияПрибыль.Маркер = ТипМаркераДиаграммы.Круг;
	СерияДоходы = ДиаграммаПрибыль.Серии.Добавить(НСтр("ru='Доходы';uk='Доходи'"));
	...
	Пока Выборка.Следующий() Цикл
		...
		Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Доход: %1 на %2';uk='Дохід: %1 на %2'"),
		...
		Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Расход: %1 на %2';uk='Витрата: %1 на %2'"),
		...
		Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Прибыль: %1 на %2';uk='Прибуток: %1 на %2'"),
...
Процедура ОбновитьВиджетДенежныеСредства(ДанныеДенежныхСредств, НастройкаВиджета)
	...
	Если Выборка.Следующий() Тогда
		Элементы.ДанныеОстаткиДС.Заголовок = СформироватьЗаголовокВарианта(НСтр("ru='Остаток денег';uk='Залишок грошей'"), Выборка.ОстатокДенег, , Выборка.ПредставлениеВалютыУчета);
		Элементы.ДанныеНаличные.Заголовок = СформироватьЗаголовокВарианта(НСтр("ru='Наличные';uk='Готівка'"), Выборка.Наличные, , Выборка.ПредставлениеВалютыУчета);
		Элементы.ДанныеБезналичные.Заголовок = СформироватьЗаголовокВарианта(НСтр("ru='Безналичные';uk='Безготівкові'"), Выборка.Безналичные, , Выборка.ПредставлениеВалютыУчета);
		Элементы.ДанныеДенежныйПоток.Заголовок = СформироватьЗаголовокВарианта(НСтр("ru='Денежный поток';uk='Грошовий потік'"), Выборка.ДенежныйПоток, Истина, Выборка.ПредставлениеВалютыУчета);
	Иначе
	...
	Серия = ДиаграммаОстатокДенег.Серии.Добавить(НСтр("ru='Остаток';uk='Залишок'"));
	Серия.Маркер = ТипМаркераДиаграммы.Круг;
	...
	Пока Выборка.Следующий() Цикл
		...
		Точка.Текст = Формат(Период, ФорматДатыТочки);
		Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Остаток денег: %1 на %2';uk='Залишок грошей: %1 на %2'"),
	...
	Серия = ДиаграммаНаличные.Серии.Добавить(НСтр("ru='Остаток';uk='Залишок'"));
	Серия.Маркер = ТипМаркераДиаграммы.Круг;
	...
	Пока Выборка.Следующий() Цикл
		...
		Точка.Текст = Формат(Период, ФорматДатыТочки);
		Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Наличные: %1 на %2';uk='Готівка: %1 на %2'"),
	...
	Серия = ДиаграммаБезналичные.Серии.Добавить(НСтр("ru='Остаток';uk='Залишок'"));
	Серия.Маркер = ТипМаркераДиаграммы.Круг;
	...
	Пока Выборка.Следующий() Цикл
		...
		Точка.Текст = Формат(Период, ФорматДатыТочки);
		Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Безналичные: %1 на %2';uk='Безготівкові: %1 на %2'"),
	...
	Серия = ДиаграммаДенежныйПоток.Серии.Добавить(НСтр("ru='Остаток';uk='Залишок'"));
	Серия.Маркер = ТипМаркераДиаграммы.Круг;
	...
	Пока Выборка.Следующий() Цикл
		...
		Точка.Текст = Формат(Период, ФорматДатыТочки);
		Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Денежный поток: %1 на %2';uk='Грошовий потік: %1 на %2'"),
...
Процедура ОбновитьВиджетДолги(ДанныеВзаиморасчетов, НастройкаВиджета)
	...
	Если Выборка.Следующий() Тогда
		Элементы.ДанныеДолгПокупателей.Заголовок =	СформироватьЗаголовокВарианта(НСтр("ru='Долг покупателей';uk='Борг покупців'"),
			Выборка.ДолгПокупателей, , Выборка.ПредставлениеВалютыУчета);
		Элементы.ДанныеДолгПоставщикам.Заголовок =	СформироватьЗаголовокВарианта(НСтр("ru='Долг поставщикам';uk='Борг постачальникам'"),
	...
	Точка.Текст = НСтр("ru='Долг';uk='Борг'");
	...
	Пока Выборка.Следующий() Цикл
		...
		Если КлючиСерий.Количество() < МаксСерийДиаграммы Тогда
			...
			Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Задолженность: %1 от покупателя: %2';uk='Заборгованість: %1 від покупця: %2'"),
		...
		Иначе
			...
			СводнаяСерия.Текст = НСтр("ru='Прочие';uk='Інші'");
			...
			Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Задолженность прочих покупателей: %1';uk='Заборгованість інших покупців: %1'"),
	...
	Серия = ДиаграммаДолгПокупателей.Серии.Добавить(НСтр("ru='Задолженность';uk='Заборгованість'"));
	Серия.Маркер = ТипМаркераДиаграммы.Круг;
	...
	Пока Выборка.Следующий() Цикл
		...
		Точка.Текст = Формат(Период, ФорматДатыТочки);
		Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Общая задолженность: %1 на %2';uk='Загальна заборгованість: %1 на %2'"),
	...
	Пока Выборка.Следующий() Цикл
		...
		Если КлючиСерий.Количество() < МаксСерийДиаграммы Тогда
			...
			Серия.Раздвигать = Истина;
			Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Задолженность: %1 поставщику: %2';uk='Заборгованість: %1 постачальникові: %2'"),
		...
		Иначе
			...
			Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Задолженность прочим поставщикам: %1';uk='Заборгованість іншим постачальникам: %1'"),
				Формат(НовоеЗначение, ФорматСуммы),
				);
	...
	Серия = ДиаграммаДолгПоставщикам.Серии.Добавить(НСтр("ru='Задолженность';uk='Заборгованість'"));
	Серия.Маркер = ТипМаркераДиаграммы.Круг;
...
Функция СформироватьПредставлениеПериода(ДатаОкончания, ВидПериода, Интервал)
	...
	ФорматнаяСтрока = "Л="+Локализация.ОпределитьКодЯзыкаДляФормат(КодЯзыка)+"; ДФ='d MMMM'";
	
	Если Интервал = Перечисления.Периодичность.День Тогда
		ПредставлениеИнтервала = НСтр("ru='по дням';uk='по днях'");
	ИначеЕсли Интервал = Перечисления.Периодичность.Неделя Тогда
		ПредставлениеИнтервала = НСтр("ru='по неделям';uk='по тижнях'");
	ИначеЕсли Интервал = Перечисления.Периодичность.Декада Тогда
		ПредставлениеИнтервала = НСтр("ru='по декадам';uk='по декадах'");
	ИначеЕсли Интервал = Перечисления.Периодичность.Месяц Тогда
		ПредставлениеИнтервала = НСтр("ru='помесячно';uk='щомісячно'");
	ИначеЕсли Интервал = Перечисления.Периодичность.Квартал Тогда
		ПредставлениеИнтервала = НСтр("ru='поквартально';uk='поквартально'");
	ИначеЕсли Интервал = Перечисления.Периодичность.Полугодие Тогда
		ПредставлениеИнтервала = НСтр("ru='по полугодиям';uk='по півріччях'");
...
Процедура ИнициализироватьДиаграмму(Диаграмма, ВидДиаграммы = Неопределено)
	...
	Диаграмма.ОбластьЗаголовка.Текст			= НСтр("ru='Нет данных для отображения';uk='Немає даних для відображення'");
