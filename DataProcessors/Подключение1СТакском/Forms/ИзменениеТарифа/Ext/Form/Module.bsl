...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТекстЗаголовка = НСтр("ru='Период: с %1 по %2';uk='Период: с %1 по %2'");
	...
	ЗаголовокЗаявки = НСтр("ru='Заявка №%1 от %2';uk='Заявка №%1 от %2'");
	...
	Если Не ПрограммноеЗакрытие Тогда
		...
		Если Модифицированность Тогда
			...
			Если ЗавершениеРаботы Тогда
				ТекстПредупреждения =
					НСтр("ru='Заявка на изменение тарифа обмена электронными документами не отправлена.';uk='Заявка на изменение тарифа обмена электронными документами не отправлена.'");
			Иначе
				ОписаниеОповещения = Новый ОписаниеОповещения(
					"ПриОтветеНаВопросОЗакрытииМодифицированнойФормы",
					ЭтотОбъект);
				ТекстВопроса = НСтр("ru='Данные изменены. Закрыть форму без сохранения данных?';uk='Данные изменены. Закрыть форму без сохранения данных?'");
...
""
"%1';uk='Не получается изменить тариф работы с оператором обмена ЭД."
""
"%1'");
		...
		ИнтернетПоддержкаПользователейКлиент.ОтправитьСообщениеВТехПоддержку(
			НСтр("ru='Интернет-поддержка. Изменение тарифа в 1С-Такском.';uk='Интернет-поддержка. Изменение тарифа в 1С-Такском.'"),
			ТекстСообщения,
			"taxcom",
			,
...
Процедура УстановитьНадписьНаГиперссылкеОбновленияСтатуса()
	...
	ТекстЗаголовка = НСтр("ru='Проверить выполнение заявки (осталось %1 сек.)';uk='Проверить выполнение заявки (осталось %1 сек.)'");
