...
"Сохранить изменения?';uk='Адрес участника обмена электронными документами изменен."
"Сохранить изменения?'");
...
Процедура КодРегионаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если СписокКодовРегионов = Неопределено Тогда
		...
		ТекстПредупреждения = НСтр("ru='Список кодов еще не загружен. Нажмите на ссылку ""Загрузить"" или введите код региона вручную.';uk='Список кодов еще не загружен. Нажмите на ссылку ""Загрузить"" или введите код региона вручную.'");
	...
	СписокКодовРегионов.ПоказатьВыборЭлемента(
		ОписаниеОповещения,
		НСтр("ru='Коды регионов';uk='Коды регионов'"),
