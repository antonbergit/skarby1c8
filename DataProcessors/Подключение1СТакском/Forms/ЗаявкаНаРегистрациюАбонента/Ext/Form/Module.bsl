...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если СтатусФормы = "new" ИЛИ НЕ ЗначениеЗаполнено(СтатусФормы) Тогда
		...
		Элементы.НадписьЗаголовкаФормы.Заголовок = НСтр("ru='Заявка на регистрацию участника обмена ЭД';uk='Заявка на регистрацию участника обмена ЭД'");
		Элементы.НадписьСтатусаЗаявки.Заголовок = НСтр("ru='Новая заявка';uk='Новая заявка'");
	...
	ИначеЕсли СтатусФормы = "change" Тогда
		...
		Элементы.НадписьЗаголовкаФормы.Заголовок = НСтр("ru='Изменение данных участника обмена ЭД';uk='Изменение данных участника обмена ЭД'");
		Элементы.НадписьСтатусаЗаявки.Заголовок = НСтр("ru='Новая заявка';uk='Новая заявка'");
		Элементы.ОтправитьЗаявку.Видимость = Истина;
	...
	ИначеЕсли СтатусФормы = "show" Тогда
		...
		ТекстЗаголовка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Заявка №%1 от %2';uk='Заявка №%1 от %2'"),
			НомерЗаявки,
	...
	Если НЕ ЗначениеЗаполнено(СтатусЗаявки) ИЛИ СтатусЗаявки = "none" Тогда
		...
		ТекстСтатуса = НСтр("ru='Новая заявка.';uk='Новая заявка.'");
		Элементы.НадписьПричина.Видимость = Ложь;
		
	ИначеЕсли СтатусЗаявки = "notconsidered" Тогда
		
		ТекстСтатуса = НСтр("ru='Заявка оператором еще не рассмотрена.';uk='Заявка оператором еще не рассмотрена.'");
		Элементы.НадписьПричина.Видимость = Ложь;
		
	ИначеЕсли СтатусЗаявки = "rejected" Тогда
		
		ТекстСтатуса = НСтр("ru='Заявка оператором отклонена.';uk='Заявка оператором отклонена.'");
		Элементы.НадписьПричина.Видимость = Истина;
		
	Иначе
		
		// Статус заявки - "obtained".
		ТекстСтатуса = НСтр("ru='Заявка успешно выполнена оператором';uk='Заявка успешно выполнена оператором'");
		Элементы.НадписьПричина.Видимость = Ложь;
	...
	Если Не ПрограммноеЗакрытие Тогда
		...
		Если Модифицированность Тогда
			...
			Если ЗавершениеРаботы Тогда
				ТекстПредупреждения =
					НСтр("ru='Заявка на регистрацию данных участника обмена электронными документами не отправлена.';uk='Заявка на регистрацию данных участника обмена электронными документами не отправлена.'");
			Иначе
				ОписаниеОповещения = Новый ОписаниеОповещения(
					"ПриОтветеНаВопросОЗакрытииМодифицированнойФормы",
					ЭтотОбъект);
				
				ТекстВопроса = НСтр("ru='Данные заявки изменены. Закрыть форму без сохранения данных?';uk='Данные заявки изменены. Закрыть форму без сохранения данных?'");
...
"%2'");
		...
		Если СтатусФормы = "new" ИЛИ ПустаяСтрока(СтатусФормы) Тогда
			ЧтоНеПолучилось = НСтр("ru='Не получается отправить заявку на регистрацию участника обмена ЭД';uk='Не получается отправить заявку на регистрацию участника обмена ЭД'");
		ИначеЕсли СтатусФормы = "change" Тогда
			ЧтоНеПолучилось = НСтр("ru='Не получается отправить заявку на изменение данных участника обмена ЭД';uk='Не получается отправить заявку на изменение данных участника обмена ЭД'");
		ИначеЕсли СтатусФормы = "show" Тогда
			ЧтоНеПолучилось = НСтр("ru='Возникли проблемы с заявкой участника обмена ЭД';uk='Возникли проблемы с заявкой участника обмена ЭД'");
		КонецЕсли;
		...
		ИнтернетПоддержкаПользователейКлиент.ОтправитьСообщениеВТехПоддержку(
			НСтр("ru='Интернет-поддержка. Заявка на регистрацию участника обмена ЭД в 1С-Такском';uk='Интернет-поддержка. Заявка на регистрацию участника обмена ЭД в 1С-Такском'"),
			ТекстСообщения,
			"taxcom",
			,
...
Процедура ОтправитьЗаявку(Команда)
	...
	Если ПустаяСтрока(Организация) Тогда
		...
		Сообщение.Текст = НСтр("ru='Не заполнено поле ""Организация""';uk='Не заполнено поле ""Организация""'");
	...
	Если ПустаяСтрока(Адрес) Тогда
		Ошибка    = Истина;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru='Не заполнено поле ""Адрес""';uk='Не заполнено поле ""Адрес""'");
	...
	Если ПустаяСтрока(Телефон) Тогда
		Ошибка    = Истина;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru='Не заполнено поле ""Телефон""';uk='Не заполнено поле ""Телефон""'");
	...
	Если ПустаяСтрока(КодРегиона) Тогда
		...
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст =
			НСтр("ru='Не указан ""Код региона"" (Код региона нужно указать в форме ""Адрес участника обмена ЭД"")';uk='Не указан ""Код региона"" (Код региона нужно указать в форме ""Адрес участника обмена ЭД"")'");
		Сообщение.Поле = "Адрес";
		Сообщение.Сообщить();
	КонецЕсли;
	...
	Если ПустаяСтрока(ИНН) Тогда
		Ошибка    = Истина;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru='Не заполнено поле ""ИНН""';uk='Не заполнено поле ""ИНН""'");
		Сообщение.Поле = "ИНН";
		Сообщение.Сообщить();
	КонецЕсли;
	...
	Если ЮрФизЛицо <> "ЮрЛицо" И ЮрФизЛицо <> "ФизЛицо" Тогда
		Ошибка    = Истина;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru='Не выбран тип организации (юридическое или физическое лицо)';uk='Не выбран тип организации (юридическое или физическое лицо)'");
	...
	Если ПустаяСтрока(КПП) И ЮрФизЛицо = "ЮрЛицо" Тогда
		Ошибка    = Истина;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru='Не заполнено поле ""КПП""';uk='Не заполнено поле ""КПП""'");
		Сообщение.Поле = "КПП";
		Сообщение.Сообщить();
	КонецЕсли;
	...
	Если ПустаяСтрока(ОГРН) И ЮрФизЛицо = "ЮрЛицо" Тогда
		Ошибка    = Истина;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru='Не заполнено поле ""ОГРН""';uk='Не заполнено поле ""ОГРН""'");
		Сообщение.Поле = "ОГРН";
		Сообщение.Сообщить();
	КонецЕсли;
	...
	Если ПустаяСтрока(КодНалоговогоОргана) Тогда
		Ошибка    = Истина;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru='Не заполнено поле ""Код налогового органа""';uk='Не заполнено поле ""Код налогового органа""'");
	...
	Если ПустаяСтрока(Фамилия) Тогда
		Ошибка    = Истина;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru='Не заполнено поле ""Фамилия""';uk='Не заполнено поле ""Фамилия""'");
	...
	Если ПустаяСтрока(Имя) Тогда
		Ошибка    = Истина;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru='Не заполнено поле ""Имя""';uk='Не заполнено поле ""Имя""'");
		Сообщение.Поле = "Имя";
		Сообщение.Сообщить();
	КонецЕсли;
	...
	Если НЕ ПустаяСтрока(Телефон) Тогда
		Если СтрДлина(Телефон) > 20 Тогда
			Ошибка    = Истина;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ru='""Телефон"" должен содержать не более 20 символов';uk='""Телефон"" должен содержать не более 20 символов'");
			Сообщение.Поле = "Телефон";
			Сообщение.Сообщить();
		КонецЕсли;
	КонецЕсли;
	...
	Если НЕ ПустаяСтрока(КодРегиона) Тогда
		Попытка
			...
			Если СтрДлина(СокрЛП(КодРегиона)) <> 2 Тогда
				Ошибка    = Истина;
				Сообщение = Новый СообщениеПользователю;
				Сообщение.Текст = НСтр("ru='""Код региона"" должен содержать 2 цифры';uk='""Код региона"" должен содержать 2 цифры'");
				Сообщение.Поле = "Адрес";
				Сообщение.Сообщить();
			Иначе
				Если КодРегионаЧисло > 99 ИЛИ КодРегионаЧисло < 1 Тогда
					Ошибка    = Истина;
					Сообщение = Новый СообщениеПользователю;
					Сообщение.Текст = НСтр("ru='""Код региона"" должен быть от 01 до 99';uk='""Код региона"" должен быть от 01 до 99'");
		...
		Исключение
			Ошибка    = Истина;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ru='В ""Коде региона"" использованы недопустимые символы';uk='В ""Коде региона"" использованы недопустимые символы'");
			Сообщение.Поле = "Адрес";
			Сообщение.Сообщить();
		КонецПопытки;
	КонецЕсли;
	...
	Если НЕ ПустаяСтрока(ИНН) Тогда
		Попытка
			...
			Если СтрДлина(СокрЛП(ИНН)) <> 12 И ЮрФизЛицо = "ФизЛицо" Тогда
				Ошибка    = Истина;
				Сообщение = Новый СообщениеПользователю;
				Сообщение.Текст = НСтр("ru='""ИНН"" должен содержать 12 цифр';uk='""ИНН"" должен содержать 12 цифр'");
				Сообщение.Поле = "ИНН";
				Сообщение.Сообщить();
			ИначеЕсли СтрДлина(СокрЛП(ИНН)) <> 10 И ЮрФизЛицо = "ЮрЛицо" Тогда
				Ошибка    = Истина;
				Сообщение = Новый СообщениеПользователю;
				Сообщение.Текст = НСтр("ru='""ИНН"" должен содержать 10 цифр';uk='""ИНН"" должен содержать 10 цифр'");
				Сообщение.Поле = "ИНН";
				Сообщение.Сообщить();
			КонецЕсли;
		Исключение
			Ошибка    = Истина;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ru='В ""ИНН"" использованы недопустимые символы';uk='В ""ИНН"" использованы недопустимые символы'");
			Сообщение.Поле = "ИНН";
			Сообщение.Сообщить();
		КонецПопытки;
	КонецЕсли;
	...
	Если НЕ ПустаяСтрока(КПП) Тогда
		Попытка
			...
			Если СтрДлина(СокрЛП(КПП)) <> 9 Тогда
				Ошибка    = Истина;
				Сообщение = Новый СообщениеПользователю;
				Сообщение.Текст = НСтр("ru='""КПП"" должен содержать 9 цифр';uk='""КПП"" должен содержать 9 цифр'");
				Сообщение.Поле = "КПП";
				Сообщение.Сообщить();
			КонецЕсли;
		Исключение
			Ошибка    = Истина;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ru='В ""КПП"" использованы недопустимые символы';uk='В ""КПП"" использованы недопустимые символы'");
			Сообщение.Поле = "КПП";
			Сообщение.Сообщить();
		КонецПопытки;
	КонецЕсли;
	...
	Если НЕ ПустаяСтрока(ОГРН) Тогда
		Попытка
			...
			Если СтрДлина(СокрЛП(ОГРН)) <> 13  И ЮрФизЛицо = "ЮрЛицо" Тогда
				Ошибка    = Истина;
				Сообщение = Новый СообщениеПользователю;
				Сообщение.Текст = НСтр("ru='""ОГРН"" должен содержать 13 цифр';uk='""ОГРН"" должен содержать 13 цифр'");
				Сообщение.Поле = "ОГРН";
				Сообщение.Сообщить();
			ИначеЕсли СтрДлина(СокрЛП(ОГРН)) <> 15  И ЮрФизЛицо = "ФизЛицо" Тогда
				Ошибка    = Истина;
				Сообщение = Новый СообщениеПользователю;
				Сообщение.Текст = НСтр("ru='""ОГРН"" должен содержать 15 цифр';uk='""ОГРН"" должен содержать 15 цифр'");
				Сообщение.Поле = "ОГРН";
				Сообщение.Сообщить();
			КонецЕсли;
		Исключение
			Ошибка    = Истина;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ru='В ""ОГРН"" использованы недопустимые символы';uk='В ""ОГРН"" использованы недопустимые символы'");
			Сообщение.Поле = "ОГРН";
			Сообщение.Сообщить();
		КонецПопытки;
	КонецЕсли;
	...
	Если НЕ ПустаяСтрока(КодНалоговогоОргана) Тогда
		Попытка
			...
			Если СтрДлина(СокрЛП(КодНалоговогоОргана)) <> 4 Тогда
				Ошибка    = Истина;
				Сообщение = Новый СообщениеПользователю;
				Сообщение.Текст = НСтр("ru='""Код налогового органа"" должен содержать 4 цифры';uk='""Код налогового органа"" должен содержать 4 цифры'");
				Сообщение.Поле = "КодНалоговогоОргана";
				Сообщение.Сообщить();
			КонецЕсли;
		Исключение
			Ошибка    = Истина;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ru='В ""Коде налогового органа"" использованы недопустимые символы';uk='В ""Коде налогового органа"" использованы недопустимые символы'");
			Сообщение.Поле = "КодНалоговогоОргана";
			Сообщение.Сообщить();
		КонецПопытки;
	КонецЕсли;
