...
"Попробуйте выполнить операцию позже.';uk='Помилка конкурентного доступу до налаштувань дозволів на використання зовнішніх ресурсів."
"Спробуйте виконати операцію пізніше.'");
		КонецПопытки;
