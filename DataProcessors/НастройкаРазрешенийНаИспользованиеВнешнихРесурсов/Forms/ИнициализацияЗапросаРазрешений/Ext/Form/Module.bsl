...
Процедура ОтменитьОбработкуЗапросов(Знач ИдентификаторЗадания)
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(НСтр("ru='Настройка разрешений на использование внешних ресурсов.Отмена выполнения фонового задания';uk='Налаштування дозволів на використання зовнішніх ресурсів.Скасування виконання фонового завдання'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
