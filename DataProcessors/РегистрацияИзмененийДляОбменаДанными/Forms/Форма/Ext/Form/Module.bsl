...
"на узле ""%1""?';uk='Зареєструвати дані для відновлення підлеглого вузла РІБ"
"на вузлі ""%1""?'"),
		"%1", УзелОбменаСсылка);
...
"Настроить сейчас?';uk='У налаштуваннях не зазначена обробка для виконання запитів."
"Настроїти зараз?'");
	
	ЗаголовокВопроса = НСтр("ru='Настройки';uk='Налаштування'");
...
"1С:Предприятие 8.3.5 с отключенным режимом совместимости или выше';uk='Обробка призначена для запуску на версії платформи"
"1С:Підприємство 8.3.5 з відключеним режимом сумісності або вище'");
