...
Процедура ПерепроведениеДокументов(СтруктураПараметров, АдресХранилища) Экспорт
	...
	Для Индекс = 0 ПО ВсегоДокументов - 1 Цикл
		...
		Исключение
			...
			ТекстСообщения = НСтр("ru='Документ %1 не проведен! %2 По причине: %3';uk='Документ %1 не проведений! % 2 Через: %3'");
...
"Необходимо исправить указанные ошибки, после чего принять решение о повторном перепроведении документов.';uk='При перепроведенні виявлене %1 помилок. "
"Повідомлення про перші 50 помилок надані до ознайомлення. "
"Необхідно виправити зазначені помилки, після чого ухвалити рішення щодо повторного перепроведення документів.'");
