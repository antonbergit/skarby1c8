...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипЗнч(МассивЭлементов) <> Тип("Массив") Тогда
		ВызватьИсключение НСтр("ru='В форму создания контрагентов переданы некорректные параметры.';uk='В форму создания контрагентов переданы некорректные параметры.'");
	КонецЕсли;
	...
	ЗаголовокКоманды = НСтр("ru='Создать контрагентов (%КоличествоЭлементов%)';uk='Создать контрагентов (%КоличествоЭлементов%)'");
