...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Шаблон = НСтр("ru='Конфигурация: [СинонимКонфигурации] ([ВерсияКонфигурации])
				|Платформа: 1С:Предприятие ([ВерсияПлатформы])
				|Идентификатор базы: [ИдентификаторБазы]';uk='Конфігурація: [СинонимКонфигурации] ([ВерсияКонфигурации])
				|Платформа: 1С:Підприємство ([ВерсияПлатформы])
				|Идентіфікатор бази: [ИдентификаторБазы]'");
...
Процедура Отправить(Команда)
	...
	Получатель.Добавить("unf@hvoya.com.ua", НСтр("ru='ООО ХВОЯ Интегра';uk='ТОВ ХВОЯ Інтегра'"));
	
	ПараметрыПисьма = Новый Структура;
	ПараметрыПисьма.Вставить("Получатель", Получатель);
	ПараметрыПисьма.Вставить("Тема", НСтр("ru='Хочу эти возможности в будущей версии';uk='Хочу ці можливості в майбутній версії'"));
...
Процедура СформироватьОписанияРазделов(СтрокиДерева)
	...
	Для Каждого СтрокаДерева Из СтрокиДерева Цикл
		...
		Если СтрокаДерева.Строки.Количество() = 0 Тогда
			...
			ГруппаПотенциальные.Заголовок = НСтр("ru='Хочу эти возможности в будущей версии';uk='Хочу ці можливості в майбутній версії'");
			...
			ГруппаСвояВозможность.Заголовок = НСтр("ru='Не нашли нужную возможность? Предложите свою';uk='Не знайшли потрібну можливість? Запропонуйте свою'");
