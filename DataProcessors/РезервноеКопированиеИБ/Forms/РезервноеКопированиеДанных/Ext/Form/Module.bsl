...
"Подготовка к резервному копированию отменена. Информационная база разблокирована.';uk='%1."
"Підготовка до резервного копіювання скасована. Інформаційна база розблокована.'"),
