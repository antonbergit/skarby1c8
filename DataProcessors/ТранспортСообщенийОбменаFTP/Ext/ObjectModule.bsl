...
Процедура ИнициализацияСообщенийОшибок()
	...
	СообщенияОшибок.Вставить(106, НСтр("ru='Ошибка удаления файла на FTP-сервере, проверьте права доступа к ресурсу.';uk='Помилка видалення файлу на Ftp-сервері, перевірте права доступу до ресурсу.'"));
...
"Рекомендується також звернутися до документації по FTP-серверу для налаштування підтримки імен файлів з кирилицею.'");
