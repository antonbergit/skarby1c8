...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ПоДублям Тогда
		...
		Заголовок = НСтр("ru='Дублирующиеся номера КиЗ';uk='Дублирующиеся номера КиЗ'");
	...
	ИначеЕсли Параметры.ПоПроблемамСопоставления Тогда
		...
		Заголовок = НСтр("ru='Номера КиЗ, несопоставленные заказанным';uk='Номера КиЗ, несопоставленные заказанным'");
