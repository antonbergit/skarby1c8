...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если СписокПечатаемыхЛистов.Количество() = 0 Тогда
		...
		Сообщение.Текст = НСтр("ru='Не выбраны листы для вывода на печать.';uk='Не выбраны листы для вывода на печать.'");
...
Процедура СформироватьТекстПодсказки()
	...
	ТекстСтатистики = НСтр("ru='Всего: ';uk='Всего: '") + КоличествоЛистовТребуется + " " + ТекстЛистовТребуется + НСтр("ru=' бумаги';uk=' бумаги'");
...
Процедура ВыгрузитьНаДиск(ВФормате)
	...
	Если КоличествоВыбранныхТабличныхДокументов() = 0 Тогда
		ПоказатьПредупреждение(,НСтр("ru='Выберите листы в дереве печатаемых листов.';uk='Выберите листы в дереве печатаемых листов.'"));
		Возврат;
	КонецЕсли;
