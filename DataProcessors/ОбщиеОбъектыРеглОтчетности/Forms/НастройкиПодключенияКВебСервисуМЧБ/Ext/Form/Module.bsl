...
"или закройте окно вручную, до выхода из программы.';uk='Настройки не сохранены."
"Нажмите кнопку [Сохранить и закрыть]"
"или закройте окно вручную, до выхода из программы.'");
	...
	Если Модифицированность И мЗадаватьВопросПриЗакрытии Тогда
		...
		ПоказатьВопрос(Оповещение, НСтр("ru='Сохранить настройки?';uk='Зберегти налаштування?'"), РежимДиалогаВопрос.ДаНетОтмена);
		Отказ = Истина;
