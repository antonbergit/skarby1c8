...
Процедура ПредставлениеЕдиницыИзмеренияПриИзменении(Элемент)
	...
	Если ПредставлениеЕдиницыИзмерения = НСтр("ru='в гривнях';uk='у гривнях'") Тогда
		ЕдиницаИзмерения = ПеречислениеПорядкиОкругленияОтчетностиОкр1;
	ИначеЕсли ПредставлениеЕдиницыИзмерения = НСтр("ru='в тысячах гривень';uk='у тисячах гривень'") Тогда
		ЕдиницаИзмерения = ПеречислениеПорядкиОкругленияОтчетностиОкр1000;
	ИначеЕсли ПредставлениеЕдиницыИзмерения = НСтр("ru='в миллионах гривень';uk='у мільйонах гривень'") Тогда
