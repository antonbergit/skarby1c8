...
"иначе измененные настройки будут утеряны.';uk='Настройки были изменены."
"Перед завершением работы рекомендуется их сохранить,"
"иначе измененные настройки будут утеряны.'");
		...
		ПоказатьВопрос(ОписаниеОповещения, НСтр("ru='Сохранить настройки?';uk='Зберегти налаштування?'"), РежимДиалогаВопрос.ДаНетОтмена);
