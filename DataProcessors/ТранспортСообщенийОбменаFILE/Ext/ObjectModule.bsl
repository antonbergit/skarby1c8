...
Процедура ИнициализацияСообщенийОшибок()
	...
	СообщенияОшибок.Вставить(9, НСтр("ru='Ошибка удаления файла из каталога обмена информацией. Проверьте права пользователя на доступ к каталогу.';uk='Помилка видалення файлу з каталогу обміну інформацією. Перевірте права користувача на доступ до каталогу.'"));
