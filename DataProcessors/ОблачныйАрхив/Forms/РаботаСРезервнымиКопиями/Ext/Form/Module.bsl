...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ДекорацияГиперссылкаКабинетКлиента.Подсказка =
		СтрШаблон(
			НСтр("ru='Логин: %1';uk='Логин: %1'"),
			?(ПустаяСтрока(ЭтотОбъект.Логин), НСтр("ru='не введен, будет запрошен в браузере.';uk='не введен, будет запрошен в браузере.'"), ЭтотОбъект.Логин));
	...
	Элементы.ФильтрПоЭтойИБ.Подсказка = СтрШаблон(НСтр("ru='Идентификатор ИБ: %1';uk='Идентификатор ИБ: %1'"), ЭтотОбъект.ИдентификаторИБ);
...
Процедура КомандаУдалитьФайл(Команда)
	...
	Если ТекущиеДанные <> Неопределено Тогда
		...
		СписокКнопок.Добавить(НСтр("ru='Удалить';uk='Видалити'")); // Идентификатор
		СписокКнопок.Добавить(НСтр("ru='Отмена';uk='Відмінити'")); // Идентификатор
		...
		ПоказатьВопрос(
			...
			НСтр("ru='Удалить файл с сервера?';uk='Удалить файл с сервера?'"),
			СписокКнопок,
			0,
			НСтр("ru='Отмена';uk='Відмінити'"), // Идентификатор
			НСтр("ru='Запрос на удаление файла с сервера';uk='Запрос на удаление файла с сервера'"));
	КонецЕсли;
...
Процедура УдалитьФайл_НаКлиенте(РезультатВопроса, ДополнительныеПараметры) Экспорт
	...
	Если РезультатВопроса = НСтр("ru='Удалить';uk='Видалити'") Тогда // Идентификатор
