...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтотОбъект.КоманднаяСтрокаДругойКомпьютер = 
		НСтр("ru='<Путь к установленному Агенту резервного копирования>';uk='<Путь к установленному Агенту резервного копирования>'")
		+ ПолучитьРазделительПути()
		+ "BackupAgent.exe stop_backup -db_id="
		+ ИдентификаторИБ_Полный;
	...
	Если НЕ РезультатЗапроса.Пустой() Тогда
		...
		ТекстПодсказки = НСтр("ru='Агенты резервного копирования были установлены на следующих компьютерах:';uk='Агенты резервного копирования были установлены на следующих компьютерах:'")
			+ Символы.ПС
			+ ТекстПодсказки;
