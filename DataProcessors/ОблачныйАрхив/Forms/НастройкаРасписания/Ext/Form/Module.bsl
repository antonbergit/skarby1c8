...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтаФорма.Еженедельно_ДниНедели.Добавить(1, НСтр("ru='Понедельник';uk='Понеділок'"), Ложь);
	ЭтаФорма.Еженедельно_ДниНедели.Добавить(2, НСтр("ru='Вторник';uk='Вівторок'"), Ложь);
	ЭтаФорма.Еженедельно_ДниНедели.Добавить(3, НСтр("ru='Среда';uk='Середа'"), Ложь);
	ЭтаФорма.Еженедельно_ДниНедели.Добавить(4, НСтр("ru='Четверг';uk='Четвер'"), Ложь);
	ЭтаФорма.Еженедельно_ДниНедели.Добавить(5, НСтр("ru='Пятница';uk='П`ятниця'"), Ложь);
	ЭтаФорма.Еженедельно_ДниНедели.Добавить(6, НСтр("ru='Суббота';uk='Субота'"), Ложь);
	ЭтаФорма.Еженедельно_ДниНедели.Добавить(7, НСтр("ru='Воскресенье';uk='Неділя'"), Ложь);

	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Очистить();
	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(1, НСтр("ru='Понедельник';uk='Понеділок'"), Ложь);
	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(2, НСтр("ru='Вторник';uk='Вівторок'"), Ложь);
	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(3, НСтр("ru='Среда';uk='Середа'"), Ложь);
	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(4, НСтр("ru='Четверг';uk='Четвер'"), Ложь);
	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(5, НСтр("ru='Пятница';uk='П`ятниця'"), Ложь);
	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(6, НСтр("ru='Суббота';uk='Субота'"), Ложь);
	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(7, НСтр("ru='Воскресенье';uk='Неділя'"), Ложь);
...
Процедура КомандаЗаписатьИЗакрыть(Команда)
	...
	Если ПустаяСтрока(ЭтаФорма.Вариант) Тогда
		ПоказатьОповещениеПользователя(
			,
			,
			НСтр("ru='Расписание не было настроено';uk='Расписание не было настроено'"),
