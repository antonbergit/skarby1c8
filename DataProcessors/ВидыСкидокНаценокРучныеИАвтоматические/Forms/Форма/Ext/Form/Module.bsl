...
"по полю ""Порядок"". Настроить необходимую сортировку?';uk='Сортування списку рекомендується встановити"
"по полю ""Порядок"". Настроїти необхідне сортування?'");
		...
		Кнопки.Добавить(КодВозвратаДиалога.Да, НСтр("ru='Настроить';uk='Налаштувати'"));
...
Процедура УстановитьСортировкуСпискаПоПолюПорядокНаКлиенте()
	...
	ОбщегоНазначенияКлиентСервер.Проверить(ПользовательскиеНастройкиПорядка <> Неопределено, НСтр("ru='Пользовательская настройка порядка не найдена.';uk='Користувацьке налаштування порядку не знайдене.'"));
...
Процедура УправлениеВидимостьюСервер()
	...
	Если ИспользоватьАвтоматическиеСкидкиНаценки И Не ИспользоватьСкидкиНаценки Тогда
		...
		Заголовок = НСтр("ru='Виды автоматических скидок, наценок';uk='Види автоматичних знижок, націнок'");
	ИначеЕсли Не ИспользоватьАвтоматическиеСкидкиНаценки И ИспользоватьСкидкиНаценки Тогда
		...
		Элементы.ГруппаРучныеИАвтоматическиеСкидки.ОтображениеСтраниц = ОтображениеСтраницФормы.Нет;
		Заголовок = НСтр("ru='Виды скидок, наценок';uk='Види знижок, націнок'");
	Иначе
		...
		Заголовок = НСтр("ru='Скидки и наценки';uk='Знижки і націнки'");
	КонецЕсли;
