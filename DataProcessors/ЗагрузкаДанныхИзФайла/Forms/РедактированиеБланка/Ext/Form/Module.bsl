...
Процедура СброситьНастройки(Команда)
	...
	ПоказатьВопрос(Оповещение, НСтр("ru='Установить настройки колонок в первоначальное состояние?';uk='Встановити налаштування стовпчиків у первісний стан?'"), РежимДиалогаВопрос.ДаНет);
КонецПроцедуры
