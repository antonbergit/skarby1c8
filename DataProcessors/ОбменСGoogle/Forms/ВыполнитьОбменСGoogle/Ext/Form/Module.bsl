...
Функция ЗаголовокВыполняетсяОбменGoogle()
	...
	Если ОбластьДоступа = Перечисления.ОбластиДоступаGoogle.Контакты Тогда
		Возврат НСтр("ru='Выполняется загрузка контактов из Google...';uk='Виконується завантаження контактів з Google...'");
	ИначеЕсли ОбластьДоступа = Перечисления.ОбластиДоступаGoogle.Календарь Тогда
		Возврат НСтр("ru='Выполняется синхронизация календаря с Google...';uk='Виконується синхронізація календаря з Google...'");
	КонецЕсли;
	
	ВызватьИсключение НСтр("ru='Не указана область доступа для синхронизации с Google';uk='Не зазначена область доступу для синхронізації з Google'");
