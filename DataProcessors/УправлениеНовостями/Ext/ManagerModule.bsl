...
"'");
	...
	ЛогШаговВыполнения.Добавить(
		Новый Структура("Шаг, ВремяНачала, ВремяОкончания",
			НСтр("ru='Загрузка: Получение настроек, формирование списка лент новостей';uk='Завантаження: Одержання налаштувань, формування списку стрічок новин'"),
			ТШаг,
...
"%ИнформацияОбОшибке%';uk='Помилка одержання новин з метаданих %ИмяФайла% для стрічки новин %ЛентаНовостей% через"
"%ИнформацияОбОшибке%'");
								...
								ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
									НСтр("ru='БИП:Новости.Загрузка новостей';uk='БІП:Новини.Завантаження новин'"), // ИмяСобытия
									НСтр("ru='Новости. Загрузка новостей. Загрузка файлов новостей. Ошибка получения файла из метаданных';uk='Новини. Завантаження новин. Завантаження файлів новин. Помилка одержання файлу з метаданих'"), // ИдентификаторШага
							...
							Если ЕстьОшибки = Ложь Тогда
								Попытка
									Если ТипЗнч(ОбъектМетаданныхМакет) = Тип("ОбъектМетаданных") Тогда
										...
										Иначе
											Макет = Неопределено;
											ТекстСообщения = НСтр("ru='Ошибка получения новостей из макета %ИмяФайла% для ленты новостей %ЛентаНовостей% - эти метаданные не обрабатываются';uk='Помилка одержання новин з макета %ИмяФайла% для стрічки новин %ЛентаНовостей% - ці метадані не обробляються'");
											ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИмяФайла%", ТекущаяЛентаНовостей.ИмяФайла);
											ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ТекущаяЛентаНовостей.ЛентаНовостей);
											// Запись в журнал регистрации
											ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
...
"%ИнформацияОбОшибке%"
""
"Рекомендуется вручную удалить этот временный файл.';uk='ЗагрузитьФайлыНовостейССервера (получено из макета): Не удалось удалить временный файл %ИмяВременногоФайла% для ленты новостей %ЛентаНовостей% по причине:"
"%ИнформацияОбОшибке%"
""
"Рекомендуется вручную удалить этот временный файл.'");
													...
													ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
														НСтр("ru='БИП:Новости.Загрузка новостей';uk='БІП:Новини.Завантаження новин'"), // ИмяСобытия
														НСтр("ru='Новости. Загрузка новостей. Загрузка файлов новостей. Ошибка удаления временного файла';uk='Новости. Загрузка новостей. Загрузка файлов новостей. Ошибка удаления временного файла'"), // ИдентификаторШага
												...
												КонецПопытки;
											Иначе
												ТекстСообщения = НСтр("ru='Ошибка получения новостей из макета %ИмяФайла% для ленты новостей %ЛентаНовостей%: возможна загрузка только из текстового макета';uk='Помилка одержання новин з макета %ИмяФайла% для стрічки новин %ЛентаНовостей%: можливе завантаження тільки з текстового макета'");
												ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИмяФайла%", ТекущаяЛентаНовостей.ИмяФайла);
												ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ТекущаяЛентаНовостей.ЛентаНовостей);
												// Запись в журнал регистрации
												ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
									...
									КонецЕсли;
								Исключение
									ТекстСообщения = НСтр("ru='Ошибка получения новостей из макета %ИмяФайла% для ленты новостей %ЛентаНовостей% по причине %ИнформацияОбОшибке%';uk='Помилка одержання новин з макета %ИмяФайла% для стрічки новин %ЛентаНовостей% через %ИнформацияОбОшибке%'");
									ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИмяФайла%", ТекущаяЛентаНовостей.ИмяФайла);
									ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ТекущаяЛентаНовостей.ЛентаНовостей);
									ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИнформацияОбОшибке%", ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
									// Запись в журнал регистрации
					...
					КонецЕсли;
				Исключение
					ТекстСообщения = НСтр("ru='Ошибка получения файла %ИмяФайла% для ленты новостей %ЛентаНовостей% по причине %ИнформацияОбОшибке%';uk='Помилка одержання файлу %ИмяФайла% для стрічки новин %ЛентаНовостей% через %ИнформацияОбОшибке%'");
					ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИмяФайла%", ТекущаяЛентаНовостей.ИмяФайла);
					ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ТекущаяЛентаНовостей.ЛентаНовостей);
					ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИнформацияОбОшибке%", ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
					// Запись в журнал регистрации
					ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
						НСтр("ru='БИП:Новости.Загрузка новостей';uk='БІП:Новини.Завантаження новин'"), // ИмяСобытия
						НСтр("ru='Новости. Загрузка новостей. Загрузка файлов новостей. Ошибка получения файла';uk='Новини. Завантаження новин. Завантаження файлів новин. Помилка одержання файлу'"), // ИдентификаторШага
						УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
						, // ОбъектМетаданных
						, // Данные
						ТекстСообщения, // Комментарий
...
"Успешно? %Успешно%';uk='Завантаження: завантаження файлу новин зі стрічки новин %ЛентаНовостей% (протокол %Протокол%, сайт %Сайт%, ім`я файлу %ИмяФайла%)."
"Успішно? %Успешно%'");
...
"Успешно? %СоединениеУстановлено%';uk='Завантаження: установка http/https з`єднання (протокол %Протокол%)."
...
"(URL %URL%).';uk='Початок спроби %ПопыткаПолученияФайла% / %HTTPСоединениеКоличествоПопытокПолученияФайла% одержання файлу %ИмяФайла% із сервера %Сайт% для стрічки новин %ЛентаНовостей% у тимчасовий файл %ИмяВременногоФайла%."
"(URL %URL%).'");
								...
								ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
									НСтр("ru='БИП:Новости.Загрузка новостей';uk='БІП:Новини.Завантаження новин'"), // ИмяСобытия
									НСтр("ru='Новости. Загрузка новостей. Загрузка файлов новостей. Получение файлов с сервера новостей. Начало загрузки';uk='Новини. Завантаження новин. Завантаження файлів новин. Одержання файлів із сервера новин. Початок завантаження'"), // ИдентификаторШага
									УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
									, // ОбъектМетаданных
									, // Данные
									ТекстСообщения, // Комментарий
...
""
"(URL %URL%)"
"Время загрузки (сек): %ВремяЗагрузки%';uk='При спробі %ПопыткаПолученияФайла% / %HTTPСоединениеКоличествоПопытокПолученияФайла% одержання файлу %ИмяФайла% із сервера %Сайт% для стрічки новин %ЛентаНовостей% у тимчасовий файл отримана відповідь сервера з кодом %КодОтвета%, заголовки:"
"%Заголовки%"
""
"(URL %URL%)"
"Час завантаження (сек): %ВремяЗагрузки%'");
								...
								ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
									НСтр("ru='БИП:Новости.Загрузка новостей';uk='БІП:Новини.Завантаження новин'"), // ИмяСобытия
									НСтр("ru='Новости. Загрузка новостей. Загрузка файлов новостей. Получение файлов с сервера новостей. Конец загрузки';uk='Новини. Завантаження новин. Завантаження файлів новин. Одержання файлів із сервера новин. Кінець завантаження'"), // ИдентификаторШага
									УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
									, // ОбъектМетаданных
									, // Данные
									ТекстСообщения, // Комментарий
...
""
"Первые строки файла:"
"%ПервыеСтрокиФайла%';uk='Успішне завершення спроби %ПопыткаПолученияФайла% / %HTTPСоединениеКоличествоПопытокПолученияФайла% одержання файлу %ИмяФайла% із сервера %Сайт% для стрічки новин %ЛентаНовостей% у тимчасовий файл %ИмяВременногоФайла%."
...
"%ПервыеСтрокиФайла%'");
									...
									ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
										НСтр("ru='БИП:Новости.Загрузка новостей';uk='БІП:Новини.Завантаження новин'"), // ИмяСобытия
										НСтр("ru='Новости. Загрузка новостей. Загрузка файлов новостей. Получение файлов с сервера новостей. Успешная проверка чтения временного файла после загрузки';uk='Новини. Завантаження новин. Завантаження файлів новин. Одержання файлів із сервера новин. Успішна перевірка читання тимчасового файлу після завантаження'"), // ИдентификаторШага
										УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
										, // ОбъектМетаданных
										, // Данные
										ТекстСообщения, // Комментарий
...
"%ИнформацияОбОшибке%"
""
"Рекомендуется вручную удалить этот временный файл.';uk='ЗагрузитьФайлыНовостейССервера (получено из интернет): Не удалось удалить временный файл %ИмяВременногоФайла% для ленты новостей %ЛентаНовостей% по причине:"
"%ИнформацияОбОшибке%"
""
"Рекомендуется вручную удалить этот временный файл.'");
										ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИмяВременногоФайла%", СокрЛП(ИмяВременногоФайла));
...
"(URL %URL%).';uk='Невдале завершення спроби %ПопыткаПолученияФайла% / %HTTPСоединениеКоличествоПопытокПолученияФайла% одержання файлу %ИмяФайла% із сервера %Сайт% для стрічки новин %ЛентаНовостей% у тимчасовий файл %ИмяВременногоФайла% - після спроби завантаження, файлу все ще не існує."
"(URL %URL%).'");
									ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ПопыткаПолученияФайла%", ПопыткаПолученияФайла);
									ТекстСообщения = СтрЗаменить(ТекстСообщения, "%HTTPСоединениеКоличествоПопытокПолученияФайла%", НастройкиПолученияНовостей.HTTPСоединениеКоличествоПопытокПолученияФайла);
									ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИмяФайла%", ТекущаяЛентаНовостей.ИмяФайла);
									...
									ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
										НСтр("ru='БИП:Новости.Загрузка новостей';uk='БІП:Новини.Завантаження новин'"), // ИмяСобытия
										НСтр("ru='Новости. Загрузка новостей. Загрузка файлов новостей. Получение файлов с сервера новостей. Ошибка чтения временного файла после загрузки';uk='Новини. Завантаження новин. Завантаження файлів новин. Одержання файлів із сервера новин. Помилка читання тимчасового файлу після завантаження'"), // ИдентификаторШага
										УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
										, // ОбъектМетаданных
										, // Данные
										ТекстСообщения, // Комментарий
						...
						Исключение
							...
							ТекстСообщения = НСтр("ru='Попытка %ПопыткаПолученияФайла% / %HTTPСоединениеКоличествоПопытокПолученияФайла%. Ошибка получения файла %ИмяФайла% с сервера %Сайт% для ленты новостей %ЛентаНовостей% во временный файл по причине: %ИнформацияОбОшибке%';uk='Спроба %ПопыткаПолученияФайла% / %HTTPСоединениеКоличествоПопытокПолученияФайла%. Помилка одержання файлу %ИмяФайла% із сервера %Сайт% для стрічки новин %ЛентаНовостей% у тимчасовий файл через: %ИнформацияОбОшибке%'");
							ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ПопыткаПолученияФайла%", ПопыткаПолученияФайла);
							ТекстСообщения = СтрЗаменить(ТекстСообщения, "%HTTPСоединениеКоличествоПопытокПолученияФайла%", НастройкиПолученияНовостей.HTTPСоединениеКоличествоПопытокПолученияФайла);
							ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИмяФайла%", ТекущаяЛентаНовостей.ИмяФайла);
							ТекстСообщения = СтрЗаменить(ТекстСообщения, "%Сайт%", ТекущаяЛентаНовостей.Сайт);
							...
							ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
								НСтр("ru='БИП:Новости.Загрузка новостей';uk='БІП:Новини.Завантаження новин'"), // ИмяСобытия
								НСтр("ru='Новости. Загрузка новостей. Загрузка файлов новостей. Получение файлов с сервера новостей. Ошибка загрузки';uk='Новини. Завантаження новин. Завантаження файлів новин. Одержання файлів із сервера новин. Помилка завантаження'"), // ИдентификаторШага
								УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
								, // ОбъектМетаданных
								, // Данные
								ТекстСообщения, // Комментарий
...
"Успешно? %Успешно%';uk='Завантаження: завантаження файлу новин зі стрічки новин %ЛентаНовостей% (протокол %Протокол%, сайт %Сайт%, ім`я файлу %ИмяФайла%, ім`я файлу на сервері %лкИмяФайлаНаСервере%)."
"Успішно? %Успешно%'");
					ТекстШага = СтрЗаменить(ТекстШага, "%ЛентаНовостей%", ТекущаяЛентаНовостей.ЛентаНовостей);
					ТекстШага = СтрЗаменить(ТекстШага, "%Протокол%", ТекущаяЛентаНовостей.Протокол);
					ТекстШага = СтрЗаменить(ТекстШага, "%Сайт%", ТекущаяЛентаНовостей.Сайт);
...
""
"Первые строки файла:"
"%ПервыеСтрокиФайла%';uk='У завантаженому файлі для стрічки новин %ЛентаНовостей% знаходиться текст не у форматі xml. Стрічка новин буде пропущена."
""
"Докладно:"
"%ИнформацияОбОшибке%"
""
...
"%ПервыеСтрокиФайла%'");
						...
						ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
							...
							ТекстСообщения, // Комментарий
							ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
						СтатусОбработки = СтатусОбработки + ", " + НСтр("ru='Формат файла не xml, или неправильно сформированный xml';uk='Формат файлу не xml, або неправильно сформований xml'");
						// Пропустить ленту новостей
						ЕстьОшибки = Истина;
					КонецПопытки;
					...
					Если ЕстьОшибки = Ложь Тогда
						...
						ИначеЕсли (НРег(ХМЛТип.ИмяТипа) = "rss") Тогда // И (ВРег(ХМЛТип.URIПространстваИмен)=ВРег("http://www.w3.org/2005/RSS_2_0")).
							...
							Если (ОбъектХДТО.Свойства().Получить("version") = Неопределено) Тогда
								ТекстСообщения = НСтр("ru='Невозможно определить версию rss в ленте новостей %ЛентаНовостей% - отсутствует свойство version. Необходимы данные в формате версии 2.0.';uk='Неможливо визначити версію rss у стрічці новин %ЛентаНовостей% - відсутня властивість version. Необхідні дані у форматі версії 2.0.'");
								ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ТекущаяСтрока.ЛентаНовостей);
								// Запись в журнал регистрации
								ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
									НСтр("ru='БИП:Новости.Загрузка новостей';uk='БІП:Новини.Завантаження новин'"), // ИмяСобытия
							...
							Иначе
								...
								Если (Число(лкВерсия) <> 2.0) Тогда
									...
									ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
										...
										ТекстСообщения, // Комментарий
										ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
									СтатусОбработки = СтатусОбработки + ", " + НСтр("ru='Неправильно сформированный xml: свойство version для rss не равно 2.0';uk='Неправильно сформований xml: властивість version для rss не дорівнює 2.0'");
									// Пропустить ленту новостей
									ЕстьОшибки = Истина;
								КонецЕсли;
							КонецЕсли;
...
""
"Первые строки файла:"
"%ПервыеСтрокиФайла%';uk='Непідтримуваний тип новин %ТипНовостей% у файлі %ИмяФайла% для стрічки новин %ЛентаНовостей%"
""
"Перші рядки файлу:"
"%ПервыеСтрокиФайла%'");
...
"%ИнформацияОбОшибке%"
""
"Рекомендуется вручную удалить этот временный файл.';uk='ПарсингХМЛФайловНовостей: Не удалось удалить временный файл %ИмяВременногоФайла% для ленты новостей %ЛентаНовостей% по причине:"
"%ИнформацияОбОшибке%"
""
"Рекомендуется вручную удалить этот временный файл.'");
						ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИмяВременногоФайла%", СокрЛП(ИмяВременногоФайла));
						...
						ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
							НСтр("ru='БИП:Новости.Загрузка новостей';uk='БІП:Новини.Завантаження новин'"), // ИмяСобытия
							НСтр("ru='Новости. Загрузка новостей. Парсинг файлов новостей. Ошибка удаления временного файла';uk='Новости. Загрузка новостей. Парсинг файлов новостей. Ошибка удаления временного файла'"), // ИдентификаторШага
							УровеньЖурналаРегистрации.Предупреждение, // УровеньЖурналаРегистрации.*
							, // ОбъектМетаданных
							, // Данные
							ТекстСообщения, // Комментарий
				...
				Иначе
					ТекстСообщения = НСтр("ru='Отсутствует загруженный файл %ИмяФайла% для ленты новостей %ЛентаНовостей%. Возможно, недостаточно места на диске, нет прав для записи в этот каталог или произошла какая-то другая ошибка.';uk='Відсутній завантажений файл %ИмяФайла% для стрічки новин %ЛентаНовостей%. Можливо, недостатньо місця на диску, немає прав для запису в цей каталог або відбулася якась інша помилка.'");
					ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИмяФайла%", СокрЛП(ИмяВременногоФайла));
					ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ТекущаяСтрока.ЛентаНовостей);
					// Запись в журнал регистрации
					ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
						...
						ТекстСообщения, // Комментарий
						ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
					СтатусОбработки = СтатусОбработки + ", " + НСтр("ru='Не удалось сохранить файл из временного хранилища';uk='Не вдалося зберегти файл із тимчасового сховища'");
					// Пропустить ленту новостей.
					ЕстьОшибки = Истина;
				КонецЕсли;

			Иначе
				ТекстСообщения = НСтр("ru='Не загружен файл новостей для ленты новостей %ЛентаНовостей% (пустой адрес в хранилище после загрузки файла [%ЛентаНовостей.ИмяФайла%] с сайта [%ЛентаНовостей.Сайт%] по протоколу [%ЛентаНовостей.Протокол%]). Лента новостей не обработана.';uk='Не завантажений файл новин для стрічки новин %ЛентаНовостей% (порожня адреса в сховище після завантаження файлу [%ЛентаНовостей.ИмяФайла%] з сайту [%ЛентаНовостей.Сайт%] по протоколу [%ЛентаНовостей.Протокол%]). Стрічка новин не оброблена.'");
				ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ТекущаяСтрока.ЛентаНовостей);
				...
				ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
					...
					ТекстСообщения, // Комментарий
					ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
				СтатусОбработки = СтатусОбработки + ", " + НСтр("ru='Отсутствует файл для обработки (пустой адрес в хранилище)';uk='Відсутній файл для обробки (порожня адреса в сховище)'");
			КонецЕсли;
...
"Успешно? %Успешно%';uk='Парсинг: стрічка новин %ЛентаНовостей%."
...
"'");
	...
	ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
		НСтр("ru='БИП:Новости.Загрузка новостей';uk='БІП:Новини.Завантаження новин'"), // ИмяСобытия
		НСтр("ru='Новости. Загрузка новостей. Настроенные разработчиками мероприятия после парсинга файлов новостей. Начало';uk='Новини. Завантаження новин. Настроєні розроблювачами заходу після парсинга файлів новин. Початок'"), // ИдентификаторШага
		УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
		, // ОбъектМетаданных
		, // Данные
		ТекстСообщения, // Комментарий
	...
	ЛогШаговВыполнения.Добавить(
		Новый Структура("Шаг, ВремяНачала, ВремяОкончания",
			НСтр("ru='Парсинг: вспомогательные мероприятия (переопределяемые), ДополнительноОбработатьНовостиПослеПолучения';uk='Парсинг: допоміжні заходи (переобумовлені), ДополнительноОбработатьНовостиПослеПолучения'"),
			ТШаг,
			ТекущаяУниверсальнаяДатаВМиллисекундах()));
...
"'");
	...
	ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
		НСтр("ru='БИП:Новости.Загрузка новостей';uk='БІП:Новини.Завантаження новин'"), // ИмяСобытия
		НСтр("ru='Новости. Загрузка новостей. Настроенные разработчиками мероприятия после парсинга файлов новостей. Конец';uk='Новини. Завантаження новин. Настроєні розроблювачами заходу після парсинга файлів новин. Кінець'"), // ИдентификаторШага
		УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
		, // ОбъектМетаданных
		Т0Длительность, // Данные
		ТекстСообщения, // Комментарий
...
"%ТаблицаОбновляемыхДанных%';uk='УправлениеНовостями.ПолучитьСтандартныеСпискиТребующиеОбновления, Таблиця оновлюваних даних:"
...
"%ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%';uk='Помилка оновлення списку значень категорії новин (Прокси.getUpdatedCategoryValuesByCode):"
"sCategoryCode = %СокрЛП(Список.Код)%"
"errCode = %errCode%"
"errDescription = %errDescription%"
...
"errDescription = %errDescription%"
"Полученные данные:"
"%Данные%';uk='Інформація про оновлення значень категорій новин (Прокси.getUpdatedCategoryValuesByCode):"
"configName = %configName%"
"configVersion = %configVersion%"
...
"%ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%';uk='Помилка запису елемента (%Режим%) з унікальним ідентифікатором %ТекущаяСтрокаХДТО.guid%:"
"%ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%'");
...
"errCode = %errCode%"
"errDescription = %errDescription%"
"%ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%';uk='Помилка оновлення списку стрічок новин (Прокси.getUpdatedChannels):"
"errCode = %errCode%"
"errDescription = %errDescription%"
"%ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%'");
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%errCode%", errCode);
...
"errDescription = %errDescription%"
"Полученные данные:"
"%Данные%';uk='Інформація про оновлення списку стрічок новин (Прокси.getUpdatedChannels):"
"configName = %configName%"
"configVersion = %configVersion%"
"lastSynchronizationDateTime = %lastSynchronizationDateTime%"
"errCode = %errCode%"
...
"errCode = %errCode%"
"errDescription = %errDescription%"
"%ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%';uk='Помилка оновлення списку стрічок новин (Прокси.getAllChannels):"
"errCode = %errCode%"
"errDescription = %errDescription%"
"%ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%'");
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%errCode%", errCode);
...
"errDescription = %errDescription%"
"Полученные данные:"
"%Данные%';uk='Інформація про оновлення списку стрічок новин (Прокси.getAllChannels):"
"configName = %configName%"
"configVersion = %configVersion%"
"errCode = %errCode%"
"errDescription = %errDescription%"
				...
				Если ТипЗнч(СписокВсехДанных.channel) = ТипСписокXDTO Тогда // Правильно сработает, даже если передали только одно значение.
					...
					Для Каждого ТекущийЭлементСписка Из СписокВсехЗагруженныхСерверныхЛентНовостей Цикл
						Если ТекущийЭлементСписка.Пометка = Ложь Тогда
							...
							ТекстСообщения = НСтр("ru='Лента новостей %ЛентаНовостейНаименование% помечена на удаление, т.к. она была отключена на сервере 1С';uk='Стрічка новин %ЛентаНовостейНаименование% позначена на видалення, тому що вона була відключена на сервері 1С'");
							...
							ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
								...
								НСтр("ru='Новости. Все обновления новостей. Обновление классификаторов. Отключение ленты новостей';uk='Новини. Всі відновлення новин. Відновлення класифікаторів. Відключення стрічки новин'"), // ИдентификаторШага
								УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
								, // ОбъектМетаданных
								, // Данные
								ТекстСообщения, // Комментарий
...
"errCode = %errCode%"
"errDescription = %errDescription%"
"%ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%';uk='Помилка оновлення списку категорій новин (Прокси.getUpdatedCategories):"
"errCode = %errCode%"
"errDescription = %errDescription%"
"%ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%'");
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%errCode%", errCode);
...
"errDescription = %errDescription%"
"Полученные данные:"
"%Данные%';uk='Інформація про оновлення списку категорій новин (Прокси.getUpdatedCategories):"
"configName = %configName%"
"configVersion = %configVersion%"
"lastSynchronizationDateTime = %lastSynchronizationDateTime%"
"errCode = %errCode%"
		...
		Если НЕ ПустаяСтрока(СписокУИН) Тогда
			...
			Если НЕ ПустаяСтрока(Владелец.ВерсияДанных) Тогда
				...
				Исключение
					...
					ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
						НСтр("ru='БИП:Новости.Загрузка классификаторов';uk='БІП:Новини.Завантаження класифікаторів'"), // ИмяСобытия
						НСтр("ru='Новости. Загрузка классификаторов. Список значений категории (по УИН). Ошибка';uk='Новини. Завантаження класифікаторів. Список значень категорії (по УІН). Помилка'"), // ИдентификаторШага
						УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
						, // ОбъектМетаданных
						, // Данные
						ТекстСообщения, // Комментарий
...
"errDescription = %errDescription%"
"Полученные данные:"
"%Данные%';uk='Інформація про оновлення значень категорій новин (Прокси.getUpdatedCategoryValuesByGuid):"
"configName = %configName%"
"configVersion = %configVersion%"
...
"%Данные%'");
					...
					ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
						НСтр("ru='БИП:Новости.Загрузка классификаторов';uk='БІП:Новини.Завантаження класифікаторів'"), // ИмяСобытия
						НСтр("ru='Новости. Загрузка классификаторов. Список значений категории (по УИН). Информация';uk='Новини. Завантаження класифікаторів. Список значень категорії (по УІН). Інформація'"), // ИдентификаторШага
						УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
						, // ОбъектМетаданных
						, // Данные
						ТекстСообщения, // Комментарий
...
"configVersion = %configVersion%"
"Время начала (мс): %ТНачало%"
"';uk='Одержання списку останніх оновлень, початок"
"configName = %configName%"
"configVersion = %configVersion%"
"Час початку (мс): %ТНачало%"
"'");
	...
	Иначе
		ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ДатыОбновленияСписков%", НСтр("ru='Получено значение с типом значения, отличным от ОбъектXDTO';uk='Отримане значення з типом значення, відмінним від ОбъектXDTO'"));
	КонецЕсли;
	ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
		НСтр("ru='БИП:Новости.Загрузка классификаторов';uk='БІП:Новини.Завантаження класифікаторів'"), // ИмяСобытия
...
"Время окончания (мс): %ТКонец%"
"Длительность (мс): %ТДлительность%"
"';uk='Одержання списку останніх оновлень, завершення"
"Час початку (мс): %ТНачало%"
"Час закінчення (мс): %ТКонец%"
"Тривалість (мс): %ТДлительность%"
"'");
...
"Определен формат ленты новостей: %ФорматНовостей%';uk='Парсинг файлу новин для стрічки новин %ЛентаНовостей%"
"Визначений формат стрічки новин: %ФорматНовостей%'");
		ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ЛентаНовостей);
		...
		Если ТипЗнч(ОбъектХДТО.Свойства().Получить("channel")) = ТипСвойствоXDTO
			...
			Если ОбъектХДТО.Свойства().Получить("channel") <> Неопределено Тогда
				...
				Иначе
					...
					// Запись в журнал регистрации
					ТекстСообщения = НСтр("ru='В файле полученном для ленты новостей %ЛентаНовостей% отсутствует поле channel.lastBuildDate. Все новости будут прочитаны и загружены, но это займет больше времени.';uk='У файлі отриманому для стрічки новин %ЛентаНовостей% відсутнє поле channel.lastBuildDate. Усі новини будуть прочитані й завантажені, але це займе більше часу.'");
					ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ЛентаНовостей);
					ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
						НСтр("ru='БИП:Новости.Загрузка новостей';uk='БІП:Новини.Завантаження новин'"), // ИмяСобытия
			...
			Иначе
				// Запись в журнал регистрации
				ТекстСообщения = НСтр("ru='В файле полученном для ленты новостей %ЛентаНовостей% отсутствует обязательное поле channel. Файл не был обработан.';uk='У файлі отриманому для стрічки новин %ЛентаНовостей% відсутнє обов`язкове поле channel. Файл не був оброблений.'");
				ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ЛентаНовостей);
				ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
					НСтр("ru='БИП:Новости.Загрузка новостей';uk='БІП:Новини.Завантаження новин'"), // ИмяСобытия
...
"Визначений формат стрічки новин: %ФорматНовостей%'");
	...
	Иначе
		...
		ТекстСообщения = НСтр("ru='Парсинг файла новостей для ленты новостей %ЛентаНовостей%"
"Не обрабатываемый формат ленты новостей: %ФорматНовостей%';uk='Парсинг файлу новин для стрічки новин %ЛентаНовостей%"
"Не оброблюваний формат стрічки новин: %ФорматНовостей%'");
		ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ЛентаНовостей);
		ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ФорматНовостей%", НРег(ФорматНовостей));
		// Запись в журнал регистрации
		ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
...
"заголовок [%ЗаголовокНовости%], УИН [%УИННовости%], лента новостей [%ЛентаНовостей%], формат [%ФорматНовостей%], дата публикации [%ДатаПубликации%],"
"по причине: %ИнформацияОбОшибке%';uk='Невдала спроба запису новини з даними:"
"заголовок [%ЗаголовокНовости%], УІН [%УИННовости%], стрічка новин [%ЛентаНовостей%], формат [%ФорматНовостей%], дата публікації [%ДатаПубликации%],"
...
"Возможно, новость уже существует в базе с такой же датой публикации или (при отмене публикации) этой новости нет в базе.';uk='Новина пропущена, її дані:"
...
"Можливо, новина вже існує в базі з такою ж датою публікації або (при скасуванні публікації) цієї новини немає в базі.'");
			...
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ЛентаНовостей);
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ФорматНовостей%", ФорматНовостей);
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЗначениеПометкаУдаления%", ?(ЗначениеПометкаУдаления = Истина, НСтр("ru='на сервере публикация отменена';uk='на сервері публікація скасована'"), НСтр("ru='опубликована на сервере';uk='опублікована на сервері'")));
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%СуществуетВБазе%", ?(СтруктураНовости.Ссылка.Пустая(), НСтр("ru='в базе еще не создана';uk='у базі ще не створена'"), НСтр("ru='существует в базе';uk='існує в базі'")));
			// Запись в журнал регистрации
			ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
				НСтр("ru='БИП:Новости.Загрузка новостей';uk='БІП:Новини.Завантаження новин'"), // ИмяСобытия
		...
		РезультатЗагрузкиНовости = СтрЗаменить(РезультатЗагрузкиНовости, "%СуществуетВБазе%", ?(СтруктураНовости.Ссылка.Пустая(), НСтр("ru='В базе еще не создана';uk='У базі ще не створена'"), НСтр("ru='Уже существует в базе';uk='Вже існує в базі'")));
		РезультатЗагрузкиНовости = СтрЗаменить(РезультатЗагрузкиНовости, "%ДатаПубликацииИБ%", ?(СтруктураНовости.Ссылка.Пустая(), " " + НСтр("ru='(в базе не было)';uk='(у базі не було)'"), " (" + Формат(ДатаПубликацииИБ, "ДЛФ=DT") + ")"));
		РезультатЗагрузкиНовости = СтрЗаменить(РезультатЗагрузкиНовости, "%ЗначениеПометкаУдаленияИБ%", ?(СтруктураНовости.Ссылка.Пустая(), " " + НСтр("ru='(в базе не было)';uk='(у базі не було)'"), " (" + ЗначениеПометкаУдаленияИБ + ")"));
		РезультатЗагрузкиНовости = СтрЗаменить(РезультатЗагрузкиНовости, "%УИН_ИБ%", ?(СтруктураНовости.Ссылка.Пустая(), НСтр("ru='(еще не создана)';uk='(еще не создана)'"), СтруктураНовости.УИН_ИБ));
		РезультатЗагрузкиНовости = СтрЗаменить(РезультатЗагрузкиНовости, "%НавигационнаяСсылка%", ?(СтруктураНовости.Ссылка.Пустая(), НСтр("ru='(еще не создана)';uk='(еще не создана)'"), ПолучитьНавигационнуюСсылку(СтруктураНовости.Ссылка)));
	...
	Если ТипЗнч(ДанныеХДТО) = ТипОбъектXDTO Тогда
		...
		Если ТипЗнч(СвойствоДвоичныеДанные) = ТипСвойствоXDTO Тогда
			...
			Исключение
				Данные = Неопределено;
				ИнформацияОбОшибке = ИнформацияОбОшибке();
				ТекстСообщения = НСтр("ru='Не удалось загрузить бинарные данные для новости с УИН %ОбъектНовость.УИННовости% по причине: %ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%';uk='Не вдалося завантажити бінарні дані для новини з УІН %ОбъектНовость.УИННовости% через: %ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%'");
...
Процедура ЗагрузитьДатуПоследнегоОбновленияСтандартногоСписка(Обновление)
	...
	Если ТипЗнч(Обновление) = ТипОбъектXDTO Тогда
		...
		Исключение
				...
				ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
					НСтр("ru='БИП:Новости.Загрузка новостей';uk='БІП:Новини.Завантаження новин'"), // ИмяСобытия
					НСтр("ru='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей. Блок дат обновления списков';uk='Новини. Завантаження новин. Парсинг файлів новин. Парсинг файлу новин. Блок дат відновлення списків'"), // ИдентификаторШага
					УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
					, // ОбъектМетаданных
					, // Данные
					ТекстСообщения, // Комментарий
			...
			Если ТипЗнч(ОбъектХДТО.categoriesRefList.categoryRef) = ТипСписокXDTO Тогда // Правильно сработает, даже если передали только одно значение.
				...
				Пока БылиУдаления = Истина Цикл
					...
					Для каждого ТекущаяКатегория Из лкОбъект.ДоступныеКатегорииНовостей Цикл
						...
						Если КатегорияЕстьНаСервере = Ложь Тогда
							ТекстСообщения = НСтр("ru='Из ленты новостей %Наименование% удалена категория %Категория%.';uk='Зі стрічки новин %Наименование% вилучена категорія %Категория%.'");
				...
				Для каждого ТекущаяКатегория Из МассивДоступныхКатегорий Цикл
					...
					Если КатегорияЕстьНаКлиенте = Ложь Тогда
						ТекстСообщения = НСтр("ru='В ленте новостей %Наименование% добавлена категория %Категория%.';uk='У стрічці новин %Наименование% додана категорія %Категория%.'");
						ТекстСообщения = СтрЗаменить(ТекстСообщения, "%Наименование%", СокрЛП(лкОбъект.Наименование));
...
"МестоположениеWSDL = %МестоположениеWSDL%';uk='Початок завантаження стандартних списків"
...
"%ИнформацияОбОшибке%';uk='Невдале підключення до веб-сервісу оновлення стандартних списків через:"
"%ИнформацияОбОшибке%'");
		ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИнформацияОбОшибке%", ПодробноеПредставлениеОшибки(ИнформацияОбОшибке));
		// Запись в журнал регистрации
		ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
