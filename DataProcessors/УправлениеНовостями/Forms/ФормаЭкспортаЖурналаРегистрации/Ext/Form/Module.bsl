...
"Данные не удалось поместить во временное хранилище.';uk='Не вдалося експортувати події журналу реєстрації у файл."
...
"%1';uk='Журнал событий успешно экспортирован в файл с именем"
"%1'"),
							ИмяФайла);
						ЭтаФорма.РезультатЭкспорта = ТекстСообщения;
					Исключение
...
"%1';uk='Не удалось записать файл по причине:"
"%1'"),
...
"Во временное хранилище помещены данные неправильного типа %1.';uk='Не удалось экспортировать события журнала регистрации в файл."
