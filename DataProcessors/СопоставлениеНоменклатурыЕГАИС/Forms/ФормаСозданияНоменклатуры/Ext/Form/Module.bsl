...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипЗнч(МассивЭлементов) <> Тип("Массив") Тогда
		ВызватьИсключение НСтр("ru='В форму создания номенклатуры переданы некорректные параметры.';uk='В форму создания номенклатуры переданы некорректные параметры.'");
	КонецЕсли;
	...
	ЗаголовокКоманды = НСтр("ru='Создать номенклатуру (%КоличествоЭлементов%)';uk='Создать номенклатуру (%КоличествоЭлементов%)'");
