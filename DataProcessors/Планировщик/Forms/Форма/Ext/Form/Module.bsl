...
&НаКлиенте
// Процедура - обработчик команды ОтправитьEmailКонтрагенту.
//
Процедура ОтправитьEmailКонтрагенту(Элемент, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(СписокТекущиеДанные.ЭлектроннаяПочтаКонтрагента) Тогда
		СтруктураПолучателя = Новый Структура;
		СтруктураПолучателя.Вставить("Представление", СписокТекущиеДанные.Контрагент);
		СтруктураПолучателя.Вставить("Адрес", СписокТекущиеДанные.ЭлектроннаяПочтаКонтрагента);
...
&НаКлиенте
// Процедура - обработчик команды ОтправитьEmailКонтактномуЛицу.
//
Процедура ОтправитьEmailКонтактномуЛицу(Элемент, СтандартнаяОбработка)
	...
	Получатели = Новый Массив;
	Если ЗначениеЗаполнено(СписокТекущиеДанные.ЭлектроннаяПочтаКонтактногоЛица) Тогда
		СтруктураПолучателя = Новый Структура;
		СтруктураПолучателя.Вставить("Представление", СписокТекущиеДанные.КонтактноеЛицо);
		СтруктураПолучателя.Вставить("Адрес", СписокТекущиеДанные.ЭлектроннаяПочтаКонтактногоЛица);
		Получатели.Добавить(СтруктураПолучателя);
	КонецЕсли;
