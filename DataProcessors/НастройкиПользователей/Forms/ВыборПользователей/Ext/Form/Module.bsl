...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОчисткаНастроек Тогда
		Заголовок = НСтр("ru='Выбор пользователей для очистки настроек';uk='Вибір користувачів для очищення налаштувань'");
		Элементы.Надпись.Заголовок = НСтр("ru='Выберите пользователей, которым необходимо очистить настройки';uk='Виберіть користувачів, яким необхідно очистити налаштування'");
	КонецЕсли;
