...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ Параметры.РежимПросмотраИстории Тогда
		Элементы.ГруппаИстории.Видимость = Ложь;
		Элементы.ТаблицаДанных.Шапка = Ложь;
	Иначе
		Заголовок = НСтр("ru='История выгрузки через сервис 1С:Бизнес-сеть';uk='История выгрузки через сервис 1С:Бизнес-сеть'");
	КонецЕсли;
