...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ВариантыИзменения = "Сумма" Тогда
		...
		ЭтаФорма.Заголовок = НСтр("ru='Изменить на сумму';uk='Змінити на суму'");
		
	ИначеЕсли ВариантыИзменения = "Процент" Тогда
		
		ЭтаФорма.Заголовок = НСтр("ru='Изменить на процент';uk='Змінити на відсоток'");
		
	ИначеЕсли ВариантыИзменения = "Округление" Тогда
		
		ЭтаФорма.Заголовок = НСтр("ru='Округление';uk='Округлення'");
		
	ИначеЕсли ВариантыИзменения = "Очистить" Тогда
		
		ЭтаФорма.Заголовок = НСтр("ru='Очистить';uk='Очистити'");
		
	ИначеЕсли ВариантыИзменения = "Формула" Тогда
		
		ЭтаФорма.Заголовок = НСтр("ru='Изменить по формуле';uk='Змінити по формулі'");
