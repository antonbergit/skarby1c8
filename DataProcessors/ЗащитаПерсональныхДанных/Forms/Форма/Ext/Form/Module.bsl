...
Процедура УстановитьУсловноеОформление()
	...
	СписокЗначений.Добавить(НСтр("ru='_$Session$_.AuthenticationError';uk='_$Session$_.AuthenticationError'"));
	СписокЗначений.Добавить(НСтр("ru='_$Access$_.AccessDenied';uk='_$Access$_.AccessDenied'"));
...
Функция ПрочитатьЖурнал(ОтборЖурналаНаКлиенте)
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru='Защита персональных данных';uk='Захист персональних даних'");
