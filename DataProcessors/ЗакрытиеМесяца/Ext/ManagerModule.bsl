...
Процедура ВыполнитьЗакрытиеМесяца(СтруктураПараметров, ФоновоеЗаданиеАдресХранилища = "") Экспорт
	...
	Если СтруктураПараметров.ВыполнитьРасчетАмортизации Тогда
		...
		Иначе
			...
			ДокОбъект.Комментарий = НСтр("ru='#Создан автоматически, помощником закрытия месяца.';uk='#Создан автоматично, помічником закриття місяця.'");
...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	ГруппаДел	= НСтр("ru='Закрытие месяца';uk='Закриття місяця'");
	...
	Дело.Важное			= Истина;
	Дело.Представление	= НСтр("ru='Выполнить закрытие месяца';uk='Виконати закриття місяця'");
	...
	Дело.Подсказка		= НСтр("ru='Закрытие месяца необходимо выполнить для окончательного расчета себестоимости, финансового результата и курсовых разниц';uk='Закриття місяця необхідно виконати для остаточного розрахунку собівартості, фінансового результату й курсових різниць'");
