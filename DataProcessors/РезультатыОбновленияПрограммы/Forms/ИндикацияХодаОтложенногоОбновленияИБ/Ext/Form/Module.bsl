...
Процедура ИзменитьРасписаниеПослеУстановкиРасписания(НовоеРасписание, ДополнительныеПараметры) Экспорт
	...
	Если НовоеРасписание <> Неопределено Тогда
		Если НовоеРасписание.ПериодПовтораВТечениеДня = 0 Тогда
			...
			КнопкиВопроса.Добавить("НастроитьРасписание", НСтр("ru='Настроить расписание';uk='Налаштувати розклад'"));
			КнопкиВопроса.Добавить("РекомендуемыеНастройки", НСтр("ru='Установить рекомендуемые настройки';uk='Встановити рекомендовані налаштування'"));
...
"и заполнить поле ""Повторять через"".';uk='Додаткові процедури обробки даних виконуються невеликими порціями,"
"тому для їхньої коректної роботи необхідно обов`язково задати інтервал повтору після завершення."
""
"Для цього у вікні налаштування розкладу необхідно перейти на вкладку ""Денне"""
