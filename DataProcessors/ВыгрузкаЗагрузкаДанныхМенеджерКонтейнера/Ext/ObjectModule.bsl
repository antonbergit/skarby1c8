...
Процедура ОбновитьСоставВыгружаемыхФайлов()
	...
	Для Каждого ТекущийФайл Из Состав Цикл 
		...
		Если Не Файл.Существует() Тогда 
			ВызватьИсключение НСтр("ru='Файл был удален';uk='Файл був видалений'");
		КонецЕсли;
...
"Возможно, файл был получен из предыдущих версий программы или поврежден!';uk='Помилка завантаження даних. Невірний формат файлу. У архіві не виявлений файл PackageContents.xml."
