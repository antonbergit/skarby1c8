...
Процедура ПриОткрытииЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Если ОбновлениеМодуляДокументооборотаНаИсправительныйДоступно Тогда
		...
		Элементы.ПроверитьОбновленияЗапрет.Заголовок 		= НСтр("ru='Обновить модуль';uk='Обновить модуль'");
		Элементы.ПроверитьОбновленияРекомендация.Заголовок 	= НСтр("ru='Обновить модуль';uk='Обновить модуль'");
	КонецЕсли;
