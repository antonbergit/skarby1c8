...
"Пользователь=%3"
"Представление=%4"
"';uk='Вивантаження налаштування пропущене, тому що налаштування не може бути прочитане:"
"КлючНастроек=%1"
"КлючОбъекта=%2"
"Пользователь=%3"
"Представление=%4"
...
Процедура ВыгрузитьЭлементНастроек(ПотокЗаписи, Знач КлючНастроек, Знач КлючОбъекта, Знач Пользователь, Знач Представление, Знач Настройки)
	...
	Если НайтиНедопустимыеСимволыXML(КлючНастроек) > 0
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru='ВыгрузкаЗагрузкаДанных.ВыгрузкаНастройкиПропущена';uk='ВыгрузкаЗагрузкаДанных.ВыгрузкаНастройкиПропущена'", Метаданные.ОсновнойЯзык.КодЯзыка),
			УровеньЖурналаРегистрации.Предупреждение,,,
			НСтр("ru='Выгрузка настройки пропущена, т.к. в ключевых параметрах содержатся недопустимые символы.';uk='Вивантаження налаштування пропущене, тому що в ключових параметрах є неприпустимі символи.'", Метаданные.ОсновнойЯзык.КодЯзыка));
