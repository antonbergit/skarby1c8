...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаголовокФормы = НСтр("ru='Настройка отладки обработчиков при %Событие% данных';uk='Налаштування налагодження обробників при %Событие% даних'");	
...
Процедура Готово(Команда)
	...
	Если ПустаяСтрока(Объект.ИмяФайлаВнешнейОбработкиОбработчиковСобытий) Тогда
		...
		СообщитьПользователю(НСтр("ru='Укажите имя файла внешней обработки.';uk='Вкажіть ім`я файлу зовнішньої обробки.'"), "ИмяФайлаВнешнейОбработкиОбработчиковСобытий");
		Возврат;
