...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Год(ДатаДокументаОбработкиСобытия) > 2013 Тогда
		Элементы.ДекорацияПФРСтраховаяСотрудники.Заголовок = НСтр("ru='ПФР';uk='ПФР'");
...
Процедура ДекорацияВсеПлатежкиНажатие(Элемент)
	Если ТолькоНулевыеСуммы() Тогда
		ПоказатьПредупреждение(,НСтр("ru='Суммы всех взносов и налогов нулевые. Уплата не требуется';uk='Суми всіх внесків і податків нульові. Сплата не потрібна'"));
		Возврат;
	КонецЕсли;
...
Процедура ОтразитьРасходыВПрограмме(Команда)
	...
	Список.Добавить(ДанныеНДФЛСотрудники,НСтр("ru='НДФЛ';uk='ПДФО'"));
	...
	Если Год(ДатаДокументаОбработкиСобытия) < 2014 Тогда
		...
		Список.Добавить(ДанныеПФРСтраховаяСотрудники,НСтр("ru='ПФР страховая';uk='ПФР страхова'"));
		Список.Добавить(ДанныеПФРНакопительнаяСотрудники,НСтр("ru='ПФР накопительная';uk='ПФР накопичувальна'"));
	Иначе
		Список.Добавить(ДанныеПФРСтраховаяСотрудники,НСтр("ru='ПФР';uk='ПФР'"));
	КонецЕсли;
	...
	Список.Добавить(ДанныеФОМССотрудники,НСтр("ru='ФОМС';uk='ФОМС'"));
	...
	Список.Добавить(ДанныеФСССотрудники,НСтр("ru='ФСС';uk='ФСС'"));
	...
	Список.Добавить(ДанныеФССТравматизмСотрудники,НСтр("ru='ФСС травматизм';uk='ФСС травматизм'"));
...
"Создать его автоматически?';uk='У довіднику «Контрагенти» не заданий державний орган для сплати податку (внеску)."
...
"Подключиться сейчас?';uk='Для автоматичного створення відділення ФСС"
"у довіднику «Контрагенти» необхідно підключитися до Інтернет-підтримки"
"користувачів. Дані по відділенню ФСС знадобляться при сплаті податків."
"Підключитися зараз?'");
...
"Подключиться сейчас?';uk='Для автоматичного створення відділення ПФ РФ"
"у довіднику «Контрагенти» необхідно підключитися до Інтернет-підтримки"
"користувачів. Дані по відділенню ПФ РФ знадобляться при сплаті податків."
"Підключитися зараз?'");
