...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(КомплектОтчетности) Тогда
		...
		Если Выборка1.Следующий() Тогда
			...
			Если Месяц(ОтчетныйПериод) = 10 И ЭтоОтчетностьРанее2013года Тогда
				...
				Элементы.ДекорацияОписаниеРаботы2.Заголовок = НСтр("ru='Распечатайте РСВ-1, АДВ-6-2, СЗВ-6-2, СЗВ-6-3, АДВ-6-4 в 2-х экземплярах';uk='Роздрукуйте РСВ-1, АДВ-6-2, СЗВ-6-2, СЗВ-6-3, АДВ-6-4 в 2-х екземплярах'");
				Элементы.ДекорацияТекстОписание7.Заголовок = НСтр("ru='Сохраните файлы РСВ-1, АДВ-6-2, СЗВ-6-2, СЗВ-6-3, АДВ-6-4 на флешку или дискету (разные налоговые по-разному принимают)';uk='Сохраните файлы РСВ-1, АДВ-6-2, СЗВ-6-2, СЗВ-6-3, АДВ-6-4 на флешку или дискету (разные налоговые по-разному принимают)'");
			...
			Если Не ЭтоОтчетностьРанее2014года Тогда
				...
				Элементы.ДекорацияОписаниеРаботы2.Заголовок = НСтр("ru='Распечатайте РСВ-1 в 2-х экземплярах';uk='Роздрукуйте РСВ-1 в 2-х екземплярах'");
				Элементы.ДекорацияТекстОписание7.Заголовок = НСтр("ru='Сохраните файлы РСВ-1 на флешку или дискету (разные налоговые по-разному принимают)';uk='Сохраните файлы РСВ-1 на флешку или дискету (разные налоговые по-разному принимают)'");
			ИначеЕсли Не ЭтоОтчетностьРанее2013года Тогда
				Элементы.ДекорацияОписаниеРаботы2.Заголовок = НСтр("ru='Распечатайте РСВ-1, АДВ-6-2, СЗВ-6-4, АДВ-6-5 в 2-х экземплярах';uk='Роздрукуйте РСВ-1, АДВ-6-2, СЗВ-6-4, АДВ-6-5 в 2-х екземплярах'");
				Элементы.ДекорацияТекстОписание7.Заголовок = НСтр("ru='Сохраните файлы РСВ-1, АДВ-6-2, СЗВ-6-4, АДВ-6-5 на флешку или дискету (разные налоговые по-разному принимают)';uk='Сохраните файлы РСВ-1, АДВ-6-2, СЗВ-6-4, АДВ-6-5 на флешку или дискету (разные налоговые по-разному принимают)'");
			КонецЕсли;
			...
			Если НЕ ЭтоОтчетностьРанее2014года И Не ЗначениеЗаполнено(ДокументРаздел6РасчетаРСВ1) Тогда
				Элементы.ДекорацияПредупреждение.Видимость = Истина;
				Элементы.ДекорацияПредупреждение.Заголовок = НСтр("ru='Внимание! В программе появились новые формы отчетности в ПФР. Сформируйте данный комплект отчетности заново.';uk='Увага! У програмі з`явилися нові форми звітності в ПФУ. Сформуйте даний комплект звітності заново.'");
	...
	Если РежимИспользованияИБ = Перечисления.РежимыИспользованияИнформационнойБазы.Демонстрационный Тогда
		Элементы.ОтправитьВКонтролирующийОрган.Заголовок = НСтр("ru='Отправить (в демо не доступно)';uk='Відправити (у демо не доступно)'");
...
Процедура ПриОткрытии(Отказ)
	...
	Если Не ИмеютсяСотрудникиВПФР Тогда
		
		Элементы.СтраницаОтчетностиВПФР.ТекущаяСтраница = Элементы.ЗадачаВыполненаБезСотрудников;
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "ПрикрепленаДоверенность" И Параметр = Объект.Организация Тогда
		Элементы.ОтправитьВКонтролирующийОрган.Заголовок = НСтр("ru='Идет проверка доверенности';uk='Іде перевірка доручення'");
	ИначеЕсли ИмяСобытия = "ИзмененаЗаявкаЭДО" Тогда
		Если Параметр.Организация = Объект.Организация Тогда
			Если Параметр.ЕстьАктуальнаяЗаявка Тогда
				Элементы.ОтправитьВКонтролирующийОрган.Заголовок = НСтр("ru='Отправить';uk='Відправити'");
				Элементы.ОтправитьВКонтролирующийОрган.Доступность = Истина;
				Элементы.ОформитьЗаявку.Видимость = Ложь;
			Иначе
				Элементы.ОтправитьВКонтролирующийОрган.Доступность = Ложь;
				Элементы.ОтправитьВКонтролирующийОрган.Заголовок = НСтр("ru='Отправить (нет заявки)';uk='Відправити (немає заявки)'");
...
Процедура ОбновитьСтатус(Команда)
	...
	ИначеЕсли ВыбранныеОрганизации.Количество() = 1 Тогда
		ТекстВопроса = НСтр("ru='Информация будет запрошена по всем отчетам, ожидающим подтверждения';uk='Інформація буде запитана по всіх звітах, що очікують підтвердження'");
	Иначе
...
Процедура ПереходВыполнил(Команда)
	...
	ПоказатьВопрос(оп, НСтр("ru='ПФР приняла отчетность?';uk='ПФР прийняла звітність?'"), РежимДиалогаВопрос.ДаНет);
	Возврат;
...
Процедура ОтправитьОтчетность(Команда)
	...
	ПоказатьВопрос(ОписаниеОповещения,
		НСтр("ru='Вы подтверждаете, что отчет заполнен полностью и корректно?';uk='Ви підтверджуєте, що звіт заповнений повністю й коректно?'"), РежимДиалогаВопрос.ДаНет);
...
Процедура ПриОтветеНаВопросОЗаполнении(РезультатВопроса, ДопПараметры) Экспорт
	...
	Если Отказ Тогда
		ПоказатьПредупреждение(,НСтр("ru='Отправка прервана! В отчете РСВ-1 найдены ошибки. Проверьте корректность заполнения отчета и повторите снова.';uk='Відправлення перерване! У звіті РСВ-1 знайдені помилки. Перевірте коректність заповнення звіту й повторіть знову.'"));
...
Процедура СохранитьФайлыЗавершение(Результат, Параметры) Экспорт
	...
	МассивФайлов = ПолучитьМассивОписанийФайловКомплекта();
	...
	Если ЗначениеЗаполнено(ДокументОтчетности) Тогда
		...
		Отказ = НЕ РегламентированнаяОтчетностьКлиент.ВыгрузитьОтчеты(МассивСохранмяемыхОтчетов, Каталог + "\", Ошибки, Ложь, Истина);
		Если Ошибки.Количество() > 0 Тогда
			ПоказатьПредупреждение(,НСтр("ru='Сохранение прервано! В отчете РСВ-1 найдены ошибки. Проверьте корректность заполнения отчета и повторите снова.';uk='Збереження перерване! У звіті РСВ-1 знайдені помилки. Перевірте коректність заповнення звіту й повторіть знову.'"));
	...
	Для Каждого ОписаниеФайла Из МассивФайлов Цикл
		...
		ПолучаемыйФайл = Новый ОписаниеПередаваемогоФайла(Каталог + "\" + ОписаниеФайла.ИмяФайла, ОписаниеФайла.СсылкаНаДвоичныеДанныеФайла);
		ПолучаемыеФайлы.Добавить(ПолучаемыйФайл);
	КонецЦикла;	
	
	Если МассивФайлов.Количество() > 0 Тогда 
		ИмяФайлаОписи = Каталог + "\" + МассивФайлов[0].ИмяФайла;
	КонецЕсли;
	
	ПолученныеФайлы = Новый Массив;
	
	ТекстПояснения = НСтр("ru='Выполняется сохранение файлов комплекта."
"Пожалуйста, подождите.';uk='Виконується збереження файлів комплекту."
"Будь ласка, зачекайте.'");
	...
	Состояние(НСтр("ru='Файлы успешно сохранены';uk='Файли успішно збережені'"), , Каталог);
...
&НаСервере
Функция ПолучитьМассивОписанийФайловКомплекта()
