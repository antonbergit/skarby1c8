...
Процедура ПереходДекларацияПоУСН(Элемент)
	...
	Элементы.СтраницаДекларация.ТекущаяСтраница = Элементы.Отчет4ФСС;
...
Процедура ПереходВыполнил(Команда)
	...
	ПоказатьВопрос(оп, НСтр("ru='ФСС приняла декларацию?';uk='ФСС прийняла декларацію?'"), РежимДиалогаВопрос.ДаНет);
	Возврат;
