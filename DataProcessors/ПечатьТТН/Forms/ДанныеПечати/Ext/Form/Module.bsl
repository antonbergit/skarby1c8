...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Источник = "РасходнаяНакладная" 
		...
		Если Источник = "ОтчетОПереработке" Тогда
			ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "Получил", "Видимость", Ложь);
			ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "МестоСоставленияДокумента", "Видимость", Ложь);
		КонецЕсли; 
...
Процедура ПриОткрытии(Отказ)
	...
	НачальныеЗначенияРеквизитов.Вставить("МестоСоставленияДокумента",	МестоСоставленияДокумента);
...
Процедура РедактироватьПредставлениеОснованияПечати(Команда)
	...
	Иначе
		...
		Элементы.ОснованиеПечати.ПодсказкаВвода = НСтр("ru='Представление основания печати';uk='Представлення основи друку'");
