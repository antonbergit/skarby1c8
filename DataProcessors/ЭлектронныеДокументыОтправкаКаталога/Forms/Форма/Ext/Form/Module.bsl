...
"Вызывать ее вручную запрещено.';uk='Данная обработка предназначена для вызова из ""Настройки ЭДО""."
"Вызывать ее вручную запрещено.'");
	...
	//	И Соглашение.СостояниеСоглашения <> Перечисления.СостоянияСоглашенийЭД.Действует Тогда
	//	
	//	ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
	//		НСтр("ru='Нельзя отправить каталог для соглашения с состоянием ""%1""!';uk='Нельзя отправить каталог для соглашения с состоянием ""%1""!'"), Соглашение.СостояниеСоглашения);
	//	
...
"Продолжить?';uk='Подобранные товары отправлены не будут. "
"Продолжить?'");
...
Процедура ЗаполнитьТаблицуТоваров(Команда)
	...
	Если Объект.Товары.Количество() > 0 Тогда
		ТекстВопроса = НСтр("ru='Таблица товаров будет перезаполнена. Продолжить?';uk='Таблица товаров будет перезаполнена. Продолжить?'");
