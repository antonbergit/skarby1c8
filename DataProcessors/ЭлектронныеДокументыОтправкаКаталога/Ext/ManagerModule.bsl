...
Процедура УстановитьОтборПоТипуЦен(Компоновщик)
	...
	Если НЕ ОтборТипЦен.Использование
		...
		Если ОтборТипЦен.Использование Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(Нстр("ru='Возможен отбор только по одному типу цен. Информация о ценах номенклатуры не заполнена.';uk='Возможен отбор только по одному типу цен. Информация о ценах номенклатуры не заполнена.'"));
		КонецЕсли;
