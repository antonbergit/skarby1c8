...
Процедура ОбновитьИнформациюОПринятииЗаказа()
	...
	Если ЗначениеЗаполнено(ДатаПринятияЗаказа) Тогда
		...
		ИнформацияОПринятииЗаказа = НСтр("ru='Заказ от ';uk='Заказ от '") + Формат(ДатаПринятияЗаказа, "ДЛФ=DD");
		
	КонецЕсли;
	
	Если ЗначениеЗаполнено(ЗаказПринял) Тогда
		
		ИнформацияОПринятииЗаказа = ИнформацияОПринятииЗаказа + НСтр("ru='; заказ принял(а) ';uk='; заказ принял(а) '") + ЗаказПринял;
