...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Выборка.ТипСайта = 4 Тогда
			НадписьТипСайта = НСтр("ru='Интернет-магазин';uk='Інтернет-магазин'");
		ИначеЕсли Выборка.ТипСайта = 3 Тогда
			НадписьТипСайта = НСтр("ru='Лендинг';uk='Лендінг'");
		ИначеЕсли Выборка.ТипСайта = 2 Тогда
			НадписьТипСайта = НСтр("ru='Сайт компании';uk='Сайт компанії'");
		ИначеЕсли Выборка.ТипСайта = 1 Тогда			
			НадписьТипСайта = НСтр("ru='Сайт специалиста';uk='Сайт спеціаліста'");
		КонецЕсли;
		...
		|<td height=40 width=""25%"" style='width:25%;padding:0cm 5pt 0cm 5pt'>
		|<p  align=center style='text-align:center'>
		|<a  href="""+Выборка.URLАдминЗоны+""">"+НСтр("ru='Открыть админзону';uk='Відкрити адмінзону'")+"</a></p>
		|</td>
		|</tr>
		|";
	...
	ПолеМетки.Заголовок = НСтр("ru='Редактировать данные сайтов';uk='Редагувати дані сайтів'");
