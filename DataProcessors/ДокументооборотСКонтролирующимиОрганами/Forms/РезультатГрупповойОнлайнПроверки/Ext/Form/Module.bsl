...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТаблицаСРезультатами.Количество() = 1 И Параметры.РежимПоказаДляОдиночногоДокументаРазрешен Тогда
		Заголовок = НСтр("ru='Проверка';uk='Перевірка'") + ": " + ТаблицаСРезультатами[0].ПредставлениеДокумента;
...
Процедура ЗаполнитьСоответствие(ПоддержкаСервисаОнлайнПроверкиВУниверсальномФормате = Ложь)
	...
	Если ПредставлениеРезультатовПроверки = Неопределено Тогда
		...
		Если ПоддержкаСервисаОнлайнПроверкиВУниверсальномФормате <> Истина Тогда
			...
			ПредставлениеРезультатовПроверки.Вставить("-1",	НСтр("ru='Неизвестная ошибка';uk='Невідома помилка'"));
			ПредставлениеРезультатовПроверки.Вставить("0",	НСтр("ru='Ошибок не обнаружено';uk='Помилок не виявлено'"));
			ПредставлениеРезультатовПроверки.Вставить("1",	НСтр("ru='Ошибка расшифровки';uk='Ошибка расшифровки'"));
			ПредставлениеРезультатовПроверки.Вставить("2",	НСтр("ru='Неизвестный формат';uk='Неизвестный формат'"));
			ПредставлениеРезультатовПроверки.Вставить("3",	НСтр("ru='Файл отчета поврежден';uk='Файл отчета поврежден'"));
			ПредставлениеРезультатовПроверки.Вставить("4",	НСтр("ru='Обнаружены ошибки';uk='Виявлено помилки'"));
			ПредставлениеРезультатовПроверки.Вставить("5",	НСтр("ru='Проверка не выполнена';uk='Перевірка не виконана'"));
			ПредставлениеРезультатовПроверки.Вставить("6",	НСтр("ru='Обнаружены ошибки';uk='Виявлено помилки'"));
		...
		Иначе
			...
			ПредставлениеРезультатовПроверки.Вставить("0",	НСтр("ru='Ошибок не обнаружено';uk='Помилок не виявлено'"));
			ПредставлениеРезультатовПроверки.Вставить("1",	НСтр("ru='Ошибка расшифровки';uk='Ошибка расшифровки'"));
			ПредставлениеРезультатовПроверки.Вставить("2",	НСтр("ru='Неизвестный формат или файл поврежден';uk='Неизвестный формат или файл поврежден'"));
			ПредставлениеРезультатовПроверки.Вставить("3",	НСтр("ru='Обнаружены ошибки';uk='Виявлено помилки'"));
			ПредставлениеРезультатовПроверки.Вставить("4",	НСтр("ru='Есть предупреждения';uk='Є попередження'"));
