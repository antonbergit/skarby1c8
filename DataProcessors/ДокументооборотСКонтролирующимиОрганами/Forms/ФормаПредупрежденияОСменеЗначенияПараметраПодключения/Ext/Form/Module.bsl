...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ИзменившиесяРеквизитыОрганизаций.Количество() = 0 Тогда
		Отказ = Истина;
	Иначе
		Элементы.ПредупреждениеОбИзмененииПараметров.Заголовок = НСтр("ru='Изменились следующие настройки подключения: ';uk='Изменились следующие настройки подключения: '") 
