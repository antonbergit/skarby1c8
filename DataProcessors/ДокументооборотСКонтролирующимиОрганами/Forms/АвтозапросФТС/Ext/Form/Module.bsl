...
Процедура ОбновитьФорму()
	...
	Если СтатусОтправки <> ПредопределенноеЗначение("Перечисление.СтатусыОтправки.Отправлен") Тогда
		...
		Если НаКонтроле Тогда
			ЦветШрифта = Новый Цвет(255, 0, 0);
			ЗаголовокРезультата = НСтр("ru='Отчет зарегистрирован, поставлен на контроль с комментарием должностного лица на портале ФТС';uk='Отчет зарегистрирован, поставлен на контроль с комментарием должностного лица на портале ФТС'");
		...
		ИначеЕсли СтатусОтправки = ПредопределенноеЗначение("Перечисление.СтатусыОтправки.Сдан") Тогда
			...
			ЗаголовокРезультата = НСтр("ru='Отчет сдан: получен протокол, ошибок не обнаружено.';uk='Отчет сдан: получен протокол, ошибок не обнаружено.'");
		КонецЕсли;
