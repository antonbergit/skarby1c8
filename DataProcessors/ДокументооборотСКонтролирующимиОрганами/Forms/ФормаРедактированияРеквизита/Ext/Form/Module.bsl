...
Процедура КнопкаОК(Команда)
	...
	Если ИмяРеквизита = "КодРосстата" Тогда
		...
		Если СтрДлина(СокрЛП(ЗначениеРеквизита))<> 5 Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru='Код органа Росстата должен состоять из 4 цифр';uk='Код органа Росстата должен состоять из 4 цифр'"), ,"ЗначениеРеквизита");
