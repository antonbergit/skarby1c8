...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru='Не задана инструкция для показа пользователю';uk='Не задана инструкция для показа пользователю'"));
	КонецЕсли;
КонецПроцедуры
