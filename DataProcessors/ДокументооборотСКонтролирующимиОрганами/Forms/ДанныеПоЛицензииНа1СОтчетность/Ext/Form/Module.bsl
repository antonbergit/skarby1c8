...
"Действует с %2 по %3';uk='Лицензия ""%1"""
"Действует с %2 по %3'");
		...
		Если КонтекстЭДОСервер <> Неопределено Тогда 
			...
			Если СрокИстеченияЛицензии = Неопределено Тогда
				// Лицензия истекла
				СрокИстеченияЛицензии 	= НСтр("ru='Срок действия лицензии истек ';uk='Срок действия лицензии истек '") + Формат(ЛицензияДатаОкончания, "ДЛФ=D");
			Иначе
				...
				Если НачалоДня(ЛицензияДатаОкончания) - НачалоДня(ТекДата) < Месяц Тогда
					...
					СрокИстеченияЛицензии = НСтр("ru='Срок действия лицензии истекает через ';uk='Срок действия лицензии истекает через '") + СрокИстеченияЛицензии;
				Иначе
	...
	Иначе
		...
		Элементы.ИнформацияОЛицензии.Заголовок = НСтр("ru='Информация о лицензии на 1С-Отчетность отсутсвует';uk='Информация о лицензии на 1С-Отчетность отсутсвует'");
		Элементы.ИнформацияОбОкончанииСрокаДействия.Видимость = Ложь;
