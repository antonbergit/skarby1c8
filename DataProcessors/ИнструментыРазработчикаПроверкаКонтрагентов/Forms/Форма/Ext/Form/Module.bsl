...
Процедура СбросНастроек(Команда)
	...
	ПоказатьОповещениеПользователя(НСтр("ru='Проверка контрагентов';uk='Проверка контрагентов'"),,НСтр("ru='Настройки проверки контрагентов сброшены';uk='Настройки проверки контрагентов сброшены'"));
КонецПроцедуры
...
"3. Проверка не отключена. Для отключения Запустите сброс настроек повторно из неразделенной области.';uk='1. Очищены состояния контрагентов в данной области."
"2. Очищены состояния документов."
...
"Запустите сброс настроек повторно из нужной области данных.';uk='1. Очищены состояния контрагентов."
"2. Проверка отключена."
"3. Состояния документов не очищены. Данные по документам необходимо очищать из области данных."
