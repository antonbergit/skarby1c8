...
Процедура УдалитьНажатие(Элемент)
	...
	ПоказатьВопрос(ОписаниеОповещения, НСтр("ru='Удалить Ваш комментарий?';uk='Видалити Ваш коментар?'"), РежимДиалогаВопрос.ДаНет, , КодВозвратаДиалога.Да);
...
Процедура ДобавитьКомментарий(Команда)
	...
	Если ПустаяСтрока(ТекстКомментария) Тогда 
		ВызватьИсключение НСтр("ru='Поле комментарий должно быть заполнено';uk='Поле коментар повинне бути заповнене'");
	КонецЕсли;
