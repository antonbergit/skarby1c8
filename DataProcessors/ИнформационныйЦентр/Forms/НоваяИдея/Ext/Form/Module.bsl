...
Процедура ДобавитьИдею(Команда)
	...
	Если ПустаяСтрока(Наименование) Тогда 
		ВызватьИсключение НСтр("ru='Поле Наименование не должно быть пустым';uk='Поле Найменування не повинне бути порожнім'");
	КонецЕсли;
	
	Если ПустаяСтрока(Предмет) Тогда 
		ВызватьИсключение НСтр("ru='Поле Предмет не должно быть пустым';uk='Поле Предмет не повинне бути порожнім'");
	КонецЕсли;
